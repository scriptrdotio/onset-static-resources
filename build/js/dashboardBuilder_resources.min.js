...
var a=this.defaults={animation:"am-collapse",disallowToggle:!1,activeClass:"in",startCollapsed:!1,allowMultiple:!1},b=this.controller=function(b,c,d){function e(a){for(var b=i.$targets.$active,c=0;c<b.length;c++)a<b[c]&&(b[c]=b[c]-1),b[c]===i.$targets.length&&(b[c]=i.$targets.length-1)}function f(a){return-1!==i.$targets.$active.indexOf(a)}function g(a){var b=i.$targets.$active.indexOf(a);-1!==b&&i.$targets.$active.splice(b,1)}function h(a){i.$options.allowMultiple||i.$targets.$active.splice(0,1),-1===i.$targets.$active.indexOf(a)&&i.$targets.$active.push(a)}var i=this;i.$options=angular.copy(a),angular.forEach(["animation","disallowToggle","activeClass","startCollapsed","allowMultiple"],function(a){angular.isDefined(d[a])&&(i.$options[a]=d[a])});var j=/^(false|0|)$/i;angular.forEach(["disallowToggle","startCollapsed","allowMultiple"],function(a){angular.isDefined(d[a])&&j.test(d[a])&&(i.$options[a]=!1)}),i.$toggles=[],i.$targets=[],i.$viewChangeListeners=[],i.$registerToggle=function(a){i.$toggles.push(a)},i.$registerTarget=function(a){i.$targets.push(a)},i.$unregisterToggle=function(a){var b=i.$toggles.indexOf(a);i.$toggles.splice(b,1)},i.$unregisterTarget=function(a){var b=i.$targets.indexOf(a);i.$targets.splice(b,1),i.$options.allowMultiple&&g(a),e(b),i.$viewChangeListeners.forEach(function(a){a()})},i.$targets.$active=i.$options.startCollapsed?[]:[0],i.$setActive=b.$setActive=function(a){angular.isArray(a)?i.$targets.$active=a:!i.$options.disallowToggle&&f(a)?g(a):h(a),i.$viewChangeListeners.forEach(function(a){a()})},i.$activeIndexes=function(){return i.$options.allowMultiple?i.$targets.$active:1===i.$targets.$active.length?i.$targets.$active[0]:-1}};this.$get=function(){var c={};return c.defaults=a,c.controller=b,c}}).directive("bsCollapse",["$window","$animate","$collapse",function(a,b,c){return{require:["?ngModel","bsCollapse"],controller:["$scope","$element","$attrs",c.controller],link:function(a,b,c,d){var e=d[0],f=d[1];e&&(f.$viewChangeListeners.push(function(){e.$setViewValue(f.$activeIndexes())}),e.$formatters.push(function(a){if(angular.isArray(a))f.$setActive(a);else{var b=f.$activeIndexes();angular.isArray(b)?-1===b.indexOf(1*a)&&f.$setActive(1*a):b!==1*a&&f.$setActive(1*a)}return a}))}}}]).directive("bsCollapseToggle",function(){return{require:["^?ngModel","^bsCollapse"],link:function(a,b,c,d){var e=d[1];b.attr("data-toggle","collapse"),e.$registerToggle(b),a.$on("$destroy",function(){e.$unregisterToggle(b)}),b.on("click",function(){if(!c.disabled){var d=c.bsCollapseToggle&&"bs-collapse-toggle"!==c.bsCollapseToggle?c.bsCollapseToggle:e.$toggles.indexOf(b);e.$setActive(1*d),a.$apply()}})}}}).directive("bsCollapseTarget",["$animate",function(a){return{require:["^?ngModel","^bsCollapse"],link:function(b,c,d,e){function f(){var b=g.$targets.indexOf(c),d=g.$activeIndexes(),e="removeClass";angular.isArray(d)?-1!==d.indexOf(b)&&(e="addClass"):b===d&&(e="addClass"),a[e](c,g.$options.activeClass)}var g=e[1];c.addClass("collapse"),g.$options.animation&&c.addClass(g.$options.animation),g.$registerTarget(c),b.$on("$destroy",function(){g.$unregisterTarget(c)}),g.$viewChangeListeners.push(function(){f()}),f()}}}]),angular.module("mgcrea.ngStrap.aside",["mgcrea.ngStrap.modal"]).provider("$aside",function(){var a=this.defaults={animation:"am-fade-and-slide-right",prefixClass:"aside",prefixEvent:"aside",placement:"right",templateUrl:"aside/aside.tpl.html",contentTemplate:!1,container:!1,element:null,backdrop:!0,keyboard:!0,html:!1,show:!0};this.$get=["$modal",function(b){function c(c){var d=angular.extend({},a,c);return b(d)}return c}]}).directive("bsAside",["$window","$sce","$aside",function(a,b,c){return{restrict:"EAC",scope:!0,link:function(a,d,e,f){var g={scope:a,element:d,show:!1};angular.forEach(["template","templateUrl","controller","controllerAs","contentTemplate","placement","backdrop","keyboard","html","container","animation"],function(a){angular.isDefined(e[a])&&(g[a]=e[a])});var h=/^(false|0|)$/i;angular.forEach(["backdrop","keyboard","html","container"],function(a){angular.isDefined(e[a])&&h.test(e[a])&&(g[a]=!1)}),angular.forEach(["onBeforeShow","onShow","onBeforeHide","onHide"],function(b){var c="bs"+b.charAt(0).toUpperCase()+b.slice(1);angular.isDefined(e[c])&&(g[b]=a.$eval(e[c]))}),angular.forEach(["title","content"],function(c){e[c]&&e.$observe(c,function(d,e){a[c]=b.trustAsHtml(d)})}),e.bsAside&&a.$watch(e.bsAside,function(b,c){angular.isObject(b)?angular.extend(a,b):a.content=b},!0);var i=c(g);d.on(e.trigger||"click",i.toggle),a.$on("$destroy",function(){i&&i.destroy(),g=null,i=null})}}}]),angular.module("mgcrea.ngStrap.alert",["mgcrea.ngStrap.modal"]).provider("$alert",function(){var a=this.defaults={animation:"am-fade",prefixClass:"alert",prefixEvent:"alert",placement:null,templateUrl:"alert/alert.tpl.html",container:!1,element:null,backdrop:!1,keyboard:!0,show:!0,duration:!1,type:!1,dismissable:!0};this.$get=["$modal","$timeout",function(b,c){function d(d){var e={},f=angular.extend({},a,d);e=b(f),e.$scope.dismissable=!!f.dismissable,f.type&&(e.$scope.type=f.type);var g=e.show;return f.duration&&(e.show=function(){g(),c(function(){e.hide()},1e3*f.duration)}),e}return d}]}).directive("bsAlert",["$window","$sce","$alert",function(a,b,c){return{restrict:"EAC",scope:!0,link:function(a,d,e,f){var g={scope:a,element:d,show:!1};angular.forEach(["template","templateUrl","controller","controllerAs","placement","keyboard","html","container","animation","duration","dismissable"],function(a){angular.isDefined(e[a])&&(g[a]=e[a])});var h=/^(false|0|)$/i;angular.forEach(["keyboard","html","container","dismissable"],function(a){angular.isDefined(e[a])&&h.test(e[a])&&(g[a]=!1)}),angular.forEach(["onBeforeShow","onShow","onBeforeHide","onHide"],function(b){var c="bs"+b.charAt(0).toUpperCase()+b.slice(1);angular.isDefined(e[c])&&(g[b]=a.$eval(e[c]))}),a.hasOwnProperty("title")||(a.title=""),angular.forEach(["title","content","type"],function(c){e[c]&&e.$observe(c,function(d,e){a[c]=b.trustAsHtml(d)})}),e.bsAlert&&a.$watch(e.bsAlert,function(b,c){angular.isObject(b)?angular.extend(a,b):a.content=b},!0);var i=c(g);d.on(e.trigger||"click",i.toggle),a.$on("$destroy",function(){i&&i.destroy(),g=null,i=null})}}}]),angular.module("mgcrea.ngStrap.affix",["mgcrea.ngStrap.helpers.dimensions","mgcrea.ngStrap.helpers.debounce"]).provider("$affix",function(){var a=this.defaults={offsetTop:"auto",inlineStyles:!0,setWidth:!0};this.$get=["$window","debounce","dimensions",function(b,c,d){function e(e,h){function i(a,b,c){var d=j(),e=k();return d<=r?"top":null!==a?d+a<=b.top?"middle":"bottom":null!==s&&b.top+c+p>=e-s?"bottom":"middle"}function j(){return n[0]===b?b.pageYOffset:n[0].scrollTop}function k(){return n[0]===b?b.document.body.scrollHeight:n[0].scrollHeight}var l={},m=angular.extend({},a,h),n=m.target,o=!1,p=0,q=0,r=0,s=0,t=null,u=null,v=e.parent();if(m.offsetParent)if(m.offsetParent.match(/^\d+$/))for(var w=0;w<1*m.offsetParent-1;w++)v=v.parent();else v=angular.element(m.offsetParent);return l.init=function(){this.$parseOffsets(),q=d.offset(e[0]).top+p,o=m.setWidth&&!e[0].style.width,n.on("scroll",this.checkPosition),n.on("click",this.checkPositionWithEventLoop),g.on("resize",this.$debouncedOnResize),this.checkPosition(),this.checkPositionWithEventLoop()},l.destroy=function(){n.off("scroll",this.checkPosition),n.off("click",this.checkPositionWithEventLoop),g.off("resize",this.$debouncedOnResize)},l.checkPositionWithEventLoop=function(){setTimeout(l.checkPosition,1)},l.checkPosition=function(){var a=j(),b=d.offset(e[0]),c=d.height(e[0]),g=i(u,b,c);t!==g&&(t=g,"top"===g?(u=null,o&&e.css("width",""),m.inlineStyles&&(e.css("position",m.offsetParent?"":"relative"),e.css("top",""))):"bottom"===g?(u=m.offsetUnpin?-1*m.offsetUnpin:b.top-a,o&&e.css("width",""),m.inlineStyles&&(e.css("position",m.offsetParent?"":"relative"),e.css("top",m.offsetParent?"":f[0].offsetHeight-s-c-q+"px"))):(u=null,o&&e.css("width",e[0].offsetWidth+"px"),m.inlineStyles&&(e.css("position","fixed"),e.css("top",p+"px"))),e.removeClass("affix affix-top affix-bottom").addClass("affix"+("middle"!==g?"-"+g:"")))},l.$onResize=function(){l.$parseOffsets(),l.checkPosition()},l.$debouncedOnResize=c(l.$onResize,50),l.$parseOffsets=function(){var a=e[0].style.position,b=e[0].style.top;m.inlineStyles&&(e.css("position",m.offsetParent?"":"relative"),e.css("top","")),m.offsetTop&&("auto"===m.offsetTop&&(m.offsetTop="+0"),m.offsetTop.match(/^[-+]\d+$/)?(p=1*-m.offsetTop,r=m.offsetParent?d.offset(v[0]).top+1*m.offsetTop:d.offset(e[0]).top-d.css(e[0],"marginTop",!0)+1*m.offsetTop):r=1*m.offsetTop),m.offsetBottom&&(s=m.offsetParent&&m.offsetBottom.match(/^[-+]\d+$/)?k()-(d.offset(v[0]).top+d.height(v[0]))+1*m.offsetBottom+1:1*m.offsetBottom),m.inlineStyles&&(e.css("position",a),e.css("top",b))},l.init(),l}var f=angular.element(b.document.body),g=angular.element(b);return e}]}).directive("bsAffix",["$affix","$window","$timeout",function(a,b,c){return{restrict:"EAC",require:"^?bsAffixTarget",link:function(d,e,f,g){var h={scope:d,target:g?g.$element:angular.element(b)};angular.forEach(["offsetTop","offsetBottom","offsetParent","offsetUnpin","inlineStyles","setWidth"],function(a){if(angular.isDefined(f[a])){var b=f[a];/true/i.test(b)&&(b=!0),/false/i.test(b)&&(b=!1),h[a]=b}});var i;c(function(){i=a(e,h)}),d.$on("$destroy",function(){i&&i.destroy(),h=null,i=null})}}}]).directive("bsAffixTarget",function(){return{controller:["$element",function(a){this.$element=a}]}}),angular.module("mgcrea.ngStrap",["mgcrea.ngStrap.modal","mgcrea.ngStrap.aside","mgcrea.ngStrap.alert","mgcrea.ngStrap.button","mgcrea.ngStrap.select","mgcrea.ngStrap.datepicker","mgcrea.ngStrap.timepicker","mgcrea.ngStrap.navbar","mgcrea.ngStrap.tooltip","mgcrea.ngStrap.popover","mgcrea.ngStrap.dropdown","mgcrea.ngStrap.typeahead","mgcrea.ngStrap.scrollspy","mgcrea.ngStrap.affix","mgcrea.ngStrap.tab","mgcrea.ngStrap.collapse"])}(window,document),function(a,b,c){"use strict";angular.module("mgcrea.ngStrap.alert").run(["$templateCache",function(a){a.put("alert/alert.tpl.html",'<div class="alert" ng-class="[type ? \'alert-\' + type : null]"><button type="button" class="close" ng-if="dismissable" ng-click="$hide()">&times;</button> <span ng-if="title"><strong ng-bind="title"></strong>&nbsp;<span ng-bind-html="content"></span> </span><span ng-if="!title" ng-bind-html="content"></span></div>')}]),angular.module("mgcrea.ngStrap.aside").run(["$templateCache",function(a){a.put("aside/aside.tpl.html",'<div class="aside" tabindex="-1" role="dialog"><div class="aside-dialog"><div class="aside-content"><div class="aside-header" ng-show="title"><button type="button" class="close" ng-click="$hide()">&times;</button><h4 class="aside-title" ng-bind="title"></h4></div><div class="aside-body" ng-bind="content"></div><div class="aside-footer"><button type="button" class="btn btn-default" ng-click="$hide()">Close</button></div></div></div></div>')}]),angular.module("mgcrea.ngStrap.datepicker").run(["$templateCache",function(a){a.put("datepicker/datepicker.tpl.html",'<div class="dropdown-menu datepicker" ng-class="\'datepicker-mode-\' + $mode" style="max-width: 320px"><table style="table-layout: fixed; height: 100%; width: 100%"><thead><tr class="text-center"><th><button tabindex="-1" type="button" class="btn btn-default pull-left" ng-click="$selectPane(-1)"><i class="{{$iconLeft}}"></i></button></th><th colspan="{{ rows[0].length - 2 }}"><button tabindex="-1" type="button" class="btn btn-default btn-block text-strong" ng-click="$toggleMode()"><strong style="text-transform: capitalize" ng-bind="title"></strong></button></th><th><button tabindex="-1" type="button" class="btn btn-default pull-right" ng-click="$selectPane(+1)"><i class="{{$iconRight}}"></i></button></th></tr><tr ng-if="showLabels" ng-bind-html="labels"></tr></thead><tbody><tr ng-repeat="(i, row) in rows" height="{{ 100 / rows.length }}%"><td class="text-center" ng-repeat="(j, el) in row"><button tabindex="-1" type="button" class="btn btn-default" style="width: 100%" ng-class="{\'btn-primary\': el.selected, \'btn-info btn-today\': el.isToday && !el.selected}" ng-click="$select(el.date, el.disabled)" ng-disabled="el.disabled"><span ng-class="{\'text-muted\': el.muted}" ng-bind="el.label"></span></button></td></tr></tbody><tfoot><tr><td colspan="{{ rows[0].length }}"><div class="btn-group btn-group-justified" role="group"><div class="btn-group" role="group" ng-if="$hasToday"><button type="button" class="btn btn-default today" ng-click="$setToday()" ng-disabled="isTodayDisabled"><strong style="text-transform: capitalize">Today</strong></button></div><div class="btn-group" role="group" ng-if="$hasClear"><button type="button" class="btn btn-default clear" ng-click="$clear()"><strong style="text-transform: capitalize">Clear</strong></button></div></div></td></tr></tfoot></table></div>')}]),angular.module("mgcrea.ngStrap.dropdown").run(["$templateCache",function(a){a.put("dropdown/dropdown.tpl.html",'<ul tabindex="-1" class="dropdown-menu" role="menu" ng-show="content && content.length"><li role="presentation" ng-class="{divider: item.divider, active: item.active}" ng-repeat="item in content"><a role="menuitem" tabindex="-1" ng-href="{{item.href}}" ng-if="!item.divider && item.href" target="{{item.target || \'\'}}" ng-bind="item.text"></a> <a role="menuitem" tabindex="-1" href="javascript:void(0)" ng-if="!item.divider && item.click" ng-click="$eval(item.click);$hide()" ng-bind="item.text"></a></li></ul>')}]),angular.module("mgcrea.ngStrap.modal").run(["$templateCache",function(a){a.put("modal/modal.tpl.html",'<div class="modal" tabindex="-1" role="dialog" aria-hidden="true"><div class="modal-dialog"><div class="modal-content"><div class="modal-header" ng-show="title"><button type="button" class="close" aria-label="Close" ng-click="$hide()"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" ng-bind="title"></h4></div><div class="modal-body" ng-bind="content"></div><div class="modal-footer"><button type="button" class="btn btn-default" ng-click="$hide()">Close</button></div></div></div></div>')}]),angular.module("mgcrea.ngStrap.popover").run(["$templateCache",function(a){a.put("popover/popover.tpl.html",'<div class="popover" tabindex="-1"><div class="arrow"></div><h3 class="popover-title" ng-bind="title" ng-show="title"></h3><div class="popover-content" ng-bind="content"></div></div>')}]),angular.module("mgcrea.ngStrap.select").run(["$templateCache",function(a){a.put("select/select.tpl.html",'<ul tabindex="-1" class="select dropdown-menu" ng-show="$isVisible()" role="select"><li ng-if="$showAllNoneButtons"><div class="btn-group" style="margin-bottom: 5px; margin-left: 5px"><button type="button" class="btn btn-default btn-xs" ng-click="$selectAll()">{{$allText}}</button> <button type="button" class="btn btn-default btn-xs" ng-click="$selectNone()">{{$noneText}}</button></div></li><li role="presentation" ng-repeat="match in $matches" ng-class="{active: $isActive($index)}"><a role="menuitem" tabindex="-1" ng-click="$select($index, $event)"><i class="{{$iconCheckmark}} pull-right" ng-if="$isMultiple && $isActive($index)"></i> <span ng-bind="match.label"></span></a></li></ul>')}]),angular.module("mgcrea.ngStrap.tab").run(["$templateCache",function(a){a.put("tab/tab.tpl.html",'<ul class="nav" ng-class="$navClass" role="tablist"><li role="presentation" ng-repeat="$pane in $panes track by $index" ng-class="[ $isActive($pane, $index) ? $activeClass : \'\', $pane.disabled ? \'disabled\' : \'\' ]"><a role="tab" data-toggle="tab" ng-click="!$pane.disabled && $setActive($pane.name || $index)" data-index="{{ $index }}" ng-bind-html="$pane.title" aria-controls="$pane.title" href=""></a></li></ul><div ng-transclude class="tab-content"></div>')}]),angular.module("mgcrea.ngStrap.timepicker").run(["$templateCache",function(a){a.put("timepicker/timepicker.tpl.html",'<div class="dropdown-menu timepicker" style="min-width: 0px;width: auto"><table height="100%"><thead><tr class="text-center"><th><button tabindex="-1" type="button" class="btn btn-default pull-left" ng-click="$arrowAction(-1, 0)"><i class="{{ $iconUp }}"></i></button></th><th>&nbsp;</th><th><button tabindex="-1" type="button" class="btn btn-default pull-left" ng-click="$arrowAction(-1, 1)"><i class="{{ $iconUp }}"></i></button></th><th ng-if="showSeconds">&nbsp;</th><th ng-if="showSeconds"><button tabindex="-1" type="button" class="btn btn-default pull-left" ng-click="$arrowAction(-1, 2)"><i class="{{ $iconUp }}"></i></button></th></tr></thead><tbody><tr ng-repeat="(i, row) in rows"><td class="text-center"><button tabindex="-1" style="width: 100%" type="button" class="btn btn-default" ng-class="{\'btn-primary\': row[0].selected}" ng-click="$select(row[0].date, 0)" ng-disabled="row[0].disabled"><span ng-class="{\'text-muted\': row[0].muted}" ng-bind="row[0].label"></span></button></td><td><span ng-bind="i == midIndex ? timeSeparator : \' \'"></span></td><td class="text-center"><button tabindex="-1" ng-if="row[1].date" style="width: 100%" type="button" class="btn btn-default" ng-class="{\'btn-primary\': row[1].selected}" ng-click="$select(row[1].date, 1)" ng-disabled="row[1].disabled"><span ng-class="{\'text-muted\': row[1].muted}" ng-bind="row[1].label"></span></button></td><td ng-if="showSeconds"><span ng-bind="i == midIndex ? timeSeparator : \' \'"></span></td><td ng-if="showSeconds" class="text-center"><button tabindex="-1" ng-if="row[2].date" style="width: 100%" type="button" class="btn btn-default" ng-class="{\'btn-primary\': row[2].selected}" ng-click="$select(row[2].date, 2)" ng-disabled="row[2].disabled"><span ng-class="{\'text-muted\': row[2].muted}" ng-bind="row[2].label"></span></button></td><td ng-if="showAM">&nbsp;</td><td ng-if="showAM"><button tabindex="-1" ng-show="i == midIndex - !isAM * 1" style="width: 100%" type="button" ng-class="{\'btn-primary\': !!isAM}" class="btn btn-default" ng-click="$switchMeridian()" ng-disabled="el.disabled">AM</button> <button tabindex="-1" ng-show="i == midIndex + 1 - !isAM * 1" style="width: 100%" type="button" ng-class="{\'btn-primary\': !isAM}" class="btn btn-default" ng-click="$switchMeridian()" ng-disabled="el.disabled">PM</button></td></tr></tbody><tfoot><tr class="text-center"><th><button tabindex="-1" type="button" class="btn btn-default pull-left" ng-click="$arrowAction(1, 0)"><i class="{{ $iconDown }}"></i></button></th><th>&nbsp;</th><th><button tabindex="-1" type="button" class="btn btn-default pull-left" ng-click="$arrowAction(1, 1)"><i class="{{ $iconDown }}"></i></button></th><th ng-if="showSeconds">&nbsp;</th><th ng-if="showSeconds"><button ng-if="showSeconds" tabindex="-1" type="button" class="btn btn-default pull-left" ng-click="$arrowAction(1, 2)"><i class="{{ $iconDown }}"></i></button></th></tr></tfoot></table></div>')}]),angular.module("mgcrea.ngStrap.tooltip").run(["$templateCache",function(a){a.put("tooltip/tooltip.tpl.html",'<div class="tooltip in" ng-show="title"><div class="tooltip-arrow"></div><div class="tooltip-inner" ng-bind="title"></div></div>')}]),angular.module("mgcrea.ngStrap.typeahead").run(["$templateCache",function(a){a.put("typeahead/typeahead.tpl.html",'<ul tabindex="-1" class="typeahead dropdown-menu" ng-show="$isVisible()" role="select"><li role="presentation" ng-repeat="match in $matches" ng-class="{active: $index == $activeIndex}"><a role="menuitem" tabindex="-1" ng-click="$select($index, $event)" ng-bind="match.label"></a></li></ul>')}])}(window,document),function(a,b){"function"==typeof define&&define.amd?define(["angular-schema-form"],b):"object"==typeof exports?module.exports=b(require("angular-schema-form")):a.angularSchemaFormDynamicSelect=b(a.schemaForm)}(this,function(a){angular.module("schemaForm").run(["$templateCache",function(a){a.put("directives/decorators/bootstrap/strap/strapmultiselect.html",'<div ng-controller="dynamicSelectController" class="form-group {{form.htmlClass}}"\n     ng-class="{\'has-error\': hasError(), \'has-success\': hasSuccess()}">\n    <label class="control-label {{form.labelHtmlClass}}" ng-show="showTitle()">{{form.title}}</label>\n\n    <div class="form-group {{form.fieldHtmlClass}}" ng-init="populateTitleMap(form)">\n        <button type="button" class="btn btn-default" sf-changed="form" schema-validate="form" ng-model="$$value$$"\n                data-placeholder="{{form.placeholder || form.schema.placeholder || (\'placeholders.select\')}}"\n                data-html="1"\n                data-multiple="1"  data-multiple="1" data-max-length="{{form.options.inlineMaxLength}}"\n                data-max-length-html="{{form.options.inlineMaxLengthHtml}}"\n                bs-options="item.value as item.name for item in form.titleMap | selectFilter:this:$$value$$:&quot;$$value$$&quot;"\n                bs-select>\n        </button>\n        <span class="help-block">{{ (hasError() && errorMessage(schemaError())) || form.description}}</span>\n    </div>\n</div>\n'),a.put("directives/decorators/bootstrap/strap/strapselect.html",'<div ng-controller="dynamicSelectController" class="select-controller form-group {{form.htmlClass}}"\n     ng-class="{\'has-error\': hasError(), \'has-success\': hasSuccess()}">\n    <label class="control-label {{form.labelHtmlClass}}" ng-show="showTitle()">{{form.title}}</label>\n\n    <div class="form-group {{form.fieldHtmlClass}}" ng-init="populateTitleMap(form)">\n        <button ng-if="(form.options.multiple == \'true\') || (form.options.multiple == true)"\n                type="button" class="btn btn-default" sf-changed="form" schema-validate="form" ng-model="$$value$$"\n                data-placeholder="{{form.placeholder || form.schema.placeholder || (\'placeholders.select\')}}"\n                data-html="1" data-multiple="1" data-max-length="{{form.options.inlineMaxLength}}"\n                data-max-length-html="{{form.options.inlineMaxLengthHtml}}"\n                bs-options="item.value as item.name for item in form.titleMap | selectFilter:this:$$value$$:&quot;$$value$$&quot;"\n                bs-select>\n        </button>\n        <button ng-if="!((form.options.multiple == \'true\') || (form.options.multiple == true))"\n                type="button" class="btn btn-default" sf-changed="form" schema-validate="form" ng-model="$$value$$"\n                data-placeholder="{{form.placeholder || form.schema.placeholder || (\'placeholders.select\')}}"\n                data-html="1"\n                bs-options="item.value as item.name for item in form.titleMap | selectFilter:this:$$value$$:&quot;$$value$$&quot;"\n                bs-select>\n        </button>\n        <span class="help-block">{{ (hasError() && errorMessage(schemaError())) || form.description}} </span>\n    </div>\n</div>\n\n')}]),angular.module("schemaForm").run(["$templateCache",function(a){a.put("directives/decorators/bootstrap/uiselect/uiselect.html",'<div ng-controller="dynamicSelectController" class="form-group"\n     ng-class="{\'has-error\': hasError(), \'has-success\': hasSuccess(), \'has-feedback\': form.feedback !== false}"\n         ng-init="insideModel=$$value$$;">\n    <label class="control-label" ng-show="showTitle()">{{form.title}}</label>\n\n    <div class="form-group">\n        <ui-select append-to-body="true" ng-model="select_model.selected"\n                   ng-if="!(form.options.tagging||false)" theme="bootstrap" ng-disabled="form.disabled"\n                   on-select="$$value$$=$item.value" class="{{form.options.uiClass}}">\n            <ui-select-match\n                    placeholder="{{form.placeholder || form.schema.placeholder || (\'placeholders.select\' | translate)}}">\n                {{select_model.selected.name}}\n            </ui-select-match>\n            <ui-select-choices refresh="populateTitleMap(form, $select.search)"\n                               refresh-delay="form.options.refreshDelay" group-by="form.options.groupBy"\n                               repeat="item in form.titleMap | propsFilter: {name: $select.search, description: (form.options.searchDescriptions===true ? $select.search : \'NOTSEARCHINGFORTHIS\') }">\n                <div ng-bind-html="item.name | highlight: $select.search"></div>\n                <div ng-if="item.description">\n                    <span ng-bind-html="\'<small>\' + (\'\'+item.description | highlight: (form.options.searchDescriptions===true ? $select.search : \'NOTSEARCHINGFORTHIS\'))+ \'</small>\'"></span>\n                </div>\n            </ui-select-choices>\n        </ui-select>\n        <ui-select append-to-body="true" ng-controller="dynamicSelectController" ng-model="select_model.selected"\n                   ng-if="(form.options.tagging||false) && !(form.options.groupBy || false)"\n                   tagging="form.options.tagging||false" tagging-label="form.options.taggingLabel"\n                   tagging-tokens="form.options.taggingTokens"\n                   theme="bootstrap" ng-disabled="form.disabled" on-select="$$value$$=$item.value"\n                   class="{{form.options.uiClass}}">\n            <ui-select-match\n                    placeholder="{{form.placeholder || form.schema.placeholder || (\'placeholders.select\' | translate)}}">\n                {{select_model.selected.name}}&nbsp;\n                <small>{{(select_model.selected.isTag===true ? form.options.taggingLabel : \'\')}}</small>\n            </ui-select-match>\n            \x3c!--repeat code because tagging does not display properly under group by but is still useful --\x3e\n            <ui-select-choices refresh="populateTitleMap(form, $select.search))"\n                               refresh-delay="form.options.refreshDelay"\n                               repeat="item in form.titleMap | propsFilter: {name: $select.search, description: (form.options.searchDescription===true ? $select.search : \'NOTSEARCHINGFORTHIS\') }">\n                <div ng-if="item.isTag"\n                     ng-bind-html="\'<div>\' + (item.name   | highlight: $select.search) + \' \' + form.options.taggingLabel + \'</div><div class=&quot;divider&quot;></div>\'"></div>\n                <div ng-if="!item.isTag" ng-bind-html="item.name + item.isTag| highlight: $select.search"></div>\n                <div ng-if="item.description">\n                    <span ng-bind-html="\'<small>\' + (\'\'+item.description | highlight: (form.options.searchDescriptions===true ? $select.search : \'NOTSEARCHINGFORTHIS\')) + \'</small>\'"></span>\n                </div>\n            </ui-select-choices>\n        </ui-select>\n\n        \x3c!--repeat code because tagging does not display properly under group by but is still useful --\x3e\n\n        <ui-select append-to-body="true" ng-controller="dynamicSelectController" ng-model="select_model.selected"\n                   ng-if="(form.options.tagging||false) && (form.options.groupBy || false)"\n                   tagging="form.options.tagging||false" tagging-label="form.options.taggingLabel"\n                   tagging-tokens="form.options.taggingTokens"\n                   theme="bootstrap" ng-disabled="form.disabled" on-select="$$value$$=$item.value"\n                   class="{{form.options.uiClass}}">\n            <ui-select-match\n                    placeholder="{{form.placeholder || form.schema.placeholder || (\'placeholders.select\' | translate)}}">\n                {{select_model.selected.name}}&nbsp;\n                <small>{{(select_model.selected.isTag===true ? form.options.taggingLabel : \'\')}}</small>\n            </ui-select-match>\n            <ui-select-choices group-by="form.options.groupBy"\n                               refresh="populateTitleMap(form, $select.search)"\n                               refresh-delay="form.options.refreshDelay"\n                               repeat="item in form.titleMap | propsFilter: {name: $select.search, description: (form.options.searchDescription===true ? $select.search : \'NOTSEARCHINGFORTHIS\') }">\n                <div ng-if="item.isTag"\n                     ng-bind-html="\'<div>\' + (item.name  | highlight: $select.search) + \' \' + form.options.taggingLabel + \'</div><div class=&quot;divider&quot;></div>\'"></div>\n                <div ng-if="!item.isTag" ng-bind-html="item.name + item.isTag| highlight: $select.search"></div>\n                <div ng-if="item.description">\n                    <span ng-bind-html="\'<small>\' + (\'\'+item.description | highlight: (form.options.searchDescriptions===true ? $select.search : \'NOTSEARCHINGFORTHIS\')) + \'</small>\'"></span>\n                </div>\n            </ui-select-choices>\n        </ui-select>\n\n        <input type="hidden" toggle-single-model sf-changed="form" ng-model="insideModel" schema-validate="form"/>\n    <span ng-if="form.feedback !== false"\n          class="form-control-feedback"\n          ng-class="evalInScope(form.feedback) || {\'glyphicon\': true, \'glyphicon-ok\': hasSuccess(), \'glyphicon-remove\': hasError() }"></span>\n\n        <div class="help-block"\n             ng-show="(hasError() && errorMessage(schemaError())) || form.description"\n             ng-bind-html="(hasError() && errorMessage(schemaError())) || form.description"></div>\n    </div>\n</div>\n'),a.put("directives/decorators/bootstrap/uiselect/uiselectmultiple.html",'\n<div class="form-group" ng-class="{\'has-error\': hasError(), \'has-success\': hasSuccess(), \'has-feedback\': form.feedback !== false}"\n        ng-controller="dynamicSelectController" ng-init="$$value$$=$$value$$||[];uiMultiSelectInitInternalModel($$value$$)">\n  <label class="control-label" ng-show="showTitle()">{{form.title}}</label>\n  <div class="form-group">\n    <ui-select first-item-active="false" skip-focusser="true" remove-selected="true" limit="{{form.options.limit}}" multiple autofocus="true"  close-on-select="{{form.options.closeOnSelect}}" append-to-body="true" sortable-options="{{form.sortableOptions}}" ng-model="internalModel" sf-changed="form" theme="bootstrap"\n               on-select="$$value$$.push($item.value)" on-remove="$$value$$.splice($$value$$.indexOf($item.value), 1)"\n               class="{{form.options.uiClass}}">\n      <ui-select-match placeholder="{{form.placeholder || form.schema.placeholder || (\'placeholders.select\' | translate)}}">{{$item.name}}</ui-select-match>\n      <ui-select-choices first-item-active="false" skip-focusser="true" remove-selected="true" repeat="item in form.titleMap | propsFilter: {name: $select.search} | limitTo: form.options.limitTo"\n         refresh="populateTitleMap(form, $select.search)"\n         refresh-delay="form.options.refreshDelay"\n         group-by="form.options.groupBy">\n        <div ng-bind-html="item.name | highlight: $select.search"></div>\n      </ui-select-choices>\n    </ui-select>\n    <span ng-if="form.feedback !== false"\n      class="form-control-feedback"\n      ng-class="evalInScope(form.feedback) || {\'glyphicon\': true, \'glyphicon-ok\': hasSuccess(), \'glyphicon-remove\': hasError() }"></span>\n    <div class="help-block"\n      ng-show="(hasError() && errorMessage(schemaError())) || form.description"\n      ng-bind-html="(hasError() && errorMessage(schemaError())) || form.description"></div>\n  </div>\n</div>\n')}]),angular.module("schemaForm").config(["schemaFormProvider","schemaFormDecoratorsProvider","sfPathProvider",function(a,b,c){var d=function(b,d,e){if("string"===d.type&&"enum"in d){var f=a.stdFormObj(b,d,e);return f.key=e.path,f.type="strapselect",e.lookup[c.stringify(e.path)]=f,f}};a.defaults.string.unshift(d),b.addMapping("bootstrapDecorator","strapselect","directives/decorators/bootstrap/strap/strapselect.html"),b.addMapping("bootstrapDecorator","strapmultiselect","directives/decorators/bootstrap/strap/strapmultiselect.html"),b.addMapping("bootstrapDecorator","strapselectdynamic","directives/decorators/bootstrap/strap/strapselect.html"),
<<<<<<< HEAD
b.addMapping("bootstrapDecorator","strapmultiselectdynamic","directives/decorators/bootstrap/strap/strapmultiselect.html"),b.addMapping("bootstrapDecorator","uiselect","directives/decorators/bootstrap/uiselect/uiselect.html"),b.addMapping("bootstrapDecorator","uiselectmultiple","directives/decorators/bootstrap/uiselect/uiselectmultiple.html")}]).directive("toggleSingleModel",function(){return{require:"ngModel",restrict:"A",scope:{},replace:!0,controller:["$scope",function(a){a.$parent.$watch("select_model.selected",function(){void 0!=a.$parent.select_model.selected&&(a.$parent.insideModel=a.$parent.select_model.selected.value,a.$parent.ngModel.$setViewValue(a.$parent.select_model.selected.value))})}]}}).directive("multipleOn",function(){return{link:function(a,b,c){a.$watch(function(){return b.attr("multiple-on")},function(a){if("true"==a){var c=angular.element(b).scope().$$childTail;c.$isMultiple=!0,c.options.multiple=!0,c.$select.$element.addClass("select-multiple")}else angular.element(b).scope().$$childTail.$isMultiple=!1})}}}).filter("whereMulti",function(){return function(a,b,c){var d=[];return angular.isArray(c)&&void 0!==a?c.forEach(function(c){for(var e=0;e<a.length;e++)if(c==a[e][b]){d.push(a[e]);break}}):d=a,d}}).filter("propsFilter",function(){return function(a,b){var c=[],d=0;return angular.isArray(a)?a.forEach(function(a){for(var e=!1,f=Object.keys(b),g=0;g<f.length;g++){var h=f[g];if(a.hasOwnProperty(h)){var i=b[h].toLowerCase();if(0===a[h].toString().toLowerCase().indexOf(i)||-1!==a[h].toString().toLowerCase().indexOf(" "+i)&&d<150){d++,e=!0;break}}}e&&c.push(a)}):c=a,c}}),angular.module("schemaForm").controller("dynamicSelectController",["$scope","$http","$timeout",function(a,b,c){a.form.options||(a.form.options={}),a.select_model={},a.form.options.scope=a,a.triggerTitleMap=function(){console.log("listener triggered"),a.form.titleMap.push({value:"345890u340598u3405u9",name:"34095u3p4ouij"}),c(function(){a.form.titleMap.pop()})},a.initFiltering=function(b){a.form.options.filterTriggers&&a.form.options.filterTriggers.forEach(function(b){a.$parent.$watch(b,a.triggerTitleMap)}),a.localModelType=Object.prototype.toString.call(b),a.filteringInitialized=!0},a.finalizeTitleMap=function(b,c,d){if(b.titleMap=[],d&&"map"in d&&d.map){var e=d.map.nameProperty.length-1,f=d.map.separatorValue?d.map.separatorValue:" - ";c.forEach(function(a){if(a.value=a[d.map.valueProperty],"string"!=typeof d.map.nameProperty){var c="";for(var g in d.map.nameProperty)c+=a[d.map.nameProperty[g]],g!=e&&(c+=f);a.name=c}else a.name=a[d.map.nameProperty];b.titleMap.push(a)})}else c.forEach(function(a){"text"in a&&(a.name=a.text)}),b.titleMap=c;a.insideModel&&void 0===a.select_model.selected&&(a.select_model.selected=a.find_in_titleMap(a.insideModel)),a.internalModel&&(console.log("Call uiMultiSelectInitInternalModel"),a.uiMultiSelectInitInternalModel(a.externalModel))},a.clone=function(b){if(null==b||"object"!=typeof b)return b;var c=b.constructor();for(var d in b)b[d]!=a&&b.hasOwnProperty(d)&&(c[d]=a.clone(b[d]));return c},a.getCallback=function(b){if("string"==typeof b){var c=a.$parent.evalExpr(b);if("function"==typeof c)return c;throw"A callback string must match name of a function in the parent scope"}if("function"==typeof b)return b;throw"A callback must either be a string matching the name of a function in the parent scope or a direct function reference"},a.getOptions=function(b,c){return b.httpPost&&b.httpPost.optionsCallback?(newOptionInstance=a.clone(b),a.getCallback(b.httpPost.optionsCallback)(newOptionInstance,c)):b.httpGet&&b.httpGet.optionsCallback?(newOptionInstance=a.clone(b),a.getCallback(b.httpGet.optionsCallback)(newOptionInstance,c)):b},a.test=function(a){a.titleMap.pop()},a.populateTitleMap=function(c,d){if(c.schema&&"enum"in c.schema)c.titleMap=[],c.schema.enum.forEach(function(a){c.titleMap.push({value:a,name:a})});else if(c.options)if(c.options.callback)c.titleMap=a.getCallback(c.options.callback)(c.options,d),a.finalizeTitleMap(c,c.titleMap,c.options),console.log("callback items: ",c.titleMap);else{if(c.options.asyncCallback)return a.getCallback(c.options.asyncCallback)(c.options,d).then(function(b){a.finalizeTitleMap(c,b.data,c.options),console.log("asyncCallback items",c.titleMap)},function(a,b){alert("Loading select items failed(Options: '"+String(c.options)+"\nError: "+b)});if(c.options.httpPost){var e=a.getOptions(c.options,d);return b.post(e.httpPost.url,e.httpPost.parameter).then(function(b){a.finalizeTitleMap(c,b.data,e),console.log("httpPost items",c.titleMap)},function(a,b){alert("Loading select items failed (URL: '"+String(e.httpPost.url)+"' Parameter: "+String(e.httpPost.parameter)+"\nError: "+b)})}if(c.options.httpGet){var e=a.getOptions(c.options,d);return b.get(e.httpGet.url,e.httpGet.parameter).then(function(b){a.finalizeTitleMap(c,b.data,e),console.log("httpGet items",c.titleMap)},function(a,b){alert("Loading select items failed (URL: '"+String(e.httpGet.url)+"\nError: "+b)})}}else console.log("dynamicSelectController.populateTitleMap(key:"+c.key+") : No options set, needed for dynamic selects")},a.find_in_titleMap=function(b){for(i=0;i<a.form.titleMap.length;i++)if(a.form.titleMap[i].value==b)return{value:a.form.titleMap[i].value,name:a.form.titleMap[i].name}},a.uiMultiSelectInitInternalModel=function(b){console.log("$scope.externalModel: Key: "+a.form.key.toString()+" Model: "+b.toString()),a.externalModel=b,a.internalModel=[],a.form.titleMap&&void 0!==b&&angular.isArray(b)&&b.forEach(function(b){a.internalModel.push(a.find_in_titleMap(b))})}}]),angular.module("schemaForm").filter("selectFilter",[function(a){return function(a,b,c,d){if(!angular.isDefined(a)||!angular.isDefined(b.form.options)||!angular.isDefined(b.form.options.filter)||""==b.form.options.filter)return a;console.log("----- In filtering for "+b.form.key+"("+b.form.title+"), model value: "+JSON.stringify(c)+"----"),console.log("Filter:"+b.form.options.filter),b.filteringInitialized||(console.log("Initialize filter"),b.initFiltering(c));var e=[];return angular.forEach(a,function(a){b.$eval(b.form.options.filter,{item:a})?e.push(a):c&&("[object Array]"==b.localModelType&&c.indexOf(a.value)>-1?c.splice(c.indexOf(a.value),1):c==a.value&&(console.log("Setting model of type "+b.localModelType+"to null."),c=null))}),"[object Array]"!=b.localModelType||c||(console.log("Resetting model of type "+b.localModelType+" to []."),b.$eval(d+"=[]")),console.log("----- Exiting filter for "+b.form.title+"-----"),e}}])});var underscore=angular.module("underscore",[]);underscore.factory("_",["$window",function(a){return a._}]),angular.module("WsClient",["ngWebSocket","ngCookies","underscore"]).provider("wsClient",function(){var a=this,b="wss://api-onset.scriptrapps.io/",c=null,d=null,e=null,f=null,g=null,h=!1,i={},j=0,k={},l=[];this.setBaseUrl=function(a){b=a},this.setPublishChannel=function(a){c=a},this.setSubscribeChannel=function(a){console.log(a),d=a},this.getSubscribeChannel=function(){return d},this.setToken=function(a){e=a},this.setIgnoreCookie=function(a){h=a,console.log(h)};var m=function(){f=b+(e?"/"+e:"")},n=function(a){return j+=1,j>1e4&&(j=0),j},o=function(a,b){return g+"-"+(b?b+"_"+a:a)},p=function(a,b){return b?b+"_"+a:a},q=function(a,b){return g+"-"+(b?b+"_"+a:a)};this.$get=["$websocket","$cookies","$q","$rootScope","$interval","_",function(b,e,j,r,s,t){e.get("token")&&!h&&this.setToken(e.get("token")),m(),s(function(){if(w.promise&&l.length>0){var a=l[0];u.send(a),l.shift()}},500);var u=b(f),v={},w=j.defer(),x=j.defer(),y=j.defer();u.onOpen(function(){z(d)}),u.onMessage(function(a){try{var b=JSON.parse(a.data);console.log("Received message data from websocket: ",b),"connected."==b.result&&(g=b.id,w&&w.resolve()),"failure"==b.status&&"429"==b.statusCode&&(0==$("body").find(".alert-transport").length&&$("body").append('<div class="alert alert-danger alert-dismissable alert-transport" style="position: absolute; z-index: 1000; top: 0; width: 600px; left: 30%; text-align: center">You have reached you requests rate limit. For more info check the <a href="https://www.scriptr.io/documentation#documentation-ratelimitingRateLimiting" target="blank">documentation.</a><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button></div>'),console.error("You have reached your requests rate limit. For more info check the documentation. https://www.scriptr.io/documentation#documentation-ratelimitingRateLimiting")),v.data=b,B(b),C(b)}catch(b){console.log("Error when parsing message received over socket",a,b)}}),u.onClose(function(a){console.log("Socket Closed",a),y.resolve(),console.log("Trying to reconnect closed socket."),u.reconnect()}),u.onError(function(a){console.log("Socket Error",a),x.resolve()});var z=function(a){if(a)if("string"==typeof a)u.send(JSON.stringify({method:"Subscribe",params:{channel:a}}));else if("Array"==a.constructor.name)for(var b=0;b<a.length;b++)u.send(JSON.stringify({method:"Subscribe",params:{channel:a[b]}}))},A=function(a){if(a)if("string"==typeof a)u.send(JSON.stringify({method:"Unsubscribe",params:{channel:a}}));else if("Array"==a.constructor.name)for(var b=0;b<a.length;b++)u.send(JSON.stringify({method:"Unscubscribe",params:{channel:a[b]}}))},B=function(a){var b=a.id;b&&i.hasOwnProperty(b)?(console.log("Execute registered call back for received socket message.",i[b]),r.$apply(i[b].cb.resolve(a.result)),delete i[b]):console.log("No callbacks registerd for received socket message.")},C=function(a){var b=a.id;if(b&&k.hasOwnProperty("subscribeToAll")){console.log("Execute registered call back for received socket message.",k.subscribeToAll);for(var c=k.subscribeToAll,d=0;d<c.length;d++)c[d].cb(a.result)}else if(b&&k.hasOwnProperty(b)){console.log("Execute registered call back for received socket message.",k[b]);for(var c=k[b],d=0;d<c.length;d++)c[d].cb(a.result)}else console.log("No subscribers registerd for received socket message.")};return{getMessage:function(){return v},getStatus:function(){return u.readyState},subscribe:function(a,b,c){if(d){var b={time:new Date,cb:b};c&&(b.id=c),k[a]?k[a].push(b):k[a]=[b]}},unsubscribe:function(a,b,c){if(!a)return void console.log("prefix is mandatory to unsubscribe.");if(console.log("---",k[a]),d)if(!a||b||c){var e={};b&&(e.cb=b),c&&(e.id=c),k[a]=t.difference(k[a],t.where(k[a],e))}else k[a]=[];console.log("+++",k[a])},publish:function(a,b,d){var e=c;if(d&&(e=d),e){var f=j.defer(),g=n(),h=o(g,b);return i[h]={time:new Date,cb:f},a.id=h,console.log("Sending publish message",a),u.send({method:"Publish",params:{channel:e,message:JSON.stringify(a)}}),f.promise}console.log("No channel is defined, message won't be sent.",a)},call:function(a,b,c){var d=j.defer(),e={method:a,params:{body:JSON.stringify(b)}},f=n(),g=q(f,c);return i[g]={time:new Date,cb:d},e.id=p(f,c),console.log("Sending call api request over socket.",e),l.push(e),d.promise},updateSubscriptionChannel:function(b){A(a.getSubscribeChannel()),a.setSubscribeChannel(b),z(b)},updatePublishingChannel:function(b){a.setPublishChannel(b)},closeSocket:function(a){a?u.close(a):u.close(!1)},onReady:w.promise,onError:x.promise,onClose:y.promise}}]}),angular.module("HttpClient",["ngCookies"]).provider("httpClient",function(){var a="",b=null,c="",d=!1;this.setBaseUrl=function(b){a=b,console.log(a)},this.setToken=function(a){b=a,console.log(b)},this.setIgnoreCookie=function(a){d=a,console.log(d)};var e=function(b){c=a+"/"+b,console.log(c)};this.$get=["$cookies","$q","$http",function(a,f,g){a.get("token")&&!d&&(b=a.get("token"));var h=function(a,b,c){return a&&a[b]||(a||(a={}),a[b]=c),a},i=function(a,d){var i=f.defer();return e(a),d.url=c,b&&(d.headers=h(d.headers,"Authorization","Bearer "+b)),g(d).then(function(a){if(a.data&&a.data.response){var b=a.data.response;"200"==b.metadata.statusCode&&"success"==b.metadata.status?"403"==b.result.status?($.removeCookie("token",{path:"/"}),window.localStorage.removeItem("user"),window.localStorage.removeItem("dataMapping"),window.localStorage.removeItem("dataStream"),window.location=onsetLoginUrl):b.result&&b.result.metadata?"200"==b.result.statusCode&&"success"==b.result.status?i.resolve(b.result.result,a):i.reject(b.result.metadata,a):i.resolve(b.result,a):i.reject(b.metadata,a)}},function(a){console.log("ERROR",a),"429"==a.status?console.error("You have reached your requests rate limit. For more info check the documentation. https://www.scriptr.io/documentation#documentation-ratelimitingRateLimiting"):"400"!=a.status&&"403"!=a.status||(window.location=onsetLoginUrl),i.reject(a)}),i.promise};return{get:function(a,b){var c={method:"GET"};return c.params=b,i(a,c)},post:function(a,b,c,d){var e={method:"POST"};return e.data=b,c&&(e.headers=c),c&&c["Content-Type"]||(e.headers=h(e.headers,"Content-Type","application/json")),d&&(e.headers["Content-Type"]=void 0,e.transformRequest=angular.identity),i(a,e)}}}]}),angular.module("Chart",["angular.morris"]),angular.element(document).ready(function(){Morris.Donut.prototype.resizeHandler=function(){return this.timeoutId=null,this.el&&this.el.width()>0&&this.el.height()>0?(this.raphael.setSize(this.el.width(),this.el.height()),this.redraw()):null},Morris.Donut.prototype.setData=function(a){var b;return this.data=a,this.values=function(){var a,c,d,e;for(d=this.data,e=[],a=0,c=d.length;a<c;a++)b=d[a],e.push(parseFloat(b.value));return e}.call(this),this.el&&this.el.width()>0&&this.el.height()>0?this.redraw():null}}),angular.module("Chart").component("scriptrChart",{bindings:{fetchFromDateParam:"@",fetchFromDateValue:"@",fetchToDateParam:"@",fetchToDateValue:"@",fetchDataInterval:"@",displayMetricValue:"@",displayMetricParam:"@",defaultMetricValue:"@",defaultMetricParam:"@",availableUnits:"<?",onLoad:"&onLoad",resize:"<?",data:"<?",type:"@",xkey:"@",ykeys:"<?",stacked:"<?",labels:"<?",api:"@",transport:"@",msgTag:"@",apiParams:"<?",onFormatData:"&",lineWidth:"@",pointSize:"@",pointFillColors:"@",pointStrokeColors:"@",ymax:"@",ymin:"@",smooth:"@",hideHover:"@",parseTime:"@",units:"@",postUnits:"@",preUnits:"@",xlabels:"@",xlabelAngle:"<?",goals:"@",goalStrokeWidth:"@",goalLineColors:"@",customGoals:"<?",events:"@",eventStrokeWidth:"@",eventLineColors:"@",customEvents:"<?",continuousLine:"@",axes:"@",grid:"@",gridTextColor:"@",gridTextSize:"@",gridTextFamily:"@",gridTextWeight:"@",fillOpacity:"@",resize:"@",behaveLikeLine:"@",labelColor:"@",donutFormatter:"&",backgroundColor:"@",hoverCallback:"&?",dateFormat:"&?",xlabelFormat:"&?",ylabelFormat:"&?",colorsMapping:"<?",showLegend:"@"},templateUrl:"/UIComponents/dashboard/frontend/components/chart/chart.html",controller:["$rootScope","httpClient","wsClient","$scope","$timeout",function(a,b,c,d,e){var f=this;f.showSelectStream=!f.api,this.$onInit=function(){if(this.apiParams=this.apiParams?this.apiParams:[],void 0===this.api&&void 0===this.msgTag&&(this.data&&0==this.data.length||null==this.data)&&(this.noResults=!0),this.displayMetricParam=this.displayMetricParam?this.displayMetricParam:"display_metric",this.displayMetricValue=a.currentDashboardUnit,this.defaultMetricParam=this.defaultMetricParam?this.defaultMetricParam:"default_metric",this.defaultMetricValue=this.defaultMetricValue?this.defaultMetricValue:null,this.defaultMetricValue&&this.displayMetricValue&&this.defaultMetricValue!=this.displayMetricValue&&this.availableUnits&&Object.keys(this.availableUnits).length>=2&&this.runMetricTransformation(),this.customGoals=this.customGoals?this.customGoals:[{"goal-line-colors":"#666633",goals:""},{"goal-line-colors":"#999966",goals:""},{"goal-line-colors":"#cc6666",goals:""},{"goal-line-colors":"#663333",goals:""}],this.goalLineColors=[],this.goals=[],this.customGoals&&this.customGoals.length>0)for(x=0;x<this.customGoals.length;x++)this.customGoals[x]["goal-line-colors"]&&this.customGoals[x].goals&&(this.goalLineColors.push(this.customGoals[x]["goal-line-colors"]),this.goals.push(this.customGoals[x].goals));if(this.customEvents=this.customEvents?this.customEvents:[{"event-line-colors":"#666633",events:""},{"event-line-colors":"#999966",events:""},{"event-line-colors":"#cc6666",events:""},{"event-line-colors":"#663333",events:""}],this.eventLineColors=[],this.events=[],this.customEvents&&this.customEvents.length>0)for(x=0;x<this.customEvents.length;x++)this.customEvents[x]["event-line-colors"]&&this.customEvents[x].events&&(this.eventLineColors.push(this.customEvents[x]["event-line-colors"]),this.events.push(this.customEvents[x].events));if(this.colors=this.colors?this.colors:["#aa241d","#edcfce"],this.colorsMapping&&(this.colors=_.pluck(this.colorsMapping,"colors")),this.colorsMapping?this.labels=_.pluck(this.colorsMapping,"labels"):this.labels=["Serie A","Serie B"],this.colorsMapping?this.ykeys=_.pluck(this.colorsMapping,"ykeys"):this.ykeys=this.ykeys?this.ykeys:["a","b"],this.stacked=!!this.stacked&&this.stacked,this.resize=!this.resize||this.resize,this.labelColor=this.labelColor?this.labelColor:"#eee",this.backgroundColor=this.backgroundColor?this.backgroundColor:"#fff",this.transport=this.transport?this.transport:"wss",this.msgTag=this.msgTag?this.msgTag:null,this.showLegend=null!=this.showLegend&&"true"==this.showLegend,this.showLegend){this.ref=d.$id,this.legendStructure=[];for(var b=0;b<this.ykeys.length;b++){var c={};c.key=this.ykeys[b],this.labels&&this.labels[b]?c.label=this.labels[b]:c.label=this.ykeys[b],this.colors&&this.colors[b]&&(c.color=this.colors[b]),this.legendStructure.push(c)}}this.fetchFromDateParam=this.fetchFromDateParam?this.fetchFromDateParam:"from_date",this.fetchToDateParam=this.fetchToDateParam?this.fetchToDateParam:"to_date",this.fetchToDateValue=this.fetchToDateValue?this.fetchToDateValue:null,this.fetchFromDateValue=this.fetchFromDateValue?this.fetchFromDateValue:null,this.fetchFromDateValue&&(this.apiParams[this.fetchFromDateParam]=this.fetchFromDateValue),this.fetchToDateValue&&(this.apiParams[this.fetchToDateParam]=this.fetchToDateValue),this.delta=!1},this.hoverCallback=function(a,b,c,e){f.datas&&_.mapObject(e,function(a,b){var e=_.findIndex(d.$ctrl.legendStructure,{key:"donut"!=f.type?b:a});if(-1!=e){d.$ctrl.legendStructure[e].value="donut"==f.type?c:a;var g=document.getElementById("value_"+e+"_"+f.ref);g&&(g.innerHTML="donut"==f.type?c:a)}})},this.runMetricTransformation=function(){if("si"!=this.defaultMetricValue)var a=this.availableUnits.us,b=this.availableUnits.si;else var a=this.availableUnits.si,b=this.availableUnits.us;if(this.customGoals)for(var c=0;c<this.customGoals.length;c++){var d=this.customGoals[c].goals;this.customGoals[c].goals=getConversionFunction(a,b)(d)}},this.$postLink=function(){g(this.transport),this.data&&!this.api?(f.timeout=!1,e(function(){f.consumeData(f.data)},2e3)):f.timeout=!0,d.$watch(function(a){if(a.$ctrl.data&&1==f.timeout)return a.$ctrl.data},function(a){a&&(f.datas=a,f.noResults=!1)})},this.$onDestroy=function(){console.log("destory chart",f.msgTag,d.$id),f.msgTag&&c.unsubscribe(f.msgTag,null,d.$id),f.refreshTimer&&e.cancel(f.refreshTimer)};var g=function(a){"wss"==a?c.onReady.then(function(){f.msgTag&&c.subscribe(f.msgTag,f.consumeData.bind(f),d.$id),f.api&&c.call(f.api,f.apiParams,f.msgTag).then(function(b,c){f.showSelectStream=!1,f.fetchDataInterval&&!f.refreshTimer&&(f.refreshTimer=e(function(){f.apiParams[f.fetchFromDateParam]=f.fetchToDateValue,f.apiParams[f.fetchToDateParam]=(new Date).getTime(),"donut"!=f.type&&(f.delta=!0),g.bind(f)(a)},1e3*f.fetchDataInterval),f.refreshTimer.then(function(){f.refreshTimer=null,console.log("Timer run resolved!",Date.now())},function(){f.refreshTimer=null,console.log("Timer run rejected!",Date.now())})),f.consumeData(b)},function(a){console.log("reject published promise",a),f.consumeData()})}):"https"==a&&f.api&&b.get(f.api,f.apiParams).then(function(a,b){f.consumeData(a)},function(a){console.log("reject published promise",a),f.consumeData()})};this.consumeData=function(a,b){f.timeout=!0,"function"==typeof f.onFormatData()&&(a=f.onFormatData()(a)),a&&a.length>0&&"object"==typeof a?this.fetchDataInterval&&this.fetchDataInterval>0&&this.datas&&this.delta?this.datas=this.datas.concat(a):(this.datas=a,this.noResults=!1):this.api&&0==a.length&&(!this.datas||this.datas&&0==this.datas.length||_.isEqual(this.datas,this.data))&&(this.datas=[],this.noResults=!0)}}]}),angular.module("Odometer",["ui.odometer"]),angular.module("Odometer").component("scriptrOdometer",{bindings:{displayMetricValue:"@",displayMetricParam:"@",onLoad:"&onLoad",api:"@",enableResize:"<?",theme:"@",duration:"@",animation:"@",transport:"@",odometerValue:"<?",data:"<?",msgTag:"@",apiParams:"<?",size:"<?",onFormatData:"&",fetchDataInterval:"@"},templateUrl:"/UIComponents/dashboard/frontend/components/odometer/odometer.html",controller:["$scope","httpClient","wsClient","$element","$window","$timeout",function(a,b,c,d,e,f){var g=this;g.noResults=!1,g.showSelectStream=!g.api,this.$onInit=function(){this.config={duration:this.duration?this.duration:1e3,animation:this.animation?this.animation:"count",theme:this.theme?this.theme:"car"},this.odometerOptions=this.config,this.odometerValue=this.odometerValue?this.odometerValue:this.data?this.data:0,this.size=this.size?this.size:1,this.enableResize=void 0===this.enableResize||this.enableResize,this.style={},this.style["font-size"]=this.size+"em",angular.element(e).on("resize",function(){return null!=g.timeoutId&&f.cancel(g.timeoutId),g.timeoutId=f(g.resize,100)}),this.transport=this.transport?this.transport:"wss",this.msgTag=this.msgTag?this.msgTag:null,this.fetchDataInterval=this.fetchDataInterval?parseInt(this.fetchDataInterval):null,this.displayMetricParam=this.displayMetricParam?this.displayMetricParam:"display_metric",this.displayMetricValue=this.displayMetricValue?this.displayMetricValue:null,this.displayMetricValue&&(this.apiParams[this.displayMetricParam]=this.displayMetricValue),h(this.transport)},g.resize=function(){g.timeoutId=null,g.enableResize&&(g.style["margin-top"]=g.noResults?0:d.parent().outerHeight(!0)/2-$(d.children()[0]).innerHeight()/2)},this.$postLink=function(){f(g.resize,100),null!=g.timeoutId&&f.cancel(g.timeoutId),g.timeoutId=f(g.resize,100),g.refreshTimer&&f.cancel(g.refreshTimer)},this.$onDestroy=function(){angular.element(e).off("resize"),g.msgTag&&c.unsubscribe(g.msgTag,null,a.$id),g.refreshTimer&&f.cancel(g.refreshTimer),console.log("destory odometer")};var h=function(d){"wss"==d?c.onReady.then(function(){g.msgTag&&c.subscribe(g.msgTag,g.consumeData.bind(g),a.$id),g.api&&c.call(g.api,g.apiParams,g.msgTag).then(function(a,b){g.showSelectStream=!1,g.fetchDataInterval&&!g.refreshTimer&&(g.refreshTimer=f(function(){h.bind(g)(d)},1e3*g.fetchDataInterval),g.refreshTimer.then(function(){g.refreshTimer=null,console.log("Timer run resolved!",Date.now())},function(){g.refreshTimer=null,console.log("Timer run rejected!",Date.now())})),g.consumeData(a)},function(a){console.log("reject published promise",a),g.consumeData()})}):"https"==d&&g.api&&b.get(g.api,g.apiParams).then(function(a,b){g.consumeData(a)},function(a){console.log("reject published promise",a)})};this.consumeData=function(a,b){"function"==typeof g.onFormatData()&&(a=g.onFormatData()(a)),null!=a?(this.noResults=!1,this.odometerValue=a):this.noResults=!0,g.style["margin-top"]=g.noResults?0:d.parent().outerHeight(!0)/2-$(d.children()[0]).innerHeight()/2}}]}),angular.module("Speedometer",["meterGauge"]),angular.module("Speedometer").component("scriptrSpeedometer",{bindings:{displayMetricValue:"@",displayMetricParam:"@",onLoad:"&onLoad",gaugeRadius:"<?",theme:"@",minValue:"<?",maxValue:"<?",needleVal:"<?",data:"<?",tickSpaceMinVal:"<?",tickSpaceMajVal:"<?",gaugeUnits:"@",tickColMaj:"@",tickColMin:"@",outerEdgeCol:"@",pivotCol:"@",innerCol:"@",unitsLabelCol:"@",tickLabelCol:"@",needleCol:"@",defaultFonts:"@",api:"@",transport:"@",msgTag:"@",apiParams:"<?",onFormatData:"&"},templateUrl:"/UIComponents/dashboard/frontend/components/speedometer/speedometer.html",controller:["httpClient","wsClient","$element","$window","$scope","$compile","$timeout",function(a,b,c,d,e,f,g){var h=this;this.$onInit=function(){this.speedoConfig={},"speed"==this.theme||void 0===this.theme?(this.speedoConfig.gaugeRadius=this.gaugeRadius?this.gaugeRadius:150,this.speedoConfig.minVal=this.minValue?this.minValue:0,this.speedoConfig.maxVal=this.maxValue?this.maxValue:220,this.speedoConfig.needleVal=this.needleVal?Math.round(this.needleVal):this.data?Math.round(this.data):0,this.speedoConfig.tickSpaceMinVal=this.tickSpaceMinVal?this.tickSpaceMinVal:10,this.speedoConfig.tickSpaceMajVal=this.tickSpaceMajVal?this.tickSpaceMajVal:20,this.speedoConfig.gaugeUnits=this.gaugeUnits?this.gaugeUnits:"kmh",this.speedoConfig.tickColMaj=this.tickColMaj?this.tickColMaj:"#C64DFF",this.speedoConfig.tickColMin=this.tickColMin?this.tickColMin:"#999999",this.speedoConfig.outerEdgeCol=this.outerEdgeCol?this.outerEdgeCol:"#f4f4f4",this.speedoConfig.pivotCol=this.pivotCol?this.pivotCol:"#434a54",this.speedoConfig.innerCol=this.innerCol?this.innerCol:"#ffffff",this.speedoConfig.unitsLabelCol=this.unitsLabelCol?this.unitsLabelCol:"#C64DFF",this.speedoConfig.tickLabelCol=this.tickLabelCol?this.tickLabelCol:"#656D78",this.speedoConfig.needleCol=this.needleCol?this.needleCol:"#C64DFF",this.speedoConfig.defaultFonts=this.defaultFonts?this.defaultFonts:""):"rpm"==this.theme&&(this.speedoConfig.gaugeRadius=this.gaugeRadius?this.gaugeRadius:120,this.speedoConfig.minVal=this.minValue?this.minValue:0,this.speedoConfig.maxVal=this.maxValue?this.maxValue:1e3,this.speedoConfig.needleVal=this.needleVal?Math.round(this.needleVal):this.data?Math.round(this.data):0,this.speedoConfig.tickSpaceMinVal=this.tickSpaceMinVal?this.tickSpaceMinVal:10,this.speedoConfig.tickSpaceMajVal=this.tickSpaceMajVal?this.tickSpaceMajVal:100,this.speedoConfig.gaugeUnits=this.gaugeUnits?this.gaugeUnits:"kmh",this.speedoConfig.tickColMaj=this.tickColMaj?this.tickColMaj:"#0194D9",this.speedoConfig.tickColMin=this.tickColMin?this.tickColMin:"#999999",this.speedoConfig.outerEdgeCol=this.outerEdgeCol?this.outerEdgeCol:"#ffffff",this.speedoConfig.pivotCol=this.pivotCol?this.pivotCol:"#434A54",this.speedoConfig.innerCol=this.innerCol?this.innerCol:"#ffffff",this.speedoConfig.unitsLabelCol=this.unitsLabelCol?this.unitsLabelCol:"#0194d9",this.speedoConfig.tickLabelCol=this.tickLabelCol?this.tickLabelCol:"#656D78",this.speedoConfig.needleCol=this.needleCol?this.needleCol:"#0194d9",this.speedoConfig.defaultFonts=this.defaultFonts?this.defaultFonts:""),this.speedoConfig.speedoTag=e.$id,this.displayMetricParam=this.displayMetricParam?this.displayMetricParam:"display_metric",this.displayMetricValue=this.displayMetricValue?this.displayMetricValue:null,this.displayMetricValue&&(this.apiParams[this.displayMetricParam]=this.displayMetricValue),this.transport=this.transport?this.transport:"wss",this.msgTag=this.msgTag?this.msgTag:null},this.calculateGaugeRadius=function(){h.timeoutId=null;var a=c.parent().height(),b=c.parent().width();h.speedoConfig.gaugeRadius=0==a?b/2:b>=a?a/2:b/2},this.$postLink=function(){g(function(){console.log("Calc"),h.gaugeRadius||(h.calculateGaugeRadius(),console.log("Gauge Size",h.speedoConfig.gaugeRadius),angular.element(d).on("resize",function(){null!=h.timeoutId&&g.cancel(h.timeoutId),h.timeoutId=g(h.calculateGaugeRadius,100)})),h.renderGauge(),e.$watch(function(a){return a.$ctrl.needleVal&&(h.speedoConfig.needleVal=a.$ctrl.needleVal),JSON.stringify(h.speedoConfig)},function(a){h.renderGauge()}),i(h.transport)},500)},this.$onDestroy=function(){this.gaugeRadius||angular.element(d).off("resize"),h.msgTag&&b.unsubscribe(h.msgTag,null,e.$id),console.log("destory speedo")},this.renderGauge=function(){angular.element(c).html(""),this.speedo=angular.element(document.createElement("meter-gauge")),this.speedo.attr("gaugeconfig",JSON.stringify(this.speedoConfig));var a=f(this.speedo)(e);angular.element(c).append(a)};var i=function(c){console.log("Gauge Size",h.speedoConfig.gaugeRadius),"wss"==c?b.onReady.then(function(){h.msgTag&&b.subscribe(h.msgTag,h.consumeData.bind(h),e.$id),h.api&&b.call(h.api,h.apiParams,h.msgTag).then(function(a,b){h.consumeData(a)},function(a){console.log("reject published promise",a),h.consumeData()})}):"https"==c&&h.api&&a.get(h.api,h.apiParams).then(function(a,b){h.consumeData(a)},function(a){console.log("reject published promise",a)})};this.consumeData=function(a,b){"function"==typeof h.onFormatData()&&(a=h.onFormatData()(a)),a=parseInt(a),a="number"==typeof a&&"NaN"!=a.toString()?a:0,this.speedoConfig.needleVal=Math.round(a)}}]}),angular.module("SearchBox",["angularBootstrapNavTree"]).component("scriptrSearchbox",{bindings:{treeControl:"<?",calculatedChannels:"<?",treeData:"<?",searchText:"@",iconLeaf:"@",paramName:"@",iconExpand:"@",iconCollapse:"@",onSelect:"&onSelect",expandLevel:"@",initialSelection:"@",apiParams:"<?",loadTree:"<?",treeSearchCriteria:"@",transport:"@",api:"@",onFormatData:"&",childrenTag:"@",labelTag:"@",widgetsConfig:"<?"},templateUrl:"/UIComponents/dashboard/frontend/components/searchBox/searchBox.html",controller:["wsClient","$uibModal","httpClient","$timeout","$scope","scriptrService",function(a,b,c,d,e,f){var g=this;this.iconExpand=this.iconExpand?this.iconExpand:null,this.$onInit=function(){this.iconLeaf=this.iconLeaf&&"$ctrl.iconLeaf"!=this.iconLeaf?this.iconLeaf:"icon-file  glyphicon glyphicon-file  fa fa-file",this.iconExpand=this.iconExpand&&"$ctrl.iconExpand"!=this.iconExpand?this.iconExpand:"icon-plus  glyphicon glyphicon-plus  fa fa-plus",this.iconCollapse=this.iconCollapse&&"$ctrl.iconCollapse"!=this.iconCollapse?this.iconCollapse:"icon-minus glyphicon glyphicon-minus fa fa-minus",this.paramName=this.paramName?this.paramName:"criteria",this.searchText=this.searchText?this.searchText:"Type to search",this.treeData=this.treeData?this.treeData:[],this.iconLeaf=this.iconLeaf?this.iconLeaf:null,this.transport=this.transport?this.transport:"wss",this.loadTree&&(this.searching=!0,this.loadCalculatedChannels(),h(this.transport))},this.deleteCalculatedChannel=function(a){b.open({animation:!0,component:"confirmationModal",backdrop:"static",size:"md",scope:e,resolve:{data:function(){return{title:"Delete this Calculated Channel?",body:'Are you sure you want to delete this Calculated Channel "'+a+'"?',btnCancelTitle:"Cancel",btnSubmitTitle:"Delete"}}}}).result.then(function(b){b&&f.deleteCalculatedChannel({calculatedChannelName:a}).then(function(a,b){"success"==a.status?(g.showAlert("success","The Calculated Channel was deleted successfully."),g.calculatedChannels=a.documents):g.showAlert("danger","The Calculated Channel could not be deleted.")},function(a){g.loading=!1,console.log("reject published promise",a)})},function(){console.info("modal-component for removing Calculated Channel dismissed at: "+new Date)})},this.editCalculatedChannel=function(a){f.getCalculatedChannelDocument({calculatedChannelName:a}).then(function(a,c){if(a){var d={},h=a.documents[0];d.key=h.key,d.calculatedChannelName=h.calculatedChannelName,d.calculatedChannelFormula=h.selectedFormula;var i=JSON.parse(h.params);for(var j in i)d[j]=i[j];b.open({animation:!0,component:"calculatedChannel",backdrop:"static",size:"lg",scope:e,resolve:{model:function(){return d}}}).result.then(function(a){f.loadCalculatedChannels({}).then(function(a,b){a?(g.calculatedChannels=a,0==a.length&&(g.noCalculatedChannels=!0)):console.log("Problem With API")},function(a){g.loading=!1,console.log("reject published promise",a)})},function(){console.info("modal-component for Calculated channel update dismissed at: "+new Date)})}},function(a){g.loading=!1,console.log("reject published promise",a)})},this.createCalculatedChannel=function(){var a=this;b.open({animation:!0,component:"calculatedChannel",backdrop:"static",size:"lg",scope:e}).result.then(function(b){f.loadCalculatedChannels({}).then(function(b,c){b?(a.calculatedChannels=b,0==b.length&&(a.noCalculatedChannels=!0)):console.log("Problem With API")},function(b){a.loading=!1,
console.log("reject published promise",b)})},function(){console.info("modal-component for Calculated channel update dismissed at: "+new Date)})},this.onFilterChanged=function(){if(null!=this.searchValue&&""!=this.searchValue){this.searching=!0;for(var a=angular.copy(this.originalData),b=[],c=0;c<a.length;c++){var d=a[c],e=d.sensors;if(-1==d.label.toLowerCase().indexOf(this.searchValue.toLowerCase())){for(var f=!1,g=[],h=0;h<e.length;h++){-1==e[h].label.toLowerCase().indexOf(this.searchValue.toLowerCase())?g.push(h):f=!0}for(var i=g.length-1,h=i;h>=0;h--)e.splice(g[h],1);f||b.push(c)}}for(var i=b.length-1,c=i;c>=0;c--)a.splice(b[c],1)}else a=angular.copy(this.originalData);this.consumeData(a,null,!0)},this.loadCalculatedChannels=function(){f.loadCalculatedChannels({}).then(function(a,b){a?(g.calculatedChannels=a,0==a.length&&(g.noCalculatedChannels=!0)):console.log("No Calculated Channels Found")},function(a){g.loading=!1,console.log("reject published promise",a)})};var h=function(b){var d={};if(g.apiParams)for(var e in g.apiParams)d[e]=g.apiParams[e];"wss"==b?a.onReady.then(function(){a.subscribe(g.msgTag,g.consumeData.bind(g)),g.api&&a.call(g.api,d,g.msgTag).then(function(a,b){g.consumeData(a)},function(a){console.log("reject published promise",a),g.consumeData()})}):"https"==b&&g.api&&c.get(g.api,d).then(function(a,b){},function(a){g.consumeData(),console.log("reject published promise",a)})};this.closeAlert=function(){this.show=!1},this.showAlert=function(a,b){this.closeAlert(),this.message={type:a,content:b},this.show=!0},this.consumeData=function(a,b,c){if("function"==typeof g.onFormatData()&&(a=g.onFormatData()(a)),!c&&a&&"string"!=typeof a){window.localStorage.setItem("dataStream",JSON.stringify(a.dataStream)),window.localStorage.setItem("dataMapping",JSON.stringify(a.dataMapping)),a=a.dataStream;for(var d=g.widgetsConfig,e={},f=0;f<d.length;f++)e[d[f].name]=d[f];for(var h=0;h<a.length;h++)if(a[h].sensors)for(var i=0;i<a[h].sensors.length;i++)if(!a[h].sensors[i].hide){var j=a[h].sensors[i].sectionData,k=angular.copy(e[j]),l=a[h].sensors[i].measurement_type;l=l.split(" ").join("_"),k.selectedStreamValue=a[h].sensors[i].selectedStreamValue,k.selectedStreamUnits=a[h].sensors[i].selectedStreamUnits,a[h].sensors[i].fieldName&&(k.selectedStreamFieldName=a[h].sensors[i].fieldName),k.selectedStreamLabel=a[h].sensors[i].label,a[h].sensors[i].sectionData=JSON.stringify(k),e[j].imgSrc&&(a[h].sensors[i].imgSrc=e[j].imgSrc)}}"object"==typeof a&&a.length>0?(this.treeData=a,this.noResults=!1):(this.treeData=[],this.noResults=!0),this.originalData||(this.originalData=angular.copy(this.treeData)),this.searching=!1}}]}),angular.module("Gauge",["frapontillo.gage"]),angular.module("Gauge").component("scriptrGauge",{bindings:{displayMetricValue:"@",displayMetricParam:"@",defaultMetricValue:"@",defaultMetricParam:"@",availableUnits:"<?",onLoad:"&onLoad",api:"@",transport:"@",msgTag:"@",apiParams:"<?",valueFontColor:"@",min:"@",max:"@",hideMinMax:"@",hideValue:"@",showInnerShadow:"<?",gaugeColor:"@",gaugeValue:"<?",data:"<?",customSectors:"<?",shadowSize:"@",shadowOpacity:"@",label:"@",labelFontColor:"@",startAnimationType:"@",refreshAnimationType:"@",valueFontFamily:"@",relativeGaugeSize:"@",valueMinFontSize:"@",hideMinMax:"@",labelMinFontSize:"@",minLabelMinFontSize:"@",maxLabelMinFontSize:"@",gaugeWidthScale:"@",shadowVerticalOffset:"@",levelColors:"@",noGradient:"@",startAnimationTime:"@",refreshAnimationTime:"@",donut:"@",donutStartAngle:"@",reverse:"@",decimals:"@",symbol:"@",formatNumber:"@",humanFriendly:"@",humanFriendlyDecimal:"@",textRenderer:"&",onAnimationEnd:"&",pointer:"<?",onFormatData:"&",heightUnit:"@",counter:"@",width:"@",height:"@",fetchDataInterval:"@"},templateUrl:"/UIComponents/dashboard/frontend/components/gauge/gauge.html",controller:["$rootScope","$scope","httpClient","wsClient","$timeout",function(a,b,c,d,e){var f=this;f.noResults=!1,f.showSelectStream=!f.api,this.$onInit=function(){this.apiParams=this.apiParams?this.apiParams:[],this.gaugeValue?this.consumeData(this.gaugeValue):this.data&&this.consumeData(this.data),this.heightUnit=this.heightUnit?this.heightUnit:"px",this.displayMetricParam=this.displayMetricParam?this.displayMetricParam:"display_metric",this.displayMetricValue=a.currentDashboardUnit,this.defaultMetricParam=this.defaultMetricParam?this.defaultMetricParam:"default_metric",this.defaultMetricValue=this.defaultMetricValue?this.defaultMetricValue:null,this.customSectors=this.customSectors?this.customSectors:{percents:!0,ranges:[{color:"#A3CD3B",lo:0,hi:25},{color:"#FF4A43",lo:25,hi:100}]},this.defaultMetricValue&&this.displayMetricValue&&this.defaultMetricValue!=this.displayMetricValue&&this.availableUnits&&Object.keys(this.availableUnits).length>=2&&this.runMetricTransformation(),this.heightUnit=this.heightUnit?this.heightUnit:"px",this.valueFontColor=this.valueFontColor?this.valueFontColor:"#999",this.min=this.min?this.min:0,this.gaugeMax=this.max?this.max:100,this.hideMinMax=!!this.hideMinMax&&this.hideMinMax,this.hideValue=!!this.hideValue&&this.hideValue,this.gaugeColor=this.gaugeColor?this.gaugeColor:"#e9e9e9",this.shadowSize=this.shadowSize?this.shadowSize:0,this.label=this.label?this.label:"",this.labelFontColor=this.labelFontColor?this.labelFontColor:"#666",this.startAnimationType=this.startAnimationType?this.startAnimationType:"linear",this.refreshAnimationType=this.refreshAnimationType?this.refreshAnimationType:"linear",this.counter=!this.counter||this.counter,this.transport=this.transport?this.transport:"wss",this.msgTag=this.msgTag?this.msgTag:null,this.fetchDataInterval=this.fetchDataInterval?parseInt(this.fetchDataInterval):null,this.symbol=this.availableUnits?this.availableUnits[this.displayMetricValue]:this.symbol?this.symbol:"",g(this.transport)},this.runMetricTransformation=function(){if("si"!=this.defaultMetricValue)var a=this.availableUnits.us,b=this.availableUnits.si;else var a=this.availableUnits.si,b=this.availableUnits.us;if(this.customSectors)for(var c=0;c<this.customSectors.ranges.length;c++){var d=this.customSectors.ranges[c].lo,e=this.customSectors.ranges[c].hi;this.customSectors.ranges[c].lo=getConversionFunction(a,b)(d),this.customSectors.ranges[c].hi=getConversionFunction(a,b)(e)}this.min=parseFloat(getConversionFunction(a,b)(this.min)).toFixed(0),this.gaugeMax=parseFloat(getConversionFunction(a,b)(this.max)).toFixed(0)},this.$onDestroy=function(){console.log("destory gauge"),f.msgTag&&d.unsubscribe(f.msgTag,null,b.$id),f.refreshTimer&&e.cancel(f.refreshTimer)};var g=function(a){"wss"==a?d.onReady.then(function(){f.msgTag&&d.subscribe(f.msgTag,f.consumeData.bind(f),b.$id),f.api&&d.call(f.api,f.apiParams,f.msgTag).then(function(b,c){f.showSelectStream=!1,f.fetchDataInterval&&!f.refreshTimer&&(f.refreshTimer=e(function(){g.bind(f)(a)},1e3*f.fetchDataInterval),f.refreshTimer.then(function(){f.refreshTimer=null,console.log("Timer run resolved!",Date.now())},function(){f.refreshTimer=null,console.log("Timer run rejected!",Date.now())})),f.consumeData(b)},function(a){console.log("reject published promise",a),f.consumeData()})}):"https"==a&&f.api&&c.get(f.api,f.apiParams).then(function(a,b){f.consumeData(a)},function(a){console.log("reject published promise",a)})};this.consumeData=function(a,b){"function"==typeof this.onFormatData()&&(a=this.onFormatData()(a)),a=parseFloat(a),"number"==typeof a&&"NaN"!=a.toString()?(this.noResults=!1,a=a,this.gaugeValue=a):this.noResults=!0}}]}),angular.module("angular-scriptrui",[]).directive("ngDisplayBox",function(){return{restrict:"E",require:"ngModel",scope:{msg:"=ngModel",type:"@"},template:'<div class="alert alert-{{type}}" role="alert"><span ng-bind="msg"></span></div>',replace:!0}}),angular.module("Message",["angular-scriptrui"]),angular.module("Message").component("scriptrDisplaybox",{bindings:{data:"@",type:"@",api:"@",transport:"@",msgTag:"@",apiParams:"<?",onFormatData:"&"},templateUrl:"/UIComponents/dashboard/frontend/components/message/message.html",controller:["httpClient","wsClient",function(a,b){var c=this;this.$onInit=function(){this.data=this.data?this.data:"Waiting for info...",this.type=this.type?this.type:"info"},this.$postLink=function(){d(this.transport)};var d=function(d){"wss"==d?b.onReady.then(function(){b.subscribe(c.msgTag,c.consumeData.bind(c)),c.api&&b.call(c.api,c.apiParams,c.msgTag).then(function(a,b){c.consumeData(a)},function(a){console.log("reject published promise",a)})}):"https"==d&&c.api&&a.get(c.api,c.apiParams).then(function(a,b){c.consumeData(a)},function(a){console.log("reject published promise",a)})};this.consumeData=function(a,b){"function"==typeof c.onFormatData()&&(a=c.onFormatData()(a)),"object"==typeof a&&(a&&a.data&&"string"==typeof a.data&&(this.data=a.data),a&&a.type&&(this.type=a.type)),"string"==typeof a&&(this.data=a)}}]}),angular.module("Display",[]),angular.module("Display").component("scriptrDisplaycount",{bindings:{alarmType:"@",fetchDataInterval:"@",widgetLayout:"@",data:"@",message:"@",borderSize:"@",borderColor:"@",numberFontFamily:"@",numberFontSize:"@",numberCellSize:"@",numberFontWeight:"@",numberTextColor:"@",numberBackgroundColor:"@",numberTextAlignment:"@",messageFontFamily:"@",messageFontSize:"@",messageFontWeight:"@",messageTextColor:"@",messageBackgroundColor:"@",messageTextAlignment:"@",api:"@",enableResize:"<?",transport:"@",msgTag:"@",apiParams:"<?",onFormatData:"&"},templateUrl:"/UIComponents/dashboard/frontend/components/displayCount/displayCount.html",controller:["$scope","httpClient","wsClient","$element","$window","$timeout",function(a,b,c,d,e,f){var g=this;g.isLoading=!0,this.$onInit=function(){this.fetchDatePeriod=a.$root.period?a.$root.period:"past_day",this.apiParams=this.apiParams?this.apiParams:{},this.alarmType&&this.apiParams&&(this.apiParams.alarm_type=this.alarmType,this.apiParams.period=this.fetchDatePeriod),this.widgetLayout="vertical"==this.widgetLayout?this.widgetLayout:"horizontal",this.data=this.data?isNaN(this.data)?"0":this.data:"0",this.message=this.message?this.message:"Items",this.borderSize=this.borderSize?this.borderSize:"1",this.numberCellSize=this.numberCellSize?this.numberCellSize:"",this.borderColor=this.borderColor?this.borderColor:"#d7d7d7",this.numberFontFamily=this.numberFontFamily?this.numberFontFamily:"Arial",this.numberFontSize=this.numberFontSize?this.numberFontSize:"42",this.numberFontWeight=this.numberFontWeight?this.numberFontWeight:"600",this.numberTextColor=this.numberTextColor?this.numberTextColor:"#ffffff",this.numberTextAlignment=this.numberTextAlignment?this.numberTextAlignment:"center",this.numberBackgroundColor=this.numberBackgroundColor?this.numberBackgroundColor:"#3a87ad",this.messageFontFamily=this.messageFontFamily?this.messageFontFamily:"Arial",this.messageFontSize=this.messageFontSize?this.messageFontSize:"18",this.messageFontWeight=this.messageFontWeight?this.messageFontWeight:"600",this.messageTextColor=this.messageTextColor?this.messageTextColor:"#686868",this.messageBackgroundColor=this.messageBackgroundColor?this.messageBackgroundColor:"white",this.messageTextAlignment=this.messageTextAlignment?this.messageTextAlignment:"center",this.enableResize=void 0===this.enableResize||this.enableResize,angular.element(e).on("resize",function(){return null!=g.timeoutId&&f.cancel(g.timeoutId),g.timeoutId=f(g.resize,100)}),this.transport=this.transport?this.transport:"wss",this.msgTag=this.msgTag?this.msgTag:null,this.style={},h(this.transport),a.$watch(function(a){return a.$root.period},function(a){a&&a!=g.fetchDatePeriod&&(g.fetchDatePeriod=a,g.apiParams.period=g.fetchDatePeriod,h(g.transport))})},this.$postLink=function(){f(g.resize,100),null!=g.timeoutId&&f.cancel(g.timeoutId),g.timeoutId=f(g.resize,100),h(this.transport)},this.$onDestroy=function(){g.msgTag&&c.unsubscribe(g.msgTag,null,a.$id),g.refreshTimer&&f.cancel(g.refreshTimer)};var h=function(a){"wss"==a?c.onReady.then(function(){c.subscribe(g.msgTag,g.consumeData.bind(g)),g.api&&g.apiParams?c.call(g.api,g.apiParams,g.msgTag).then(function(b,c){g.isLoading=!1,g.fetchDataInterval&&!g.refreshTimer&&(g.refreshTimer=f(function(){h.bind(g)(a)},1e3*g.fetchDataInterval),g.refreshTimer.then(function(){g.refreshTimer=null,console.log("Timer run resolved!",Date.now())},function(){g.refreshTimer=null,console.log("Timer run rejected!",Date.now())})),g.consumeData(b)},function(a){console.log("reject published promise",a)}):g.consumeData(data)}):"https"==a&&g.api&&b.get(g.api,g.apiParams).then(function(a,b){g.consumeData(a)},function(a){console.log("reject published promise",a)})};this.consumeData=function(a,b){"function"==typeof g.onFormatData()&&(a=g.onFormatData()(a)),this.data=a,"object"==typeof a&&a&&a.data&&"string"==typeof a.data&&(this.data=a.data),"string"==typeof a&&(this.data=a)}}]}),angular.module("Thermometer",["angularThermometer"]),angular.module("Thermometer").component("scriptrThermometer",{bindings:{displayMetricValue:"@",displayMetricParam:"@",defaultMetricValue:"@",defaultMetricParam:"@",availableUnits:"<?",onLoad:"&onLoad",api:"@",value:"<?",data:"<?",step:"<?",customSectors:"<?",outOfRangeColor:"@",ticks:"<?",percent:"@",unit:"@",height:"@",transport:"@",msgTag:"@",apiParams:"<?",onFormatData:"&",fetchDataInterval:"@"},templateUrl:"/UIComponents/dashboard/frontend/components/thermometer/thermometer.html",controller:["$rootScope","$scope","$window","$element","$timeout","httpClient","wsClient","_",function(a,b,c,d,e,f,g,h){var i=this;i.showSelectStream=!i.api,this.$onInit=function(){this.apiParams=this.apiParams?this.apiParams:[],this.fetchDataInterval=this.fetchDataInterval?parseInt(this.fetchDataInterval):null,this.displayMetricParam=this.displayMetricParam?this.displayMetricParam:"display_metric",this.displayMetricValue=a.currentDashboardUnit,this.defaultMetricParam=this.defaultMetricParam?this.defaultMetricParam:"default_metric",this.defaultMetricValue=this.defaultMetricValue?this.defaultMetricValue:null,this.customSectors=this.customSectors&&this.customSectors.length>0?this.customSectors:[{color:"#005588",lo:0,hi:30},{color:"#aa241d",lo:30,hi:60},{color:"#ffa500",lo:60,hi:90}],this.customSectors&&(this.customSectors=h.reject(this.customSectors,h.isEmpty)),this.defaultMetricValue&&this.displayMetricValue&&this.defaultMetricValue!=this.displayMetricValue&&this.availableUnits&&Object.keys(this.availableUnits).length>=2&&this.runMetricTransformation(),this.outOfRangeColor=this.outOfRangeColor?this.outOfRangeColor:"#5fc100",this.value=this.value?this.value>100?100:this.value:this.data?this.data:0,this.thermoUnit=this.availableUnits?this.availableUnits[this.displayMetricValue]:this.unit?this.unit:"",this.height=this.height?this.height:"100",this.mercuryColor=this.evaluateColor(this.value),this.step=this.step?this.step:"30";var b=this.getLowestTick(),d=this.getHighestTick(),f=parseInt(b);for(this.sectors=[],this.sectors.push(f);f<d;)f+=parseInt(this.step),this.sectors.push(f);this.sectors=this.sectors?this.sectors:[0,30,60,90],this.mercuryMax=h.max(this.sectors),this.minSectorValue=h.min(this.sectors),this.ticks=[];for(var g=0;g<this.sectors.length;g++){var k={};k.tick=this.sectors[g],k.percent=(this.sectors[g]-this.minSectorValue)*this.height/(this.mercuryMax-this.minSectorValue),this.ticks.push(k)}this.transport=this.transport?this.transport:"wss",this.msgTag=this.msgTag?this.msgTag:null,this.style={},angular.element(c).on("resize",function(){return null!=i.timeoutId&&e.cancel(i.timeoutId),i.timeoutId=e(i.resize,500)}),j(this.transport)},this.runMetricTransformation=function(){if("si"!=this.defaultMetricValue)var a=this.availableUnits.us,b=this.availableUnits.si;else var a=this.availableUnits.si,b=this.availableUnits.us;if(this.customSectors)for(var c=0;c<this.customSectors.length;c++){var d=this.customSectors[c].lo,e=this.customSectors[c].hi;this.customSectors[c].lo=getConversionFunction(a,b)(d),this.customSectors[c].hi=getConversionFunction(a,b)(e)}},i.resize=function(){i.timeoutId=null,i.style["margin-top"]=i.noResults?0:d.parent().outerHeight(!0)/2-$(d.find(".tg-thermometer")).innerHeight()/2,i.style["margin-left"]=i.noResults?0:d.parent().outerWidth(!0)/2-50},this.$postLink=function(){e(i.resize,100),null!=i.timeoutId&&e.cancel(i.timeoutId),i.timeoutId=e(i.resize,100),b.$watch(function(a){return a.$ctrl.value},function(a){!isNaN(parseFloat(a))&&isFinite(a)&&(a=a>b.$ctrl.mercuryMax?b.$ctrl.mercuryMax:a,i.percent=parseInt((a-b.$ctrl.minSectorValue)*b.$ctrl.height/(b.$ctrl.mercuryMax-b.$ctrl.minSectorValue)))})},this.$onDestroy=function(){console.log("destory Thermometer"),i.msgTag&&g.unsubscribe(i.msgTag,null,b.$id),i.refreshTimer&&e.cancel(i.refreshTimer)};var j=function(a){"wss"==a?g.onReady.then(function(){i.msgTag&&g.subscribe(i.msgTag,i.consumeData.bind(i),b.$id),i.api&&g.call(i.api,i.apiParams,i.msgTag).then(function(b,c){i.showSelectStream=!1,i.fetchDataInterval&&!i.refreshTimer&&(i.refreshTimer=e(function(){j.bind(i)(a)},1e3*i.fetchDataInterval),i.refreshTimer.then(function(){i.refreshTimer=null,console.log("Timer run resolved!",Date.now())},function(){i.refreshTimer=null,console.log("Timer run rejected!",Date.now())})),i.consumeData(b)},function(a){console.log("reject published promise",a),i.consumeData()})}):"https"==a&&i.api&&f.get(i.api,i.apiParams).then(function(a,b){i.consumeData(a)},function(a){console.log("reject published promise",a)})};this.consumeData=function(a,b){"function"==typeof this.onFormatData()&&(a=this.onFormatData()(a)),null!=a?(this.noResults=!1,this.value=parseFloat(a),this.mercuryColor=this.evaluateColor(a)):this.noResults=!0,i.style["margin-top"]=i.noResults?0:d.parent().outerHeight(!0)/2-$(d.find(".tg-thermometer")).innerHeight()/2,i.style["margin-left"]=i.noResults?0:d.parent().outerWidth(!0)/2-50},this.evaluateColor=function(a){var b=i.outOfRangeColor;return h.some(i.customSectors,function(c){if(c.lo<=a&&a<=c.hi)return b=c.color,!0}),b},this.getLowestTick=function(){return h.min(h.pluck(this.customSectors,"lo"))},this.getHighestTick=function(){return h.max(h.pluck(this.customSectors,"hi"))}}]}),agGrid.initialiseAgGridWithAngular1(angular),angular.module("Grid",["agGrid","ui.bootstrap"]),angular.module("Grid").component("scriptrGrid",{bindings:{fetchDataInterval:"@",onLoad:"&onLoad",columnsDefinition:"<columnsDefinition",rowHeight:"<?",enableServerSideSorting:"<?",enableServerSideFilter:"<?",refreshOnEdit:"<?",enableColResize:"<?",pagination:"@",enableDeleteRow:"<?",fixedHeight:"<?",enableAddRow:"<?",cellEditable:"<?",enableClientSideSorting:"<?",api:"@",onInsertRowScript:"@",onDeleteRowScript:"@",transport:"@",enableClientSideFilter:"<?",rowModelType:"@",rowModelSelection:"@",rowDeselection:"<?",onSelectionChanged:"&?",rowData:"<?",suppressFilter:"<?",gridHeight:"@",paginationPageSize:"<?",paginationOverflowSize:"<?",maxConcurrentDatasourceRequests:"<?",paginationInitialRowCount:"<?",maxPagesInCache:"<?",apiParams:"<?",deleteParams:"<?",addParams:"<?",editParams:"<?",onFormatData:"&",onCellValueChanged:"&",onCellClicked:"&",msgTag:"@",class:"@",defaultCellRenderer:"&",onGridReady:"&"},templateUrl:"/UIComponents/dashboard/frontend/components/grid/grid.html",controller:["$scope","$window","$uibModal","$timeout","wsClient","dataService","$filter",function(a,b,c,d,e,f,g){var h=this;h.broadcastData=null,h.msgTag="grid",h.noData=!1,h.showSelectStream=!h.api,this.dataSource={getRows:function(a){if(null!=h.broadcastData){if(null!=h.broadcastData.api)var b=h.broadcastData.api;else var b=h.api;if(null!=h.broadcastData.params&&(h.apiParams=h.broadcastData.params),null!=h.broadcastData.transport)var c=h.broadcastData.transport;else var c=h.transport}else var b=h.api,c=h.transport;var d=h.buildParams(a),e=null;"function"==typeof h.onFormatData()&&(e=function(a){return h.onFormatData()(a)}),h.gridOptions.api.showLoadingOverlay(),f.getGridData(b,d,c,e,h.fetchDataInterval).then(function(b,c){if(h.showSelectStream=!1,b&&b.documents){var d=b.documents;0==d.length?h.noData=!0:h.noData=!1;var e=parseInt(b.count),f=h.cleanRows(d);if(a.successCallback(f,e),h.gridOptions.api.sizeColumnsToFit(),null==f||0==f.length){h.gridOptions.api.showNoRowsOverlay();angular.element(document.querySelector("#btNext")).attr("disabled","true")}else h.gridOptions.api.hideOverlay();h.gridOptions.api.hideOverlay()}else a.failCallback(),h.gridOptions.api.showNoRowsOverlay()},function(a){console.log("reject",a)})}},this.$onDestroy=function(){h.msgTag&&e.unsubscribe(h.msgTag,null,a.$id),h.refreshTimer&&d.cancel(h.refreshTimer),console.log("destory Grid")},this.cleanRows=function(a){Array.isArray(a)||(a=[a]);for(var b=!1,c=0;c<a.length;c++)for(row in a[c])if("key"!=row){b=!1;for(var d=0;d<h.gridOptions.columnDefs.length;d++)if(row==h.gridOptions.columnDefs[d].field){b=!0;break}b||delete a[c][row]}return a},this._createNewDatasource=function(){this.gridOptions.api.setDatasource(this.dataSource)},this.setGridPaginationIcons=function(){$("button[ref=btPrevious]").html('<img src="//cdn.rawgit.com/scriptrdotio/onset-static-resources/6309fad6/images/previous.png" />'),$("button[ref=btFirst]").html('<img src="//cdn.rawgit.com/scriptrdotio/onset-static-resources/6309fad6/images/first.png" />'),$("button[ref=btNext]").html('<img src="//cdn.rawgit.com/scriptrdotio/onset-static-resources/6309fad6/images/next.png" />'),$("button[ref=btLast]").html('<img src="//cdn.rawgit.com/scriptrdotio/onset-static-resources/6309fad6/images/last.png" />')},this.$onInit=function(){this.gridId=a.$id;for(var b=0;b<this.columnsDefinition.length;b++)this.columnsDefinition[b].hasOwnProperty("field")&&"date"==this.columnsDefinition[b].field&&(this.columnsDefinition[b].cellRenderer=function(a){return g("date")(a.value,"MM/dd/yyyy HH:mm")});this.gridOptions={unSortIcon:!0,icons:{sortAscending:'<i class="fa fa-sort-up" aria-hidden="true"></i>',sortDescending:'<i class="fa fa-sort-desc" aria-hidden="true"></i>',sortUnSort:'<span class="unsort-state"><i class="fa fa-angle-up" aria-hidden="true"></i><i class="fa fa-angle-down" aria-hidden="true"></i></span>'},domLayout:"autoHeight",angularCompileRows:!0,rowHeight:this.rowHeight?this.rowHeight:25,enableSorting:void 0===this.enableClientSideSorting||this.enableClientSideSorting,enableServerSideSorting:void 0===this.enableServerSideSorting||this.enableServerSideSorting,enableServerSideFilter:void 0===this.enableServerSideFilter||this.enableServerSideFilter,enableColResize:void 0!==this.enableColResize&&this.enableColResize,enableFilter:void 0!==this.enableServerSideFilter&&this.enableServerSideFilter,columnDefs:this.columnsDefinition,editType:"fullRow",pagination:void 0!==this.pagination&&this.pagination,cacheBlockSize:this.paginationPageSize?this.paginationPageSize:50,rowData:this.rowData?this.rowData:null,rowModelType:this.api?"infinite":"",rowSelection:this.rowModelSelection?this.rowModelSelection:"multiple",paginationPageSize:this.paginationPageSize?this.paginationPageSize:50,overlayLoadingTemplate:'<span class="ag-overlay-loading-center"><i class="fa fa-spinner fa-spin fa-3x"></i></span>',defaultColDef:{filterParams:{applyButton:!0,clearButton:!0},filter:"text",suppressFilter:void 0!==this.suppressFilter&&this.suppressFilter,editable:void 0===this.cellEditable||this.cellEditable,cellRenderer:"function"==typeof this.defaultCellRenderer()?this.defaultCellRenderer():null},onSelectionChanged:function(){if(null!=h.onSelectionChanged&&"function"==typeof h.onSelectionChanged())return h.onSelectionChanged()(h.gridOptions,h.gridApi)},onCellClicked:function(){if(null!=h.onCellClicked&&"function"==typeof h.onCellClicked())return h.onCellClicked()(h.gridOptions,h.gridApi)},onRowValueChanged:function(a){h.cellEditable&&(null!=h.onCellValueChanged&&"function"==typeof h.onCellValueChanged()&&h.onCellValueChanged()(h.gridOptions),"infinite"==h.gridOptions.rowModelType&&(h.api?(h.gridOptions.api.showLoadingOverlay(),h._saveData(a)):(h.undoChanges(),h.showAlert("danger","No script defined for cell edit"))))},onGridReady:function(a){if(console.log("the grid is now ready"),d(function(){h.gridOptions.api=a.api,h.gridApi=a.api},3e3),"function"==typeof h.onGridReady()&&h.onGridReady()(h),a.api.filterManager.availableFilters.text.CONTAINS="startsWith",void 0===h.rowData||null==h.rowData||h.rowData&&0==h.rowData.length?h.api?h._createNewDatasource():a.api.setRowData([]):a.api.sizeColumnsToFit(),h.columnsDefinition)for(var b=0;b<h.columnsDefinition.length;b++)h.columnsDefinition[b].hasOwnProperty("type")&&"numeric"==h.columnsDefinition[b].type&&(h.columnsDefinition[b].filter="number");h.setGridPaginationIcons()},onGridSizeChanged:function(a){for(var b=document.getElementById("grid-"+h.gridId).offsetWidth,c=[],d=[],e=0,f=h.gridOptions.columnApi.getAllColumns(),g=0;g<f.length;g++){var i=f[g];e+=i.getMinWidth(),e>b?d.push(i.colId):c.push(i.colId)}h.gridOptions.columnApi.setColumnsVisible(c,!0),h.gridOptions.columnApi.setColumnsVisible(d,!1),h.gridOptions.api.sizeColumnsToFit()}},this.fixedHeight=void 0===this.fixedHeight||this.fixedHeight,this.style={},this.fixedHeight&&(this.gridHeight=this.gridHeight?this.gridHeight:"500",this.style.clear="left",this.style.width="100%"),this.refreshOnEdit=void 0!==this.refreshOnEdit&&this.refreshOnEdit,this.transport=this.transport?this.transport:"wss",this.enableDeleteRow=1!=this.enableDeleteRow,this.enableAddRow=1!=this.enableAddRow,this.mode="infinite"==this.gridOptions.rowModelType?"infinite":"normal",h.msgTag&&f.subscribe(this.onServerCall,h.msgTag,a),a.$on("updateGridData",function(a,b){h.broadcastData=b,h._createNewDatasource()})},this.closeAlert=function(){this.show=!1},this.showAlert=function(a,b){h.message={type:a,content:b},h.showError=!0,d(function(){h.showError=!1},5e3)},this._saveData=function(a){if(a.data&&a.data.key){var b=a.data;if(b.action="edit",this.editParams)for(var c in this.editParams)b[c]=this.editParams[c];f.gridHelper(h.api,b).then(function(a,b){h.gridOptions.api.hideOverlay(),!a||"success"!=a.result&&"success"!=a.status?(h.undoChanges(),a&&a.errorDetail?h.showAlert("danger",a.errorDetail):h.showAlert("danger","An error has occured")):h.refreshOnEdit&&h.onServerCall(a)},function(a){h.gridOptions.api.hideOverlay(),console.log("reject",a),h.showAlert("danger","An error has occured")})}else{var b=a.data;if(b.action="add",this.addParams)for(var c in this.addParams)b[c]=this.addParams[c];f.gridHelper(h.api,a.data).then(function(a,b){h.gridOptions.api.hideOverlay(),!a||"success"!=a.result&&"success"!=a.status?(h.undoChanges(),a&&a.errorDetail?h.showAlert("danger",a.errorDetail):h.showAlert("danger","An error has occured")):h.refreshOnEdit&&h.onServerCall(a)},function(a){h.gridOptions.api.hideOverlay(),console.log("reject",a),h.showAlert("danger","An error has occured")})}},this.onAddRow=function(){for(var a={},b=0;b<h.gridOptions.columnDefs.length;b++)a[h.gridOptions.columnDefs[b].field]="";h.gridOptions.api.insertItemsAtIndex(0,[a]),h.gridOptions.api.setFocusedCell(0,h.gridOptions.columnDefs[0].field),h.gridOptions.api.startEditingCell({rowIndex:0,colKey:h.gridOptions.columnDefs[0].field,charPress:h.gridOptions.columnDefs[0].field})},this.openConfirmationPopUp=function(){if(h.gridOptions.api.getSelectedNodes().length>0){c.open({animation:!0,component:"deleteConfirmation",size:"md",resolve:{grid:function(){return h}}})}},this.onRemoveRow=function(a){if("infinite"==h.gridOptions.rowModelType)if(h.api){for(var b=h.gridOptions.api.getSelectedNodes(),c=[],d=0;d<b.length;d++)c.push(b[d].data.key);if(c.length>0){h.gridOptions.api.showLoadingOverlay();var e={keys:c,action:"delete"};if(this.deleteParams)for(var a in this.deleteParams)e[a]=this.deleteParams[a];f.gridHelper(h.api,e).then(function(a,b){h.gridOptions.api.hideOverlay(),!a||"success"!=a.result&&"success"!=a.status?a&&a.errorDetail?h.showAlert("danger",a.errorDetail):h.showAlert("danger","An error has occured"):h.onServerCall(a)},function(a){h.gridOptions.api.hideOverlay(),console.log("reject",a),h.showAlert("danger","An error has occured")})}}else h.showAlert("danger","No script defined for delete row");else{var b=h.gridOptions.api.getSelectedNodes();h.gridOptions.api.removeItems(b)}},this.onServerCall=function(a){h.gridOptions.api.refreshInfiniteCache()},this.undoChanges=function(a){if(h.oldEditedValue){h.gridOptions.api.forEachNode(function(a){a.childIndex!=h.editedChildIndex&&a.id!=h.editedChildIndex||a.setSelected(!0,!0)});h.gridOptions.api.getSelectedNodes()[0].data[h.editedColumn]=h.oldEditedValue,h.gridOptions.api.refreshView()}else h.gridOptions.api.refreshInfiniteCache()},this.onFilterChanged=function(){this.gridOptions.enableServerSideFilter=!1,this.gridOptions.api.setQuickFilter(this.quickFilterValue),this.gridOptions.enableServerSideFilter=!0},this.onServerFilterChanged=function(){h._createNewDatasource()},this.buildParams=function(a){var b=h.serverFilterText,c=null,d=a.endRow/this.gridOptions.paginationPageSize;if(a.sortModel&&a.sortModel.length>0){var e=a.sortModel[0].sort,f=a.sortModel[0].colId;c=this.gridOptions.api.getColumnDef(f).type?this.gridOptions.api.getColumnDef(f).type:null}if(a.filterModel)for(p in a.filterModel){b=a.filterModel[p].filter;var g=a.filterModel[p].type,i=p;c=this.gridOptions.api.getColumnDef(i).type?this.gridOptions.api.getColumnDef(i).type:null}var j={resultsPerPage:this.gridOptions.paginationPageSize,pageNumber:d};if(f&&(j.sortingColumnName=f),i&&(j.filterColumnName=i),e&&(j.sort=e),c&&(j.sortType=c),b&&(j.queryFilter=b),g&&(j.queryType=g),j.startRow=a.startRow,j.endRow=a.endRow,this.apiParams)for(var k in this.apiParams)j[k]=this.apiParams[k];return j}}]}),angular.module("Grid").service("dataService",["httpClient","wsClient","$q","$timeout",function(a,b,c,d){this.subscribe=function(a,c,d){b.onReady.then(function(){b.subscribe(c,a.bind(self),d.$id)})},this.gridHelper=function(b,d){var e=c.defer();return a.get(b,d,"grid").then(function(a,b){e.resolve(a,b)},function(a){e.reject(a)}),e.promise},this.getGridData=function(e,f,g,h,i){var j=c.defer(),k=this;return"https"==g?(a.get(e,f).then(function(a,b){if(h&&(a=h(a)),a&&a.documents){var a={documents:a.documents,count:a.count};j.resolve(a,b)}else j.resolve(null,b)},function(a){j.resolve(null),j.reject(a)}),j.promise):"wss"==g?e&&void 0!==e?(b.onReady.then(function(){b.call(e,f,"grid").then(function(a,b){if(i&&!k.refreshTimer&&(k.refreshTimer=d(function(){k.getGridData.bind(k)(e,f,g,h,i)},1e3*i),k.refreshTimer.then(function(){k.refreshTimer=null,console.log("Timer run resolved!",Date.now())},function(){k.refreshTimer=null,console.log("Timer run rejected!",Date.now())})),h&&(a=h(a)),a&&a.documents){var a={documents:a.documents,count:a.count};j.resolve(a,b)}else j.resolve(null,b)},function(a){j.resolve(null),j.reject(a)})}),j.promise):(b.onReady.then(function(){b.publish(f,"publish").then(function(a,b){if(a&&a.documents){var a={documents:a.documents,count:a.count};j.resolve(a,b)}else j.resolve(null,b)},function(a){j.resolve(null),j.reject(a)})}),j.promise):void 0}}]),angular.module("Grid").component("deleteConfirmation",{bindings:{resolve:"<",close:"&",dismiss:"&"},templateUrl:"/UIComponents/dashboard/frontend/components/grid/popup.html",controller:["$scope",function(a){this.onSubmit=function(){this.resolve.grid.onRemoveRow(),this.close({$value:!0})},this.onCancel=function(){this.dismiss({$value:!1})}}]}),angular.module("ACL",["ui.bootstrap","List"]),angular.module("ACL").component("scriptrAcl",{bindings:{users:"<?",defaultSetObject:"<?",onSave:"&"},templateUrl:"/UIComponents/dashboard/frontend/components/ACL/ACL.html",controller:["$uibModal",function(a){var b=this;this.$onInit=function(){console.log("$onInit initialized"),b.accessType=1==b.users.length&&"anonymous"==b.users[0].code?"Anonymous access":"Restricted access"},this.$postLink=function(){console.log("$postLink initialized")},this.openModal=function(){a.open({animation:!0,size:"lg",component:"aclPopup",resolve:{widget:function(){return{parent:b,users:b.users,defaultSetObject:b.defaultSetObject,onSave:b.onSave}}}}).result.then(function(a){console.log("selectedItem: "+a)
},function(){})}}]}),angular.module("ACL").component("aclPopup",{bindings:{resolve:"<",users:"<?",defaultSetObject:"<?",close:"&",dismiss:"&"},templateUrl:"/UIComponents/dashboard/frontend/components/ACL/myModalContent.html",controller:["$scope","$sce",function(a,b){var c=this;c.listScope,this.$onInit=function(){c.users=c.resolve.widget.users,c.defaultSetObject=c.resolve.widget.defaultSetObject,c.popoverContent=b.trustAsHtml("<span style='color: #323232;'><strong>Scriptr.io provides the following predefined groups:</strong><div class='mt10 mb5'><i class='fa fa-caret-right text-primary'></i> authenticated represents anyone with a valid token.</div><div class='mb5'><i class='fa fa-caret-right text-primary'></i> anonymous represents everyone.</div><div class='mb5'><i class='fa fa-caret-right text-primary'></i> nobody represents no one.</div></span>")},this.onSelect=function(a){c.resolve.modalScope=this,"anonymous"==a.originalObject[this.titleField]&&(this.disableInput=!0,this.hideObjects=!0,c.showMsg=!0)},this.removeAnonymousAccess=function(){c.showMsg=!1,c.resolve.modalScope.disableInput=!1,c.resolve.modalScope.hideObjects=!1;var b=[{code:"anonymous",icon:"fa fa-group"}];a.$broadcast("angucomplete-alt:addObjectToList",c.id,b)},this.addAnonymousAccess=function(){c.showMsg=!1,c.resolve.modalScope.disableInput=!1,c.resolve.modalScope.hideObjects=!1;for(var b=[],d=0;d<c.resolve.modalScope.objects.length;d++)"anonymous"!=c.resolve.modalScope.objects[d].code&&b.push(c.resolve.modalScope.objects[d]);a.$broadcast("angucomplete-alt:addObjectToList",c.id,b)},this.closeAlert=function(){this.show=!1},this.showAlert=function(a,b){this.closeAlert(),this.message={type:a,content:b},this.show=!0},this.updateFileACL=function(){c.listScope||(c.listScope=a.$broadcast("angucomplete-alt:getSetObjects",c.id));var b=c.listScope.targetScope.$$childTail.$ctrl;if("function"==typeof c.resolve.widget.onSave()){var d=[];if(void 0===b.objects&&(b.objects=c.resolve.modalScope.objects),b.objects.length>0)var e=b.objects;else var e=c.resolve.widget.defaultSetObject;for(var f=0;f<e.length;f++)d.push(e[f].code);b.showList=!1,c.resolve.widget.onSave()(d).then(function(a,d){b.showList=!0,c.showAlert("success","The Access Control List is saved successfully."),c.resolve.widget.parent.users=b.objects,c.resolve.widget.parent.accessType=1==b.objects.length&&"anonymous"==b.objects[0].code?"Anonymous access":"Restricted access",console.log("success")},function(a){b.showList=!0,c.showMsg("danger",a.data.response.metadata.errorDetail),console.log("reject",a)})}},this.onCancel=function(a){this.dismiss({$value:"cancel"}),console.log("Dissmisseddd")}}]}),angular.module("List",["angucomplete-alt"]).component("scriptrAutocomplete",{bindings:{id:"@",objects:"<?",hideObjects:"<?",listSelectedObject:"<?",defaultSetObject:"<?",placeholder:"@",maxlength:"@",pause:"@",selectedObject:"<?",selectedObjectData:"<?",titleField:"@",descriptionField:"@",imageField:"@",minlength:"@",inputName:"@",inputClass:"@",matchClass:"@",localData:"<?",searchFields:"@",clearSelected:"@",overrideSuggestions:"@",fieldRequired:"@",fieldRequiredClass:"@",textSearching:"@",textNoResults:"@",initialValue:"@",inputChanged:"&",autoMatch:"@",focusIn:"&",focusOut:"&",disableInput:"@",focusFirst:"@",fieldTabindex:"@",parseInput:"&",localSearch:"&",transport:"@",msgTag:"@",api:"@",onFormatData:"&"},templateUrl:"/UIComponents/dashboard/frontend/components/list/autocomplete.html",controller:["$scope","wsClient","httpClient",function(a,b,c){var d=this;this.$onInit=function(){this.localData=this.localData?this.localData:[],this.fieldRequired=void 0!==this.fieldRequired&&this.fieldRequired,this.textSearching=void 0!==this.textSearching&&this.textSearching,this.transport=this.transport?this.transport:"wss",this.objects=this.objects?this.objects:[],this.listSelectedObject&&this.objects.length>0&&!d.api&&(a.$broadcast("angucomplete-alt:setData",d.id,this.localData),a.$broadcast("angucomplete-alt:setSelectedObjects",d.id,this.objects)),d.api&&(d.showList=!1,e(this.transport))},d.addObjectToList=function(b){a.$broadcast("angucomplete-alt:addObjectToList",d.id,b),0==this.objects.length&&void 0!==this.defaultSetObject&&(this.objects=JSON.parse(JSON.stringify(this.defaultSetObject)))};var e=function(a){"wss"==a?b.onReady.then(function(){b.subscribe(d.msgTag,d.consumeData.bind(d)),d.api&&b.call(d.api,d.apiParams,d.msgTag).then(function(a,b){d.consumeData(a)})}):"https"==a&&d.api&&c.get(d.api,d.apiParams).then(function(a,b){d.consumeData(a)},function(a){console.log("reject published promise",a)})};this.consumeData=function(b,c){d.showList=!0,"function"==typeof d.onFormatData()&&(b=d.onFormatData()(b)),this.localData=b,this.listSelectedObject&&this.objects.length>0&&(a.$broadcast("angucomplete-alt:setData",d.id,this.localData),a.$broadcast("angucomplete-alt:setSelectedObjects",d.id,this.objects))}}]}),angular.module("Dygraphs",["angular-dygraphs"]),angular.module("Dygraphs").component("scriptrDygraphs",{bindings:{displayMetricValue:"@",displayMetricParam:"@",defaultMetricValue:"@",defaultMetricParam:"@",availableUnits:"<?",onLoad:"&onLoad",api:"@",transport:"@",msgTag:"@",apiParams:"<?",onFormatData:"&",resize:"<?",data:"<?",legend:"<?",drawX1Axis:"@",drawYAxis:"@",drawY2Axis:"@",colors:"<?",x1AxisLabelFontSize:"@",yAxisLabelFontSize:"@",y2AxisLabelFontSize:"@",yAxisLabelsKmb:"@",y2AxisLabelsKmb:"@",x1AxisLabelWidth:"@",yAxisLabelWidth:"@",y2AxisLabelWidth:"@",x1AxisLineColor:"@",yAxisLineColor:"@",y2AxisLineColor:"@",x1AxisLineWidth:"@",yAxisLineWidth:"@",y2AxisLineWidth:"@",x1AxisTickSize:"@",yAxisTickSize:"@",y2AxisTickSize:"@",yAxisIncludeZero:"@",y2AxisIncludeZero:"@",x1AxisLabel:"@",yAxisLabel:"@",y2AxisLabel:"@",showRangeSelector:"@",rangeSelectorAlpha:"@",rangeSelectorBackgroundLineWidth:"@",rangeSelectorBackgroundStrokeColor:"@",rangeSelectorForegroundLineWidth:"@",rangeSelectorForegroundStrokeColor:"@",rangeSelectorHeight:"@",rangeSelectorPlotFillColor:"@",rangeSelectorPlotFillGradientColor:"@",rangeSelectorPlotLineWidth:"@",rangeSelectorPlotStrokeColor:"@",goals:"<?",goalLineColors:"<?",events:"<?",eventLineColors:"<?",legendPosition:"@",showLegend:"@",x1DrawGrid:"@",yDrawGrid:"@",y2DrawGrid:"@",x1GridLineColor:"@",yGridLineColor:"@",y2GridLineColor:"@",x1GridLineWidth:"@",yGridLineWidth:"@",y2GridLineWidth:"@",legendLabels:"<?",independentTicks:"@",legendMapping:"<?",customGoals:"<?",colorsMapping:"<?",fetchFromDateParam:"@",fetchFromDateValue:"@",fetchToDateParam:"@",fetchToDateValue:"@",fetchDataInterval:"@"},templateUrl:"/UIComponents/dashboard/frontend/components/dygraphs/dygraphs.html",controller:["$rootScope","httpClient","wsClient","$scope","$timeout",function(a,b,c,d,e){var f=this;f.showSelectStream=!f.api,this.$onInit=function(){this.apiParams=this.apiParams?this.apiParams:[],void 0===this.api&&void 0===this.msgTag&&(this.data&&0==this.data.length||null==this.data)&&(this.noResults=!0),this.drawX1Axis=!this.drawX1Axis||JSON.parse(this.drawX1Axis),this.drawYAxis=!this.drawYAxis||JSON.parse(this.drawYAxis),this.drawY2Axis=!this.drawY2Axis||JSON.parse(this.drawY2Axis),this.colors=this.colors?this.colors:["#005588","#aa241d"],this.colorsMapping&&(this.colors=_.pluck(this.colorsMapping,"colors")),this.colorsMapping&&(this.legendLabels=["x"],this.legendLabels=this.legendLabels.concat(_.pluck(this.colorsMapping,"labels"))),this.colorsMapping&&(this.legendMapping=["X"],this.legendMapping=this.legendMapping.concat(_.pluck(this.colorsMapping,"axisSelection"))),this.displayMetricParam=this.displayMetricParam?this.displayMetricParam:"display_metric",this.displayMetricValue=a.currentDashboardUnit,this.defaultMetricParam=this.defaultMetricParam?this.defaultMetricParam:"default_metric",this.defaultMetricValue=this.defaultMetricValue?this.defaultMetricValue:null,this.defaultMetricValue&&this.displayMetricValue&&this.defaultMetricValue!=this.displayMetricValue&&this.availableUnits&&Object.keys(this.availableUnits).length>=2&&this.runMetricTransformation(),this.customGoals=this.customGoals?this.customGoals:[{"goal-line-colors":"#ffffff",goals:0}],this.goalLineColors=_.pluck(this.customGoals,"goal-line-colors"),this.goals=_.pluck(this.customGoals,"goals"),this.events=this.events?this.events:[],this.eventLineColors=this.eventLineColors?this.eventLineColors:["#ffffff"],this.x1AxisLabelFontSize=this.x1AxisLabelFontSize?JSON.parse(this.x1AxisLabelFontSize):14,this.yAxisLabelFontSize=this.yAxisLabelFontSize?JSON.parse(this.yAxisLabelFontSize):14,this.y2AxisLabelFontSize=this.y2AxisLabelFontSize?JSON.parse(this.y2AxisLabelFontSize):14,this.yAxisLabelsKmb=!!this.yAxisLabelsKmb&&JSON.parse(this.yAxisLabelsKmb),this.y2AxisLabelsKmb=!!this.y2AxisLabelsKmb&&JSON.parse(this.y2AxisLabelsKmb),this.x1AxisLabelWidth=this.x1AxisLabelWidth?JSON.parse(this.x1AxisLabelWidth):60,this.yAxisLabelWidth=this.yAxisLabelWidth?JSON.parse(this.yAxisLabelWidth):50,this.y2AxisLabelWidth=this.y2AxisLabelWidth?JSON.parse(this.y2AxisLabelWidth):50,this.x1AxisLineColor=this.x1AxisLineColor?this.x1AxisLineColor:"#000000",this.yAxisLineColor=this.yAxisLineColor?this.yAxisLineColor:"#000000",this.y2AxisLineColor=this.y2AxisLineColor?this.y2AxisLineColor:"#000000",this.showLegend=!this.showLegend||JSON.parse(this.showLegend),this.x1AxisLabel=this.x1AxisLabel?this.x1AxisLabel:"",this.yAxisLabel=this.yAxisLabel?this.yAxisLabel:"",this.y2AxisLabel=this.y2AxisLabel?this.y2AxisLabel:"",this.x1AxisLineWidth=this.x1AxisLineWidth?JSON.parse(this.x1AxisLineWidth):.3,this.yAxisLineWidth=this.yAxisLineWidth?JSON.parse(this.yAxisLineWidth):.3,this.y2AxisLineWidth=this.y2AxisLineWidth?JSON.parse(this.y2AxisLineWidth):.3,this.x1AxisTickSize=this.x1AxisTickSize?JSON.parse(this.x1AxisTickSize):3,this.yAxisTickSize=this.yAxisTickSize?JSON.parse(this.yAxisTickSize):3,this.y2AxisTickSize=this.y2AxisTickSize?JSON.parse(this.y2AxisTickSize):3,this.yAxisIncludeZero=!!this.yAxisIncludeZero&&JSON.parse(this.yAxisIncludeZero),this.y2AxisIncludeZero=!!this.y2AxisIncludeZero&&JSON.parse(this.y2AxisIncludeZero),this.showRangeSelector=!!this.showRangeSelector&&JSON.parse(this.showRangeSelector),this.rangeSelectorAlpha=this.rangeSelectorAlpha?JSON.parse(this.rangeSelectorAlpha):.6,this.rangeSelectorBackgroundLineWidth=this.rangeSelectorBackgroundLineWidth?JSON.parse(this.rangeSelectorBackgroundLineWidth):1,this.rangeSelectorBackgroundStrokeColor=this.rangeSelectorBackgroundStrokeColor?this.rangeSelectorBackgroundStrokeColor:"#808080",this.rangeSelectorForegroundLineWidth=this.rangeSelectorForegroundLineWidth?JSON.parse(this.rangeSelectorForegroundLineWidth):1,this.rangeSelectorForegroundStrokeColor=this.rangeSelectorForegroundStrokeColor?this.rangeSelectorForegroundStrokeColor:"#000000",this.rangeSelectorHeight=this.rangeSelectorHeight?JSON.parse(this.rangeSelectorHeight):40,this.rangeSelectorPlotFillColor=this.rangeSelectorPlotFillColor?this.rangeSelectorPlotFillColor:"#A7B1C4",this.rangeSelectorPlotFillGradientColor=this.rangeSelectorPlotFillGradientColor?this.rangeSelectorPlotFillGradientColor:"#FFFFFF",this.rangeSelectorPlotLineWidth=this.rangeSelectorPlotLineWidth?JSON.parse(this.rangeSelectorPlotLineWidth):1.5,this.rangeSelectorPlotStrokeColor=this.rangeSelectorPlotStrokeColor?this.rangeSelectorPlotStrokeColor:"#808FAB",this.x1DrawGrid=!this.x1DrawGrid||JSON.parse(this.x1DrawGrid),this.yDrawGrid=!this.yDrawGrid||JSON.parse(this.yDrawGrid),this.y2DrawGrid=!!this.y2DrawGrid&&JSON.parse(this.y2DrawGrid),this.x1GridLineColor=this.x1GridLineColor?this.x1GridLineColor:"#000000",this.yGridLineColor=this.yGridLineColor?this.yGridLineColor:"#000000",this.y2GridLineColor=this.y2GridLineColor?this.y2GridLineColor:"#000000",this.x1GridLineWidth=this.x1GridLineWidth?JSON.parse(this.x1GridLineWidth):.3,this.yGridLineWidth=this.yGridLineWidth?JSON.parse(this.yGridLineWidth):.3,this.y2GridLineWidth=this.y2GridLineWidth?JSON.parse(this.y2GridLineWidth):.3,this.xDrawGrid=!this.xDrawGrid||JSON.parse(this.xDrawGrid),this.independentTicks=this.independentTicks?this.independentTicks:"y-primary",this.legendLabels=this.legendLabels?this.legendLabels:["X","Y1","Y2","Y3","Y4"],this.legendMapping=this.legendMapping?this.legendMapping:["x","y","y","y2","y2"],this.options={},this.options.axes={},this.x1AxisLabel&&""!=this.x1AxisLabel&&(this.options.xlabel=this.x1AxisLabel),this.yAxisLabel&&""!=this.yAxisLabel&&(this.options.ylabel=this.yAxisLabel),this.y2AxisLabel&&""!=this.y2AxisLabel&&(this.options.y2label=this.y2AxisLabel),this.legendLabels&&""!=this.legendLabels&&(this.options.labels=this.legendLabels),this.options.axes.x={},this.options.axes.x.drawAxis=JSON.parse(this.drawX1Axis),this.options.axes.x.axisLabelFontSize=JSON.parse(this.x1AxisLabelFontSize),this.options.axes.x.axisLabelWidth=JSON.parse(this.x1AxisLabelWidth),this.options.axes.x.axisLineColor=this.x1AxisLineColor,this.options.axes.x.axisLineWidth=JSON.parse(this.x1AxisLineWidth),this.options.axes.x.axisTickSize=JSON.parse(this.x1AxisTickSize),this.options.xValueParser=function(a){return moment(a).format("YYYY-MM-DD HH:mm")},this.options.axes.x.axisLabelFormatter=function(a,b,c){return Dygraph.dateAxisLabelFormatter(new Date(a),Dygraph.TWO_HOURLY,c)},this.options.axes.x.valueFormatter=function(a){return moment(a).format("MM/DD/YYYY hh:mm:ss")},this.options.axes.y={},this.options.axes.y.drawAxis=JSON.parse(this.drawYAxis),this.options.axes.y.axisLabelFontSize=JSON.parse(this.yAxisLabelFontSize),this.options.axes.y.axisLabelWidth=JSON.parse(this.yAxisLabelWidth),this.options.axes.y.axisLineColor=this.yAxisLineColor,this.options.axes.y.axisLineWidth=JSON.parse(this.yAxisLineWidth),this.options.axes.y.axisTickSize=JSON.parse(this.yAxisTickSize),this.options.axes.y.includeZero=JSON.parse(this.yAxisIncludeZero),this.options.axes.y.labelsKMB=JSON.parse(this.yAxisLabelsKmb),this.options.axes.y2={},this.options.axes.y2.drawAxis=JSON.parse(this.drawY2Axis),this.options.axes.y2.axisLabelFontSize=JSON.parse(this.y2AxisLabelFontSize),this.options.axes.y2.axisLabelWidth=JSON.parse(this.y2AxisLabelWidth),this.options.axes.y2.axisLineColor=this.y2AxisLineColor,this.options.axes.y2.axisLineWidth=JSON.parse(this.y2AxisLineWidth),this.options.axes.y2.axisTickSize=JSON.parse(this.y2AxisTickSize),this.options.axes.y2.includeZero=JSON.parse(this.y2AxisIncludeZero),this.options.axes.y2.labelsKMB=JSON.parse(this.y2AxisLabelsKmb),this.options.showRangeSelector=JSON.parse(this.showRangeSelector),this.options.rangeSelectorAlpha=JSON.parse(this.rangeSelectorAlpha),this.options.rangeSelectorBackgroundLineWidth=JSON.parse(this.rangeSelectorBackgroundLineWidth),this.options.rangeSelectorBackgroundStrokeColor=this.rangeSelectorBackgroundStrokeColor,this.options.rangeSelectorForegroundLineWidth=JSON.parse(this.rangeSelectorForegroundLineWidth),this.options.rangeSelectorForegroundStrokeColor=this.rangeSelectorForegroundStrokeColor,this.options.rangeSelectorHeight=JSON.parse(this.rangeSelectorHeight),this.options.rangeSelectorPlotFillColor=this.rangeSelectorPlotFillColor,this.options.rangeSelectorPlotFillGradientColor=this.rangeSelectorPlotFillGradientColor,this.options.rangeSelectorPlotLineWidth=JSON.parse(this.rangeSelectorPlotLineWidth),this.options.rangeSelectorPlotStrokeColor=this.rangeSelectorPlotStrokeColor,this.options.colors=this.colors,this.showLegend?(this.options.showLabelsOnHighlight=!0,this.options.legend="always"):(this.options.showLabelsOnHighlight=!1,this.options.hideOverlayOnMouseOut=!0),this.options.legendPosition=this.legendPosition?this.legendPosition:"top",this.options.axes.x.drawGrid=JSON.parse(this.x1DrawGrid),this.options.axes.y.drawGrid=JSON.parse(this.yDrawGrid),this.options.axes.y2.drawGrid=JSON.parse(this.y2DrawGrid),this.options.axes.x.gridLineColor=this.x1GridLineColor,this.options.axes.y.gridLineColor=this.yGridLineColor,this.options.axes.y2.gridLineColor=this.y2GridLineColor,this.options.axes.x.gridLineWidth=JSON.parse(this.x1GridLineWidth),this.options.axes.y.gridLineWidth=JSON.parse(this.yGridLineWidth),this.options.axes.y2.gridLineWidth=JSON.parse(this.y2GridLineWidth),"y-primary"==this.independentTicks?(this.options.axes.y.independentTicks=!0,this.options.axes.y2.independentTicks=!1):"y2-primary"==this.independentTicks?(this.options.axes.y.independentTicks=!1,this.options.axes.y2.independentTicks=!0):"independent"==this.independentTicks&&(this.options.axes.y.independentTicks=!0,this.options.axes.y2.independentTicks=!0),this.options.goals=this.goals?this.goals:[],this.options.goalLineColors=this.goalLineColors?this.goalLineColors:["#ffffff"],this.options.events=this.events?this.events:[],this.options.eventLineColors=this.eventLineColors?this.eventLineColors:["#ffffff"],this.options.series={};for(var b=0;b<this.legendLabels.length;b++){var c=this.legendLabels[b];0!=b&&"y2"==this.legendMapping[b]&&this.drawY2Axis&&(c?this.options.series[c]={axis:this.legendMapping[b]}:this.options.series["Y"+b]={axis:this.legendMapping[b]})}this.resize=!this.resize||this.resize,this.transport=this.transport?this.transport:"wss",this.msgTag=this.msgTag?this.msgTag:null,this.fetchFromDateParam=this.fetchFromDateParam?this.fetchFromDateParam:"from_date",this.fetchToDateParam=this.fetchToDateParam?this.fetchToDateParam:"to_date",this.fetchToDateValue=this.fetchToDateValue?this.fetchToDateValue:null,this.fetchFromDateValue=this.fetchFromDateValue?this.fetchFromDateValue:null,this.fetchFromDateValue&&(this.apiParams[this.fetchFromDateParam]=this.fetchFromDateValue),this.fetchToDateValue&&(this.apiParams[this.fetchToDateParam]=this.fetchToDateValue),this.fetchDataInterval=this.fetchDataInterval?parseInt(this.fetchDataInterval):null,this.delta=!1},this.runMetricTransformation=function(){if("si"!=this.defaultMetricValue)var a=this.availableUnits.us,b=this.availableUnits.si;else var a=this.availableUnits.si,b=this.availableUnits.us;if(this.customGoals)for(var c=0;c<this.customGoals.length;c++){var d=this.customGoals[c].goals;this.customGoals[c].goals=getConversionFunction(a,b)(d)}},this.$postLink=function(){g(this.transport),this.data&&!this.api?(f.timeout=!1,e(function(){f.consumeData(f.data)},2e3)):f.timeout=!0,d.$watch(function(a){if(a.$ctrl.data&&1==f.timeout)return a.$ctrl.data},function(a){a&&(f.datas=a,f.noResults=!1)})},this.$onDestroy=function(){console.log("destory chart",f.msgTag,d.$id),f.msgTag&&c.unsubscribe(f.msgTag,null,d.$id),f.refreshTimer&&e.cancel(f.refreshTimer)};var g=function(a){"wss"==a?c.onReady.then(function(){f.msgTag&&c.subscribe(f.msgTag,f.consumeData.bind(f),d.$id),f.api&&c.call(f.api,f.apiParams,f.msgTag).then(function(b,c){f.showSelectStream=!1,f.fetchDataInterval&&(f.refreshTimer=e(function(){f.apiParams[f.fetchFromDateParam]=f.fetchToDateValue,f.apiParams[f.fetchToDateParam]=(new Date).getTime(),f.delta=!0,g.bind(f)(a)},1e3*f.fetchDataInterval).then(function(){console.log("Timer resolved!",Date.now())},function(){console.log("Timer rejected!",Date.now())})),f.consumeData(b)},function(a){console.log("reject published promise",a),f.consumeData()})}):"https"==a&&f.api&&b.get(f.api,f.apiParams).then(function(a,b){f.consumeData(a)},function(a){console.log("reject published promise",a),f.consumeData()})};this.consumeData=function(a,b){f.timeout=!0,"function"==typeof f.onFormatData()&&(a=f.onFormatData()(a)),a&&a.length>0&&"object"==typeof a?this.fetchDataInterval&&this.fetchDataInterval>0&&this.datas&&this.delta?this.datas=this.datas.concat(a):(this.datas=a,this.noResults=!1):this.api&&0==a.length&&(!this.datas||this.datas&&0==this.datas.length)&&(this.datas=[],this.noResults=!0)}}]}),angular.module("plotly",["angularPlotly"]),angular.module("plotly").component("scriptrPlotly",{bindings:{displayMetricValue:"@",displayMetricParam:"@",defaultMetricValue:"@",defaultMetricParam:"@",availableUnits:"<?",fetchFromDateParam:"@",fetchFromDateValue:"@",fetchToDateParam:"@",fetchToDateValue:"@",fetchDataInterval:"@",onLoad:"&onLoad",api:"@",retrievedData:"<?",customRanges:"<?",layout:"<?",options:"<?",transport:"@",showLegend:"@",fontSize:"@",msgTag:"@",apiParams:"<?",onFormatData:"&"},templateUrl:"/UIComponents/dashboard/frontend/components/plotly/plotly.html",controller:["$rootScope","$scope","$window","$element","$timeout","httpClient","wsClient","_",function(a,b,c,d,e,f,g,h){var i=this;this.directions=["N","NNE","ENE","E","ESE","SSE","S","SSW","WSW","W","WNW","NNW"],this.speedUnit="m/s",this.noResults=!1,this.showSelectStream=!i.api,this.$onInit=function(){if(this.apiParams=this.apiParams?this.apiParams:{},this.apiParams&&this.apiParams.streams&&this.apiParams.streams.length>0){for(var b=[],d=[],f=0;f<this.apiParams.streams.length;f++){b=this.apiParams.streams[f].split("|");for(var g=0;g<b.length;g++)d.push(b[g])}this.apiParams.streams=d}this.plotCustomRanges=this.customRanges&&this.customRanges.length>0?this.customRanges:[{color:"#00476b",lo:0,hi:2},{color:"#005487",lo:2,hi:4},{color:"#006699",lo:4,hi:6},{color:"#0082b5",lo:6,hi:8},{color:"#0294c1",lo:8,hi:10},{color:"#06a9ce",lo:10,hi:20}],this.fetchFromDateParam=this.fetchFromDateParam?this.fetchFromDateParam:"from_date",this.fetchToDateParam=this.fetchToDateParam?this.fetchToDateParam:"to_date",this.fetchToDateValue=this.fetchToDateValue?this.fetchToDateValue:null,this.fetchFromDateValue=this.fetchFromDateValue?this.fetchFromDateValue:null,this.fetchFromDateValue&&(this.apiParams[this.fetchFromDateParam]=this.fetchFromDateValue),this.fetchToDateValue&&(this.apiParams[this.fetchToDateParam]=this.fetchToDateValue),this.displayMetricParam=this.displayMetricParam?this.displayMetricParam:"display_metric",this.displayMetricValue=a.currentDashboardUnit,this.defaultMetricParam=this.defaultMetricParam?this.defaultMetricParam:"default_metric",this.defaultMetricValue=this.defaultMetricValue?this.defaultMetricValue:null,this.retrievedData=this.retrievedData?this.retrievedData:[],this.staticData=angular.copy(this.retrievedData),this.defaultMetricValue&&this.displayMetricValue&&this.defaultMetricValue!=this.displayMetricValue&&this.availableUnits&&Object.keys(this.availableUnits).length>=2&&this.runMetricTransformation(),this.showLegend=this.showLegend?this.showLegend:"true",this.fontSize=this.fontSize?this.fontSize:"12",this.layout={title:"",font:{size:this.fontSize},radialaxis:{ticksuffix:"%"},orientation:270},this.maxRange=h.max(h.pluck(this.plotCustomRanges,"hi")),this.listOfMinRanges=h.pluck(this.plotCustomRanges,"lo"),this.listOfMaxRanges=h.pluck(this.plotCustomRanges,"hi"),this.listOfColors=h.pluck(this.plotCustomRanges,"color"),this.listOfColors.push("#10c3e0"),this.speedUnit=this.availableUnits?this.availableUnits[this.displayMetricValue]:this.speedUnit?this.speedUnit:"",this.style={},angular.element(c).on("resize",function(){return null!=i.timeoutId&&e.cancel(i.timeoutId),i.timeoutId=e(i.resize,100)}),j(this.transport)},i.resize=function(){i.timeoutId=null,c.matchMedia(a.mobileBreakPoint).matches?(i.style.height="300",i.style.width=d.parent()[0].clientWidth):null==i.showLegend||"true"!=i.showLegend?(i.style.height=d.parent()[0].clientHeight,i.style.width=d.parent()[0].clientWidth):(i.style.height=d.parent()[0].clientHeight,i.style.width=d.parent()[0].clientWidth-d.find(".plotly-chart-legend").outerWidth(!0)-5,i.style.width<=0&&(i.style.width=d.parent()[0].clientWidth)),i.layout={title:"",font:{size:i.fontSize},radialaxis:{ticksuffix:"%"},orientation:270,width:i.style.width,height:i.style.height}},this.runMetricTransformation=function(){if("si"!=this.defaultMetricValue)var a=this.availableUnits.us,b=this.availableUnits.si;else var a=this.availableUnits.si,b=this.availableUnits.us;if(this.plotCustomRanges)for(var c=0;c<this.plotCustomRanges.length;c++){var d=this.plotCustomRanges[c].lo,e=this.plotCustomRanges[c].hi;this.plotCustomRanges[c].lo=getConversionFunction(a,b)(d),this.plotCustomRanges[c].hi=getConversionFunction(a,b)(e)}},this.$postLink=function(){e(i.resize,100),null!=i.timeoutId&&e.cancel(i.timeoutId),i.timeoutId=e(i.resize,100),b.$watch(function(a){return a.$ctrl.retrievedData},function(a){i.retrievedData=a})},this.$onDestroy=function(){angular.element(c).off("resize"),console.log("destory wind rose"),i.msgTag&&g.unsubscribe(i.msgTag,null,b.$id),i.refreshTimer&&e.cancel(i.refreshTimer)};var j=function(a){"wss"==a?g.onReady.then(function(){i.msgTag&&g.subscribe(i.msgTag,i.consumeData.bind(i),b.$id),i.api&&i.apiParams&&i.apiParams.streams&&i.apiParams.streams.length>0?g.call(i.api,i.apiParams,i.msgTag).then(function(b,c){i.showSelectStream=!1,i.fetchDataInterval&&!i.refreshTimer&&(i.refreshTimer=e(function(){i.apiParams[i.fetchFromDateParam]=i.fetchToDateValue,i.apiParams[i.fetchToDateParam]=(new Date).getTime(),i.delta=!0,j.bind(i)(a)},1e3*i.fetchDataInterval),i.refreshTimer.then(function(){i.refreshTimer=null,console.log("Timer run resolved!",Date.now())},function(){i.refreshTimer=null,console.log("Timer run rejected!",Date.now())})),i.consumeData(b)},function(a){console.log("reject published promise",a),i.consumeData()}):i.buildWindRoseData()}):"https"==a&&i.api&&f.get(i.api,i.apiParams).then(function(a,b){i.consumeData(a)},function(a){console.log("reject published promise",a)})};this.consumeData=function(a,b){if(h.isEqual(this.retrievedData,this.staticData)&&(this.retrievedData=[]),"function"==typeof this.onFormatData()&&(a=this.onFormatData()(a)),a&&a.length>0){if(this.fetchDataInterval&&this.fetchDataInterval>0&&this.retrievedData&&this.retrievedData.length>0)for(var c=0;c<a.length;c++)this.retrievedData[c].speeds=this.retrievedData[c].speeds.concat(a[c].speeds);else this.retrievedData=a;this.buildWindRoseData()}else this.api&&0==a.length&&(!this.retrievedData||this.retrievedData&&0==this.retrievedData.length)&&(this.retrievedData=[],this.noResults=!0)},this.buildWindRoseData=function(){var a=h.pluck(i.retrievedData,"speeds");i.totalSpeeds=0;for(var b=0;b<a.length;b++)i.totalSpeeds+=a[b].length;0==i.totalSpeeds?i.noResults=!0:i.noResults=!1,i.speedRangeDirectionObj={};for(var b=0;b<i.listOfMinRanges.length;b++)i.speedRangeDirectionObj[i.listOfMinRanges[b]+"-"+i.listOfMaxRanges[b]]=[];i.speedRangeDirectionObj[">="+i.maxRange]=[];for(var b=0;i.retrievedData&&b<i.retrievedData.length;b++){for(var c=i.retrievedData[b].direction,d=i.retrievedData[b].speeds,e=0;e<i.plotCustomRanges.length;e++){var f=this.plotCustomRanges[e],g=h.filter(d,function(a){return a>=f.lo&&a<f.hi}).length;i.speedRangeDirectionObj[i.plotCustomRanges[e].lo+"-"+i.plotCustomRanges[e].hi].push({direction:c,percentage:g/i.totalSpeeds*100})}var j=i.maxRange,k=h.filter(d,function(a){return a>=j}).length;i.speedRangeDirectionObj[">="+i.maxRange].push({direction:c,percentage:k/i.totalSpeeds*100})}for(var l=Object.keys(i.speedRangeDirectionObj),m=Object.keys(i.speedRangeDirectionObj)[0],n=(i.speedRangeDirectionObj[m],JSON.parse(JSON.stringify(i.speedRangeDirectionObj))[m]),b=0;b<l.length;b++){var o=l[b],p=i.speedRangeDirectionObj[o];if(o!=m){for(var e=0;e<p.length;e++)n[e].percentage=p[e].percentage+n[e].percentage,0!=p[e].percentage&&(p[e].percentage=n[e].percentage);i.speedRangeDirectionObj[o]=p}}i.data=[],l=Object.keys(i.speedRangeDirectionObj);for(var b=l.length-1;b>=0;b--){var q=h.pluck(i.speedRangeDirectionObj[l[b]],"percentage"),r=l[b],s=i.listOfColors[b],t={r:q,t:i.directions,name:r+" "+i.speedUnit,marker:{color:s},type:"area",showlegend:!1};i.data.push(t)}}}]}),angular.module("MenuLayout",["ui.bootstrap","ngAnimate","ngSanitize"]).config(["$compileProvider",function(a){a.aHrefSanitizationWhitelist(/^\s*(https?|ftp|mailto|file|javascript):/)}]).component("menu",{bindings:{menuOpened:"<?",transport:"@",api:"@",msgTag:"@",apiParams:"<?",user:"<?"},templateUrl:"/UIComponents/layout/frontend/components/onsetmenu/menu.html",controller:["$scope","$window","httpClient","wsClient",function(a,b,c,d){this.opened=!0,this.firstLoad=!0,this.webVersion=!0;var e=this;this.menuArray=[],this.changeIsCollapsed=function(b){a["isCollapsed"+b]=!a["isCollapsed"+b]},this.$onInit=function(){this.windowWidth=b.innerWidth,this.windowWidth>=992?this.webVersion=!0:this.webVersion=!1,this.webVersion||(this.opened=!1),this.initDataService(),a.$on("reload-menu",function(){e.initDataService()})},this.logout=function(){c.get("app/api/users/revokeToken",{}).then(function(a,b){"success"==a.data.metadata.status&&($.removeCookie("token",{path:"/"}),window.localStorage.removeItem("user"),window.localStorage.removeItem("dataMapping"),window.localStorage.removeItem("dataStream"),window.location=onsetLoginUrl+"/?action=logout")},function(a){})},this.openCloseChild=function(a){this.opened=!this.opened,this.firstLoad=!1,a.stopPropagation()},this.closeChild=function(a){this.opened=!1,this.firstLoad=!1,a.stopPropagation()},this.initDataService=function(){"wss"==this.transport?d.onReady.then(function(){e.msgTag&&d.subscribe(e.msgTag,e.consumeData.bind(e),a.$id),e.api&&d.call(e.api,e.apiParams,e.msgTag).then(function(a,b){e.consumeData(a)},function(a){console.log("reject published promise",a),e.consumeData()})}):"https"==this.transport&&this.api&&c.get(e.api,e.apiParams).then(function(a,b){e.consumeData(a)},function(a){console.log("reject published promise",a)})},this.consumeData=function(a,b){a&&(this.menuArray=a.menuArray,this.user=a.userName,this.prepareMenuParams())},this.prepareMenuParams=function(){for(var b=0;b<this.menuArray.length;b++)a["isCollapsed"+b]=!0},angular.element(b).bind("resize",function(){a.$apply(function(){a.windowWidth=b.innerWidth,a.windowWidth>=992?e.webVersion=!0:e.webVersion=!1})})}]});var underscore=angular.module("underscore",[]);underscore.factory("_",["$window",function(a){return a._}]),angular.module("DashboardBuilder",["underscore","schemaForm","ACL","Grid","Message","xeditable","ui.bootstrap","ngRoute","slickCarousel","ngAnimate","ngSanitize","WsClient","HttpClient","Chart","gridster","DashboardBuilder","Gauge","Speedometer","Odometer","SearchBox","ngMaterial","ngMessages","material.svgAssetsCache","Thermometer","angularSpectrumColorpicker","angular-underscore/filters","pascalprecht.translate","ui.select","ui.codemirror","Display","Dygraphs","plotly","ngSchemaFormFile","mgcrea.ngStrap","mgcrea.ngStrap.modal","mgcrea.ngStrap.select","MenuLayout","ToggleSwitch","ngclipboard"]),angular.module("DashboardBuilder").constant("alarmsConfig",{form:[{type:"tabs",tabs:[{title:"Format",items:["message",{key:"widget-layout",notitle:!1,type:"strapselect",titleMap:[{value:"horizontal",name:"Horizontal"},{value:"vertical",name:"Vertical"}]},"border-size",{key:"border-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}},{key:"number-cell-size",notitle:!1,type:"strapselect",titleMap:[{value:"small",name:"Small"},{value:"medium",name:"Medium"},{value:"large",name:"Large"},{value:"",name:"no-width"}]},{type:"section",htmlClass:"col-xs-12 col-sm-6 row",items:[{key:"number-font-family",notitle:!1,type:"strapselect",titleMap:[{value:"Arial",name:"Arial"},{value:"Helvetica",name:"Helvetica"},{value:"Times New Roman",name:"Times New Roman"},{value:"Courier New",name:"Courier New"},{value:"Courier",name:"Courier"},{value:"Verdana",name:"Verdana"},{value:"Georgia",name:"Georgia"},{value:"Palatino",name:"Palatino"},{value:"Garamond",label:"Garamond"},{value:"Bookman",label:"Bookman"},{value:"Comic Sans MS",name:"Comic Sans MS"},{value:"Trebuchet MS",name:"Trebuchet MS"},{value:"Arial Black",name:"Arial Black"},{value:"Impact",name:"Impact"},{value:"Sans-Serif",name:"Sans-Serif"},{value:"Source Sans Pro",name:"Source Sans Pro"}]},"number-font-size","number-font-weight",{key:"number-text-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}},{key:"number-background-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,
preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}},{key:"number-Text-Alignment",notitle:!1,type:"strapselect",titleMap:[{value:"left",name:"Left"},{value:"center",name:"Center"},{value:"right",name:"Right"}]}]},{type:"section",htmlClass:"col-xs-12 col-sm-6 row pull-right",items:[{key:"message-font-family",notitle:!1,type:"strapselect",titleMap:[{value:"Arial",name:"Arial"},{value:"Helvetica",name:"Helvetica"},{value:"Times New Roman",name:"Times New Roman"},{value:"Courier New",name:"Courier New"},{value:"Courier",name:"Courier"},{value:"Verdana",name:"Verdana"},{value:"Georgia",name:"Georgia"},{value:"Palatino",name:"Palatino"},{value:"Garamond",name:"Garamond"},{value:"Bookman",name:"Bookman"},{value:"Comic Sans MS",name:"Comic Sans MS"},{value:"Trebuchet MS",name:"Trebuchet MS"},{value:"Arial Black",name:"Arial Black"},{value:"Impact",name:"Impact"},{value:"Sans-Serif",name:"Sans-Serif"},{value:"Source Sans Pro",name:"Source Sans Pro"}]},"message-font-size","message-font-weight",{key:"message-text-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}},{key:"message-background-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}},{key:"message-Text-Alignment",notitle:!1,type:"strapselect",titleMap:[{value:"left",name:"Left"},{value:"center",name:"Center"},{value:"right",name:"Right"}]}]}]}]}],schema:{type:"object",title:"Schema",properties:{"widget-layout":{title:"Layout",type:"string",default:"horizontal",placeholder:" ",description:"Define your widget's layout."},"number-cell-size":{title:"Numbers Cell Size",type:"string",default:"",placeholder:" ",description:"Define your widget's numbers cell size."},message:{title:"Message",type:"string",default:"Items",description:"Define your widget message."},"number-font-family":{title:"Number Font family",type:"string",description:"Define your widget number font family.",default:"Arial",placeholder:" "},"message-font-family":{title:"Message Font family",type:"string",description:"Define your widget message font family.",default:"Arial",placeholder:" "},"number-font-size":{title:"Number Font Size",type:"number",default:42,description:"Define your widget number font size."},"message-font-size":{title:"Message Font Size",type:"number",default:18,description:"Define your widget message font size."},"number-font-weight":{title:"Number Font Weight",type:"number",default:600,description:"Define your widget number font weight."},"message-font-weight":{title:"Message Font Weight",type:"number",default:600,description:"Define your widget message font weight."},"number-text-color":{title:"Number Text Color",type:"string",description:"Define your widget number text color.",format:"color",default:"#ffffff",validationMessage:"Invalid Color"},"message-text-color":{title:"Message Text Color",type:"string",description:"Define your widget message text color.",format:"color",default:"#686868",validationMessage:"Invalid Color"},"number-background-color":{title:"Number Backgrount Color",type:"string",description:"Define your widget number background color.",format:"color",default:"#005588",validationMessage:"Invalid Color"},"message-background-color":{title:"Message Backgrount Color",type:"string",description:"Define your widget message background color.",format:"color",default:"white",validationMessage:"Invalid Color"},"message-Text-Alignment":{title:"Message Text Alignment",type:"string",default:"center",placeholder:" ",description:"Define your widget message text alignment."},"number-Text-Alignment":{title:"Number Text Alignment",type:"string",default:"center",placeholder:" ",description:"Define your widget number text alignment."},"border-size":{title:"Border Weight",type:"number",default:1,description:"Define your widget border weight."},"border-color":{title:"Border Color",type:"string",description:"Define your widget border color.",format:"color",default:"#d7d7d7",validationMessage:"Invalid Color"},data:{title:"Count",type:"string",description:"Count to display."}},required:[]}}),angular.module("DashboardBuilder").constant("common",{formTab:{title:"Data",hidden:!0,items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:[{key:"transport",notitle:!1,type:"strapselect",titleMap:[{value:"wss",name:"wss"},{value:"https",name:"https"}]}]},{type:"section",htmlClass:"col-xs-6",items:[{key:"msg-tag",condition:"model.transport=='wss'"},{key:"http-method",notitle:!1,type:"strapselect",titleMap:[{value:"GET",name:"GET"}],condition:"model.transport=='https'"}]}]},{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:[{key:"api",condition:"model.stream.length > 0 "}]},{type:"section",htmlClass:"col-xs-6",items:["api-params"]}]},{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12",items:[{key:"data-type"},{key:"data-format"},{key:"schema-for"}]}]},{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12",items:[{key:"columns-definition",condition:"model['schema-for'] == 'grid'"},{key:"row-data",condition:"model['schema-for'] == 'grid'"}]}]},{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12",items:[{key:"data"},{key:"on-format-data",type:"codemirror",codemirrorOptions:{value:"return",styleActiveLine:!0,lineNumbers:!0,lineWrapping:!0,autoCloseBrackets:!0,matchBrackets:!0,theme:"neo",mode:"javascript",readOnly:!1,autoRefresh:!0}}]}]},{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12",items:[{type:"help",helpvalue:"<hr>"}]}]},{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12",items:[{type:"help",helpvalue:'<div class="alert alert-info"><ul><li>Messages published over the subscibe channel need to have the following format in order to be consumed by a widget:<ul><li>{“id”: “&lt;message tag value&gt;”, “result”: “&lt;static data structure&gt;”}</li></ul></li><li>A script would publish a message  over the subscribe channel as follow:<ul><li>publish(“responseChannel”, {“id”: “&lt;message tag value&gt;”, “result”: “&lt;static data structure&gt;”});</li></ul></li><li>Whether https or wss transport is used, Sciptr API should return the static data structure for widget initial load:<ul><li>return &lt;static data structure&gt;;</li></ul></li></ul></div>'}]}]}]},schemaFields:{api:{title:"Api",type:"string",description:"Name of the scriptr api (script name) responsible for publishing or returning the widget data.",default:"app/api/dashboard/GetUserData"},"api-params":{title:"Api params",type:"string",description:"A JSON formatted object containing the parameters to be sent to the scriptr api.","x-schema-form":{type:"textarea",placeholder:"Ex: {'id' : '599865'}"}},"http-method":{title:"Http method",type:"string",description:"Method to be used when calling the scriptr api over https. Default: GET.",default:"GET",placeholder:" "},transport:{title:"Transport",type:"string",description:"Protocol used to call the  scriptr api. Use wss for real time communication whenever your widget needs to update its data live by consuming messages published from scriptr over the subscribe channel defined in settings.",placeholder:""},"msg-tag":{title:"Message tag",type:"string",description:"The dashboard widgets consume messages published over the subscribe channel defined in dashboard settings. Message tag is an identifier sent as part of the published message. The widget uses it to know which messages to consume or ignore."},"on-format-data":{title:"Format data",default:"return data;",type:"string",description:"Callback function to be called after data is returned from backend."},"data-type":{title:"Data Type",type:"string",description:"Set the data type if raw, aggregate, latest.",enum:["raw","aggregate","latest"]},"aggregation-range":{title:"Aggregation Range",type:"string",description:"Select the aggregatin data range.",default:"1800000"},"data-format":{title:"Data Format",type:"string",enum:["dygraphs","grid","live","morris","windrose"]},"schema-for":{title:"Widget Class",type:"string",enum:["line","bar","area","donut","gauge","grid","thermometer","odometer","displaycount","windrose"]},"available-units":{title:"Main Stream Units",type:"string"}}}),angular.module("DashboardBuilder").constant("config",{script:{form:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12 col-md-1 file-attachment",items:[{key:"image",type:"nwpFileUpload",i18n:{add:"Open file browser",preview:"Preview Upload",filename:"File Name",progress:"Progress Status",upload:"Upload",dragorclick:"Drag and drop your file here or click here"},notitle:!0}]},{type:"section",htmlClass:"col-xs-12 col-md-5",items:[{key:"dashboardName",notitle:!0,placeholder:"Dashboard Name"}]},{type:"section",htmlClass:"col-xs-12 col-md-3 period-select-box",items:[{key:"period",type:"strapselect",notitle:!0,placeholder:"Period",titleMap:[{value:"past_day",name:"Past day"},{value:"past_week",name:"Past week"},{value:"past_month",name:"Past month"}],onChange:"setFetchFromDate(modelValue, form);"}]},{type:"section",htmlClass:"col-xs-12 col-md-3 unit-select-box",items:[{key:"unit",notitle:!0,placeholder:"Unit",type:"strapselect",titleMap:[{value:"si",name:"SI units"},{value:"us",name:"US units"}],onChange:"setUnitInLocalStorage(modelValue, form);"}]}]}],schema:{type:"object",title:"Schema",properties:{scriptName:{type:"hidden",fieldHtmlClass:"script-name-input"},dashboardName:{type:"string",fieldHtmlClass:"script-name-input",maxLength:30,pattern:"^[A-Za-z0-9 -]+$",validationMessage:{202:"Dashboard name can contain letters, numbers and hyphens.",201:"Maximum number of characters allowed is 30."}},image:{title:"Image",type:"array",format:"singlefile",default:"//cdn.rawgit.com/scriptrdotio/onset-static-resources/a923190a/images/default-icon.svg","x-schema-form":{type:"array"},pattern:{mimeType:"image/*",validationMessage:"Wrong File Type. Allowed types "},maxSize:{maximum:"1MB",validationMessage:"File exceeded allowed size of "}},period:{title:"Period",type:"string",description:"",default:"past_day"},unit:{title:"Unit",type:"string",description:"",default:"si",placeholder:" "}},required:["dashboardName","period","unit"]}},metricselector:{form:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12 col-md-3 col-lg-2 period-select-box",items:[{key:"period",type:"strapselect",notitle:!0,placeholder:"Period",titleMap:[{value:"past_day",name:"Past day"},{value:"past_week",name:"Past week"},{value:"past_month",name:"Past month"}],onChange:"setFetchFromDate(modelValue, form);"}]},{type:"section",htmlClass:"col-xs-12 col-md-3 col-lg-2 unit-select-box",items:[{key:"unit",notitle:!0,placeholder:"Unit",type:"strapselect",titleMap:[{value:"si",name:"SI units"},{value:"us",name:"US units"}],onChange:"setUnitInLocalStorage(modelValue, form);"}]}]}],schema:{type:"object",title:"Schema",properties:{period:{title:"Period",type:"string",description:"",default:"past_day"},unit:{title:"Unit",type:"string",description:"",default:"si",placeholder:" "}},required:["unit"]}},transport:{label:"Transport configuration",defaults:{publishChannel:"requestChannel",subscribeChannel:"responseChannel"},form:["*"],schema:{type:"object",title:"Schema",properties:{publishChannel:{title:"Publish channel",type:"string",description:"Widgets use the publish channel to publish messages that will be distributed to its subscribers."},subscribeChannel:{title:"Subscribe channel",type:"string",description:"Widgets use the subscribe channel to consume the messages published over that channel as a data source."}},required:["token","baseUrl","publishChannel","subscribeChannel"]}},defaultWidget:{name:"displaybox"},widgets:[{name:"line",label:"Line Chart",class:"scriptr-dygraphs",commonData:!0,show:!0,defaults:{type:"line","on-format-data":"return data;","data-type":"raw","data-format":"dygraphs","schema-for":"line","fetch-from-date-param":"from_date","fetch-to-date-param":"to_date","display-metric-param":"display_metric","fetch-data-interval":300,boxLabel:"Line Chart",boxBorder:!0,transport:"wss",data:"[[1519312895840,10,26,16,20],[1519312896840,11,25,16,20],[1519312897840,10,26,16,20],[1519312898840,11,25,15,20],[1519312899840,10,26,16,21]]","grid-text-family":"Source Sans Pro","x1-axis-label-font-size":12,"x1-axis-label-width":60,"y2-axis-label-width":95,"y-axis-label-width":95,"y2-axis-label-font-size":12,"y-axis-label-font-size":12},box:{sizeX:3,sizeY:3,minSizeX:2,minSizeY:2},imgSrc:"//cdn.rawgit.com/scriptrdotio/onset-static-resources/97574e7b/images/line-chart.svg",form:[{type:"tabs",tabs:[{title:"Data",items:[{type:"section",htmlClass:"",items:[{key:"stream",type:"uiselectmultiple",placeholder:"",options:{closeOnSelect:!1,groupBy:"dataStream",multiple:"true",callback:"multiSelectCallBack",widgetName:"line",limit:20,limitTo:50},onChange:function(a,b,c){for(var d=["#CC5464","#FCC717","#38B9D6","#1DBC68","#E90088"],e={},f=c["colors-mapping"],g=0;g<f.length;g++)f[g].ykeys&&(e[f[g].ykeys]={labels:f[g].labels,colors:f[g].colors,axisSelection:f[g].axisSelection});for(var h=[],i=0;i<a.length;i++)if(e[a[i].value])h.push({ykeys:a[i].value,labels:e[a[i].value].labels,colors:e[a[i].value].colors,axisSelection:e[a[i].value].axisSelection});else{for(var j=0;j<d.length;j++){for(var k=!1,l=d[j],m=0;m<h.length;m++){var n=h[m].colors;if(n==l){k=!0;break}}if(!k)break}h.push({ykeys:a[i].value,labels:a[i].name,colors:k?d[0]:d[j],axisSelection:"y"})}0==h.length&&(h=[{}]),c["colors-mapping"]=h;for(var o='["x",',p='["X",',i=0;i<a.length;i++)o+="'y'"+(i<a.length-1?" , ":""),p+='"'+a[i].name+'"'+(i<a.length-1?" , ":"");if(c["legend-labels"]=p+"]",c["legend-Mapping"]=o+"]",a.length>0&&delete c.data,a&&a.length>0){for(var q,r=0;r<c["colors-mapping"].length;r++)if("y"==c["colors-mapping"][r].axisSelection){q=c["colors-mapping"][r].ykeys+"-"+c["colors-mapping"][r].labels;break}for(var j=0;j<a.length;j++){if(a[j].value+"-"+a[j].name==q){c["available-units"]={si:a[j].availableUnits.si,us:a[j].availableUnits.us};break}}}}}]}]},{title:"X",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:[{type:"radios-inline",key:"draw-x1-axis",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]},"x1-axis-label","x1-axis-label-font-size"]},{type:"section",htmlClass:"col-xs-6",items:[{key:"x1-axis-line-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}},{key:"x1-axis-line-width",step:"0.1"},"x1-axis-label-width"]}]}]},{title:"Y",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:[{type:"radios-inline",key:"draw-y-axis",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]},"y-axis-label","y-axis-label-font-size","y-axis-label-width"]},{type:"section",htmlClass:"col-xs-6",items:[{key:"y-axis-line-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}},{key:"y-axis-line-width",step:"0.1"},{type:"radios-inline",key:"y-axis-include-zero",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]},{type:"radios-inline",key:"y-axis-labels-kmb",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]}]}]}]},{title:"Y2",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:[{type:"radios-inline",key:"draw-y2-axis",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]},"y2-axis-label","y2-axis-label-font-size","y2-axis-label-width"]},{type:"section",htmlClass:"col-xs-6",items:[{key:"y2-axis-line-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}},{key:"y2-axis-line-width",step:"0.1"},{type:"radios-inline",key:"y2-axis-include-zero",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]},{type:"radios-inline",key:"y2-axis-labels-kmb",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]}]}]}]},{title:"Legend",items:[{type:"radios-inline",key:"show-legend",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]},{type:"section",htmlClass:"",items:[{key:"colors-mapping",title:"Legend Details",add:null,remove:null,items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6 col-sm-3",items:[{key:"colors-mapping[].ykeys",title:"Channel"}]},{type:"section",htmlClass:"col-xs-6 col-sm-3",items:[{key:"colors-mapping[].labels",title:"Legend Label"}]},{type:"section",htmlClass:"col-xs-6 col-sm-3",items:[{key:"colors-mapping[].colors",title:"Color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}}]},{type:"section",htmlClass:"col-xs-6 col-sm-3",items:[{key:"colors-mapping[].axisSelection",title:"Legend Axis",notitle:!1,type:"strapselect",titleMap:[{value:"y",name:"Y"},{value:"y2",name:"Y2"}]}]}]}]}]}]},{title:"Grid",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-4",items:[{type:"radios-inline",key:"x1-draw-grid",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]},{key:"x1-grid-line-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}},{key:"x1-grid-line-width",step:"0.1"}]},{type:"section",htmlClass:"col-xs-4",items:[{type:"radios-inline",key:"y-draw-grid",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]},{key:"y-grid-line-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}},{key:"y-grid-line-width",step:"0.1"}]},{type:"section",htmlClass:"col-xs-4",items:[{type:"radios-inline",key:"y2-draw-grid",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]},{key:"y2-grid-line-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}},{key:"y2-grid-line-width",step:"0.1"}]},{type:"section",htmlClass:"col-xs-12",items:[{key:"independent-ticks",notitle:!1,type:"strapselect",titleMap:[{value:"y-primary",name:"Ticks are aligned. Y is primary"},{value:"y2-primary",name:"Ticks are aligned. Y2 is primary"},{value:"independent",name:"Ticks are not aligned"}]}]}]}]},{title:"Slider",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:[{type:"radios-inline",key:"show-range-selector",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]},"range-selector-alpha","range-selector-background-line-width",{key:"range-selector-background-stroke-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}},"range-selector-foreground-line-width"]},{type:"section",htmlClass:"col-xs-6",items:[{key:"range-selector-foreground-stroke-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}},"range-selector-height",{key:"range-selector-plot-fill-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}},{key:"range-selector-plot-fill-gradient-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}},{key:"range-selector-plot-line-width",step:"0.1"},{key:"range-selector-plot-stroke-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}}]}]}]},{title:"Goals",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12",items:[{key:"custom-goals",title:"Fill Colors & Goals",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:[{key:"custom-goals[].goal-line-colors",title:"Colors",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}}]},{type:"section",htmlClass:"col-xs-6",items:[{key:"custom-goals[].goals",title:"Goals",onFieldLoad:function(a,b,c){if(c["default-metric-value"]&&c["default-metric-value"]!=c["display-metric-value"]&&c["available-units"]){var d=c["available-units"][c["default-metric-value"]],e=c["available-units"][c["display-metric-value"]];d!==e&&(c[b.key[0]][b.key[1]][b.key[2]]=getConversionFunction(d,e)(c[b.key[0]][b.key[1]][b.key[2]]))}}}]}]}]}]}]}]},{title:"Box Properties",items:["boxLabel"]}]}],schema:{type:"object",title:"Schema",properties:{"show-legend":{title:"Show Legend",default:"true",type:"string",description:""},stream:{title:"Channels",type:"array",items:{type:"string"},description:"",placeholder:" "},"legend-position":{title:"Legend Position ",type:"string",default:"bottom",description:"Determines the legend position relative to the graph.",placeholder:" "},"draw-x1-axis":{title:"Draw X-axis",type:"string",default:"true",description:"Determines whether to draw the X-axis. Setting this to false also prevents x-axis ticks from being drawn and reclaims the space for the chart grid/lines."},"draw-y-axis":{title:"Draw Y-axis",type:"string",default:"true",description:"Determines whether to draw the Y-axis. Setting this to false also prevents y-axis ticks from being drawn and reclaims the space for the chart grid/lines."},"draw-y2-axis":{title:"Draw Y2-axis",type:"string",default:"false",description:"Determines whether to draw the Y2-axis. Setting this to false also prevents y2-axis ticks from being drawn and reclaims the space for the chart grid/lines."},"colors-mapping":{title:"Colors",type:"array",default:[],description:"",items:{type:"object",properties:{colors:{title:"Colors",type:"string",format:"color",validationMessage:"Invalid Color"},labels:{title:"Labels",type:"string"},ykeys:{title:"Channel",readonly:!0,type:"string"},axisSelection:{title:"Legend Axis",type:"string",placeholder:" "}}}},"custom-goals":{title:"Goals",type:"array",default:[{"goal-line-colors":"#00476b",goals:0}],description:"Goals: List of y-values to draw as horizontal 'goal' lines on the chart.<br/>Colors: List of color values to use for the goal line colors.",items:{type:"object",properties:{"goal-line-colors":{title:"Colors",type:"string",format:"color",validationMessage:"Invalid Color",default:"#00476b"},goals:{title:"Goals",type:"string"}}}},events:{title:"Events",type:"array",default:["2010-02-02"],description:"List of x-values to draw as vertical 'event' lines on the chart.",items:{type:"string"}},"event-line-colors":{title:"Event Line Colors",type:"array",default:["#ffffff"],description:"List of color values to use for the event line colors.",items:{format:"color",type:"string",validationMessage:"Invalid Color"}},colors:{title:"Lines' Colors",type:"array",default:["#005588","#aa241d"],description:"Array containing colors for the series lines.",items:{format:"color",type:"string",validationMessage:"Invalid Color"}},"x1-axis-label-font-size":{title:"Axis Label Font Size",type:"number",default:12,description:"Size of the font (in pixels) to use in the x axis labels."},"y-axis-label-font-size":{title:"Axis Label Font Size",type:"number",default:12,description:"Size of the font (in pixels) to use in the y axis labels."},"y2-axis-label-font-size":{title:"Axis Label Font Size",type:"number",default:12,description:"Size of the font (in pixels) to use in the y2 axis labels."},"x1-axis-label-width":{title:"Axis Label Width",type:"number",default:60,description:"Width (in pixels) of the axis label width."},"y-axis-label-width":{title:"Axis Label Width",type:"number",default:95,description:"Width (in pixels) of the axis label width. This also controls the width of the y-axis."},"y2-axis-label-width":{title:"Axis Label Width",type:"number",default:95,description:"Width (in pixels) of the axis label width. This also controls the width of the y-axis."},"x1-axis-line-color":{title:"Axis Line Color",type:"string",default:"#000000",format:"color",description:"Color of the axis line.",validationMessage:"Invalid Color"},"y-axis-line-color":{title:"Axis Line Color",type:"string",default:"#000000",format:"color",description:"Color of the axis line.",validationMessage:"Invalid Color"},"y2-axis-line-color":{title:"Axis Line Color",type:"string",default:"#000000",format:"color",description:"Color of the axis line.",validationMessage:"Invalid Color"},"x1-axis-line-width":{title:"Axis Line Width",type:"number",default:.3,description:"Thickness (in pixels) of the axis line."},"y-axis-line-width":{title:"Axis Line Width",type:"number",default:.3,description:"Thickness (in pixels) of the axis line."},"y2-axis-line-width":{title:"Axis Line Width",type:"number",default:.3,description:"Thickness (in pixels) of the axis line."},"y-axis-include-zero":{title:"Include Zero",type:"string",default:"false",description:"If this option is set, the y-axis will always include zero, typically as the lowest value. This can be used to avoid exaggerating the variance in the data."},"y2-axis-include-zero":{title:"Include Zero",type:"string",default:"false",description:"If this option is set, the y-axis will always include zero, typically as the lowest value. This can be used to avoid exaggerating the variance in the data."},"y-axis-labels-kmb":{title:"Labels KMB",type:"string",default:"false",description:"Show K/M/B for thousands/millions/billions on y-axis."},"y2-axis-labels-kmb":{title:"Labels KMB",type:"string",default:"false",description:"Show K/M/B for thousands/millions/billions on y-axis."},"show-range-selector":{title:"Show Slider",type:"string",default:"false",description:"Show or hide the slider widget."},"range-selector-alpha":{title:"Alpha",type:"number",default:.6,description:"The transparency of the veil that is drawn over the unselected portions of the slider mini plot. A value of 0 represents full transparency and the unselected portions of the mini plot will appear as normal. A value of 1 represents full opacity and the unselected portions of the mini plot will be hidden."},"range-selector-background-line-width":{title:"Background Line Width",type:"number",default:1,description:"The width of the lines below and on both sides of the slider mini plot."},"range-selector-background-stroke-color":{title:"Background Stroke Color",type:"string",default:"#808080",format:"color",description:"The color of the lines below and on both sides of the slider mini plot.",validationMessage:"Invalid Color"},"range-selector-foreground-line-width":{title:"Forground Line Width",type:"number",default:1,description:"The width the lines in the interactive layer of the slider."},"range-selector-foreground-stroke-color":{title:"Forground Stroke Color",type:"string",default:"#000000",format:"color",description:"The color of the lines in the interactive layer of the slider.",validationMessage:"Invalid Color"},"range-selector-height":{title:"Height",type:"number",default:40,description:"Height, in pixels, of the slider widget."},"range-selector-plot-fill-color":{title:"Plot Fill Color",type:"string",default:"#A7B1C4",format:"color",description:"The slider mini plot fill color.",validationMessage:"Invalid Color"},"range-selector-plot-fill-gradient-color":{title:"Plot Fill Gradient Color",type:"string",default:"#FFFFFF",format:"color",description:"The top color for the slider mini plot fill color gradient.",validationMessage:"Invalid Color"},"range-selector-plot-line-width":{title:"Plot Line Width",type:"number",default:1.5,description:"The width of the slider mini plot line."},"range-selector-plot-stroke-color":{title:"Plot Stroke Color",type:"string",default:"#808FAB",format:"color",description:"The slider mini plot stroke color.",validationMessage:"Invalid Color"},"x1-draw-grid":{title:"Draw X-Axis Grid Lines",type:"string",default:"true",description:"Determines whether to display x-axis grid lines in the chart."},"y-draw-grid":{title:"Draw Y-Axis Grid Lines",type:"string",default:"true",description:"Determines whether to display y-axis grid lines in the chart."},"y2-draw-grid":{title:"Draw Y2-Axis Grid Lines",type:"string",default:"false",description:"Determines whether to display y2-axis grid lines in the chart."},"x1-grid-line-color":{title:"X-Axis Grid Line Color",type:"string",default:"#000000",format:"color",description:"X-axis grid line color.",validationMessage:"Invalid Color"},"y-grid-line-color":{title:"Y-Axis Grid Line Color",type:"string",default:"#000000",format:"color",description:"Y-axis grid line color.",validationMessage:"Invalid Color"},"y2-grid-line-color":{title:"Y2-Axis Grid Line Color",type:"string",default:"#000000",format:"color",description:"Y2-axis grid line color.",validationMessage:"Invalid Color"},"x1-grid-line-width":{title:"X-Axis Grid Line Width",type:"number",default:.3,description:"X-axis grid line width."},"y-grid-line-width":{title:"Y-Axis Grid Line Width",type:"number",default:.3,description:"Y-axis grid line width."},"y2-grid-line-width":{title:"Y2-Axis Grid Line Width",type:"number",default:.3,description:"Y2-axis grid line width."},"independent-ticks":{title:"Y Axes Alignment",type:"string",default:"y-primary",description:"This option defines whether the y axes should align their ticks or if they should be independent.",placeholder:" "},data:{title:"Data",type:"string",description:"Data series in case of static data.","x-schema-form":{type:"textarea",placeholder:'[["2009-12-31T22:00:00.000Z",1,99,1039600.0000000001,1960400],["2010-01-01T22:00:00.000Z",2,98,1078400,1921600]]'}},"x1-axis-label":{title:"X-axis Label",type:"string",default:"",description:"X-axis Label."},"y-axis-label":{title:"Y-axis Label",type:"string",default:"",description:"Y-axis Label."},"y2-axis-label":{title:"Y2-axis Label",type:"string",default:"",description:"Y2-axis Label."},"legend-labels":{title:"Legend Labels",type:"string",default:"['X', 'Y1', 'Y2', 'Y3', 'Y4']",description:"A name for each data series, including the independent (X) series."},"legend-Mapping":{title:"Legend Mapping",type:"string",default:"['x', 'y', 'y', 'y2', 'y2']",description:"Mapping the legends to their corresponding axis."},boxLabel:{title:"Box label",type:"string",description:"Define your widget box title."},boxBorder:{title:"Box Border",type:"hidden",default:"true",description:"Define your widget box border."}}}},{
name:"bar",label:"Bar Chart",class:"scriptr-chart",commonData:!0,show:!0,defaults:{type:"bar",boxLabel:"Bar Chart",boxBorder:!0,stacked:"true","data-type":"aggregate","aggregation-range":"1800000","parse-time":"true","data-format":"morris","schema-for":"bar","xlabel-angle":45,"fetch-from-date-param":"from_date","fetch-to-date-param":"to_date","display-metric-param":"display_metric","fetch-data-interval":300,xkey:"date",labels:'["Serie A", "Serie B"]',colors:["#aa241d","#edcfce"],transport:"wss","on-format-data":"return data;",data:'[{"date":"2006","a":88,"b":20},{"date":"2007","a":30,"b":34},{"date":"2008","a":90,"b":42},{"date":"2009","a":89,"b":59},{"date":"2010","a":43,"b":61},{"date":"2011","a":85,"b":69},{"date":"2012","a":29,"b":65}]',"grid-text-family":"Arial","hide-hover":"auto","show-legend":"true"},box:{sizeX:2,sizeY:3,minSizeX:2,minSizeY:2},imgSrc:"//cdn.rawgit.com/scriptrdotio/onset-static-resources/b8a3ec79/images/bar-chart.svg",form:[{type:"tabs",tabs:[{title:"Data",items:[{type:"section",htmlClass:"col-xs-12",items:[{key:"stream",type:"uiselectmultiple",placeholder:"",onChange:function(a,b,c){for(var d=["#CC5464","#FCC717","#38B9D6","#1DBC68","#E90088"],e={},f=c["colors-mapping"],g=0;g<f.length;g++)f[g].ykeys&&(e[f[g].ykeys]={labels:f[g].labels,colors:f[g].colors});for(var h=[],i=0;i<a.length;i++)if(e[a[i].value])h.push({ykeys:a[i].value,labels:e[a[i].value].labels,colors:e[a[i].value].colors});else{for(var j=0;j<d.length;j++){for(var k=!1,l=d[j],m=0;m<h.length;m++){var n=h[m].colors;if(n==l){k=!0;break}}if(!k)break}h.push({ykeys:a[i].value,labels:a[i].name,colors:k?d[0]:d[j]})}0==h.length&&(h=[{}]),c["colors-mapping"]=h,c.xkey="date",a.length>0&&delete c.data,a&&a.length>0&&(c["available-units"]={si:a[0].availableUnits.si,us:a[0].availableUnits.us})},options:{closeOnSelect:!1,groupBy:"dataStream",multiple:"true",callback:"multiSelectCallBack",widgetName:"bar",limit:20,limitTo:50}}]},{type:"section",htmlClass:"col-xs-12",items:[{key:"aggregation-range",condition:"model['data-type'] == 'aggregate'",type:"strapselect",placeholder:"Select the aggregation range for the streams data you are charting.",titleMap:[{value:"1800000",name:"30 minutes"},{value:"3600000",name:"1 hour"},{value:"14400000",name:"4 hours"}]}]}]},{title:"X",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12",items:["xkey","xlabel-angle"]}]}]},{title:"Y",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:["pre-units","ymin",{key:"stacked",type:"radios-inline",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]}]}]}]},{title:"Legend",items:[{type:"radios-inline",key:"show-legend",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]},{type:"section",htmlClass:"",items:[{key:"colors-mapping",title:"Legend Details",add:null,remove:null,items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12 col-sm-4",items:[{key:"colors-mapping[].ykeys",title:"Channel"}]},{type:"section",htmlClass:"col-xs-12 col-sm-4",items:[{key:"colors-mapping[].labels",title:"Legend Label"}]},{type:"section",htmlClass:"col-xs-12 col-sm-4",items:[{key:"colors-mapping[].colors",title:"Color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}}]}]}]}]}]},{title:"Grid",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:[{type:"radios-inline",key:"grid",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]},{type:"radios-inline",key:"axes",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]},{key:"grid-text-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}}]},{type:"section",htmlClass:"col-xs-6",items:[{key:"grid-text-family",notitle:!1,type:"strapselect",titleMap:[{value:"Arial",name:"Arial"},{value:"Helvetica",name:"Helvetica"},{value:"Times New Roman",name:"Times New Roman"},{value:"Courier New",name:"Courier New"},{value:"Courier",name:"Courier"},{value:"Verdana",name:"Verdana"},{value:"Georgia",name:"Georgia"},{value:"Palatino",name:"Palatino"},{value:"Garamond",name:"Garamond"},{value:"Bookman",name:"Bookman"},{value:"Comic Sans MS",name:"Comic Sans MS"},{value:"Trebuchet MS",name:"Trebuchet MS"},{value:"Arial Black",name:"Arial Black"},{value:"Impact",name:"Impact"},{value:"Sans-Serif",name:"Sans-Serif"},{value:"Source Sans Pro",name:"Source Sans Pro"}]},{key:"grid-text-weight",notitle:!1,type:"strapselect",titleMap:[{value:"normal",name:"Normal"},{value:"bold",name:"Bold"}]},"grid-text-size"]}]}]},{title:"Goals",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12",items:[{key:"custom-goals",title:"Fill Colors & Goals",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:[{key:"custom-goals[].goal-line-colors",title:"Colors",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}}]},{type:"section",htmlClass:"col-xs-6",items:[{key:"custom-goals[].goals",onFieldLoad:function(a,b,c){if(c["default-metric-value"]&&c["default-metric-value"]!=c["display-metric-value"]&&c["available-units"]){var d=c["available-units"][c["default-metric-value"]],e=c["available-units"][c["display-metric-value"]];d!==e&&(c[b.key[0]][b.key[1]][b.key[2]]=getConversionFunction(d,e)(c[b.key[0]][b.key[1]][b.key[2]]))}}}]}]}]}]},{type:"section",htmlClass:"col-xs-6",items:["goal-stroke-width"]}]}]},{title:"Box Properties",items:["boxLabel"]}]}],schema:{type:"object",title:"Schema",properties:{boxLabel:{title:"Box label",type:"string",description:"Define your widget box title."},boxBorder:{title:"Box Border",type:"hidden",default:"true",description:"Define your widget box border."},stream:{title:"Channels",type:"array",items:{type:"string"},description:"",placeholder:" "},data:{title:"Data",type:"string",description:"Data to plot in case of static data.This is an array of objects, containing x and y attributes as described by the xkey and ykeys options. The order in which you provide the data is the order in which the bars are displayed.","x-schema-form":{type:"textarea",placeholder:"[{ y: '2006', a: 100, b: 90 },{ y: '2007', a: 75,  b: 65 }, { y: '2008', a: 50,  b: 40 }]"}},"parse-time":{title:"Parse time",type:"hidden",default:"true",description:"Set to false to skip time/date parsing for X values, instead treating them as an equally-spaced series."},xkey:{title:"X key",type:"string",description:"A string containing the name of the attribute that contains X labels.",default:"date"},"colors-mapping":{title:"Colors",type:"array",default:[],description:"",items:{type:"object",properties:{colors:{title:"Colors",type:"string",format:"color",validationMessage:"Invalid Color"},labels:{title:"Labels",type:"string"},ykeys:{title:"Channel",readonly:!0,type:"string"}}}},stacked:{title:"Stacked",type:"string",default:"false",description:"Set to true to draw bars stacked vertically."},"hide-hover":{title:"Hide hover",default:"auto",type:"hidden",description:"Set to Never to always show a hover legend. Set to 'auto' to only show the hover legend when the mouse cursor is over the chart. Set to 'always' to never show a hover legend."},"show-legend":{title:"Show Legend",type:"string",default:"true",description:"Set visibility of the legend."},"hover-callback":{title:"Hover callback",type:"string",description:"Provide a function on this option to generate custom hover legends. The function will be called with the index of the row under the hover legend, the options object passed to the constructor as arguments, a string containing the default generated hover legend content HTML, and an object containing the original data for the row as passed in the data option. hoverCallback: function (index, options, content, row) {return 'sin(' + row.x + ')='+ row.y}"},axes:{title:"Axes",type:"string",description:"Set to false to disable drawing the x and y axes.",default:"true"},grid:{title:"Grid",type:"string",description:"Set to false to disable drawing the horizontal grid lines.",default:"true"},"grid-text-color":{title:"Grid text color",type:"string",description:"Set the color of the axis labels (default: #888).",format:"color",default:"#888",validationMessage:"Invalid Color"},"grid-text-size":{title:"Grid text size",type:"number",description:"Set the point size of the axis labels (default: 12).",default:12},"grid-text-family":{title:"Grid text family",type:"string",description:"Set the font family of the axis labels (default: sans-serif).",default:"Source Sans Pro",placeholder:" "},"grid-text-weight":{title:"Grid text weight",type:"string",description:"Set the font weight of the axis labels (default: normal).",default:"normal",placeholder:" "},ymax:{title:"Y maximum value",type:"string",default:"auto",description:"Max. bound for Y-values. Alternatively, set this to 'auto' to compute automatically, or 'auto [num]' to automatically compute and ensure that the max y-value is at least [num]."},ymin:{title:"Y minimum value",type:"string",default:"auto 0",description:"Min. bound for Y-values. Alternatively, set this to 'auto' to compute automatically, or 'auto [num]' to automatically compute and ensure that the min y-value is at most [num]. You can use this to create graphs with false origins."},"post-units":{title:"Post units",type:"string",description:"Set to a string value (eg: '%') to add a label suffix all y-labels."},"pre-units":{title:"Pre units",type:"string",description:"Set to a string value (eg: '$') to add a label prefix all y-labels."},"xlabel-angle":{title:"X label angle",type:"number",default:0,description:"The angle in degrees from horizontal to draw x-axis labels."},"ylabel-format":{title:"Y label Format",type:"string",description:"A function that accepts y-values and formats them for display as y-axis labels. function (y) { return y.toString() + 'km'; }"},"goal-stroke-width":{title:"Goal stroke width",type:"number",default:1,description:"Width, in pixels, of the goal lines."},"custom-goals":{title:"Goals",type:"array",description:"Goals: A list of y-values to draw as horizontal 'goal' lines on the chart. goals: [1.0, -1.0] <br/>Colors: Array of color values to use for the goal line colors.",default:[{"goal-line-colors":"#666633",goals:""},{"goal-line-colors":"#999966",goals:""},{"goal-line-colors":"#cc6666",goals:""},{"goal-line-colors":"#663333",goals:""}],items:{type:"object",properties:{"goal-line-colors":{title:"Goal Line Colors",type:"string",format:"color",validationMessage:"Invalid Color",default:"#666633"},goals:{title:"Goals",type:"number"}}}}},required:["xkey","ykeys","labels"]}},{name:"area",label:"Area Chart",class:"scriptr-chart",commonData:!0,show:!0,defaults:{type:"area","on-format-data":"return data;","parse-time":"true","data-type":"raw","data-format":"morris","schema-for":"area","fetch-from-date-param":"from_date","fetch-to-date-param":"to_date","display-metric-param":"display_metric","fetch-data-interval":300,boxLabel:"Area Chart",boxBorder:!0,xkey:"y",labels:'["Serie A", "Serie B"]',colors:["#5fc100","#005487"],transport:"wss","grid-text-family":"Arial",data:'[{"y":2000,"a":64,"b":82},{"y":2003,"a":53,"b":48},{"y":2004,"a":81,"b":58},{"y":2005,"a":68,"b":72},{"y":2008,"a":52,"b":60},{"y":20011,"a":55,"b":30},{"y":2013,"a":79,"b":40}]',"hide-hover":"auto","show-legend":"true"},box:{sizeX:2,sizeY:3,minSizeX:2,minSizeY:2},imgSrc:"//cdn.rawgit.com/scriptrdotio/onset-static-resources/15759895/images/area-chart.svg",form:[{type:"tabs",tabs:[{title:"Data",items:[{type:"section",htmlClass:"col-xs-12",items:[{key:"stream",type:"uiselectmultiple",placeholder:"",onChange:function(a,b,c){for(var d=["#CC5464","#FCC717","#38B9D6","#1DBC68","#E90088"],e={},f=c["colors-mapping"],g=0;g<f.length;g++)f[g].ykeys&&(e[f[g].ykeys]={labels:f[g].labels,colors:f[g].colors});for(var h=[],i=0;i<a.length;i++)if(e[a[i].value])h.push({ykeys:a[i].value,labels:e[a[i].value].labels,colors:e[a[i].value].colors});else{for(var j=0;j<d.length;j++){for(var k=!1,l=d[j],m=0;m<h.length;m++){var n=h[m].colors;if(n==l){k=!0;break}}if(!k)break}h.push({ykeys:a[i].value,labels:a[i].name,colors:k?d[0]:d[j]})}0==h.length&&(h=[{}]),c["colors-mapping"]=h;for(var o="[",p="[",i=0;i<a.length;i++)o+='"'+a[i].value+'"'+(i<a.length-1?" , ":""),p+='"'+a[i].name+'"'+(i<a.length-1?" , ":"");c.ykeys=o+"]",c.labels=p+"]",c.xkey="date",a.length>0&&delete c.data,a&&a.length>0&&(c["available-units"]={si:a[0].availableUnits.si,us:a[0].availableUnits.us})},options:{closeOnSelect:!1,groupBy:"dataStream",multiple:"true",callback:"multiSelectCallBack",widgetName:"area",limit:20,limitTo:50}}]}]},{title:"X",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12",items:["xkey","xlabel-angle"]}]}]},{title:"Y",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:["pre-units","ymin"]},{type:"section",htmlClass:"col-xs-6",items:["post-units","ymax"]}]}]},{title:"Legend",items:[{type:"radios-inline",key:"show-legend",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]},{type:"section",htmlClass:"",items:[{key:"colors-mapping",title:"Legend Details",add:null,remove:null,items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12 col-sm-4",items:[{key:"colors-mapping[].ykeys",title:"Channel"}]},{type:"section",htmlClass:"col-xs-12 col-sm-4",items:[{key:"colors-mapping[].labels",title:"Legend Label"}]},{type:"section",htmlClass:"col-xs-12 col-sm-4",items:[{key:"colors-mapping[].colors",title:"Color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}}]}]}]}]}]},{title:"Grid",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:[{type:"radios-inline",key:"grid",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]},{type:"radios-inline",key:"axes",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]},{key:"grid-text-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}}]},{type:"section",htmlClass:"col-xs-6",items:[{key:"grid-text-family",notitle:!1,type:"strapselect",titleMap:[{value:"Arial",name:"Arial"},{value:"Helvetica",name:"Helvetica"},{value:"Times New Roman",name:"Times New Roman"},{value:"Courier New",name:"Courier New"},{value:"Courier",name:"Courier"},{value:"Verdana",name:"Verdana"},{value:"Georgia",name:"Georgia"},{value:"Palatino",name:"Palatino"},{value:"Garamond",name:"Garamond"},{value:"Bookman",name:"Bookman"},{value:"Comic Sans MS",name:"Comic Sans MS"},{value:"Trebuchet MS",name:"Trebuchet MS"},{value:"Arial Black",name:"Arial Black"},{value:"Impact",name:"Impact"},{value:"Sans-Serif",name:"Sans-Serif"},{value:"Source Sans Pro",name:"Source Sans Pro"}]},{key:"grid-text-weight",notitle:!1,type:"strapselect",titleMap:[{value:"normal",name:"Normal"},{value:"bold",name:"Bold"}]},"grid-text-size"]}]}]},{title:"Lines & Points",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:["line-width",{type:"radios-inline",key:"smooth",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]}]},{type:"section",htmlClass:"col-xs-6",items:["point-size",{key:"point-fill-colors",items:[{key:"point-fill-colors[]",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}}]},{key:"point-stroke-colors",items:[{key:"point-stroke-colors[]",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}}]}]}]}]},{title:"Area",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:[{type:"radios-inline",key:"behave-like-line",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]},{key:"fill-opacity",step:"0.1"}]}]}]},{title:"Goals",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12",items:[{key:"custom-goals",title:"Fill Color & Goals",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:[{key:"custom-goals[].goal-line-colors",title:"Colors",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}}]},{type:"section",htmlClass:"col-xs-6",items:[{key:"custom-goals[].goals",onFieldLoad:function(a,b,c){if(c["default-metric-value"]&&c["default-metric-value"]!=c["display-metric-value"]&&c["available-units"]){var d=c["available-units"][c["default-metric-value"]],e=c["available-units"][c["display-metric-value"]];d!==e&&(c[b.key[0]][b.key[1]][b.key[2]]=getConversionFunction(d,e)(c[b.key[0]][b.key[1]][b.key[2]]))}}}]}]}]}]},{type:"section",htmlClass:"col-xs-6",items:["goal-stroke-width"]}]}]},{title:"Events",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12",items:[{key:"custom-events",title:"Fill Colors & Events",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:[{key:"custom-events[].event-line-colors",title:"Colors",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}}]},{type:"section",htmlClass:"col-xs-6",items:[{key:"custom-events[].events"}]}]}]}]},{type:"section",htmlClass:"col-xs-6",items:["event-stroke-width"]}]}]},{title:"Box Properties",items:["boxLabel"]}]}],schema:{type:"object",title:"Schema",properties:{boxLabel:{title:"Box Label",type:"string",description:"Define your widget box title."},boxBorder:{title:"Box Border",type:"hidden",default:"true",description:"Define your widget box border."},stream:{title:"Channels",type:"array",items:{type:"string"},description:"",placeholder:" "},data:{title:"Data",type:"string",description:"Data series in case of static data.","x-schema-form":{type:"textarea",placeholder:"[{ y: '2006', a: 100, b: 90 },{ y: '2007', a: 75,  b: 65 }, { y: '2008', a: 50,  b: 40 }]"}},"parse-time":{title:"Parse time",type:"hidden",default:"true",description:"Set to false to skip time/date parsing for X values, instead treating them as an equally-spaced series."},xkey:{title:"X key",type:"string",description:"A string containing the name of the attribute that contains date (X) values. Timestamps are accepted in the form of millisecond timestamps (as returned by Date.getTime() or as strings in the following formats: 2012, 2012 Q1, 2012 W1, 2012-02, 2012-02-24, 2012-02-24 15:00, 2012-02-24 15:00:00, 2012-02-24 15:00:00.000. date/time strings can optionally contain a T between the date and time parts, and/or a Z suffix, for compatibility with ISO-8601 dates.",default:"date"},"colors-mapping":{title:"Colors",type:"array",default:[],description:"An array of strings containing HTML-style hex colors for each of the donut segments. Note: if there are fewer colors than segments, the colors will cycle back to the start of the array when exhausted.",items:{type:"object",properties:{colors:{title:"Colors",type:"string",format:"color",validationMessage:"Invalid Color"},labels:{title:"labels",type:"string"},ykeys:{title:"Channel",readonly:!0,type:"string"}}}},"line-width":{title:"Line width",type:"number",default:3,description:"Width of the series lines, in pixels."},"point-size":{title:"Point size",type:"number",default:4,description:"Diameter of the series points, in pixels."},"point-fill-colors":{title:"Point fill colors",type:"array",description:"Colors for the series points. By default uses the same values as lineColors.",items:{format:"color",type:"string",validationMessage:"Invalid Color"}},"point-stroke-colors":{title:"Point Stroke Colors",type:"array",default:["#fff"],description:"Colors for the outlines of the series points. (#ffffff by default).",items:{format:"color",type:"string",validationMessage:"Invalid Color"}},ymax:{title:"Y maximum value",type:"string",default:"auto",description:"Max. bound for Y-values. Alternatively, set this to 'auto' to compute automatically, or 'auto [num]' to automatically compute and ensure that the max y-value is at least [num]."},ymin:{title:"Y minimum value",type:"string",default:"auto 0",description:"Min. bound for Y-values. Alternatively, set this to 'auto' to compute automatically, or 'auto [num]' to automatically compute and ensure that the min y-value is at most [num]. You can use this to create graphs with false origins."},smooth:{title:"Smooth",type:"string",default:"true",description:"Set to false to disable line smoothing."},"hide-hover":{title:"Hide hover",default:"auto",type:"hidden",description:"Set to Never to always show a hover legend. Set to 'auto' to only show the hover legend when the mouse cursor is over the chart. Set to 'always' to never show a hover legend."},"show-legend":{title:"Show Legend",type:"string",default:"true",description:"Set visibility of the legend."},"hover-callback":{title:"Hover callback",type:"string",description:"Provide a function on this option to generate custom hover legends. The function will be called with the index of the row under the hover legend, the options object passed to the constructor as arguments, a string containing the default generated hover legend content HTML, and an object containing the original data for the row as passed in the data option. hoverCallback: function (index, options, content, row) {return 'sin(' + row.x + ')='+ row.y}"},"post-units":{title:"Post units",type:"string",description:"Set to a string value (eg: '%') to add a label suffix all y-labels."},"pre-units":{title:"Pre units",type:"string",description:"Set to a string value (eg: '$') to add a label prefix all y-labels."},xlabels:{title:"X labels",type:"string",default:"auto",description:"Sets the x axis labelling interval. By default the interval will be automatically computed.",format:"uiselect",placeholder:" ",items:[{value:"auto",label:"auto"},{value:"decade",label:"decade"},{value:"year",label:"year"},{value:"month",label:"month"},{value:"week",label:"week"},{value:"day",label:"day"},{value:"hour",label:"hour"},{value:"30min",label:"30min"},{value:"15min",label:"15min"},{value:"10min",label:"10min"},{value:"5min",label:"5min"},{value:"minute",label:"minute"},{value:"30sec",label:"30sec"},{value:"15sec",label:"15sec"},{value:"10sec",label:"10sec"},{value:"5sec",label:"5sec"},{value:"second",label:"second"}]},"xlabel-angle":{title:"X label angle",type:"number",default:0,description:"The angle in degrees from horizontal to draw x-axis labels."},"xlabel-format":{title:"X label format",type:"string",description:"A function that accepts Date objects and formats them for display as x-axis labels. Overrides the default formatter chosen by the automatic labeller or the xLabels option. function (x) { return x.toString(); }"},"ylabel-format":{title:"Y label format",type:"string",description:"A function that accepts y-values and formats them for display as y-axis labels. function (y) { return y.toString() + 'km'; }"},"goal-stroke-width":{title:"Goal stroke width",type:"number",default:1,description:"Width, in pixels, of the goal lines."},"custom-goals":{title:"Goals",type:"array",description:"Goals: A list of y-values to draw as horizontal 'goal' lines on the chart. goals: [1.0, -1.0] <br/>Colors: Array of color values to use for the goal line colors.",default:[{"goal-line-colors":"#666633",goals:""},{"goal-line-colors":"#999966",goals:""},{"goal-line-colors":"#cc6666",goals:""},{"goal-line-colors":"#663333",goals:""}],items:{type:"object",properties:{"goal-line-colors":{title:"Goal Line Colors",type:"string",format:"color",validationMessage:"Invalid Color",default:"#666633"},goals:{title:"Goals",type:"number"}}}},"event-stroke-width":{title:"Event stroke width",type:"number",default:1,description:"Width, in pixels, of the event lines."},"custom-events":{title:"Events",type:"array",description:"Events: A list of x-values to draw as vertical 'event' lines on the chart. ex: ['2012-01-01', '2012-02-01'] <br/>Colors: Array of color values to use for the event line colors.",default:[{"event-line-colors":"#666633",events:""},{"event-line-colors":"#999966",events:""},{"event-line-colors":"#cc6666",events:""},{"event-line-colors":"#663333",events:""}],items:{type:"object",properties:{"event-line-colors":{title:"Event Line Colors",type:"string",format:"color",validationMessage:"Invalid Color"},events:{title:"Events",type:"string"}}}},axes:{title:"Axes",type:"string",description:"Set to false to disable drawing the x and y axes.",default:"true"},grid:{title:"Grid",type:"string",description:"Set to false to disable drawing the horizontal grid lines.",default:"true"},"grid-text-color":{title:"Grid text color",type:"string",description:"Set the color of the axis labels (default: #888).",format:"color",default:"#888",validationMessage:"Invalid Color"},"grid-text-size":{title:"Grid text size",type:"number",description:"Set the point size of the axis labels (default: 12).",default:12},"grid-text-family":{title:"Grid text family",type:"string",description:"Set the font family of the axis labels (default: sans-serif).",default:"Source Sans Pro",placeholder:" "},"grid-text-weight":{title:"Grid text weight",type:"string",description:"Set the font weight of the axis labels (default: normal).",default:"normal",placeholder:" "},"fill-opacity":{title:"Fill opacity",type:"number",default:1,description:"Change the opacity of the area fill color. Accepts values between 0.0 (for completely transparent) and 1.0 (for completely opaque).",minimum:0,maximum:1},"behave-like-line":{title:"Behave like Line",type:"string",default:"false",description:"Set to true to overlay the areas on top of each other instead of stacking them."},"date-format":{title:"Date format",type:"string",description:"A function that accepts millisecond timestamps and formats them for display as chart labels. default is function (x) { return new Date(x).toString() }."}},required:["xkey","ykeys"]}},{name:"donut",label:"Donut Chart",class:"scriptr-chart",commonData:!0,show:!0,defaults:{type:"donut","data-type":"latest","data-format":"morris","schema-for":"donut","fetch-from-date-param":"from_date","fetch-to-date-param":"to_date","fetch-data-interval":300,"on-format-data":"return data;",boxLabel:"Donut Chart",boxBorder:!0,transport:"wss",colors:["#005487","#fba723","#aa241d"],data:'[{label: "Serie A", value: 70}, {label: "Serie B",value: 30 }]',ykeys:["Serie A","Serie B"],"show-legend":"true"},box:{sizeX:2,sizeY:3,minSizeX:2,minSizeY:3},imgSrc:"//cdn.rawgit.com/scriptrdotio/onset-static-resources/97574e7b/images/donut-chart.svg",form:[{type:"tabs",tabs:[{title:"Data",items:[{type:"section",htmlClass:"col-xs-12",items:[{key:"stream",type:"uiselectmultiple",placeholder:"",options:{closeOnSelect:!0,groupBy:"dataStream",multiple:"false",callback:"multiSelectCallBack",widgetName:"donut",limit:20,limitTo:50},onChange:function(a,b,c){for(var d=["#CC5464","#FCC717","#38B9D6","#1DBC68","#E90088"],e={},f=c["colors-mapping"],g=0;g<f.length;g++)f[g].ykeys&&(e[f[g].ykeys]={labels:f[g].labels,colors:f[g].colors});for(var h=[],i=0;i<a.length;i++)if(e[a[i].value])h.push({ykeys:a[i].value,labels:e[a[i].value].labels,colors:e[a[i].value].colors});else{for(var j=0;j<d.length;j++){for(var k=!1,l=d[j],m=0;m<h.length;m++){var n=h[m].colors;if(n==l){k=!0;break}}if(!k)break}h.push({ykeys:a[i].value,labels:a[i].name,colors:k?d[0]:d[j]})}0==h.length&&(h=[{}]),c["colors-mapping"]=h}}]}]},{title:"Format",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12",items:[{key:"background-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}},{key:"label-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}}]}]}]},{title:"Legend",items:[{type:"radios-inline",key:"show-legend",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]},{type:"section",htmlClass:"",items:[{key:"colors-mapping",title:"Legend Details",add:null,remove:null,items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12 col-sm-4",items:[{key:"colors-mapping[].ykeys",title:"Channel"}]},{type:"section",htmlClass:"col-xs-12 col-sm-4",items:[{key:"colors-mapping[].labels",title:"Legend Label"}]},{type:"section",htmlClass:"col-xs-12 col-sm-4",items:[{key:"colors-mapping[].colors",title:"Color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}}]}]}]}]}]},{title:"Box Properties",items:["boxLabel"]}]}],schema:{type:"object",title:"Schema",properties:{"show-legend":{title:"Show Legend",default:"true",type:"string",description:"Set visibility of the legend."},"hover-callback":{title:"Hover callback",type:"string",description:"Provide a function on this option to generate custom hover legends. The function will be called with the index of the row under the hover legend, the options object passed to the constructor as arguments, a string containing the default generated hover legend content HTML, and an object containing the original data for the row as passed in the data option. hoverCallback: function (index, options, content, row) {return 'sin(' + row.x + ')='+ row.y}"},stream:{title:"Channel",type:"string",description:"",placeholder:" "},boxLabel:{title:"Box Label",type:"string",description:"Define your widget box title."},boxBorder:{title:"Box Border",type:"hidden",default:"true",description:"Define your widget box border."},data:{title:"Data",type:"string",description:"Data series in case of static data.","x-schema-form":{type:"textarea",placeholder:"[{ y: '2006', a: 100, b: 90 },{ y: '2007', a: 75,  b: 65 }, { y: '2008', a: 50,  b: 40 }]"}},"colors-mapping":{title:"Colors",type:"array",default:[],description:"An array of strings containing HTML-style hex colors for each of the donut segments. Note: if there are fewer colors than segments, the colors will cycle back to the start of the array when exhausted.",items:{type:"object",properties:{colors:{title:"Colors",type:"string",format:"color",validationMessage:"Invalid Color"},labels:{title:"labels",type:"string"},ykeys:{title:"Channel",readonly:!0,type:"string"}}}},"label-color":{title:"Donut Label Color",type:"string",description:"Donut label color.",format:"color",default:"#eeeeee",validationMessage:"Invalid Color"},"background-color":{title:"Donut Background Color",type:"string",description:"Donut background color.",format:"color",default:"#ffffff",validationMessage:"Invalid Color"}},required:[]}},{name:"gauge",label:"Gauge",class:"scriptr-gauge",
commonData:!0,show:!0,defaults:{transport:"wss","on-format-data":"if(data && data.length > 0) return data[0].value; else return data;","data-type":"latest","data-format":"live","schema-for":"gauge","display-metric-param":"display_metric","fetch-data-interval":300,boxLabel:"Gauge",boxBorder:!0,data:[{value:30}],"value-font-color":"#005588",height:"99","height-unit":"%"},box:{sizeX:1,sizeY:2,minSizeX:1,minSizeY:2},imgCls:"gauge-img",imgSrc:"//cdn.rawgit.com/scriptrdotio/onset-static-resources/97574e7b/images/gauge.svg",form:[{type:"tabs",tabs:[{title:"Data",items:[{type:"section",htmlClass:"",items:[{key:"stream",type:"uiselect",placeholder:"",options:{closeOnSelect:!0,groupBy:"dataStream",callback:"multiSelectCallBack",widgetName:"gauge"},onChange:function(a,b,c){if(a&&a.length>0){var d=_.findWhere(_.findWhere(JSON.parse(window.localStorage.dataStream),{logger_sn:a.split("-")[0]}).sensors,{selectedStreamValue:a});c["available-units"]={si:d.si_unit,us:d.us_unit}}}}]}]},{title:"Format",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6 col-sm-3",items:["symbol"]},{type:"section",htmlClass:"col-xs-6 col-sm-3",items:["value-min-font-size"]},{type:"section",htmlClass:"col-xs-6 col-sm-3",items:[{key:"value-font-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}}]},{type:"section",htmlClass:"col-xs-6 col-sm-3",items:[{key:"hide-value",type:"radios-inline",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]}]}]},{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12",items:[{type:"help",helpvalue:"<hr/>"}]}]},{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-4",items:["label"]},{type:"section",htmlClass:"col-xs-4",items:["label-min-font-size"]},{type:"section",htmlClass:"col-xs-4",items:[{key:"label-font-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}}]}]},{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12",items:[{type:"help",helpvalue:"<hr/>"}]}]},{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:[{key:"value-font-family",notitle:!1,type:"strapselect",titleMap:[{value:"Arial",name:"Arial"},{value:"Helvetica",name:"Helvetica"},{value:"Times New Roman",name:"Times New Roman"},{value:"Courier New",name:"Courier New"},{value:"Courier",name:"Courier"},{value:"Verdana",name:"Verdana"},{value:"Georgia",name:"Georgia"},{value:"Palatino",name:"Palatino"},{value:"Garamond",name:"Garamond"},{value:"Bookman",name:"Bookman"},{value:"Comic Sans MS",name:"Comic Sans MS"},{value:"Trebuchet MS",name:"Trebuchet MS"},{value:"Arial Black",name:"Arial Black"},{value:"Impact",name:"Impact"},{value:"Sans-Serif",name:"Sans-Serif"},{value:"Source Sans Pro",name:"Source Sans Pro"}]}]},{type:"section",htmlClass:"col-xs-6",items:[{key:"gauge-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}}]}]},{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12",items:[{type:"help",helpvalue:"<hr/>"}]}]},{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:[{key:"format-number",type:"radios-inline",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]}]},{type:"section",htmlClass:"col-xs-6",items:["decimals"]}]},{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:[{key:"human-friendly",type:"radios-inline",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]}]},{type:"section",htmlClass:"col-xs-6",items:["human-friendly-decimal"]}]}]},{title:"Min/Max",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:[{key:"min",onFieldLoad:function(a,b,c){if(c["default-metric-value"]&&c["default-metric-value"]!=c["display-metric-value"]&&c["available-units"]){var d=c["available-units"][c["default-metric-value"]],e=c["available-units"][c["display-metric-value"]];d!==e&&(c[b.key[0]]=getConversionFunction(d,e)(c[b.key[0]])),c.unit&&c.unit!=e&&(c.unit=e)}}},"min-label-min-font-size",{key:"hide-min-max",type:"radios-inline",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]}]},{type:"section",htmlClass:"col-xs-6",items:[{key:"max",onFieldLoad:function(a,b,c){if(c["default-metric-value"]&&c["default-metric-value"]!=c["display-metric-value"]&&c["available-units"]){var d=c["available-units"][c["default-metric-value"]],e=c["available-units"][c["display-metric-value"]];d!==e&&(c[b.key[0]]=getConversionFunction(d,e)(c[b.key[0]])),c.unit&&c.unit!=e&&(c.unit=e)}}},"max-label-min-font-size",{key:"reverse",type:"radios-inline",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]}]}]}]},{title:"Sectors",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:[{key:"pointer",type:"radios-inline",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]}]},{type:"section",htmlClass:"col-xs-6",items:[{key:"gauge-width-scale",step:"0.1"}]}]},{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:[{key:"donut",type:"radios-inline",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]}]},{type:"section",htmlClass:"col-xs-6",items:["donut-start-angle"]}]},{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:[{key:"no-gradient",type:"radios-inline",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]}]},{type:"section",htmlClass:"col-xs-6",items:[{key:"level-colors",items:[{key:"level-colors[]",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}}],style:{add:"btn-primary btn-sm pull-left"}}]}]},{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:[{key:"custom-sectors",title:"",items:[{key:"custom-sectors.percents",title:"Custom percent",type:"radios-inline",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]}]}]},{type:"section",htmlClass:"col-xs-6",items:[{key:"custom-sectors",title:"",items:[{key:"custom-sectors.ranges",startEmpty:!0,title:"Custom Ranges",style:{add:"btn-primary btn-sm pull-left"},items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:[{key:"custom-sectors.ranges[].color",title:"color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}}]},{type:"section",htmlClass:"col-xs-6",items:[{key:"custom-sectors.ranges[].lo",onFieldLoad:function(a,b,c){if(c["default-metric-value"]&&c["default-metric-value"]!=c["display-metric-value"]&&c["available-units"]){var d=c["available-units"][c["default-metric-value"]],e=c["available-units"][c["display-metric-value"]];d!==e&&(c[b.key[0]][b.key[1]][b.key[2]][b.key[3]]=getConversionFunction(d,e)(c[b.key[0]][b.key[1]][b.key[2]][b.key[3]])),c.unit&&c.unit!=e&&(c.unit=e)}}}]},{type:"section",htmlClass:"col-xs-6",items:[{key:"custom-sectors.ranges[].hi",onFieldLoad:function(a,b,c){if(c["default-metric-value"]&&c["default-metric-value"]!=c["display-metric-value"]&&c["available-units"]){var d=c["available-units"][c["default-metric-value"]],e=c["available-units"][c["display-metric-value"]];d!==e&&(c[b.key[0]][b.key[1]][b.key[2]][b.key[3]]=getConversionFunction(d,e)(c[b.key[0]][b.key[1]][b.key[2]][b.key[3]])),c.unit&&c.unit!=e&&(c.unit=e)}}}]}]}]}]}]}]}]},{title:"Shadow",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6 col-sm-3",items:[{key:"show-inner-shadow",type:"radios-inline",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]}]},{type:"section",htmlClass:"col-xs-6 col-sm-3",items:["shadow-size"]},{type:"section",htmlClass:"col-xs-6 col-sm-3",items:[{key:"shadow-opacity",step:"0.1"}]},{type:"section",htmlClass:"col-xs-6 col-sm-3",items:["shadow-vertical-offset"]}]}]},{title:"Animation",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:[{key:"start-animation-type",notitle:!1,type:"strapselect",titleMap:[{value:"linear",name:"linear"},{value:">",name:">"},{value:"<",name:"<"},{value:"<>",name:"<>"},{value:"bounce",name:"bounce"}]},{key:"refresh-animation-type",notitle:!1,type:"strapselect",titleMap:[{value:"linear",name:"linear"},{value:">",name:">"},{value:"<",name:"<"},{value:"<>",name:"<>"},{value:"bounce",name:"bounce"}]},{key:"counter",type:"radios-inline",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]}]},{type:"section",htmlClass:"col-xs-6",items:["start-animation-time","refresh-animation-time"]}]}]},{title:"Box Properties",items:["boxLabel"]}]}],schema:{type:"object",title:"Schema",properties:{boxLabel:{title:"Box Label",type:"string",description:"Define your widget box title."},boxBorder:{title:"Box Border",type:"hidden",default:"true",description:"Define your widget box border."},data:{title:"Static data",type:"number",description:"Gauge static value to show"},stream:{title:"Channel",type:"string",description:"",placeholder:" "},"value-font-color":{title:"Value color",type:"string",default:"#005386",format:"color",description:"Color of the gauge value text",validationMessage:"Invalid Color"},min:{title:"Gauge min",type:"number",default:0,description:"Minimum gauge value."},max:{title:"Gauge max",type:"number",default:100,description:"Maximum gauge value."},"hide-min-max":{title:"Hide min/max",type:"string",default:"false",description:"Select true to hide min and max values (bool)"},"hide-value":{title:"Hide value",type:"string",default:"false",description:"Select true to hide gauge value"},"show-inner-shadow":{title:"Show shadow",type:"string",default:"false",description:"Show gauge inner shadow"},"gauge-color":{title:"Gauge background",type:"string",format:"color",description:"Background color of gauge.",validationMessage:"Invalid Color"},"custom-sectors":{title:"Custom sectors",type:"object",properties:{percents:{title:"Percents",type:"string",default:"false",description:"Set to true for to have percent based sectors."},ranges:{type:"array",items:{type:"object",properties:{color:{title:"Sector Color",type:"string",format:"color",required:!0,validationMessage:"Invalid Color"},lo:{title:"Low",type:"number",required:!0},hi:{title:"High",type:"number",required:!0}}}}}},"shadow-size":{title:"Shadow size",type:"number",default:5,description:"Gauge inner shadow size."},"shadow-opacity":{title:"Shadow opacity",type:"number",default:.2,description:"Shadow opacity, values 0 ~ 1",minimum:0,maximum:1},label:{title:"Label",type:"string",description:"Text to show below gauge value."},"label-font-color":{title:"Label color",type:"string",description:"Color of label under the value",format:"color",validationMessage:"Invalid Color"},"start-animation-type":{title:"Start animation",type:"string",default:"linear",description:"Select type of initial animation.",placeholder:" "},"refresh-animation-type":{title:"Refresh animation",type:"string",default:"linear",description:"Select type of refresh animation.",placeholder:" "},"value-font-family":{title:"Gauge font family",type:"string",default:"Arial",placeholder:" ",description:"Font family of the gauge."},"value-min-font-size":{title:"Value size",type:"number",default:12,description:"Minimum font size for the value."},"label-min-font-size":{title:"Label size",type:"number",default:12,description:"Minimum font size for the label."},"min-label-min-font-size":{title:"Min label size",type:"number",default:12,description:"Minimum font size for the minimum label."},"max-label-min-font-size":{title:"Max label size",type:"number",default:12,description:"Minimum font size for the maximum label."},"gauge-width-scale":{title:"Width scale",type:"number",default:1,description:"Gauge width scale."},"shadow-vertical-offset":{title:"Shadow vertical offset",type:"number",default:3,description:"Defines how much is shadow offset from top."},"level-colors":{title:"Level colors",type:"array",minItems:1,items:{type:"string",format:"color",validationMessage:"Invalid Color"},format:"color",default:["#005588","#5fc100","#fe4444"],description:"Colors of indicator, from lower to upper."},"relative-gauge-size":{title:"Relative gauge size",type:"string",default:"true",description:"Set to true to use sector-based color change, false to use gradual color change."},"no-gradient":{title:"No gradient",type:"string",default:"false",description:"Set to true to use sector-based color change, false to use gradual color change."},"start-animation-time":{title:"Start animation time",type:"number",default:700,description:"Duration of initial load animation in ms."},"refresh-animation-time":{title:"Refresh animation time",type:"number",default:700,description:"Length of refresh animation in ms."},donut:{title:"Donut",type:"string",default:"false",description:"Turn the gauge into a full circle donut."},"donut-start-angle":{title:"Donut start angle",type:"number",default:90,description:"Angle to start from when in donut mode."},width:{title:"Width",type:"number",description:"Gauge width"},height:{title:"Height",type:"number",description:"Gauge height."},reverse:{title:"Reverse",type:"string",default:"false",description:"Set to trueto swap max and min (with max appearing on the left, min on the right)."},decimals:{title:"Decimals",type:"number",default:0,description:"Quantity of decimal numbers to show."},symbol:{title:"Symbol",type:"string",description:"Unit of measure that will be appended to value."},"format-number":{title:"Format number",type:"string",default:"false",description:"Set to true to format numbers."},"human-friendly":{title:"Human friendly",type:"string",default:"false",description:"Set to true to show shorthand big numbers (300K instead of 300XXX)."},"human-friendly-decimal":{title:"Human friendly decimals",type:"number",default:0,description:"Number of decimal places for our human friendly number to contain."},pointer:{title:"Pointer",type:"string",default:"false",description:"Set to true to show value pointer."},counter:{title:"Counter",type:"string",default:"false",description:"Set to true to increase numbers one by one."}},required:["level-colors"]}},{name:"thermometer",label:"Thermometer",class:"scriptr-thermometer",commonData:!0,show:!0,defaults:{transport:"wss","on-format-data":"if(data) return data[0].value; else return data;","data-type":"latest","data-format":"live","schema-for":"thermometer","display-metric-param":"display_metric","fetch-data-interval":300,data:[{value:0}],value:80,boxLabel:"Thermometer",boxBorder:!0,step:30,unit:"°C","custom-sectors":[{color:"#005588",lo:0,hi:30},{color:"#aa241d",lo:30,hi:60},{color:"#ffa500",lo:60,hi:90}]},box:{sizeX:1,sizeY:3,minSizeX:1,minSizeY:3,maxSizeX:1},imgCls:"thermometer-img",imgSrc:"//cdn.rawgit.com/scriptrdotio/onset-static-resources/97574e7b/images/thermometer.svg",form:[{type:"tabs",tabs:[{title:"Data",items:[{type:"section",htmlClass:"",items:[{key:"stream",type:"uiselect",placeholder:"",options:{closeOnSelect:!0,groupBy:"dataStream",callback:"multiSelectCallBack",widgetName:"thermometer"},onChange:function(a,b,c){if(a&&a.length>0){var d=_.findWhere(_.findWhere(JSON.parse(window.localStorage.dataStream),{logger_sn:a.split("-")[0]}).sensors,{selectedStreamValue:a});c["available-units"]={si:d.si_unit,us:d.us_unit}}}}]}]},{title:"Format",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12 col-sm-6",items:[{key:"out-of-range-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}}]},{type:"section",htmlClass:"col-xs-12 col-sm-6",items:[{type:"section",htmlClass:"",items:["step"]},{type:"section",htmlClass:"",items:[{key:"custom-sectors",title:"Fill Color",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-4",items:[{key:"custom-sectors[].color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}}]},{type:"section",htmlClass:"col-xs-4",items:[{key:"custom-sectors[].lo",onFieldLoad:function(a,b,c){if(c["default-metric-value"]&&c["default-metric-value"]!=c["display-metric-value"]&&c["available-units"]){var d=c["available-units"][c["default-metric-value"]],e=c["available-units"][c["display-metric-value"]];d!==e&&(c[b.key[0]][b.key[1]][b.key[2]]=getConversionFunction(d,e)(c[b.key[0]][b.key[1]][b.key[2]])),c.unit&&c.unit!=e&&(c.unit=e)}}}]},{type:"section",htmlClass:"col-xs-4",items:[{key:"custom-sectors[].hi",onFieldLoad:function(a,b,c){if(c["default-metric-value"]&&c["default-metric-value"]!=c["display-metric-value"]&&c["available-units"]){var d=c["available-units"][c["default-metric-value"]],e=c["available-units"][c["display-metric-value"]];d!==e&&(c[b.key[0]][b.key[1]][b.key[2]]=getConversionFunction(d,e)(c[b.key[0]][b.key[1]][b.key[2]])),c.unit&&c.unit!=e&&(c.unit=e)}}}]}]}]}]}]}]}]},{title:"Box Properties",items:["boxLabel"]}]}],schema:{type:"object",title:"Schema",properties:{data:{title:"Thermometer Value",type:"string",description:"Thermometer Value (0 to 100)"},stream:{title:"Channel",type:"string",description:"",placeholder:" "},height:{title:"Height",type:"number",description:"Set the height of Thermometer."},unit:{title:"Unit",type:"hidden",default:"°C",description:"Set the unit value of Thermometer."},"out-of-range-color":{title:"Out Of Range Color",type:"string",description:"Set the default color for out of range values (default: #005588).",format:"color",default:"#5fc100",validationMessage:"Invalid Color"},"custom-sectors":{title:"Custom sectors",type:"array",items:{type:"object",properties:{color:{title:"Color",type:"string",format:"color",required:!0,validationMessage:"Invalid Color"},lo:{title:"Low",type:"number",required:!0},hi:{title:"High",type:"number",required:!0}}}},step:{title:"Interval",type:"number",description:"Set the interval value between ticks."},boxLabel:{title:"Box Label",type:"string",description:"Define your widget box title."},boxBorder:{title:"Box Border",type:"hidden",default:"true",description:"Define your widget box border."}},required:[]}},{name:"plotly",label:"Wind Rose",class:"scriptr-plotly",commonData:!0,show:!0,defaults:{transport:"wss","data-type":"raw","schema-for":"windrose","data-format":"windrose","fetch-from-date-param":"from_date","fetch-to-date-param":"to_date","display-metric-param":"display_metric","fetch-data-interval":300,"on-format-data":"return data;",boxLabel:"Wind Rose",boxBorder:!0,"retrieved-data":[{direction:"E",speeds:[2,3,15,17]},{direction:"ESE",speeds:[24,8,4]},{direction:"SSE",speeds:[2.5,7,16]},{direction:"S",speeds:[3,8,2,1,9,11]},{direction:"SSW",speeds:[13,3,7.5,8]},{direction:"WSW",speeds:[21,14,9]},{direction:"W",speeds:[7,0,8,9,15,19,11]},{direction:"WNW",speeds:[4,17,21]},{direction:"NNW",speeds:[14,7]},{direction:"N",speeds:[20,0,5,9,7]},{direction:"NNE",speeds:[1,.5,6.5]},{direction:"ENE",speeds:[3.5,30,15]}]},box:{sizeX:2,sizeY:4,minSizeX:2,minSizeY:4},imgCls:"",imgSrc:"//cdn.rawgit.com/scriptrdotio/onset-static-resources/6106965d/images/wind-rose.svg",form:[{type:"tabs",tabs:[{title:"Data",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12",items:[{key:"stream",notitle:!1,type:"uiselectmultiple",placeholder:"",options:{closeOnSelect:!0,groupBy:"dataStream",callback:"multiSelectCallBack",widgetName:"plotly",limit:"1",limitTo:50}}]}]}]},{title:"Format",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12 col-sm-6",items:["font-size",{key:"show-legend",type:"radios-inline",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]}]},{type:"section",htmlClass:"col-xs-12 col-sm-6",items:[{key:"custom-ranges",title:"Fill Color & Ranges",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-4",items:[{key:"custom-ranges[].color",title:"color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}}]},{type:"section",htmlClass:"col-xs-4",items:[{key:"custom-ranges[].lo",onFieldLoad:function(a,b,c){if(c["default-metric-value"]&&c["default-metric-value"]!=c["display-metric-value"]&&c["available-units"]){var d=c["available-units"][c["default-metric-value"]],e=c["available-units"][c["display-metric-value"]];d!==e&&(c[b.key[0]][b.key[1]][b.key[2]]=getConversionFunction(d,e)(c[b.key[0]][b.key[1]][b.key[2]])),c.unit&&c.unit!=e&&(c.unit=e)}}}]},{type:"section",htmlClass:"col-xs-4",items:[{key:"custom-ranges[].hi",onFieldLoad:function(a,b,c){if(c["default-metric-value"]&&c["default-metric-value"]!=c["display-metric-value"]&&c["available-units"]){var d=c["available-units"][c["default-metric-value"]],e=c["available-units"][c["display-metric-value"]];d!==e&&(c[b.key[0]][b.key[1]][b.key[2]]=getConversionFunction(d,e)(c[b.key[0]][b.key[1]][b.key[2]])),c.unit&&c.unit!=e&&(c.unit=e)}}}]}]}]}]}]}]},{title:"Box Properties",items:["boxLabel"]}]}],schema:{type:"object",title:"Schema",properties:{stream:{title:"Channels",type:"array",items:{type:"string"},description:"",placeholder:" "},"font-size":{title:"Font Size",type:"number",default:16,description:"Set the font size of the wind rose (in px)."},"show-legend":{title:"Show Legend",type:"string",default:"true",description:"Set visibility of the legend."},boxLabel:{title:"Box Label",type:"string",description:"Define your widget box title."},boxBorder:{title:"Box Border",type:"hidden",default:"true",description:"Define your widget box border."},"custom-ranges":{title:"Custom Ranges",type:"array",default:[{color:"#00476b",lo:0,hi:2},{color:"#005487",lo:2,hi:4},{color:"#006699",lo:4,hi:6},{color:"#0082b5",lo:6,hi:8},{color:"#0294c1",lo:8,hi:10},{color:"#06a9ce",lo:10,hi:20}],items:{type:"object",properties:{color:{title:"Sector Color",type:"string",format:"color",required:!0,validationMessage:"Invalid Color"},lo:{title:"Low",type:"number",required:!0},hi:{title:"High",type:"number",required:!0}}}}},required:[]}},{name:"grid",label:"Grid",class:"scriptr-grid",show:!0,commonData:!0,defaults:{"columns-definition":'[{headerName: "Name", field: "name", "minWidth": 110},{headerName: "Model", field: "model", "minWidth": 110},{headerName: "Price", field: "price", "minWidth": 110}]',"row-data":'[{name: "Toyota", model: "Celica", price: 35000},{name: "Ford", model: "Mondeo", price: 32000},{name: "Porsche", model: "Boxter", price: 72000}]',"data-type":"raw","data-format":"morris","schema-for":"grid","fetch-data-interval":300,boxLabel:"Grid",boxBorder:!0,"fixed-height":"false","on-format-data":'return {"documents":data, "count": data.length};',"pagination-page-size":"20",transport:"wss","cell-editable":!1,"enable-client-side-sorting":!0,pagination:"true","enable-server-side-sorting":!1,"enable-server-side-filter":!1,"enable-col-resize":"false"},box:{sizeX:2,sizeY:3,minSizeX:2,minSizeY:3},imgCls:"grid-img",imgSrc:"//cdn.rawgit.com/scriptrdotio/onset-static-resources/97574e7b/images/grid.svg",form:[{type:"tabs",tabs:[{title:"Data",items:[{type:"section",htmlClass:"",items:[{key:"stream",type:"uiselectmultiple",placeholder:"",onChange:function(a,b,c){var e=[];e.push({headerName:"Date",field:"date",minWidth:110,cellRenderer:function(a,b){return moment(d).format("YYYY-MM-DD HH:mm")}}),_.forEach(a,function(a){e.push({headerName:a.name,field:a.value,minWidth:110})}),e.length>0&&(c["columns-definition"]=JSON.stringify(e),console.log("-------model[columns-definition]",c["columns-definition"]),delete c["row-data"])},options:{closeOnSelect:!1,groupBy:"dataStream",multiple:"true",callback:"multiSelectCallBack",widgetName:"grid",limitTo:50,limit:8}}]}]},{title:"Format",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12",items:[{key:"pagination",type:"radios-inline",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]}]}]},{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12",items:["pagination-page-size",{key:"enable-server-side-sorting",type:"radios-inline",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]},{key:"enable-server-side-filter",type:"radios-inline",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]},{key:"enable-col-resize",type:"radios-inline",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]}]}]}]},{title:"Box Properties",items:["boxLabel"]}]}],schema:{type:"object",title:"Schema",properties:{boxLabel:{title:"Box Label",type:"string",description:"Define your widget box title."},boxBorder:{title:"Box Border",type:"hidden",default:"true",description:"Define your widget box border."},stream:{title:"Channels",type:"array",items:{type:"string"},description:"",placeholder:" "},"columns-definition":{title:"Columns definition",type:"string",description:"Series of data (Each column in the grid is defined using a column definition).","x-schema-form":{type:"textarea",placeholder:"[{'headerName': 'Name', 'field': 'name'}, {'headerName': 'Model', 'field': 'model'}, {'headerName': 'Price', 'field': 'price', 'type': 'numeric'}]"}},"row-data":{title:"Row data",type:"string",description:"You pass static data to the grid.","x-schema-form":{type:"textarea",placeholder:"[{'name': 'Golf', 'model': 'GT', 'price' : '10000'}, {'name': 'BMW', 'model': 'Z3', 'price' : '20000'}]"}},"enable-client-side-sorting":{title:"Enable client Side Sorting",type:"string",description:"Turn on client sorting for the grid."},"enable-client-side-filter":{title:"Enable Client Side Filter",type:"string",description:"Turn on client side filter."},"enable-add-row":{title:"Enable Add Row",type:"hidden",description:"Turn on insert row."},"enable-delete-row":{title:"Enable Delete Row",type:"hidden",description:"Turn on delete row."},"cell-editable":{title:"Cell Editable",type:"hidden",description:"Turn on cell editing."},"row-model-selection":{title:"Row Model Selection",type:"hidden",description:"Set to either 'single' or 'multiple' in case of backend data.",default:"Source Sans Pro",placeholder:" "},"suppress-filter":{title:"Suppress filer",type:"hidden",description:"Hide column filter."},"add-params":{title:"on-add API Params",type:"hidden",description:"On add API params.","x-schema-form":{placeholder:"Ex: {'id' : '599865'}"}},"delete-params":{title:"on-delete API Params",type:"hidden",description:"On delete API params.","x-schema-form":{placeholder:"Ex: {'id' : '599865'}"}},"edit-params":{title:"on-edit API Params",type:"hidden",description:"On edit API params.","x-schema-form":{placeholder:"Ex: {'id' : '599865'}"}},"enable-server-side-sorting":{title:"Enable Sorting",type:"string",description:"Turn on server sorting for the grid."},"enable-server-side-filter":{title:"Enable Filter",type:"string",description:"Turn on server side filter."},"enable-col-resize":{title:"Enable Column Resize",type:"string",description:"Enable column resize."},pagination:{title:"Enable Pagination",type:"string",description:"Enable Pagination."},"row-model-type":{title:"Row Model Type",type:"string",description:"The supported ways are 'virtual' and 'pagination' for only non-static data",default:"pagination",placeholder:" "},"pagination-page-size":{title:"Pagination Page Size",type:"string",description:"Number of rows per page."}},required:["columns-definition"]}},{name:"odometer",label:"Odometer",class:"scriptr-odometer",commonData:!0,show:!0,defaults:{transport:"wss",boxLabel:"Odometer","on-format-data":"if(data) return data[0].value; else return data;","data-type":"latest","data-format":"live","display-metric-param":"display_metric",boxBorder:!0,"schema-for":"odometer","fetch-data-interval":300,data:[{value:28022017}],animation:"count",duration:1e3,size:2},box:{sizeX:1,sizeY:2,minSizeX:1,minSizeY:2},imgCls:"odometer-img",imgSrc:"//cdn.rawgit.com/scriptrdotio/onset-static-resources/97574e7b/images/odometer.svg",form:[{type:"tabs",tabs:[{title:"Data",items:[{type:"section",htmlClass:"",items:[{key:"stream",type:"uiselect",placeholder:"",options:{closeOnSelect:!0,groupBy:"dataStream",callback:"multiSelectCallBack",widgetName:"odometer"}}]}]},{title:"Format",items:["duration","animation","size"]},{title:"Box Properties",items:["boxLabel"]}]}],schema:{type:"object",title:"Schema",properties:{boxLabel:{title:"Box Label",type:"string",description:"Define your widget box title."},boxBorder:{title:"Box Border",type:"hidden",default:"true",description:"Define your widget box border."},stream:{title:"Channel",type:"string",description:"",placeholder:" "},data:{title:"Static data",type:"number",description:"Set a static value for Odometer."},duration:{title:"Duration",type:"number",description:"Animation duration"},size:{title:"Size",type:"number",description:"Recommended size between 0 & 5."},animation:{title:"Animation",type:"string",description:"Count is a simpler animation method which just increments the value,use it when you're looking for something more subtle."}},required:[]}},{name:"separator",show:!1},{name:"alarms",label:"Alarms",class:"scriptr-displaycount",commonData:!1,show:!0,defaults:{"on-format-data":"return data;",transport:"wss",data:"12",message:"Alarms","number-background-color":"#005588","message-font-size":12,"number-font-size":34,"fetch-data-interval":300,api:"app/api/dashboard/getUserAlarms","alarm-type":"number_of_stations"},box:{sizeX:1,sizeY:1,minSizeX:1,minSizeY:1},imgCls:"alarms-img",imgSrc:"//cdn.rawgit.com/scriptrdotio/onset-static-resources/17f2c092/images/alarms.svg",isAlarm:!0},{name:"connectedDevices",label:"Connected Devices",class:"scriptr-displaycount",commonData:!1,show:!0,defaults:{"on-format-data":"return data;",transport:"wss",data:"12","number-background-color":"#005588",message:"Connected Devices","message-font-size":12,"number-font-size":34,"fetch-data-interval":300,api:"app/api/dashboard/getUserAlarms","alarm-type":"successful_connections"},box:{sizeX:1,sizeY:1,minSizeX:1,minSizeY:1},imgCls:"connected-img",imgSrc:"//cdn.rawgit.com/scriptrdotio/onset-static-resources/17f2c092/images/connected-devices.svg",isAlarm:!0},{name:"connectionIssues",label:"Connection Issues",class:"scriptr-displaycount",commonData:!1,show:!0,defaults:{"on-format-data":"return data;",transport:"wss",message:"Connection Issues","number-background-color":"#005588","message-font-size":12,"number-font-size":34,data:"12","fetch-data-interval":300,api:"app/api/dashboard/getUserAlarms","alarm-type":"failed_connections"},box:{sizeX:1,sizeY:1,minSizeX:1,minSizeY:1},imgCls:"connection-img",imgSrc:"//cdn.rawgit.com/scriptrdotio/onset-static-resources/17f2c092/images/connection-issues.svg",isAlarm:!0},{name:"totalDevices",label:"Total Devices",class:"scriptr-displaycount",commonData:!1,show:!0,defaults:{"on-format-data":"return data;",transport:"wss",message:"Total Devices","message-font-size":12,"number-font-size":34,"number-background-color":"#005588",data:"12","fetch-data-interval":300,api:"app/api/dashboard/getUserAlarms","alarm-type":"total"},box:{sizeX:1,sizeY:1,minSizeX:1,minSizeY:1},imgCls:"connected-img",
imgSrc:"//cdn.rawgit.com/scriptrdotio/onset-static-resources/17f2c092/images/total-devices.svg",isAlarm:!0},{name:"latestConditions",label:"Latest Conditions",class:"scriptr-grid",show:!0,commonData:!0,defaults:{"columns-definition":'[{headerName: "Channel", field: "label", "minWidth": 110},{headerName: "Value", field: "value", "minWidth": 110}]',"row-data":'[{label: "Channel 1", value: "23"},{label: "Channel 2", value: "34"}]',"data-type":"latest","data-format":"latestconditions","schema-for":"grid","fetch-data-interval":300,boxLabel:"Latest Conditions",boxBorder:!0,"fixed-height":"false","on-format-data":'return {"documents":data, "count": data.length};',transport:"wss","cell-editable":!1,"enable-client-side-sorting":!1,pagination:"false","enable-server-side-sorting":!1,"enable-server-side-filter":!1,"enable-col-resize":"false"},box:{sizeX:2,sizeY:3,minSizeX:2,minSizeY:3},imgCls:"latest-img",imgSrc:"//cdn.rawgit.com/scriptrdotio/onset-static-resources/4f83aaea/images/latest-conditions.svg",form:[{type:"tabs",tabs:[{title:"Data",items:[{type:"section",htmlClass:"",items:[{key:"stream",type:"uiselectmultiple",placeholder:"",onChange:function(a,b,c){delete c["row-data"]},options:{closeOnSelect:!1,groupBy:"dataStream",multiple:"true",callback:"multiSelectCallBack",widgetName:"grid",limitTo:50,limit:20}}]}]},{title:"Box Properties",items:["boxLabel"]}]}],schema:{type:"object",title:"Schema",properties:{boxLabel:{title:"Box Label",type:"string",description:"Define your widget box title."},boxBorder:{title:"Box Border",type:"hidden",default:"true",description:"Define your widget box border."},stream:{title:"Channels",type:"array",items:{type:"string"},description:"",placeholder:" "},"columns-definition":{title:"Columns definition",type:"string",description:"Series of data (Each column in the grid is defined using a column definition).","x-schema-form":{type:"textarea",placeholder:"[{'headerName': 'Channel', 'field': 'label'}, {'headerName': 'Value', 'field': 'value'}]"}},"row-data":{title:"Row data",type:"string",description:"You pass static data to the grid.","x-schema-form":{type:"textarea",placeholder:"[{label: 'Channel 1', value: '23'},{label: 'Channel 2', value: '34'}]"}}},required:["columns-definition"]}}]}),angular.module("DashboardBuilder").component("dashboardsList",{bindings:{dashboard:"<",layout:"@"},templateUrl:"/UIComponents/dashboardBuilder/javascript/components/dashboardsList.html",controller:["$scope","$rootScope","$filter","$timeout","$sce","$window","httpClient","wsClient","$cookies","config","$uibModal","scriptrService","$route","$routeParams","$q","_",function(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p){this.wsClient=h;var q=this;q.acls,this.$onInit=function(){q.user=window.localStorage.user?JSON.parse(window.localStorage.user):null,null!=q.user&&q.user.favDashboardKey&&(q.favDashboardKey=q.user.favDashboardKey),q.loading=!0,q.showPanelMsg=!1,q.layout=void 0!==b.layout?b.layout:"grid",q.users=[{code:"anonymous",icon:"fa fa-group"}],this.urlParams=[],this.transport=angular.copy(j.transport),this.frmGlobalOptions={destroyStrategy:"remove",formDefaults:{feedback:!0}},this.gridOptions={columnDefs:[{headerName:"",field:"star",valueGetter:function(a){return a.data},cellRenderer:function(a){return'<a href="" ng-click="$ctrl.setFavoriteDashboard(\''+a.value.key+'\')" class="favorite-star" uib-tooltip="Star this dashboard for easy access from the menu. You can star one dashboard at a time." tooltip-placement="auto" tooltip-append-to-body="true"><i ng-class="$ctrl.favDashboardKey == \''+a.value.key+"' ? 'fas fa-star' : 'far fa-star'\" aria-hidden=\"true\"></i></a>"},width:35,cellStyle:{paddingTop:8,textAlign:"center"}},{headerName:"Name",unSortIcon:!0,icons:{sortAscending:'<i class="fas fa-sort-up" aria-hidden="true"></i>',sortDescending:'<i class="fas fa-sort-down" aria-hidden="true"></i>',sortUnSort:'<span class="unsort-state"><i class="fas fa-angle-up" aria-hidden="true"></i><i class="fas fa-angle-down" aria-hidden="true"></i></span>'},field:"dashboardName",comparator:function(a,b,c,d){return a.dashboardName.localeCompare(b.dashboardName)},cellStyle:{paddingTop:6},valueGetter:function(a){return a.data},cellRenderer:function(a){return'<span class="img-thumb"><div class="table-display"><div class="cell-display">'+(a.value.viewFile?'<img class="img-responsive grid-img" src="'+a.value.viewFile+'" />':'<img class="img-responsive" src="//cdn.rawgit.com/scriptrdotio/onset-static-resources/a923190a/images/default-icon.svg" />')+'</div></div></span><span class="grid-name"><a href="#/dockey/'+a.value.key+'">'+a.value.dashboardName+"</a></span>"}},{headerName:"Modified",field:"lastModifiedDate",cellRenderer:function(a){return c("date")(a.value,"MMMM dd, yyyy HH:mm")},unSortIcon:!0,icons:{sortAscending:'<i class="fas fa-sort-up" aria-hidden="true"></i>',sortDescending:'<i class="fas fa-sort-down" aria-hidden="true"></i>',sortUnSort:'<span class="unsort-state"><i class="fas fa-angle-up" aria-hidden="true"></i><i class="fas fa-angle-down" aria-hidden="true"></i></span>'},cellStyle:{paddingTop:6}},{headerName:"",field:"isPublic",valueGetter:function(a){return a.data},cellRenderer:function(a){return'<span ng-show="{{'+a.value.isPublic+'}}" class="badge badge-warning mt5"><i class="fa fa-eye" aria-hidden="true"></i> Public</span>'},cellStyle:{textAlign:"right",paddingTop:2}},{headerName:"",field:"key",cellRenderer:function(a){return'<a title="Configure this dashboard" ng-href="#/dockey/'+a.value+'/edit"><img class="icon-img" src="//cdn.rawgit.com/scriptrdotio/onset-static-resources/2a8afcdb/images/blue-wrench.svg" /></a>'},width:50,cellStyle:{textAlign:"center",paddingTop:5}},{headerName:"",field:"dashboard",valueGetter:function(a){return a.data},cellRenderer:function(a){return'<a title="Remove this dashboard" ng-click="$ctrl.deleteDashboardConfirmation(\''+a.value.dashboardName+"', '"+a.value.key+'\')"><img class="icon-img pointer" src="//cdn.rawgit.com/scriptrdotio/onset-static-resources/2a8afcdb/images/blue-bin.svg" /></a>'},width:30,cellStyle:{textAlign:"center",paddingTop:4}}],rowData:null,rowHeight:34,headerHeight:37,angularCompileRows:!0,enableSorting:!0,animateRows:!0,domLayout:"autoHeight",pagination:!0,paginationPageSize:10,onGridSizeChanged:function(a){if(f.innerWidth<=768){var b=["star","dashboardName","dashboard","key"],c=["lastModifiedDate","public"];q.gridOptions.columnApi.setColumnsVisible(b,!0),q.gridOptions.columnApi.setColumnsVisible(c,!1)}else q.gridOptions.columnApi.setColumnsVisible(["star","dashboardName","dashboard","key","lastModifiedDate","public"],!0);d(q.gridOptions.api.sizeColumnsToFit(),1e3)}},a.$watch(function(a){return a.query},function(a){var b=[];if(void 0!==a&&null!=a&&""!=a)for(var c=0;c<q.customDashboards.length;c++)-1!=q.customDashboards[c].dashboardName.toLowerCase().indexOf(a.toLowerCase())&&b.push(q.customDashboards[c]);else q.customDashboards&&(b=q.customDashboards);q.customDashboards&&(0==b.length?q.noDashboards=!0:(q.noDashboards=!1,q.gridOptions.api.setRowData(b),q.setGridPaginationIcons()))})},this.setGridPaginationIcons=function(){$("button[ref=btPrevious]").html('<img src="//cdn.rawgit.com/scriptrdotio/onset-static-resources/6309fad6/images/previous.png" />'),$("button[ref=btFirst]").html('<img src="//cdn.rawgit.com/scriptrdotio/onset-static-resources/6309fad6/images/first.png" />'),$("button[ref=btNext]").html('<img src="//cdn.rawgit.com/scriptrdotio/onset-static-resources/6309fad6/images/next.png" />'),$("button[ref=btLast]").html('<img src="//cdn.rawgit.com/scriptrdotio/onset-static-resources/6309fad6/images/last.png" />')},this.$postLink=function(){l.loadDashboards({}).then(function(a,b){a?(q.customDashboards=a,q.gridOptions.api.setRowData(a),q.setGridPaginationIcons(),q.loading=!1,0==a.length&&(q.noDashboards=!0)):(console.log("No Dashboards Found"),q.loading=!1)},function(a){q.loading=!1,console.log("reject published promise",a)})},this.deleteDashboardConfirmation=function(a,b){k.open({controller:"PopupCont",templateUrl:"/UIComponents/dashboardBuilder/javascript/components/deletePopup.html",backdrop:"static",resolve:{dashboard:function(){return q},name:function(){return a},key:function(){return b}}})},this.checkCreateDashboardEligibility=function(b){if(this.customDashboards&&10==this.customDashboards.length){b.preventDefault();k.open({animation:!0,component:"confirmationModal",backdrop:"static",size:"md",scope:a,resolve:{data:function(){return{title:"Information Message",body:"You can save a maximum of 10 dashboards.",btnCancelTitle:"Ok"}}}})}},this.setFavoriteDashboard=function(b){var c=!1;q.favDashboardKey&&b==q.favDashboardKey&&(c=!0);var d={dockey:c?null:b};l.setFavoriteDashboard(d).then(function(b,d){b&&b.status&&"success"==b.status?(q.favDashboardKey=b.favDashboardKey,null!=q.user&&(c?delete q.user.favDashboardKey:q.user.favDashboardKey=q.favDashboardKey,window.localStorage.setItem("user",JSON.stringify(q.user))),a.$emit("render-menu")):console.log("failure fav")},function(a){q.showMsg("danger","An error has occured"),console.log("reject published promise",a)})},this.deleteDashboard=function(b){q.user=window.localStorage.user?JSON.parse(window.localStorage.user):null,null!=q.user&&q.user.favDashboardKey&&(q.favDashboardKey=q.user.favDashboardKey);var c={dockey:b};q=this,l.deleteDashboard(c).then(function(c,d){if(c&&c.status&&"success"==c.status){if(q.customDashboards=c.documents,q.gridOptions.api.setRowData(c.documents),q.setGridPaginationIcons(),0==c.documents.length?q.noDashboards=!0:q.noDashboards=!1,q.favDashboardKey&&b&&b==q.favDashboardKey){var e=JSON.parse(window.localStorage.user);delete e.favDashboardKey,window.localStorage.setItem("user",JSON.stringify(e)),a.$emit("render-menu")}}else c&&c.errorDetail?q.showMsg("danger",c.errorDetail):q.showMsg("danger","An error occurred while deleting the dashboard. Please try again later")},function(a){q.showMsg("danger","An error has occured"),console.log("reject published promise",a)})},this.changeLayout=function(a){this.layout=a,b.layout=this.layout},this.closeAlert=function(){this.show=!1},this.showAlert=function(a,b){this.closeAlert(),this.message={type:a,content:b},this.show=!0},this.closeMsg=function(){this.showPanelMsg=!1},this.showMsg=function(a,b){this.closeMsg(),this.message={type:a,content:b},this.showPanelMsg=!0}}]}),angular.module("DashboardBuilder").controller("PopupCont",["$scope","$uibModalInstance",function(a,b){a.name=a.$resolve.name,a.close=function(){b.dismiss("cancel")},a.ondeleteDashboard=function(){this.$resolve.dashboard.deleteDashboard(this.$resolve.key),b.dismiss("cancel")}}]),angular.module("DashboardBuilder").service("scriptrService",function(a,b){this.saveScript=function(b,c){return a.post("app/api/dashboard/save",b,null,!0)},this.getDashboardDocument=function(b){return a.get("app/api/dashboard/get",b)},this.loadDashboards=function(b){return a.get("app/api/dashboard/list",{})},this.deleteDashboard=function(b){return a.get("app/api/dashboard/delete",b)},this.setFavoriteDashboard=function(b){return a.get("app/api/dashboard/favorite",b)},this.setDashboardPublicName=function(b){return a.get("app/api/dashboard/setPublicName",b)},this.setDashboardPublicAccess=function(b){return a.get("app/api/dashboard/setRevokePublicAccess",b)},this.getToken=function(){return b.get("token")||null},this.saveCalculatedChannel=function(b,c){return a.post("app/api/calculatedChannel/save",b,null,!0)},this.loadCalculatedChannels=function(b){return a.get("app/api/calculatedChannel/list",{})},this.deleteCalculatedChannel=function(b){return a.get("app/api/calculatedChannel/delete",b)},this.getCalculatedChannelDocument=function(b){return a.get("app/api/calculatedChannel/get",b)}}),angular.module("DashboardBuilder").component("dashboard",{bindings:{widgets:"<",dashboard:"<",treeSearchCriteria:"@",iconExpand:"@",iconCollapse:"@",loadTree:"<?",showTree:"<",devicesModel:"@"},templateUrl:"/UIComponents/dashboardBuilder/javascript/components/dashboard.html",controller:function(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s){this.wsClient=g;var t=this;t.acls,b.multiSelectCallBack=function(a,b){var c=a.widgetName,d=a.widgetField,e=window.localStorage.getItem("dataStream"),f=window.localStorage.getItem("dataMapping"),g=[];f&&e&&(f=JSON.parse(f),e=JSON.parse(e));for(var h=0;h<e.length;h++)for(var i=e[h].label,j=e[h].sensors,k=0;k<j.length;k++){var l=j[k].measurement_type;if(f[l]){var m=f[l].allowed;if((m.indexOf(c)>-1||"calculatedChannel"==c)&&(!d||l==d)){var n=j[k].selectedStreamValue;g.push({value:n,name:j[k].label,dataStream:i,availableUnits:{si:j[k].si_unit,us:j[k].us_unit}})}}}return g},this.$onInit=function(){window.localStorage.user&&JSON.parse(window.localStorage.user).id;this.publicDashboardUrl=window.location.origin+"/public/";var d=new UAParser,e=d.getResult(),f=e.device&&"tablet"===e.device.type;t.tablet=!1,(f||window.matchMedia(b.tabletBreakPoint).matches)&&(t.tablet=!0),t.showTree=void 0===this.showTree||this.showTree,t.loading=!0,t.showPanelMsg=!1,t.isEdit=!1,t.users=[{code:"anonymous",icon:"fa fa-group"}],this.urlParams=[],this.transport=angular.copy(k.transport),this.frmGlobalOptions={destroyStrategy:"remove",formDefaults:{feedback:!1},validationMessage:{302:"Required field."}},this.initializeDashboard();var g="si",h=window.localStorage.user?JSON.parse(window.localStorage.user):null;h&&null!=h.preferredUnit&&""!=h.preferredUnit&&(g="SI (Metric)"==h.preferredUnit?"si":"us"),this.schema=angular.copy(k.script.schema),this.form=angular.copy(k.script.form),this.model={period:"past_day",unit:g},this.metric_schema=angular.copy(k.metricselector.schema),this.metric_form=angular.copy(k.metricselector.form),this.metric_model={},a.$root&&a.$root.isNew?(this.isEdit=!0,this.isNew=a.$root.isNew):(this.isEdit=!!o.edit,this.isNew=!1),a.$root&&a.$root.isPresentationMode?this.isPresentationMode=a.$root.isPresentationMode:this.isPresentationMode=!1,this.isNew?(this.setDefaultDashboardName(),b.currentDashboardUnit=g):(this.dashboardKey=o.dockey?o.dockey:b.dockey,this.getDashboard(this.dashboardKey)),this.slickConfig={enabled:!0,autoplay:!0,draggable:!1,autoplaySpeed:3e3,method:{},event:{beforeChange:function(a,b,c,d){},afterChange:function(a,b,c,d){}}},this.gridsterOptions={defaultSizeY:200,defaultSizeX:200,minRows:1,maxRows:100,floating:!0,columns:(t.tablet,5),colWidth:"auto",rowHeight:"83",margins:[10,10],defaultSizeX:1,defaultSizeY:2,mobileBreakPoint:480,minColumns:1,sparse:!1,resizable:{enabled:t.isEdit,handle:".my-class",start:function(a,b,c){setTimeout(function(){$(window).trigger("resize"),window.dispatchEvent(new Event("resize"))},100)},resize:function(a,b,c){setTimeout(function(){$(window).trigger("resize"),window.dispatchEvent(new Event("resize"))},100)},stop:function(a,b,c){console.log("End resize:",a,b,c),setTimeout(function(){$(window).trigger("resize"),window.dispatchEvent(new Event("resize"))},100)}},draggable:{enabled:t.isEdit,handle:".drag-box",start:function(a,b,c){setTimeout(function(){$(window).trigger("resize"),window.dispatchEvent(new Event("resize"))},100)},drag:function(a,b,c){setTimeout(function(){$(window).trigger("resize"),window.dispatchEvent(new Event("resize"))},100)},stop:function(a,b,c){setTimeout(function(){$(window).trigger("resize"),window.dispatchEvent(new Event("resize"))},100)}}},a.$on("gridster-resized",function(a,b,c){setTimeout(function(){$(window).trigger("resize"),window.dispatchEvent(new Event("resize"))},100)}),a.$on("gridster-item-initialized",function(a){setTimeout(function(){$(window).trigger("resize"),window.dispatchEvent(new Event("resize"))},100)}),this.widgetsConfig=k.widgets,this.widgetsCommon=i,this.dataLoaded=!0,c(function(){$("#stickDiv").sticky({topSpacing:0})})},this.trustSrc=function(a){return d.trustAsResourceUrl(a)},this.setDefaultDashboardName=function(){this.model.dashboardName="Dashboard "+r("date")(new Date,"MM-dd-yyyy")},this.enableEditDashboard=function(){this.closeAlert(),this.isEdit=!0,this.gridsterOptions.draggable.enabled=this.isEdit,this.gridsterOptions.resizable.enabled=this.isEdit,a.setUnitInLocalStorage(t.model.unit)},this.disableEditMode=function(){this.isNew?window.location.href="#/dashboardsList":(this.dashboard.widgets=angular.copy(this.dashboard.originalWidgets),this.dashboard.counter=angular.copy(this.dashboard.originalCounter),this.model=angular.copy(this.originalModel),this.isEdit=!1,this.gridsterOptions.draggable.enabled=this.isEdit,this.gridsterOptions.resizable.enabled=this.isEdit)},this.deleteDashboardConfirmation=function(){var a=this.model.dashboardName;l.open({controller:"PopupCont",templateUrl:"/UIComponents/dashboardBuilder/javascript/components/deletePopup.html",backdrop:"static",resolve:{dashboard:function(){return t},name:function(){return a}}})},this.deleteDashboard=function(){t.user=window.localStorage.user?JSON.parse(window.localStorage.user):null,null!=t.user&&t.user.favDashboardKey&&(t.favDashboardKey=t.user.favDashboardKey);var b={dockey:t.model.key};m.deleteDashboard(b).then(function(b,c){if(b&&b.status&&"success"==b.status&&(window.location.href="#/dashboardsList",t.favDashboardKey&&t.model.key==t.favDashboardKey)){var d=JSON.parse(window.localStorage.user);delete d.favDashboardKey,window.localStorage.setItem("user",JSON.stringify(d)),a.$emit("render-menu")}},function(a){console.log("reject published promise",a)})},b.fetchFromDate=(new Date).getTime()-864e5,b.fetchToDate=(new Date).getTime(),a.setFetchFromDate=function(a,c){b.period=a,"past_day"==a&&(b.fetchFromDate=(new Date).getTime()-864e5),"past_week"==a&&(b.fetchFromDate=(new Date).getTime()-6048e5),"past_month"==a&&(b.fetchFromDate=(new Date).getTime()-2592e6),console.log("--------\x3e$rootScope.fetchFromDate---------\x3e",b.fetchFromDate)},a.setUnitInLocalStorage=function(c,d){b.currentDashboardUnit=c,a.$broadcast("unit_change"),console.log("--------\x3e$rootScope.setUnitInLocalStorage---------\x3e",b.currentDashboardUnit)},this.closeAlert=function(){this.show=!1},this.showAlert=function(a,b){this.closeAlert(),this.message={type:a,content:b},this.show=!0},this.closeMsg=function(){this.showPanelMsg=!1},this.showMsg=function(a,b){this.closeMsg(),this.message={type:a,content:b},this.showPanelMsg=!0},this.initializeDashboard=function(){this.dashboard={widgets:[],counter:0},this.widgets&&(this.dashboard.widgets=this.widgets),this.dashboard.counter=this.dashboard.widgets.length},this.clear=function(){var b=this;l.open({animation:!0,component:"confirmationModal",backdrop:"static",size:"md",scope:a,resolve:{data:function(){return{title:"Clear this dashboard?",body:"Are you sure you want to remove all the widgets?",btnCancelTitle:"Cancel",btnSubmitTitle:"Clear dashboard"}}}}).result.then(function(a){a&&b.clearWidgets()},function(){console.info("modal-component for clearing dashboard update dismissed at: "+new Date)})},this.clearWidgets=function(){this.dashboard.counter=0,this.dashboard.widgets=[]},this.logout=function(){$.scriptr.authorization({loginPage:login.loginTarget}).logout()};var u=function(a,b){var c={};for(var d in a)c[d]=a[d];for(var d in b)c[d]=b[d];return c};this.addWidget=function(a){if("string"==typeof a&&(a=JSON.parse(a)),a.url)return void window.open(a.url);if(this.dashboard.counter>=20)this.showInformationModel();else{a.defaults["default-metric-value"]||(a.defaults["default-metric-value"]=b.currentDashboardUnit);var c=angular.copy(a.form),d=angular.copy(a.schema),e=q.findWhere(t.widgetsConfig,{name:a.name}),c=angular.copy(e.form),d=angular.copy(e.schema);if(e.commonData&&(c[0].tabs=angular.copy([i.formTab].concat(e.form[0].tabs)),c[0].selectedTabIndex=1,d.properties=u(e.schema.properties,i.schemaFields)),a.isAlarm&&(c=angular.copy(j.form),c[0].selectedTabIndex=0,d=angular.copy(j.schema)),a.selectedStreamValue&&a.selectedStreamFieldName){var f=[a.selectedStreamValue];a.defaults[a.selectedStreamFieldName]=f,a.defaults["available-units"]={si:a.selectedStreamUnits.si,us:a.selectedStreamUnits.us},a.defaults.boxLabel=a.selectedStreamLabel,a.defaults["colors-mapping"]=[{ykeys:a.selectedStreamLabel,labels:a.selectedStreamLabel,colors:"#CC5464",axisSelection:"y"}],a.defaults.data=[],a.defaults["fetch-from-date-value"]=b.fetchFromDate,a.defaults["fetch-to-date-value"]=b.fetchToDate,a.defaults.api="app/api/dashboard/GetUserData",a.defaults["api-params"]=JSON.stringify({dataType:a.defaults["data-type"],streams:a.defaults[a.selectedStreamFieldName],dataFormat:a.defaults["data-format"],aggregationRange:a.defaults["aggregation-range"],display_metric:b.currentDashboardUnit})}var g=(t.tablet,0);a.selectedStreamValue=null,this.dashboard.widgets.push({name:a.name,sizeX:a.box&&a.box.sizeX?a.box.sizeX<3?a.box.sizeX+g:a.box.sizeX:2,sizeY:a.box&&a.box.sizeY?a.box.sizeY:2,minSizeX:a.box&&a.box.minSizeX?a.box.minSizeX<3?a.box.minSizeX+0:a.box.minSizeX:2,maxSizeX:a.box&&a.box.maxSizeX?a.box.maxSizeX+g:null,minSizeY:a.box&&a.box.minSizeY?a.box.minSizeY:2,maxSizeY:a.box&&a.box.maxSizeY?a.box.maxSizeY+g:null,label:a.label,type:a.class,options:a.defaults,schema:d,form:c})}},this.showInformationModel=function(){l.open({animation:!0,component:"confirmationModal",backdrop:"static",size:"md",scope:a,resolve:{data:function(){return{title:"Information Message",body:"You can add a maximum of 20 widgets.",btnCancelTitle:"Ok"}}}})},this.getDashboard=function(a){var c={dockey:a};m.getDashboardDocument(c).then(function(a,c){console.log("resolve",a),a.documents&&a.documents.length>0&&(t.dashboardDocument=angular.copy(a.documents[0]),t.model.dashboardName=t.dashboardDocument.dashboardName,t.model.unit=t.dashboardDocument.unit,t.model.period=t.dashboardDocument.period,t.model.image=t.dashboardDocument.viewFile,t.model.isPublic=t.dashboardDocument["document.readACL"].indexOf("anonymous")>-1,t.model.publicDashboardName=t.dashboardDocument.publicDashboardName?t.dashboardDocument.publicDashboardName:t.dashboardDocument.dashboardName,t.model.key=t.dashboardDocument.key,t.model.pluginData=t.dashboardDocument.pluginData,b.currentDashboardUnit=t.dashboardDocument.unit,t.originalModel=angular.copy(t.model),t.metric_model&&(t.metric_model.unit=t.model.unit,t.metric_model.period=t.model.period)),t.model.key?t.postLoadScript(JSON.parse(t.model.pluginData)):t.setDefaultDashboardName()},function(a){t.showAlert("danger",a.data.response.metadata.errorDetail),console.log("reject",a.data.response.metadata.errorDetail)})},this.showLoading=function(){this.loadingModalInstance=l.open({controller:"LoadingCtrl",windowTemplateUrl:"/UIComponents/dashboardBuilder/javascript/components/loading.html",templateUrl:"/UIComponents/dashboardBuilder/javascript/components/loading.html",backdrop:"static",resolve:{loadingTitle:function(){return"Saving..."}}})},this.hideLoadingModalInstance=function(){this.loadingModalInstance.dismiss()},this.saveDashboard=function(b,c,d){var e=this;if(a.$broadcast("schemaFormValidate"),b&&b.$valid||d){if(!(this.dashboard.widgets.length>20)){this.showLoading();var f={},g=angular.copy(this.dashboard.widgets);f.items=q.map(g,function(a,b){return q.omit(a,["form","schema"])}),f.urlParams=angular.copy(this.urlParams);var h={};h.dashboardName=this.model.dashboardName,h.unit=this.model.unit,h.period=this.model.period,b.uploadForm.file.$dirty&&(h.apsdb_attachments=b.uploadForm.file.$modelValue),e.dashboardDocument&&e.model.image!=e.dashboardDocument.viewFile&&(h.apsdb_attachments=null),h.pluginData=JSON.stringify({wdg:f.items,urlParams:f.urlParams,builtWithTablet:e.tablet}),e.isEdit&&!e.isNew&&(h.update=!0,h.dockey=this.model.key);var i=new FormData;for(var j in h)i.append(j,h[j]);var k=p.defer();return m.saveScript(i).then(function(a,b){"failure"==a.status?(e.isEdit=!0,e.showAlert("danger",a.errorDetail),e.hideLoadingModalInstance()):(a&&a.document&&a.document.key&&e.getDashboard(a.document.key),e.dashboardKey=a.document.key,e.hideLoadingModalInstance(),e.isEdit=!1,e.isNew=!1,e.gridsterOptions.draggable.enabled=e.isEdit,e.gridsterOptions.resizable.enabled=e.isEdit,e.showAlert("info","Dashboard successfully saved."),k.resolve(a,b))},function(a){e.hideLoadingModalInstance(),e.showAlert("danger",a.data.response.metadata.errorDetail),console.log("reject",a.data.response.metadata.errorDetail),k.reject(a)}),k.promise}e.showAlert("danger","You can add a maximum of 20 widgets.")}},this.postLoadScript=function(a){if(a){this.widgets=[];var b=a.wdg;q.map(b,function(a,b){var c=q.findWhere(t.widgetsConfig,{name:a.name}),d=angular.copy(c.form),e=angular.copy(c.schema);if(c.commonData&&(d[0].tabs=angular.copy([i.formTab].concat(c.form[0].tabs)),d[0].selectedTabIndex=1,e.properties=u(c.schema.properties,i.schemaFields)),c.isAlarm&&(d=angular.copy(j.form),d[0].selectedTabIndex=0,e=angular.copy(j.schema)),a.form=angular.copy(d),a.schema=angular.copy(e),t.model.key){var f={};a.options["api-params"]&&(f=JSON.parse(a.options["api-params"])),f.dockey=t.model.key,a.options["api-params"]=JSON.stringify(f)}t.widgets.push(a)}),this.urlParams=a.urlParams,this.dashboard.widgets=this.widgets,this.dashboard.originalWidgets=angular.copy(this.dashboard.widgets),this.dashboard.counter=this.widgets.length,this.dashboard.originalCounter=this.dashboard.counter}},this.onClipboardCopySuccess=function(a){console.log(a)},this.setPublicDashboardName=function(a){return a?m.setDashboardPublicName({dockey:this.dashboardDocument.key,publicName:a}).then(function(a,b){if("failure"==a.status)return t.model.publicDashboardName=t.originalModel.publicDashboardName,a.errorDetail;t.originalModel=angular.copy(t.model)},function(a){return t.model.publicDashboardName=t.originalModel.publicDashboardName,a.errorDetail}):"Public dashboard name is required."},this.changingPublicAccess=!1,this.revokePublicAccessConfirmation=function(){if(this.changingPublicAccess=!0,this.model.isPublic)this.updatePublicStatus();else{var a=this.model.dashboardName,b=this.model.publicName;l.open({controller:"PopupCont",templateUrl:"/UIComponents/dashboardBuilder/javascript/components/revokeAccessPopup.html",backdrop:"static",resolve:{dashboard:function(){return t},publicName:function(){return b},name:function(){return a}}})}},this.cancelUpdatePublicStatus=function(){t.changingPublicAccess=!1,t.model.isPublic=t.dashboardDocument["document.readACL"].indexOf("anonymous")>-1},this.updatePublicStatus=function(){m.setDashboardPublicAccess({dockey:this.dashboardDocument.key,sharing:this.model.isPublic}).then(function(a,b){t.changingPublicAccess=!1,"failure"==a.status?(t.cancelUpdatePublicStatus(),t.showAlert("danger",a.errorDetail)):(t.model["document.readACL"]=t.dashboardDocument["document.readACL"]=a["document.readACL"],t.model.publicDashboardName=t.dashboardDocument.publicDashboardName=a.publicDashboardName,t.originalModel=angular.copy(t.model))},function(a){t.cancelUpdatePublicStatus(),t.showAlert("danger",a.errorDetail),console.log("reject",a.errorDetail)})}}}),angular.module("DashboardBuilder").component("box",{require:{parent:"^^dashboard"},bindings:{widget:"<",isEdit:"<?"},templateUrl:"/UIComponents/dashboardBuilder/javascript/components/box.html",controller:function(a,b,c,d,e){this.remove=function(a){var c=this;e.open({animation:!0,component:"confirmationModal",backdrop:"static",size:"md",scope:b,resolve:{data:function(){return{title:"Delete this widget?",body:'Are you sure you want to delete this widget "'+a.label+'"?',btnCancelTitle:"Cancel",btnSubmitTitle:"Delete"}}}}).result.then(function(b){b&&c.removeWidget(a)},function(){console.info("modal-component for removing widget dismissed at: "+new Date)})},this.removeWidget=function(a){delete this[a.formatFunction],this.parent.dashboard.widgets.splice(this.parent.dashboard.widgets.indexOf(a),1),this.parent.dashboard.counter--},this.$postLink=function(){setTimeout(function(){var a=document.getElementsByClassName("gridster-item");if(a&&a.length>0){a[a.length-1]}},200)},this.$onInit=function(){a.mobileBreakPoint="(max-width: 480px)",a.tabletBreakPoint="(max-width: 991px)",b.$on("gridster-mobile-changed",function(b,c){c.isMobile&&(a.mobileBreakPoint="(max-width:"+$(window).innerWidth()+"px)")}),b.$on("unit_change",function(a){if(c.widget.options["api-params"]){var b;"us"==JSON.parse(c.widget.options["api-params"]).display_metric?(b=JSON.parse(c.widget.options["api-params"]),b.display_metric="si"):(b=JSON.parse(c.widget.options["api-params"]),b.display_metric="us"),c.widget.options["api-params"]=JSON.stringify(b)}c.updateWidget(c.widget.options)}),b.$on("gridster-item-transition-end",function(a){setTimeout(function(){$(window).trigger("resize"),window.dispatchEvent(new Event("resize"))},100)}),b.$on("gridster-item-resized",function(a){setTimeout(function(){$(window).trigger("resize"),window.dispatchEvent(new Event("resize"))},100)});var c=this;this.widget&&this.addWidget(this.widget),b.$on("resize_widget",function(a,b){if(setTimeout(function(){$(window).trigger("resize"),window.dispatchEvent(new Event("resize"))},100),c.widget==b.element&&"scriptr-grid"==c.widget.type){var d=b.wdg.height();b.element.options["grid-height"]=d-110,c.updateWidget(b.element.options)}}),b.$on("drag_widget",function(a,b){})},this.openSettings=function(){var a=this;e.open({animation:!0,component:"modalComponent",backdrop:"static",size:"lg",scope:b,resolve:{widget:function(){return a.widget}}}).result.then(function(b){"cancel"!=b&&a.updateWidget(b)},function(){console.info("modal-component for widget update dismissed at: "+new Date)})},this.addWidget=function(e){var f=this;this.chart=angular.element(document.createElement(e.type)),angular.forEach(e.options,function(b,c){if(angular.isArray(b)||angular.isObject(b))f.chart.attr(c,JSON.stringify(b));else if("on-format-data"==c){this.parent.dashboard.counter||(this.parent.dashboard.counter=0);var d=!1;e.formatFunction&&(d=!0),d||(this.parent.dashboard.counter+=1);var g=this.parent.dashboard.counter,h=e.name+"FormatData"+g;f[h]=new Function("data",b),e.formatFunction=h,e.formatFunctionValue=b,f.chart.attr("on-format-data","$ctrl."+h)}else if("fetch-from-date-value"==c)f.chart.attr("fetch-from-date-value",a.fetchFromDate);else if("fetch-to-date-value"==c)f.chart.attr("fetch-to-date-value",a.fetchToDate);else if("display-metric-value"==c)f.chart.attr("display-metric-value",a.currentDashboardUnit);else if("api-params"==c){var i=JSON.parse(b);i.display_metric&&(i.display_metric=a.currentDashboardUnit),f.chart.attr("api-params",JSON.stringify(i))}else f.chart.attr(c,b)},this);var g=c(this.chart)(b);angular.element(d.find(".box-content")).append(g)},this.updateWidget=function(a){var b=this;angular.forEach(a,function(a,c){angular.isArray(a)||angular.isObject(a)?b.chart.attr(c,JSON.stringify(a)):"on-format-data"==c?(b[b.widget.formatFunction]=new Function("data",a),b[b.widget.formatFunctionValue]=a,b.chart.attr("on-format-data","$ctrl."+b.widget.formatFunction)):b.chart.attr(c,a)},this);var c=angular.copy(a),d=this.parent.dashboard.widgets.indexOf(this.widget),e=angular.copy(this.widget);e.options=angular.copy(c),this.parent.dashboard.widgets.splice(d,1,e)}}}),angular.module("DashboardBuilder").component("modalComponent",{bindings:{resolve:"<",close:"&",dismiss:"&"},templateUrl:"/UIComponents/dashboardBuilder/javascript/components/myModalContent.html",controller:function(a,b,c,d,e){this.$onInit=function(){this.widget=this.resolve.widget,b.$broadcast("schemaFormRedraw"),this.frmGlobalOptions={destroyStrategy:"remove",formDefaults:{feedback:!1}},this.widget&&(this.widget.schema&&(this.schema=angular.copy(this.widget.schema)),this.widget.form&&(this.form=angular.copy(this.widget.form)),this.widget.options["display-metric-value"]=a.currentDashboardUnit,this.model=this.widget.options?angular.copy(this.widget.options):{})},b.multiSelectCallBack=function(b,c){return a.multiSelectCallBack(b,c)},this.onSubmit=function(c){b.$broadcast("schemaFormValidate"),console.log(this.model),c.$valid&&(this.model.stream&&this.model.stream.length>0?(this.model["fetch-from-date-value"]=a.fetchFromDate,this.model["fetch-to-date-value"]=a.fetchToDate,this.model["default-metric-value"]=a.currentDashboardUnit,this.model["api-params"]=JSON.stringify({
dataType:this.model["data-type"],streams:this.model.stream,dataFormat:this.model["data-format"],aggregationRange:this.model["aggregation-range"],display_metric:a.currentDashboardUnit})):this.schema.properties.stream&&delete this.model.api,this.close({$value:this.model}),console.log("component_form_parent",this.model))},this.onCancel=function(a){this.schema={},this.form={},this.model=angular.copy(this.widget.options),this.dismiss({$value:"cancel"}),console.log("Dissmissed")}}}),angular.module("DashboardBuilder").component("sidetoolbar",{bindings:{},templateUrl:"/UIComponents/dashboardBuilder/javascript/components/sideToolbar.html",controller:function(a,b){this.close=function(){b("left").close().then(function(){console.debug("close LEFT is done")})}}}),angular.module("DashboardBuilder").component("confirmationModal",{bindings:{resolve:"<",close:"&",dismiss:"&"},templateUrl:"/UIComponents/dashboardBuilder/javascript/components/confirmation.html",controller:function(a){this.$onInit=function(){this.data=this.resolve.data},this.onSubmit=function(){this.close({$value:!0})},this.onCancel=function(){this.dismiss({$value:!1})}}}),angular.module("DashboardBuilder").controller("PopupCont",["$scope","$uibModalInstance",function(a,b){a.name=a.$resolve.name,a.close=function(){b.dismiss("cancel")},a.ondeleteDashboard=function(){this.$resolve.dashboard.deleteDashboard(this.$resolve.key),b.dismiss("cancel")},a.onrevokeAccess=function(){this.$resolve.dashboard.updatePublicStatus(),b.dismiss("cancel")},a.cancelRevokeAccess=function(){this.$resolve.dashboard.cancelUpdatePublicStatus(),b.dismiss("cancel")}}]),angular.module("DashboardBuilder").controller("LoadingCtrl",["$scope","$uibModalInstance",function(a,b){a.title=a.$resolve.title}]);
=======
b.addMapping("bootstrapDecorator","strapmultiselectdynamic","directives/decorators/bootstrap/strap/strapmultiselect.html"),b.addMapping("bootstrapDecorator","uiselect","directives/decorators/bootstrap/uiselect/uiselect.html"),b.addMapping("bootstrapDecorator","uiselectmultiple","directives/decorators/bootstrap/uiselect/uiselectmultiple.html")}]).directive("toggleSingleModel",function(){return{require:"ngModel",restrict:"A",scope:{},replace:!0,controller:["$scope",function(a){a.$parent.$watch("select_model.selected",function(){void 0!=a.$parent.select_model.selected&&(a.$parent.insideModel=a.$parent.select_model.selected.value,a.$parent.ngModel.$setViewValue(a.$parent.select_model.selected.value))})}]}}).directive("multipleOn",function(){return{link:function(a,b,c){a.$watch(function(){return b.attr("multiple-on")},function(a){if("true"==a){var c=angular.element(b).scope().$$childTail;c.$isMultiple=!0,c.options.multiple=!0,c.$select.$element.addClass("select-multiple")}else angular.element(b).scope().$$childTail.$isMultiple=!1})}}}).filter("whereMulti",function(){return function(a,b,c){var d=[];return angular.isArray(c)&&void 0!==a?c.forEach(function(c){for(var e=0;e<a.length;e++)if(c==a[e][b]){d.push(a[e]);break}}):d=a,d}}).filter("propsFilter",function(){return function(a,b){var c=[],d=0;return angular.isArray(a)?a.forEach(function(a){for(var e=!1,f=Object.keys(b),g=0;g<f.length;g++){var h=f[g];if(a.hasOwnProperty(h)){var i=b[h].toLowerCase();if(0===a[h].toString().toLowerCase().indexOf(i)||-1!==a[h].toString().toLowerCase().indexOf(" "+i)&&d<150){d++,e=!0;break}}}e&&c.push(a)}):c=a,c}}),angular.module("schemaForm").controller("dynamicSelectController",["$scope","$http","$timeout",function(a,b,c){a.form.options||(a.form.options={}),a.select_model={},a.form.options.scope=a,a.triggerTitleMap=function(){console.log("listener triggered"),a.form.titleMap.push({value:"345890u340598u3405u9",name:"34095u3p4ouij"}),c(function(){a.form.titleMap.pop()})},a.initFiltering=function(b){a.form.options.filterTriggers&&a.form.options.filterTriggers.forEach(function(b){a.$parent.$watch(b,a.triggerTitleMap)}),a.localModelType=Object.prototype.toString.call(b),a.filteringInitialized=!0},a.finalizeTitleMap=function(b,c,d){if(b.titleMap=[],d&&"map"in d&&d.map){var e=d.map.nameProperty.length-1,f=d.map.separatorValue?d.map.separatorValue:" - ";c.forEach(function(a){if(a.value=a[d.map.valueProperty],"string"!=typeof d.map.nameProperty){var c="";for(var g in d.map.nameProperty)c+=a[d.map.nameProperty[g]],g!=e&&(c+=f);a.name=c}else a.name=a[d.map.nameProperty];b.titleMap.push(a)})}else c.forEach(function(a){"text"in a&&(a.name=a.text)}),b.titleMap=c;a.insideModel&&void 0===a.select_model.selected&&(a.select_model.selected=a.find_in_titleMap(a.insideModel)),a.internalModel&&(console.log("Call uiMultiSelectInitInternalModel"),a.uiMultiSelectInitInternalModel(a.externalModel))},a.clone=function(b){if(null==b||"object"!=typeof b)return b;var c=b.constructor();for(var d in b)b[d]!=a&&b.hasOwnProperty(d)&&(c[d]=a.clone(b[d]));return c},a.getCallback=function(b){if("string"==typeof b){var c=a.$parent.evalExpr(b);if("function"==typeof c)return c;throw"A callback string must match name of a function in the parent scope"}if("function"==typeof b)return b;throw"A callback must either be a string matching the name of a function in the parent scope or a direct function reference"},a.getOptions=function(b,c){return b.httpPost&&b.httpPost.optionsCallback?(newOptionInstance=a.clone(b),a.getCallback(b.httpPost.optionsCallback)(newOptionInstance,c)):b.httpGet&&b.httpGet.optionsCallback?(newOptionInstance=a.clone(b),a.getCallback(b.httpGet.optionsCallback)(newOptionInstance,c)):b},a.test=function(a){a.titleMap.pop()},a.populateTitleMap=function(c,d){if(c.schema&&"enum"in c.schema)c.titleMap=[],c.schema.enum.forEach(function(a){c.titleMap.push({value:a,name:a})});else if(c.options)if(c.options.callback)c.titleMap=a.getCallback(c.options.callback)(c.options,d),a.finalizeTitleMap(c,c.titleMap,c.options),console.log("callback items: ",c.titleMap);else{if(c.options.asyncCallback)return a.getCallback(c.options.asyncCallback)(c.options,d).then(function(b){a.finalizeTitleMap(c,b.data,c.options),console.log("asyncCallback items",c.titleMap)},function(a,b){alert("Loading select items failed(Options: '"+String(c.options)+"\nError: "+b)});if(c.options.httpPost){var e=a.getOptions(c.options,d);return b.post(e.httpPost.url,e.httpPost.parameter).then(function(b){a.finalizeTitleMap(c,b.data,e),console.log("httpPost items",c.titleMap)},function(a,b){alert("Loading select items failed (URL: '"+String(e.httpPost.url)+"' Parameter: "+String(e.httpPost.parameter)+"\nError: "+b)})}if(c.options.httpGet){var e=a.getOptions(c.options,d);return b.get(e.httpGet.url,e.httpGet.parameter).then(function(b){a.finalizeTitleMap(c,b.data,e),console.log("httpGet items",c.titleMap)},function(a,b){alert("Loading select items failed (URL: '"+String(e.httpGet.url)+"\nError: "+b)})}}else console.log("dynamicSelectController.populateTitleMap(key:"+c.key+") : No options set, needed for dynamic selects")},a.find_in_titleMap=function(b){for(i=0;i<a.form.titleMap.length;i++)if(a.form.titleMap[i].value==b)return{value:a.form.titleMap[i].value,name:a.form.titleMap[i].name}},a.uiMultiSelectInitInternalModel=function(b){console.log("$scope.externalModel: Key: "+a.form.key.toString()+" Model: "+b.toString()),a.externalModel=b,a.internalModel=[],a.form.titleMap&&void 0!==b&&angular.isArray(b)&&b.forEach(function(b){a.internalModel.push(a.find_in_titleMap(b))})}}]),angular.module("schemaForm").filter("selectFilter",[function(a){return function(a,b,c,d){if(!angular.isDefined(a)||!angular.isDefined(b.form.options)||!angular.isDefined(b.form.options.filter)||""==b.form.options.filter)return a;console.log("----- In filtering for "+b.form.key+"("+b.form.title+"), model value: "+JSON.stringify(c)+"----"),console.log("Filter:"+b.form.options.filter),b.filteringInitialized||(console.log("Initialize filter"),b.initFiltering(c));var e=[];return angular.forEach(a,function(a){b.$eval(b.form.options.filter,{item:a})?e.push(a):c&&("[object Array]"==b.localModelType&&c.indexOf(a.value)>-1?c.splice(c.indexOf(a.value),1):c==a.value&&(console.log("Setting model of type "+b.localModelType+"to null."),c=null))}),"[object Array]"!=b.localModelType||c||(console.log("Resetting model of type "+b.localModelType+" to []."),b.$eval(d+"=[]")),console.log("----- Exiting filter for "+b.form.title+"-----"),e}}])});var underscore=angular.module("underscore",[]);underscore.factory("_",["$window",function(a){return a._}]),angular.module("WsClient",["ngWebSocket","ngCookies","underscore"]).provider("wsClient",function(){var a=this,b="wss://api-onset.scriptrapps.io/",c=null,d=null,e=null,f=null,g=null,h={},i=0,j={},k=[];this.setBaseUrl=function(a){b=a},this.setPublishChannel=function(a){c=a},this.setSubscribeChannel=function(a){console.log(a),d=a},this.getSubscribeChannel=function(){return d},this.setToken=function(a){e=a};var l=function(){f=b+(e?"/"+e:"")},m=function(a){return i+=1,i>1e4&&(i=0),i},n=function(a,b){return g+"-"+(b?b+"_"+a:a)},o=function(a,b){return b?b+"_"+a:a},p=function(a,b){return g+"-"+(b?b+"_"+a:a)};this.$get=["$websocket","$cookies","$q","$rootScope","$interval","_",function(b,e,i,q,r,s){e.get("token")&&this.setToken(e.get("token")),l(),r(function(){if(v.promise&&k.length>0){var a=k[0];t.send(a),k.shift()}},500);var t=b(f),u={},v=i.defer(),w=i.defer(),x=i.defer();t.onOpen(function(){y(d)}),t.onMessage(function(a){try{var b=JSON.parse(a.data);console.log("Received message data from websocket: ",b),"connected."==b.result&&(g=b.id,v&&v.resolve()),"failure"==b.status&&"429"==b.statusCode&&(0==$("body").find(".alert-transport").length&&$("body").append('<div class="alert alert-danger alert-dismissable alert-transport" style="position: absolute; z-index: 1000; top: 0; width: 600px; left: 30%; text-align: center">You have reached you requests rate limit. For more info check the <a href="https://www.scriptr.io/documentation#documentation-ratelimitingRateLimiting" target="blank">documentation.</a><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button></div>'),console.error("You have reached your requests rate limit. For more info check the documentation. https://www.scriptr.io/documentation#documentation-ratelimitingRateLimiting")),u.data=b,A(b),B(b)}catch(b){console.log("Error when parsing message received over socket",a,b)}}),t.onClose(function(a){console.log("Socket Closed",a),x.resolve(),console.log("Trying to reconnect closed socket."),t.reconnect()}),t.onError(function(a){console.log("Socket Error",a),w.resolve()});var y=function(a){if(a)if("string"==typeof a)t.send(JSON.stringify({method:"Subscribe",params:{channel:a}}));else if("Array"==a.constructor.name)for(var b=0;b<a.length;b++)t.send(JSON.stringify({method:"Subscribe",params:{channel:a[b]}}))},z=function(a){if(a)if("string"==typeof a)t.send(JSON.stringify({method:"Unsubscribe",params:{channel:a}}));else if("Array"==a.constructor.name)for(var b=0;b<a.length;b++)t.send(JSON.stringify({method:"Unscubscribe",params:{channel:a[b]}}))},A=function(a){var b=a.id;b&&h.hasOwnProperty(b)?(console.log("Execute registered call back for received socket message.",h[b]),q.$apply(h[b].cb.resolve(a.result)),delete h[b]):console.log("No callbacks registerd for received socket message.")},B=function(a){var b=a.id;if(b&&j.hasOwnProperty("subscribeToAll")){console.log("Execute registered call back for received socket message.",j.subscribeToAll);for(var c=j.subscribeToAll,d=0;d<c.length;d++)c[d].cb(a.result)}else if(b&&j.hasOwnProperty(b)){console.log("Execute registered call back for received socket message.",j[b]);for(var c=j[b],d=0;d<c.length;d++)c[d].cb(a.result)}else console.log("No subscribers registerd for received socket message.")};return{getMessage:function(){return u},getStatus:function(){return t.readyState},subscribe:function(a,b,c){if(d){var b={time:new Date,cb:b};c&&(b.id=c),j[a]?j[a].push(b):j[a]=[b]}},unsubscribe:function(a,b,c){if(!a)return void console.log("prefix is mandatory to unsubscribe.");if(console.log("---",j[a]),d)if(!a||b||c){var e={};b&&(e.cb=b),c&&(e.id=c),j[a]=s.difference(j[a],s.where(j[a],e))}else j[a]=[];console.log("+++",j[a])},publish:function(a,b,d){var e=c;if(d&&(e=d),e){var f=i.defer(),g=m(),j=n(g,b);return h[j]={time:new Date,cb:f},a.id=j,console.log("Sending publish message",a),t.send({method:"Publish",params:{channel:e,message:JSON.stringify(a)}}),f.promise}console.log("No channel is defined, message won't be sent.",a)},call:function(a,b,c){var d=i.defer(),e={method:a,params:{body:JSON.stringify(b)}},f=m(),g=p(f,c);return h[g]={time:new Date,cb:d},e.id=o(f,c),console.log("Sending call api request over socket.",e),k.push(e),d.promise},updateSubscriptionChannel:function(b){z(a.getSubscribeChannel()),a.setSubscribeChannel(b),y(b)},updatePublishingChannel:function(b){a.setPublishChannel(b)},closeSocket:function(a){a?t.close(a):t.close(!1)},onReady:v.promise,onError:w.promise,onClose:x.promise}}]}),angular.module("HttpClient",["ngCookies"]).provider("httpClient",function(){var a="",b=null,c="";this.setBaseUrl=function(b){a=b,console.log(a)},this.setToken=function(a){b=a,console.log(b)};var d=function(b){c=a+"/"+b,console.log(c)};this.$get=["$cookies","$q","$http",function(a,e,f){a.get("token")&&(b=a.get("token"));var g=function(a,b,c){return a&&a[b]||(a||(a={}),a[b]=c),a},h=function(h,i){var j=e.defer();return d(h),i.url=c,a.get("token")&&(i.headers=g(i.headers,"Authorization","Bearer "+b)),f(i).then(function(a){if(a.data&&a.data.response){var b=a.data.response;"200"==b.metadata.statusCode&&"success"==b.metadata.status?"403"==b.result.status?($.removeCookie("token",{path:"/"}),window.localStorage.removeItem("user"),window.location=onsetLoginUrl):b.result&&b.result.metadata?"200"==b.result.statusCode&&"success"==b.result.status?j.resolve(b.result.result,a):j.reject(b.result.metadata,a):j.resolve(b.result,a):j.reject(b.metadata,a)}},function(a){console.log("ERROR",a),"429"==a.status?(0==$("body").find(".alert-transport").length&&$("body").append('<div class="alert alert-danger alert-dismissable alert-transport" style="position: absolute; z-index: 1000; top: 0; width: 600px; left: 30%; text-align: center">You have reached you requests rate limit. For more info check the <a href="https://www.scriptr.io/documentation#documentation-ratelimitingRateLimiting" target="blank">documentation.</a><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button></div>'),console.error("You have reached your requests rate limit. For more info check the documentation. https://www.scriptr.io/documentation#documentation-ratelimitingRateLimiting")):"400"!=a.status&&"403"!=a.status||(window.location=onsetLoginUrl),j.reject(a)}),j.promise};return{get:function(a,b){var c={method:"GET"};return c.params=b,h(a,c)},post:function(a,b,c,d){var e={method:"POST"};return e.data=b,c&&(e.headers=c),c&&c["Content-Type"]||(e.headers=g(e.headers,"Content-Type","application/json")),d&&(e.headers["Content-Type"]=void 0,e.transformRequest=angular.identity),h(a,e)}}}]}),angular.module("Chart",["angular.morris"]),angular.element(document).ready(function(){Morris.Donut.prototype.resizeHandler=function(){return this.timeoutId=null,this.el&&this.el.width()>0&&this.el.height()>0?(this.raphael.setSize(this.el.width(),this.el.height()),this.redraw()):null},Morris.Donut.prototype.setData=function(a){var b;return this.data=a,this.values=function(){var a,c,d,e;for(d=this.data,e=[],a=0,c=d.length;a<c;a++)b=d[a],e.push(parseFloat(b.value));return e}.call(this),this.el&&this.el.width()>0&&this.el.height()>0?this.redraw():null}}),angular.module("Chart").component("scriptrChart",{bindings:{fetchFromDateParam:"@",fetchFromDateValue:"@",fetchToDateParam:"@",fetchToDateValue:"@",fetchDataInterval:"@",displayMetricValue:"@",displayMetricParam:"@",defaultMetricValue:"@",defaultMetricParam:"@",availableUnits:"<?",onLoad:"&onLoad",resize:"<?",data:"<?",type:"@",xkey:"@",stacked:"<?",labels:"<?",api:"@",transport:"@",msgTag:"@",apiParams:"<?",onFormatData:"&",lineWidth:"@",pointSize:"@",pointFillColors:"@",pointStrokeColors:"@",ymax:"@",ymin:"@",smooth:"@",hideHover:"@",parseTime:"@",units:"@",postUnits:"@",preUnits:"@",xlabels:"@",xlabelAngle:"<?",goals:"@",goalStrokeWidth:"@",goalLineColors:"@",customGoals:"<?",events:"@",eventStrokeWidth:"@",eventLineColors:"@",customEvents:"<?",continuousLine:"@",axes:"@",grid:"@",gridTextColor:"@",gridTextSize:"@",gridTextFamily:"@",gridTextWeight:"@",fillOpacity:"@",resize:"@",behaveLikeLine:"@",labelColor:"@",donutFormatter:"&",backgroundColor:"@",hoverCallback:"&?",dateFormat:"&?",xlabelFormat:"&?",ylabelFormat:"&?",colorsMapping:"<?",showLegend:"@"},templateUrl:"/UIComponents/dashboard/frontend/components/chart/chart.html",controller:["$rootScope","httpClient","wsClient","$scope","$timeout",function(a,b,c,d,e){var f=this;this.$onInit=function(){if(this.apiParams=this.apiParams?this.apiParams:[],void 0===this.api&&void 0===this.msgTag&&(this.data&&0==this.data.length||null==this.data)&&(this.noResults=!0),this.displayMetricParam=this.displayMetricParam?this.displayMetricParam:"display_metric",this.displayMetricValue=a.currentDashboardUnit,this.defaultMetricParam=this.defaultMetricParam?this.defaultMetricParam:"default_metric",this.defaultMetricValue=this.defaultMetricValue?this.defaultMetricValue:null,this.defaultMetricValue&&this.displayMetricValue&&this.defaultMetricValue!=this.displayMetricValue&&this.availableUnits&&Object.keys(this.availableUnits).length>=2&&this.runMetricTransformation(),this.customGoals=this.customGoals?this.customGoals:[{"goal-line-colors":"#666633",goals:""},{"goal-line-colors":"#999966",goals:""},{"goal-line-colors":"#cc6666",goals:""},{"goal-line-colors":"#663333",goals:""}],this.goalLineColors=[],this.goals=[],this.customGoals&&this.customGoals.length>0)for(x=0;x<this.customGoals.length;x++)this.customGoals[x]["goal-line-colors"]&&this.customGoals[x].goals&&(this.goalLineColors.push(this.customGoals[x]["goal-line-colors"]),this.goals.push(this.customGoals[x].goals));if(this.customEvents=this.customEvents?this.customEvents:[{"event-line-colors":"#666633",events:""},{"event-line-colors":"#999966",events:""},{"event-line-colors":"#cc6666",events:""},{"event-line-colors":"#663333",events:""}],this.eventLineColors=[],this.events=[],this.customEvents&&this.customEvents.length>0)for(x=0;x<this.customEvents.length;x++)this.customEvents[x]["event-line-colors"]&&this.customEvents[x].events&&(this.eventLineColors.push(this.customEvents[x]["event-line-colors"]),this.events.push(this.customEvents[x].events));if(this.colors=this.colors?this.colors:["#aa241d","#edcfce"],this.colorsMapping&&(this.colors=_.pluck(this.colorsMapping,"colors")),this.colorsMapping?this.labels=_.pluck(this.colorsMapping,"labels"):this.labels=["Serie A","Serie B"],this.colorsMapping?this.ykeys=_.pluck(this.colorsMapping,"ykeys"):this.ykeys=this.ykeys?this.ykeys:["a","b"],this.stacked=!!this.stacked&&this.stacked,this.resize=!this.resize||this.resize,this.labelColor=this.labelColor?this.labelColor:"#eee",this.backgroundColor=this.backgroundColor?this.backgroundColor:"#fff",this.transport=this.transport?this.transport:"wss",this.msgTag=this.msgTag?this.msgTag:null,this.showLegend=null!=this.showLegend&&"true"==this.showLegend,this.showLegend){this.ref=d.$id,this.legendStructure=[];for(var b=0;b<this.ykeys.length;b++){var c={};c.key=this.ykeys[b],this.labels&&this.labels[b]?c.label=this.labels[b]:c.label=this.ykeys[b],this.colors&&this.colors[b]&&(c.color=this.colors[b]),this.legendStructure.push(c)}}this.fetchFromDateParam=this.fetchFromDateParam?this.fetchFromDateParam:"from_date",this.fetchToDateParam=this.fetchToDateParam?this.fetchToDateParam:"to_date",this.fetchToDateValue=this.fetchToDateValue?this.fetchToDateValue:null,this.fetchFromDateValue=this.fetchFromDateValue?this.fetchFromDateValue:null,this.fetchFromDateValue&&(this.apiParams[this.fetchFromDateParam]=this.fetchFromDateValue),this.fetchToDateValue&&(this.apiParams[this.fetchToDateParam]=this.fetchToDateValue),this.delta=!1},this.hoverCallback=function(a,b,c,e){f.datas&&_.mapObject(e,function(a,b){var e=_.findIndex(d.$ctrl.legendStructure,{key:"donut"!=f.type?b:a});if(-1!=e){d.$ctrl.legendStructure[e].value="donut"==f.type?c:a;var g=document.getElementById("value_"+e+"_"+f.ref);g&&(g.innerHTML="donut"==f.type?c:a)}})},this.runMetricTransformation=function(){if("si"!=this.defaultMetricValue)var a=this.availableUnits.us,b=this.availableUnits.si;else var a=this.availableUnits.si,b=this.availableUnits.us;if(this.customGoals)for(var c=0;c<this.customGoals.length;c++){var d=this.customGoals[c].goals;this.customGoals[c].goals=getConversionFunction(a,b)(d)}},this.$postLink=function(){g(this.transport),this.data&&!this.api?(f.timeout=!1,e(function(){f.consumeData(f.data)},2e3)):f.timeout=!0,d.$watch(function(a){if(a.$ctrl.data&&1==f.timeout)return a.$ctrl.data},function(a){a&&(f.datas=a,f.noResults=!1)})},this.$onDestroy=function(){console.log("destory chart",f.msgTag,d.$id),f.msgTag&&c.unsubscribe(f.msgTag,null,d.$id),f.refreshTimer&&e.cancel(f.refreshTimer)};var g=function(a){"wss"==a?c.onReady.then(function(){f.msgTag&&c.subscribe(f.msgTag,f.consumeData.bind(f),d.$id),f.api&&c.call(f.api,f.apiParams,f.msgTag).then(function(b,c){f.fetchDataInterval&&!f.refreshTimer&&(f.refreshTimer=e(function(){f.apiParams[f.fetchFromDateParam]=f.fetchToDateValue,f.apiParams[f.fetchToDateParam]=(new Date).getTime(),"donut"!=f.type&&(f.delta=!0),g.bind(f)(a)},1e3*f.fetchDataInterval),f.refreshTimer.then(function(){f.refreshTimer=null,console.log("Timer run resolved!",Date.now())},function(){f.refreshTimer=null,console.log("Timer run rejected!",Date.now())})),f.consumeData(b)},function(a){console.log("reject published promise",a),f.consumeData()})}):"https"==a&&f.api&&b.get(f.api,f.apiParams).then(function(a,b){f.consumeData(a)},function(a){console.log("reject published promise",a),f.consumeData()})};this.consumeData=function(a,b){f.timeout=!0,"function"==typeof f.onFormatData()&&(a=f.onFormatData()(a)),a&&a.length>0&&"object"==typeof a?this.fetchDataInterval&&this.fetchDataInterval>0&&this.datas&&this.delta?this.datas=this.datas.concat(a):(this.datas=a,this.noResults=!1):this.api&&0==a.length&&(!this.datas||this.datas&&0==this.datas.length||_.isEqual(this.datas,this.data))&&(this.datas=[],this.noResults=!0)}}]}),angular.module("Odometer",["ui.odometer"]),angular.module("Odometer").component("scriptrOdometer",{bindings:{displayMetricValue:"@",displayMetricParam:"@",onLoad:"&onLoad",api:"@",enableResize:"<?",theme:"@",duration:"@",animation:"@",transport:"@",odometerValue:"<?",data:"<?",msgTag:"@",apiParams:"<?",size:"<?",onFormatData:"&",fetchDataInterval:"@"},templateUrl:"/UIComponents/dashboard/frontend/components/odometer/odometer.html",controller:["$scope","httpClient","wsClient","$element","$window","$timeout",function(a,b,c,d,e,f){var g=this;g.noResults=!1,this.$onInit=function(){this.config={duration:this.duration?this.duration:1e3,animation:this.animation?this.animation:"count",theme:this.theme?this.theme:"car"},this.odometerOptions=this.config,this.odometerValue=this.odometerValue?this.odometerValue:this.data?this.data:0,this.size=this.size?this.size:1,this.enableResize=void 0===this.enableResize||this.enableResize,this.style={},this.style["font-size"]=this.size+"em",angular.element(e).on("resize",function(){return null!=g.timeoutId&&f.cancel(g.timeoutId),g.timeoutId=f(g.resize,100)}),this.transport=this.transport?this.transport:"wss",this.msgTag=this.msgTag?this.msgTag:null,this.fetchDataInterval=this.fetchDataInterval?parseInt(this.fetchDataInterval):null,this.displayMetricParam=this.displayMetricParam?this.displayMetricParam:"display_metric",this.displayMetricValue=this.displayMetricValue?this.displayMetricValue:null,this.displayMetricValue&&(this.apiParams[this.displayMetricParam]=this.displayMetricValue),h(this.transport)},g.resize=function(){g.timeoutId=null,g.enableResize&&(g.style["margin-top"]=g.noResults?0:d.parent().outerHeight(!0)/2-$(d.children()[0]).innerHeight()/2)},this.$postLink=function(){f(g.resize,100),null!=g.timeoutId&&f.cancel(g.timeoutId),g.timeoutId=f(g.resize,100),g.refreshTimer&&f.cancel(g.refreshTimer)},this.$onDestroy=function(){angular.element(e).off("resize"),g.msgTag&&c.unsubscribe(g.msgTag,null,a.$id),g.refreshTimer&&f.cancel(g.refreshTimer),console.log("destory odometer")};var h=function(d){"wss"==d?c.onReady.then(function(){g.msgTag&&c.subscribe(g.msgTag,g.consumeData.bind(g),a.$id),g.api&&c.call(g.api,g.apiParams,g.msgTag).then(function(a,b){g.fetchDataInterval&&!g.refreshTimer&&(g.refreshTimer=f(function(){h.bind(g)(d)},1e3*g.fetchDataInterval),g.refreshTimer.then(function(){g.refreshTimer=null,console.log("Timer run resolved!",Date.now())},function(){g.refreshTimer=null,console.log("Timer run rejected!",Date.now())})),g.consumeData(a)},function(a){console.log("reject published promise",a),g.consumeData()})}):"https"==d&&g.api&&b.get(g.api,g.apiParams).then(function(a,b){g.consumeData(a)},function(a){console.log("reject published promise",a)})};this.consumeData=function(a,b){"function"==typeof g.onFormatData()&&(a=g.onFormatData()(a)),null!=a?(this.noResults=!1,this.odometerValue=a):this.noResults=!0,g.style["margin-top"]=g.noResults?0:d.parent().outerHeight(!0)/2-$(d.children()[0]).innerHeight()/2}}]}),angular.module("Speedometer",["meterGauge"]),angular.module("Speedometer").component("scriptrSpeedometer",{bindings:{displayMetricValue:"@",displayMetricParam:"@",onLoad:"&onLoad",gaugeRadius:"<?",theme:"@",minValue:"<?",maxValue:"<?",needleVal:"<?",data:"<?",tickSpaceMinVal:"<?",tickSpaceMajVal:"<?",gaugeUnits:"@",tickColMaj:"@",tickColMin:"@",outerEdgeCol:"@",pivotCol:"@",innerCol:"@",unitsLabelCol:"@",tickLabelCol:"@",needleCol:"@",defaultFonts:"@",api:"@",transport:"@",msgTag:"@",apiParams:"<?",onFormatData:"&"},templateUrl:"/UIComponents/dashboard/frontend/components/speedometer/speedometer.html",controller:["httpClient","wsClient","$element","$window","$scope","$compile","$timeout",function(a,b,c,d,e,f,g){var h=this;this.$onInit=function(){this.speedoConfig={},"speed"==this.theme||void 0===this.theme?(this.speedoConfig.gaugeRadius=this.gaugeRadius?this.gaugeRadius:150,this.speedoConfig.minVal=this.minValue?this.minValue:0,this.speedoConfig.maxVal=this.maxValue?this.maxValue:220,this.speedoConfig.needleVal=this.needleVal?Math.round(this.needleVal):this.data?Math.round(this.data):0,this.speedoConfig.tickSpaceMinVal=this.tickSpaceMinVal?this.tickSpaceMinVal:10,this.speedoConfig.tickSpaceMajVal=this.tickSpaceMajVal?this.tickSpaceMajVal:20,this.speedoConfig.gaugeUnits=this.gaugeUnits?this.gaugeUnits:"kmh",this.speedoConfig.tickColMaj=this.tickColMaj?this.tickColMaj:"#C64DFF",this.speedoConfig.tickColMin=this.tickColMin?this.tickColMin:"#999999",this.speedoConfig.outerEdgeCol=this.outerEdgeCol?this.outerEdgeCol:"#f4f4f4",this.speedoConfig.pivotCol=this.pivotCol?this.pivotCol:"#434a54",this.speedoConfig.innerCol=this.innerCol?this.innerCol:"#ffffff",this.speedoConfig.unitsLabelCol=this.unitsLabelCol?this.unitsLabelCol:"#C64DFF",this.speedoConfig.tickLabelCol=this.tickLabelCol?this.tickLabelCol:"#656D78",this.speedoConfig.needleCol=this.needleCol?this.needleCol:"#C64DFF",this.speedoConfig.defaultFonts=this.defaultFonts?this.defaultFonts:""):"rpm"==this.theme&&(this.speedoConfig.gaugeRadius=this.gaugeRadius?this.gaugeRadius:120,this.speedoConfig.minVal=this.minValue?this.minValue:0,this.speedoConfig.maxVal=this.maxValue?this.maxValue:1e3,this.speedoConfig.needleVal=this.needleVal?Math.round(this.needleVal):this.data?Math.round(this.data):0,this.speedoConfig.tickSpaceMinVal=this.tickSpaceMinVal?this.tickSpaceMinVal:10,this.speedoConfig.tickSpaceMajVal=this.tickSpaceMajVal?this.tickSpaceMajVal:100,this.speedoConfig.gaugeUnits=this.gaugeUnits?this.gaugeUnits:"kmh",this.speedoConfig.tickColMaj=this.tickColMaj?this.tickColMaj:"#0194D9",this.speedoConfig.tickColMin=this.tickColMin?this.tickColMin:"#999999",this.speedoConfig.outerEdgeCol=this.outerEdgeCol?this.outerEdgeCol:"#ffffff",this.speedoConfig.pivotCol=this.pivotCol?this.pivotCol:"#434A54",this.speedoConfig.innerCol=this.innerCol?this.innerCol:"#ffffff",this.speedoConfig.unitsLabelCol=this.unitsLabelCol?this.unitsLabelCol:"#0194d9",this.speedoConfig.tickLabelCol=this.tickLabelCol?this.tickLabelCol:"#656D78",this.speedoConfig.needleCol=this.needleCol?this.needleCol:"#0194d9",this.speedoConfig.defaultFonts=this.defaultFonts?this.defaultFonts:""),this.speedoConfig.speedoTag=e.$id,this.displayMetricParam=this.displayMetricParam?this.displayMetricParam:"display_metric",this.displayMetricValue=this.displayMetricValue?this.displayMetricValue:null,this.displayMetricValue&&(this.apiParams[this.displayMetricParam]=this.displayMetricValue),this.transport=this.transport?this.transport:"wss",this.msgTag=this.msgTag?this.msgTag:null},this.calculateGaugeRadius=function(){h.timeoutId=null;var a=c.parent().height(),b=c.parent().width();h.speedoConfig.gaugeRadius=0==a?b/2:b>=a?a/2:b/2},this.$postLink=function(){g(function(){console.log("Calc"),h.gaugeRadius||(h.calculateGaugeRadius(),console.log("Gauge Size",h.speedoConfig.gaugeRadius),angular.element(d).on("resize",function(){null!=h.timeoutId&&g.cancel(h.timeoutId),h.timeoutId=g(h.calculateGaugeRadius,100)})),h.renderGauge(),e.$watch(function(a){return a.$ctrl.needleVal&&(h.speedoConfig.needleVal=a.$ctrl.needleVal),JSON.stringify(h.speedoConfig)},function(a){h.renderGauge()}),i(h.transport)},500)},this.$onDestroy=function(){this.gaugeRadius||angular.element(d).off("resize"),h.msgTag&&b.unsubscribe(h.msgTag,null,e.$id),console.log("destory speedo")},this.renderGauge=function(){angular.element(c).html(""),this.speedo=angular.element(document.createElement("meter-gauge")),this.speedo.attr("gaugeconfig",JSON.stringify(this.speedoConfig));var a=f(this.speedo)(e);angular.element(c).append(a)};var i=function(c){console.log("Gauge Size",h.speedoConfig.gaugeRadius),"wss"==c?b.onReady.then(function(){h.msgTag&&b.subscribe(h.msgTag,h.consumeData.bind(h),e.$id),h.api&&b.call(h.api,h.apiParams,h.msgTag).then(function(a,b){h.consumeData(a)},function(a){console.log("reject published promise",a),h.consumeData()})}):"https"==c&&h.api&&a.get(h.api,h.apiParams).then(function(a,b){h.consumeData(a)},function(a){console.log("reject published promise",a)})};this.consumeData=function(a,b){"function"==typeof h.onFormatData()&&(a=h.onFormatData()(a)),a=parseInt(a),a="number"==typeof a&&"NaN"!=a.toString()?a:0,this.speedoConfig.needleVal=Math.round(a)}}]}),angular.module("SearchBox",["angularBootstrapNavTree"]).component("scriptrSearchbox",{bindings:{treeControl:"<?",treeData:"<?",searchText:"@",iconLeaf:"@",paramName:"@",iconExpand:"@",iconCollapse:"@",onSelect:"&onSelect",expandLevel:"@",initialSelection:"@",apiParams:"<?",loadTree:"<?",treeSearchCriteria:"@",transport:"@",api:"@",onFormatData:"&",childrenTag:"@",labelTag:"@",widgetsConfig:"<?"},templateUrl:"/UIComponents/dashboard/frontend/components/searchBox/searchBox.html",controller:["wsClient","httpClient","$timeout",function(a,b,c){var d=this;this.iconExpand=this.iconExpand?this.iconExpand:null,this.$onInit=function(){this.iconLeaf=this.iconLeaf&&"$ctrl.iconLeaf"!=this.iconLeaf?this.iconLeaf:"icon-file  glyphicon glyphicon-file  fa fa-file",this.iconExpand=this.iconExpand&&"$ctrl.iconExpand"!=this.iconExpand?this.iconExpand:"icon-plus  glyphicon glyphicon-plus  fa fa-plus",this.iconCollapse=this.iconCollapse&&"$ctrl.iconCollapse"!=this.iconCollapse?this.iconCollapse:"icon-minus glyphicon glyphicon-minus fa fa-minus",this.paramName=this.paramName?this.paramName:"criteria",this.searchText=this.searchText?this.searchText:"Type to search",this.treeData=this.treeData?this.treeData:[],this.iconLeaf=this.iconLeaf?this.iconLeaf:null,this.transport=this.transport?this.transport:"wss",this.loadTree&&(this.searching=!0,e(this.transport))},this.onFilterChanged=function(){if(null!=this.searchValue&&""!=this.searchValue){this.searching=!0;for(var a=angular.copy(this.originalData),b=[],c=0;c<a.length;c++){var d=a[c],e=d.sensors;if(-1==d.label.toLowerCase().indexOf(this.searchValue.toLowerCase())){for(var f=!1,g=[],h=0;h<e.length;h++){-1==e[h].label.toLowerCase().indexOf(this.searchValue.toLowerCase())?g.push(h):f=!0}for(var i=g.length-1,h=i;h>=0;h--)e.splice(g[h],1);f||b.push(c)}}for(var i=b.length-1,c=i;c>=0;c--)a.splice(b[c],1)}else a=angular.copy(this.originalData);this.consumeData(a,null,!0)};var e=function(c){var e={};if(d.apiParams)for(var f in d.apiParams)e[f]=d.apiParams[f];"wss"==c?a.onReady.then(function(){a.subscribe(d.msgTag,d.consumeData.bind(d)),d.api&&a.call(d.api,e,d.msgTag).then(function(a,b){d.consumeData(a)},function(a){console.log("reject published promise",a),d.consumeData()})}):"https"==c&&d.api&&b.get(d.api,e).then(function(a,b){},function(a){d.consumeData(),console.log("reject published promise",a)})};this.consumeData=function(a,b,c){if("function"==typeof d.onFormatData()&&(a=d.onFormatData()(a)),!c&&a&&"string"!=typeof a){window.localStorage.setItem("dataStream",JSON.stringify(a.dataStream)),window.localStorage.setItem("dataMapping",JSON.stringify(a.dataMapping)),a=a.dataStream;for(var e=d.widgetsConfig,f={},g=0;g<e.length;g++)f[e[g].name]=e[g];for(var h=0;h<a.length;h++)if(a[h].sensors)for(var i=0;i<a[h].sensors.length;i++){var j=a[h].sensors[i].sectionData,k=angular.copy(f[j]),l=a[h].sensors[i].measurement_type;l=l.split(" ").join("_"),k.selectedStreamValue=a[h].sensors[i].selectedStreamValue,k.selectedStreamUnits=a[h].sensors[i].selectedStreamUnits,a[h].sensors[i].fieldName&&(k.selectedStreamFieldName=a[h].sensors[i].fieldName),k.selectedStreamLabel=a[h].sensors[i].label,a[h].sensors[i].sectionData=JSON.stringify(k),f[j].imgSrc&&(a[h].sensors[i].imgSrc=f[j].imgSrc)}}
console.log("display tree"),window.localStorage.getItem("streamData",a),"object"==typeof a&&a.length>0?(this.treeData=a,this.noResults=!1):(this.treeData=[],this.noResults=!0),this.originalData||(this.originalData=angular.copy(this.treeData)),this.searching=!1}}]}),angular.module("Gauge",["frapontillo.gage"]),angular.module("Gauge").component("scriptrGauge",{bindings:{displayMetricValue:"@",displayMetricParam:"@",defaultMetricValue:"@",defaultMetricParam:"@",availableUnits:"<?",onLoad:"&onLoad",api:"@",transport:"@",msgTag:"@",apiParams:"<?",valueFontColor:"@",min:"@",max:"@",hideMinMax:"@",hideValue:"@",showInnerShadow:"<?",gaugeColor:"@",gaugeValue:"<?",data:"<?",customSectors:"<?",shadowSize:"@",shadowOpacity:"@",label:"@",labelFontColor:"@",startAnimationType:"@",refreshAnimationType:"@",valueFontFamily:"@",relativeGaugeSize:"@",valueMinFontSize:"@",hideMinMax:"@",labelMinFontSize:"@",minLabelMinFontSize:"@",maxLabelMinFontSize:"@",gaugeWidthScale:"@",shadowVerticalOffset:"@",levelColors:"@",noGradient:"@",startAnimationTime:"@",refreshAnimationTime:"@",donut:"@",donutStartAngle:"@",reverse:"@",decimals:"@",symbol:"@",formatNumber:"@",humanFriendly:"@",humanFriendlyDecimal:"@",textRenderer:"&",onAnimationEnd:"&",pointer:"<?",onFormatData:"&",heightUnit:"@",counter:"@",width:"@",height:"@",fetchDataInterval:"@"},templateUrl:"/UIComponents/dashboard/frontend/components/gauge/gauge.html",controller:["$rootScope","$scope","httpClient","wsClient","$timeout",function(a,b,c,d,e){var f=this;f.noResults=!1,this.$onInit=function(){this.apiParams=this.apiParams?this.apiParams:[],this.gaugeValue?this.consumeData(this.gaugeValue):this.data&&this.consumeData(this.data),this.heightUnit=this.heightUnit?this.heightUnit:"px",this.displayMetricParam=this.displayMetricParam?this.displayMetricParam:"display_metric",this.displayMetricValue=a.currentDashboardUnit,this.defaultMetricParam=this.defaultMetricParam?this.defaultMetricParam:"default_metric",this.defaultMetricValue=this.defaultMetricValue?this.defaultMetricValue:null,this.customSectors=this.customSectors?this.customSectors:{percents:!0,ranges:[{color:"#A3CD3B",lo:0,hi:25},{color:"#FF4A43",lo:25,hi:100}]},this.defaultMetricValue&&this.displayMetricValue&&this.defaultMetricValue!=this.displayMetricValue&&this.availableUnits&&Object.keys(this.availableUnits).length>=2&&this.runMetricTransformation(),this.heightUnit=this.heightUnit?this.heightUnit:"px",this.valueFontColor=this.valueFontColor?this.valueFontColor:"#999",this.min=this.min?this.min:0,this.gaugeMax=this.max?this.max:100,this.hideMinMax=!!this.hideMinMax&&this.hideMinMax,this.hideValue=!!this.hideValue&&this.hideValue,this.gaugeColor=this.gaugeColor?this.gaugeColor:"#e9e9e9",this.shadowSize=this.shadowSize?this.shadowSize:0,this.label=this.label?this.label:"",this.labelFontColor=this.labelFontColor?this.labelFontColor:"#666",this.startAnimationType=this.startAnimationType?this.startAnimationType:"linear",this.refreshAnimationType=this.refreshAnimationType?this.refreshAnimationType:"linear",this.counter=!this.counter||this.counter,this.transport=this.transport?this.transport:"wss",this.msgTag=this.msgTag?this.msgTag:null,this.fetchDataInterval=this.fetchDataInterval?parseInt(this.fetchDataInterval):null,this.symbol=this.availableUnits?this.availableUnits[this.displayMetricValue]:this.symbol?this.symbol:"",g(this.transport)},this.runMetricTransformation=function(){if("si"!=this.defaultMetricValue)var a=this.availableUnits.us,b=this.availableUnits.si;else var a=this.availableUnits.si,b=this.availableUnits.us;if(this.customSectors)for(var c=0;c<this.customSectors.ranges.length;c++){var d=this.customSectors.ranges[c].lo,e=this.customSectors.ranges[c].hi;this.customSectors.ranges[c].lo=getConversionFunction(a,b)(d),this.customSectors.ranges[c].hi=getConversionFunction(a,b)(e)}this.min=parseFloat(getConversionFunction(a,b)(this.min)).toFixed(0),this.gaugeMax=parseFloat(getConversionFunction(a,b)(this.max)).toFixed(0)},this.$onDestroy=function(){console.log("destory gauge"),f.msgTag&&d.unsubscribe(f.msgTag,null,b.$id),f.refreshTimer&&e.cancel(f.refreshTimer)};var g=function(a){"wss"==a?d.onReady.then(function(){f.msgTag&&d.subscribe(f.msgTag,f.consumeData.bind(f),b.$id),f.api&&d.call(f.api,f.apiParams,f.msgTag).then(function(b,c){f.fetchDataInterval&&!f.refreshTimer&&(f.refreshTimer=e(function(){g.bind(f)(a)},1e3*f.fetchDataInterval),f.refreshTimer.then(function(){f.refreshTimer=null,console.log("Timer run resolved!",Date.now())},function(){f.refreshTimer=null,console.log("Timer run rejected!",Date.now())})),f.consumeData(b)},function(a){console.log("reject published promise",a),f.consumeData()})}):"https"==a&&f.api&&c.get(f.api,f.apiParams).then(function(a,b){f.consumeData(a)},function(a){console.log("reject published promise",a)})};this.consumeData=function(a,b){"function"==typeof this.onFormatData()&&(a=this.onFormatData()(a)),a=parseFloat(a),"number"==typeof a&&"NaN"!=a.toString()?(this.noResults=!1,a=a,this.gaugeValue=a):this.noResults=!0}}]}),angular.module("angular-scriptrui",[]).directive("ngDisplayBox",function(){return{restrict:"E",require:"ngModel",scope:{msg:"=ngModel",type:"@"},template:'<div class="alert alert-{{type}}" role="alert"><span ng-bind="msg"></span></div>',replace:!0}}),angular.module("Message",["angular-scriptrui"]),angular.module("Message").component("scriptrDisplaybox",{bindings:{data:"@",type:"@",api:"@",transport:"@",msgTag:"@",apiParams:"<?",onFormatData:"&"},templateUrl:"/UIComponents/dashboard/frontend/components/message/message.html",controller:["httpClient","wsClient",function(a,b){var c=this;this.$onInit=function(){this.data=this.data?this.data:"Waiting for info...",this.type=this.type?this.type:"info"},this.$postLink=function(){d(this.transport)};var d=function(d){"wss"==d?b.onReady.then(function(){b.subscribe(c.msgTag,c.consumeData.bind(c)),c.api&&b.call(c.api,c.apiParams,c.msgTag).then(function(a,b){c.consumeData(a)},function(a){console.log("reject published promise",a)})}):"https"==d&&c.api&&a.get(c.api,c.apiParams).then(function(a,b){c.consumeData(a)},function(a){console.log("reject published promise",a)})};this.consumeData=function(a,b){"function"==typeof c.onFormatData()&&(a=c.onFormatData()(a)),"object"==typeof a&&(a&&a.data&&"string"==typeof a.data&&(this.data=a.data),a&&a.type&&(this.type=a.type)),"string"==typeof a&&(this.data=a)}}]}),angular.module("Display",[]),angular.module("Display").component("scriptrDisplaycount",{bindings:{alarmType:"@",fetchDataInterval:"@",widgetLayout:"@",data:"@",message:"@",borderSize:"@",borderColor:"@",numberFontFamily:"@",numberFontSize:"@",numberCellSize:"@",numberFontWeight:"@",numberTextColor:"@",numberBackgroundColor:"@",numberTextAlignment:"@",messageFontFamily:"@",messageFontSize:"@",messageFontWeight:"@",messageTextColor:"@",messageBackgroundColor:"@",messageTextAlignment:"@",api:"@",enableResize:"<?",transport:"@",msgTag:"@",apiParams:"<?",onFormatData:"&"},templateUrl:"/UIComponents/dashboard/frontend/components/displayCount/displayCount.html",controller:["$scope","httpClient","wsClient","$element","$window","$timeout",function(a,b,c,d,e,f){var g=this;this.$onInit=function(){this.fetchDatePeriod=a.$root.period?a.$root.period:"past_day",this.apiParams=this.apiParams?this.apiParams:{},this.alarmType&&this.apiParams&&(this.apiParams.alarm_type=this.alarmType,this.apiParams.period=this.fetchDatePeriod),this.widgetLayout="vertical"==this.widgetLayout?this.widgetLayout:"horizontal",this.data=this.data?isNaN(this.data)?"0":this.data:"0",this.message=this.message?this.message:"Items",this.borderSize=this.borderSize?this.borderSize:"1",this.numberCellSize=this.numberCellSize?this.numberCellSize:"",this.borderColor=this.borderColor?this.borderColor:"#d7d7d7",this.numberFontFamily=this.numberFontFamily?this.numberFontFamily:"Arial",this.numberFontSize=this.numberFontSize?this.numberFontSize:"42",this.numberFontWeight=this.numberFontWeight?this.numberFontWeight:"600",this.numberTextColor=this.numberTextColor?this.numberTextColor:"#ffffff",this.numberTextAlignment=this.numberTextAlignment?this.numberTextAlignment:"center",this.numberBackgroundColor=this.numberBackgroundColor?this.numberBackgroundColor:"#3a87ad",this.messageFontFamily=this.messageFontFamily?this.messageFontFamily:"Arial",this.messageFontSize=this.messageFontSize?this.messageFontSize:"18",this.messageFontWeight=this.messageFontWeight?this.messageFontWeight:"600",this.messageTextColor=this.messageTextColor?this.messageTextColor:"#686868",this.messageBackgroundColor=this.messageBackgroundColor?this.messageBackgroundColor:"white",this.messageTextAlignment=this.messageTextAlignment?this.messageTextAlignment:"center",this.enableResize=void 0===this.enableResize||this.enableResize,angular.element(e).on("resize",function(){return null!=g.timeoutId&&f.cancel(g.timeoutId),g.timeoutId=f(g.resize,100)}),this.transport=this.transport?this.transport:"wss",this.msgTag=this.msgTag?this.msgTag:null,this.style={},h(this.transport),a.$watch(function(a){return a.$root.period},function(a){a&&a!=g.fetchDatePeriod&&(g.fetchDatePeriod=a,g.apiParams.period=g.fetchDatePeriod,h(g.transport))})},g.resize=function(){g.timeoutId=null,g.enableResize&&(g.style["margin-top"]=d.parent().outerHeight(!0)/2-d.outerHeight(!0)/2)},this.$postLink=function(){f(g.resize,100),null!=g.timeoutId&&f.cancel(g.timeoutId),g.timeoutId=f(g.resize,100),h(this.transport)},this.$onDestroy=function(){g.msgTag&&c.unsubscribe(g.msgTag,null,a.$id),g.refreshTimer&&f.cancel(g.refreshTimer)};var h=function(a){"wss"==a?c.onReady.then(function(){c.subscribe(g.msgTag,g.consumeData.bind(g)),g.api&&g.apiParams?c.call(g.api,g.apiParams,g.msgTag).then(function(b,c){g.fetchDataInterval&&!g.refreshTimer&&(g.refreshTimer=f(function(){h.bind(g)(a)},1e3*g.fetchDataInterval),g.refreshTimer.then(function(){g.refreshTimer=null,console.log("Timer run resolved!",Date.now())},function(){g.refreshTimer=null,console.log("Timer run rejected!",Date.now())})),g.consumeData(b)},function(a){console.log("reject published promise",a)}):g.consumeData(data)}):"https"==a&&g.api&&b.get(g.api,g.apiParams).then(function(a,b){g.consumeData(a)},function(a){console.log("reject published promise",a)})};this.consumeData=function(a,b){"function"==typeof g.onFormatData()&&(a=g.onFormatData()(a)),this.data=a,"object"==typeof a&&a&&a.data&&"string"==typeof a.data&&(this.data=a.data),"string"==typeof a&&(this.data=a)}}]}),angular.module("Thermometer",["angularThermometer"]),angular.module("Thermometer").component("scriptrThermometer",{bindings:{displayMetricValue:"@",displayMetricParam:"@",defaultMetricValue:"@",defaultMetricParam:"@",availableUnits:"<?",onLoad:"&onLoad",api:"@",value:"<?",data:"<?",step:"<?",customSectors:"<?",outOfRangeColor:"@",ticks:"<?",percent:"@",unit:"@",height:"@",transport:"@",msgTag:"@",apiParams:"<?",onFormatData:"&",fetchDataInterval:"@"},templateUrl:"/UIComponents/dashboard/frontend/components/thermometer/thermometer.html",controller:["$rootScope","$scope","$window","$element","$timeout","httpClient","wsClient","_",function(a,b,c,d,e,f,g,h){var i=this;this.$onInit=function(){this.apiParams=this.apiParams?this.apiParams:[],this.fetchDataInterval=this.fetchDataInterval?parseInt(this.fetchDataInterval):null,this.displayMetricParam=this.displayMetricParam?this.displayMetricParam:"display_metric",this.displayMetricValue=a.currentDashboardUnit,this.defaultMetricParam=this.defaultMetricParam?this.defaultMetricParam:"default_metric",this.defaultMetricValue=this.defaultMetricValue?this.defaultMetricValue:null,this.customSectors=this.customSectors&&this.customSectors.length>0?this.customSectors:[{color:"#005588",lo:0,hi:30},{color:"#aa241d",lo:30,hi:60},{color:"#ffa500",lo:60,hi:90}],this.customSectors&&(this.customSectors=h.reject(this.customSectors,h.isEmpty)),this.defaultMetricValue&&this.displayMetricValue&&this.defaultMetricValue!=this.displayMetricValue&&this.availableUnits&&Object.keys(this.availableUnits).length>=2&&this.runMetricTransformation(),this.outOfRangeColor=this.outOfRangeColor?this.outOfRangeColor:"#5fc100",this.value=this.value?this.value>100?100:this.value:this.data?this.data:0,this.thermoUnit=this.availableUnits?this.availableUnits[this.displayMetricValue]:this.unit?this.unit:"",this.height=this.height?this.height:"100",this.mercuryColor=this.evaluateColor(this.value),this.step=this.step?this.step:"30";var b=this.getLowestTick(),d=this.getHighestTick(),f=parseInt(b);for(this.sectors=[],this.sectors.push(f);f<d;)f+=parseInt(this.step),this.sectors.push(f);this.sectors=this.sectors?this.sectors:[0,30,60,90],this.mercuryMax=h.max(this.sectors),this.minSectorValue=h.min(this.sectors),this.ticks=[];for(var g=0;g<this.sectors.length;g++){var k={};k.tick=this.sectors[g],k.percent=(this.sectors[g]-this.minSectorValue)*this.height/(this.mercuryMax-this.minSectorValue),this.ticks.push(k)}this.transport=this.transport?this.transport:"wss",this.msgTag=this.msgTag?this.msgTag:null,this.style={},angular.element(c).on("resize",function(){return null!=i.timeoutId&&e.cancel(i.timeoutId),i.timeoutId=e(i.resize,500)}),j(this.transport)},this.runMetricTransformation=function(){if("si"!=this.defaultMetricValue)var a=this.availableUnits.us,b=this.availableUnits.si;else var a=this.availableUnits.si,b=this.availableUnits.us;if(this.customSectors)for(var c=0;c<this.customSectors.length;c++){var d=this.customSectors[c].lo,e=this.customSectors[c].hi;this.customSectors[c].lo=getConversionFunction(a,b)(d),this.customSectors[c].hi=getConversionFunction(a,b)(e)}},i.resize=function(){i.timeoutId=null,i.style["margin-top"]=i.noResults?0:d.parent().outerHeight(!0)/2-$(d.find(".tg-thermometer")).innerHeight()/2,i.style["margin-left"]=i.noResults?0:d.parent().outerWidth(!0)/2-50},this.$postLink=function(){e(i.resize,100),null!=i.timeoutId&&e.cancel(i.timeoutId),i.timeoutId=e(i.resize,100),b.$watch(function(a){return a.$ctrl.value},function(a){!isNaN(parseFloat(a))&&isFinite(a)&&(a=a>b.$ctrl.mercuryMax?b.$ctrl.mercuryMax:a,i.percent=parseInt((a-b.$ctrl.minSectorValue)*b.$ctrl.height/(b.$ctrl.mercuryMax-b.$ctrl.minSectorValue)))})},this.$onDestroy=function(){console.log("destory Thermometer"),i.msgTag&&g.unsubscribe(i.msgTag,null,b.$id),i.refreshTimer&&e.cancel(i.refreshTimer)};var j=function(a){"wss"==a?g.onReady.then(function(){i.msgTag&&g.subscribe(i.msgTag,i.consumeData.bind(i),b.$id),i.api&&g.call(i.api,i.apiParams,i.msgTag).then(function(b,c){i.fetchDataInterval&&!i.refreshTimer&&(i.refreshTimer=e(function(){j.bind(i)(a)},1e3*i.fetchDataInterval),i.refreshTimer.then(function(){i.refreshTimer=null,console.log("Timer run resolved!",Date.now())},function(){i.refreshTimer=null,console.log("Timer run rejected!",Date.now())})),i.consumeData(b)},function(a){console.log("reject published promise",a),i.consumeData()})}):"https"==a&&i.api&&f.get(i.api,i.apiParams).then(function(a,b){i.consumeData(a)},function(a){console.log("reject published promise",a)})};this.consumeData=function(a,b){"function"==typeof this.onFormatData()&&(a=this.onFormatData()(a)),null!=a?(this.noResults=!1,this.value=parseFloat(a),this.mercuryColor=this.evaluateColor(a)):this.noResults=!0,i.style["margin-top"]=i.noResults?0:d.parent().outerHeight(!0)/2-$(d.find(".tg-thermometer")).innerHeight()/2,i.style["margin-left"]=i.noResults?0:d.parent().outerWidth(!0)/2-50},this.evaluateColor=function(a){var b=i.outOfRangeColor;return h.some(i.customSectors,function(c){if(c.lo<=a&&a<=c.hi)return b=c.color,!0}),b},this.getLowestTick=function(){return h.min(h.pluck(this.customSectors,"lo"))},this.getHighestTick=function(){return h.max(h.pluck(this.customSectors,"hi"))}}]}),agGrid.initialiseAgGridWithAngular1(angular),angular.module("Grid",["agGrid","ui.bootstrap"]),angular.module("Grid").component("scriptrGrid",{bindings:{fetchDataInterval:"@",onLoad:"&onLoad",columnsDefinition:"<columnsDefinition",rowHeight:"<?",enableServerSideSorting:"<?",enableServerSideFilter:"<?",refreshOnEdit:"<?",enableColResize:"<?",pagination:"@",enableDeleteRow:"<?",fixedHeight:"<?",enableAddRow:"<?",cellEditable:"<?",enableClientSideSorting:"<?",api:"@",onInsertRowScript:"@",onDeleteRowScript:"@",transport:"@",enableClientSideFilter:"<?",rowModelType:"@",rowModelSelection:"@",rowDeselection:"<?",onSelectionChanged:"&?",rowData:"<?",suppressFilter:"<?",gridHeight:"@",paginationPageSize:"<?",paginationOverflowSize:"<?",maxConcurrentDatasourceRequests:"<?",paginationInitialRowCount:"<?",maxPagesInCache:"<?",apiParams:"<?",deleteParams:"<?",addParams:"<?",editParams:"<?",onFormatData:"&",onCellValueChanged:"&",onCellClicked:"&",msgTag:"@",class:"@",defaultCellRenderer:"&",onGridReady:"&"},templateUrl:"/UIComponents/dashboard/frontend/components/grid/grid.html",controller:["$scope","$window","$uibModal","$timeout","wsClient","dataService","$filter",function(a,b,c,d,e,f,g){var h=this;h.broadcastData=null,h.msgTag="grid",h.noData=!1,this.dataSource={getRows:function(a){if(null!=h.broadcastData){if(null!=h.broadcastData.api)var b=h.broadcastData.api;else var b=h.api;if(null!=h.broadcastData.params&&(h.apiParams=h.broadcastData.params),null!=h.broadcastData.transport)var c=h.broadcastData.transport;else var c=h.transport}else var b=h.api,c=h.transport;var d=h.buildParams(a),e=null;"function"==typeof h.onFormatData()&&(e=function(a){return h.onFormatData()(a)}),h.gridOptions.api.showLoadingOverlay(),f.getGridData(b,d,c,e,h.fetchDataInterval).then(function(b,c){if(b&&b.documents){var d=b.documents;0==d.length?h.noData=!0:h.noData=!1;var e=parseInt(b.count),f=h.cleanRows(d);if(a.successCallback(f,e),h.gridOptions.api.sizeColumnsToFit(),null==f||0==f.length){h.gridOptions.api.showNoRowsOverlay();angular.element(document.querySelector("#btNext")).attr("disabled","true")}else h.gridOptions.api.hideOverlay();h.gridOptions.api.hideOverlay()}else a.failCallback(),h.gridOptions.api.showNoRowsOverlay()},function(a){console.log("reject",a)})}},this.$onDestroy=function(){h.msgTag&&e.unsubscribe(h.msgTag,null,a.$id),h.refreshTimer&&d.cancel(h.refreshTimer),console.log("destory Grid")},this.cleanRows=function(a){Array.isArray(a)||(a=[a]);for(var b=!1,c=0;c<a.length;c++)for(row in a[c])if("key"!=row){b=!1;for(var d=0;d<h.gridOptions.columnDefs.length;d++)if(row==h.gridOptions.columnDefs[d].field){b=!0;break}b||delete a[c][row]}return a},this._createNewDatasource=function(){this.gridOptions.api.setDatasource(this.dataSource)},this.setGridPaginationIcons=function(){$("button[ref=btPrevious]").html('<img src="//cdn.rawgit.com/scriptrdotio/onset-static-resources/6309fad6/images/previous.png" />'),$("button[ref=btFirst]").html('<img src="//cdn.rawgit.com/scriptrdotio/onset-static-resources/6309fad6/images/first.png" />'),$("button[ref=btNext]").html('<img src="//cdn.rawgit.com/scriptrdotio/onset-static-resources/6309fad6/images/next.png" />'),$("button[ref=btLast]").html('<img src="//cdn.rawgit.com/scriptrdotio/onset-static-resources/6309fad6/images/last.png" />')},this.$onInit=function(){this.gridId=a.$id;for(var b=0;b<this.columnsDefinition.length;b++)this.columnsDefinition[b].hasOwnProperty("field")&&"date"==this.columnsDefinition[b].field&&(this.columnsDefinition[b].cellRenderer=function(a){return g("date")(a.value,"MM/dd/yyyy HH:mm")});this.gridOptions={unSortIcon:!0,icons:{sortAscending:'<i class="fa fa-sort-up" aria-hidden="true"></i>',sortDescending:'<i class="fa fa-sort-desc" aria-hidden="true"></i>',sortUnSort:'<span class="unsort-state"><i class="fa fa-angle-up" aria-hidden="true"></i><i class="fa fa-angle-down" aria-hidden="true"></i></span>'},domLayout:"autoHeight",angularCompileRows:!0,rowHeight:this.rowHeight?this.rowHeight:25,enableSorting:void 0===this.enableClientSideSorting||this.enableClientSideSorting,enableServerSideSorting:void 0===this.enableServerSideSorting||this.enableServerSideSorting,enableServerSideFilter:void 0===this.enableServerSideFilter||this.enableServerSideFilter,enableColResize:void 0!==this.enableColResize&&this.enableColResize,enableFilter:!0,columnDefs:this.columnsDefinition,editType:"fullRow",pagination:void 0!==this.pagination&&this.pagination,cacheBlockSize:this.paginationPageSize?this.paginationPageSize:50,rowData:this.rowData?this.rowData:null,rowModelType:this.api?"infinite":"",rowSelection:this.rowModelSelection?this.rowModelSelection:"multiple",paginationPageSize:this.paginationPageSize?this.paginationPageSize:50,overlayLoadingTemplate:'<span class="ag-overlay-loading-center"><i class="fa fa-spinner fa-spin fa-3x"></i></span>',defaultColDef:{filterParams:{applyButton:!0,clearButton:!0},filter:"text",suppressFilter:void 0!==this.suppressFilter&&this.suppressFilter,editable:void 0===this.cellEditable||this.cellEditable,cellRenderer:"function"==typeof this.defaultCellRenderer()?this.defaultCellRenderer():null},onSelectionChanged:function(){if(null!=h.onSelectionChanged&&"function"==typeof h.onSelectionChanged())return h.onSelectionChanged()(h.gridOptions,h.gridApi)},onCellClicked:function(){if(null!=h.onCellClicked&&"function"==typeof h.onCellClicked())return h.onCellClicked()(h.gridOptions,h.gridApi)},onRowValueChanged:function(a){h.cellEditable&&(null!=h.onCellValueChanged&&"function"==typeof h.onCellValueChanged()&&h.onCellValueChanged()(h.gridOptions),"infinite"==h.gridOptions.rowModelType&&(h.api?(h.gridOptions.api.showLoadingOverlay(),h._saveData(a)):(h.undoChanges(),h.showAlert("danger","No script defined for cell edit"))))},onGridReady:function(a){if(console.log("the grid is now ready"),d(function(){h.gridOptions.api=a.api,h.gridApi=a.api},3e3),"function"==typeof h.onGridReady()&&h.onGridReady()(h),a.api.filterManager.availableFilters.text.CONTAINS="startsWith",void 0===h.rowData||null==h.rowData||h.rowData&&0==h.rowData.length?h.api?h._createNewDatasource():a.api.setRowData([]):a.api.sizeColumnsToFit(),h.columnsDefinition)for(var b=0;b<h.columnsDefinition.length;b++)h.columnsDefinition[b].hasOwnProperty("type")&&"numeric"==h.columnsDefinition[b].type&&(h.columnsDefinition[b].filter="number");h.setGridPaginationIcons()},onGridSizeChanged:function(a){for(var b=document.getElementById("grid-"+h.gridId).offsetWidth,c=[],d=[],e=0,f=h.gridOptions.columnApi.getAllColumns(),g=0;g<f.length;g++){var i=f[g];e+=i.getMinWidth(),e>b?d.push(i.colId):c.push(i.colId)}h.gridOptions.columnApi.setColumnsVisible(c,!0),h.gridOptions.columnApi.setColumnsVisible(d,!1),h.gridOptions.api.sizeColumnsToFit()}},this.fixedHeight=void 0===this.fixedHeight||this.fixedHeight,this.style={},this.fixedHeight&&(this.gridHeight=this.gridHeight?this.gridHeight:"500",this.style.clear="left",this.style.width="100%"),this.refreshOnEdit=void 0!==this.refreshOnEdit&&this.refreshOnEdit,this.transport=this.transport?this.transport:"wss",this.enableDeleteRow=1!=this.enableDeleteRow,this.enableAddRow=1!=this.enableAddRow,this.mode="infinite"==this.gridOptions.rowModelType?"infinite":"normal",h.msgTag&&f.subscribe(this.onServerCall,h.msgTag,a),a.$on("updateGridData",function(a,b){h.broadcastData=b,h._createNewDatasource()})},this.closeAlert=function(){this.show=!1},this.showAlert=function(a,b){h.message={type:a,content:b},h.showError=!0,d(function(){h.showError=!1},5e3)},this._saveData=function(a){if(a.data&&a.data.key){var b=a.data;if(b.action="edit",this.editParams)for(var c in this.editParams)b[c]=this.editParams[c];f.gridHelper(h.api,b).then(function(a,b){h.gridOptions.api.hideOverlay(),!a||"success"!=a.result&&"success"!=a.status?(h.undoChanges(),a&&a.errorDetail?h.showAlert("danger",a.errorDetail):h.showAlert("danger","An error has occured")):h.refreshOnEdit&&h.onServerCall(a)},function(a){h.gridOptions.api.hideOverlay(),console.log("reject",a),h.showAlert("danger","An error has occured")})}else{var b=a.data;if(b.action="add",this.addParams)for(var c in this.addParams)b[c]=this.addParams[c];f.gridHelper(h.api,a.data).then(function(a,b){h.gridOptions.api.hideOverlay(),!a||"success"!=a.result&&"success"!=a.status?(h.undoChanges(),a&&a.errorDetail?h.showAlert("danger",a.errorDetail):h.showAlert("danger","An error has occured")):h.refreshOnEdit&&h.onServerCall(a)},function(a){h.gridOptions.api.hideOverlay(),console.log("reject",a),h.showAlert("danger","An error has occured")})}},this.onAddRow=function(){for(var a={},b=0;b<h.gridOptions.columnDefs.length;b++)a[h.gridOptions.columnDefs[b].field]="";h.gridOptions.api.insertItemsAtIndex(0,[a]),h.gridOptions.api.setFocusedCell(0,h.gridOptions.columnDefs[0].field),h.gridOptions.api.startEditingCell({rowIndex:0,colKey:h.gridOptions.columnDefs[0].field,charPress:h.gridOptions.columnDefs[0].field})},this.openConfirmationPopUp=function(){if(h.gridOptions.api.getSelectedNodes().length>0){c.open({animation:!0,component:"deleteConfirmation",size:"md",resolve:{grid:function(){return h}}})}},this.onRemoveRow=function(a){if("infinite"==h.gridOptions.rowModelType)if(h.api){for(var b=h.gridOptions.api.getSelectedNodes(),c=[],d=0;d<b.length;d++)c.push(b[d].data.key);if(c.length>0){h.gridOptions.api.showLoadingOverlay();var e={keys:c,action:"delete"};if(this.deleteParams)for(var a in this.deleteParams)e[a]=this.deleteParams[a];f.gridHelper(h.api,e).then(function(a,b){h.gridOptions.api.hideOverlay(),!a||"success"!=a.result&&"success"!=a.status?a&&a.errorDetail?h.showAlert("danger",a.errorDetail):h.showAlert("danger","An error has occured"):h.onServerCall(a)},function(a){h.gridOptions.api.hideOverlay(),console.log("reject",a),h.showAlert("danger","An error has occured")})}}else h.showAlert("danger","No script defined for delete row");else{var b=h.gridOptions.api.getSelectedNodes();h.gridOptions.api.removeItems(b)}},this.onServerCall=function(a){h.gridOptions.api.refreshInfiniteCache()},this.undoChanges=function(a){if(h.oldEditedValue){h.gridOptions.api.forEachNode(function(a){a.childIndex!=h.editedChildIndex&&a.id!=h.editedChildIndex||a.setSelected(!0,!0)});h.gridOptions.api.getSelectedNodes()[0].data[h.editedColumn]=h.oldEditedValue,h.gridOptions.api.refreshView()}else h.gridOptions.api.refreshInfiniteCache()},this.onFilterChanged=function(){this.gridOptions.enableServerSideFilter=!1,this.gridOptions.api.setQuickFilter(this.quickFilterValue),this.gridOptions.enableServerSideFilter=!0},this.onServerFilterChanged=function(){h._createNewDatasource()},this.buildParams=function(a){var b=h.serverFilterText,c=null,d=a.endRow/this.gridOptions.paginationPageSize;if(a.sortModel&&a.sortModel.length>0){var e=a.sortModel[0].sort,f=a.sortModel[0].colId;c=this.gridOptions.api.getColumnDef(f).type?this.gridOptions.api.getColumnDef(f).type:null}if(a.filterModel)for(p in a.filterModel){b=a.filterModel[p].filter;var g=a.filterModel[p].type,i=p;c=this.gridOptions.api.getColumnDef(i).type?this.gridOptions.api.getColumnDef(i).type:null}var j={resultsPerPage:this.gridOptions.paginationPageSize,pageNumber:d};if(f&&(j.sortingColumnName=f),i&&(j.filterColumnName=i),e&&(j.sort=e),c&&(j.sortType=c),b&&(j.queryFilter=b),g&&(j.queryType=g),j.startRow=a.startRow,j.endRow=a.endRow,this.apiParams)for(var k in this.apiParams)j[k]=this.apiParams[k];return j}}]}),angular.module("Grid").service("dataService",["httpClient","wsClient","$q","$timeout",function(a,b,c,d){this.subscribe=function(a,c,d){b.onReady.then(function(){b.subscribe(c,a.bind(self),d.$id)})},this.gridHelper=function(b,d){var e=c.defer();return a.get(b,d,"grid").then(function(a,b){e.resolve(a,b)},function(a){e.reject(a)}),e.promise},this.getGridData=function(e,f,g,h,i){var j=c.defer(),k=this;return"https"==g?(a.get(e,f).then(function(a,b){if(h&&(a=h(a)),a&&a.documents){var a={documents:a.documents,count:a.count};j.resolve(a,b)}else j.resolve(null,b)},function(a){j.resolve(null),j.reject(a)}),j.promise):"wss"==g?e&&void 0!==e?(b.onReady.then(function(){b.call(e,f,"grid").then(function(a,b){if(i&&!k.refreshTimer&&(k.refreshTimer=d(function(){k.getGridData.bind(k)(e,f,g,h,i)},1e3*i),k.refreshTimer.then(function(){k.refreshTimer=null,console.log("Timer run resolved!",Date.now())},function(){k.refreshTimer=null,console.log("Timer run rejected!",Date.now())})),h&&(a=h(a)),a&&a.documents){var a={documents:a.documents,count:a.count};j.resolve(a,b)}else j.resolve(null,b)},function(a){j.resolve(null),j.reject(a)})}),j.promise):(b.onReady.then(function(){b.publish(f,"publish").then(function(a,b){if(a&&a.documents){var a={documents:a.documents,count:a.count};j.resolve(a,b)}else j.resolve(null,b)},function(a){j.resolve(null),j.reject(a)})}),j.promise):void 0}}]),angular.module("Grid").component("deleteConfirmation",{bindings:{resolve:"<",close:"&",dismiss:"&"},templateUrl:"/UIComponents/dashboard/frontend/components/grid/popup.html",controller:["$scope",function(a){this.onSubmit=function(){this.resolve.grid.onRemoveRow(),this.close({$value:!0})},this.onCancel=function(){this.dismiss({$value:!1})}}]}),angular.module("ACL",["ui.bootstrap","List"]),angular.module("ACL").component("scriptrAcl",{bindings:{users:"<?",defaultSetObject:"<?",onSave:"&"},templateUrl:"/UIComponents/dashboard/frontend/components/ACL/ACL.html",controller:["$uibModal",function(a){var b=this;this.$onInit=function(){console.log("$onInit initialized"),b.accessType=1==b.users.length&&"anonymous"==b.users[0].code?"Anonymous access":"Restricted access"},this.$postLink=function(){console.log("$postLink initialized")},this.openModal=function(){a.open({animation:!0,size:"lg",component:"aclPopup",resolve:{widget:function(){return{parent:b,users:b.users,defaultSetObject:b.defaultSetObject,onSave:b.onSave}}}}).result.then(function(a){console.log("selectedItem: "+a)},function(){})}}]}),angular.module("ACL").component("aclPopup",{bindings:{resolve:"<",users:"<?",defaultSetObject:"<?",close:"&",dismiss:"&"},templateUrl:"/UIComponents/dashboard/frontend/components/ACL/myModalContent.html",controller:["$scope","$sce",function(a,b){var c=this;c.listScope,this.$onInit=function(){c.users=c.resolve.widget.users,c.defaultSetObject=c.resolve.widget.defaultSetObject,c.popoverContent=b.trustAsHtml("<span style='color: #323232;'><strong>Scriptr.io provides the following predefined groups:</strong><div class='mt10 mb5'><i class='fa fa-caret-right text-primary'></i> authenticated represents anyone with a valid token.</div><div class='mb5'><i class='fa fa-caret-right text-primary'></i> anonymous represents everyone.</div><div class='mb5'><i class='fa fa-caret-right text-primary'></i> nobody represents no one.</div></span>")},this.onSelect=function(a){c.resolve.modalScope=this,"anonymous"==a.originalObject[this.titleField]&&(this.disableInput=!0,this.hideObjects=!0,c.showMsg=!0)},this.removeAnonymousAccess=function(){c.showMsg=!1,c.resolve.modalScope.disableInput=!1,c.resolve.modalScope.hideObjects=!1;var b=[{code:"anonymous",icon:"fa fa-group"}];a.$broadcast("angucomplete-alt:addObjectToList",c.id,b)},this.addAnonymousAccess=function(){c.showMsg=!1,c.resolve.modalScope.disableInput=!1,c.resolve.modalScope.hideObjects=!1;for(var b=[],d=0;d<c.resolve.modalScope.objects.length;d++)"anonymous"!=c.resolve.modalScope.objects[d].code&&b.push(c.resolve.modalScope.objects[d]);a.$broadcast("angucomplete-alt:addObjectToList",c.id,b)},this.closeAlert=function(){this.show=!1},this.showAlert=function(a,b){this.closeAlert(),this.message={type:a,content:b},this.show=!0},this.updateFileACL=function(){c.listScope||(c.listScope=a.$broadcast("angucomplete-alt:getSetObjects",c.id));var b=c.listScope.targetScope.$$childTail.$ctrl;if("function"==typeof c.resolve.widget.onSave()){var d=[];if(void 0===b.objects&&(b.objects=c.resolve.modalScope.objects),b.objects.length>0)var e=b.objects;else var e=c.resolve.widget.defaultSetObject;for(var f=0;f<e.length;f++)d.push(e[f].code);b.showList=!1,c.resolve.widget.onSave()(d).then(function(a,d){b.showList=!0,c.showAlert("success","The Access Control List is saved successfully."),c.resolve.widget.parent.users=b.objects,c.resolve.widget.parent.accessType=1==b.objects.length&&"anonymous"==b.objects[0].code?"Anonymous access":"Restricted access",console.log("success")},function(a){b.showList=!0,
c.showMsg("danger",a.data.response.metadata.errorDetail),console.log("reject",a)})}},this.onCancel=function(a){this.dismiss({$value:"cancel"}),console.log("Dissmisseddd")}}]}),angular.module("List",["angucomplete-alt"]).component("scriptrAutocomplete",{bindings:{id:"@",objects:"<?",hideObjects:"<?",listSelectedObject:"<?",defaultSetObject:"<?",placeholder:"@",maxlength:"@",pause:"@",selectedObject:"<?",selectedObjectData:"<?",titleField:"@",descriptionField:"@",imageField:"@",minlength:"@",inputName:"@",inputClass:"@",matchClass:"@",localData:"<?",searchFields:"@",clearSelected:"@",overrideSuggestions:"@",fieldRequired:"@",fieldRequiredClass:"@",textSearching:"@",textNoResults:"@",initialValue:"@",inputChanged:"&",autoMatch:"@",focusIn:"&",focusOut:"&",disableInput:"@",focusFirst:"@",fieldTabindex:"@",parseInput:"&",localSearch:"&",transport:"@",msgTag:"@",api:"@",onFormatData:"&"},templateUrl:"/UIComponents/dashboard/frontend/components/list/autocomplete.html",controller:["$scope","wsClient","httpClient",function(a,b,c){var d=this;this.$onInit=function(){this.localData=this.localData?this.localData:[],this.fieldRequired=void 0!==this.fieldRequired&&this.fieldRequired,this.textSearching=void 0!==this.textSearching&&this.textSearching,this.transport=this.transport?this.transport:"wss",this.objects=this.objects?this.objects:[],this.listSelectedObject&&this.objects.length>0&&!d.api&&(a.$broadcast("angucomplete-alt:setData",d.id,this.localData),a.$broadcast("angucomplete-alt:setSelectedObjects",d.id,this.objects)),d.api&&(d.showList=!1,e(this.transport))},d.addObjectToList=function(b){a.$broadcast("angucomplete-alt:addObjectToList",d.id,b),0==this.objects.length&&void 0!==this.defaultSetObject&&(this.objects=JSON.parse(JSON.stringify(this.defaultSetObject)))};var e=function(a){"wss"==a?b.onReady.then(function(){b.subscribe(d.msgTag,d.consumeData.bind(d)),d.api&&b.call(d.api,d.apiParams,d.msgTag).then(function(a,b){d.consumeData(a)})}):"https"==a&&d.api&&c.get(d.api,d.apiParams).then(function(a,b){d.consumeData(a)},function(a){console.log("reject published promise",a)})};this.consumeData=function(b,c){d.showList=!0,"function"==typeof d.onFormatData()&&(b=d.onFormatData()(b)),this.localData=b,this.listSelectedObject&&this.objects.length>0&&(a.$broadcast("angucomplete-alt:setData",d.id,this.localData),a.$broadcast("angucomplete-alt:setSelectedObjects",d.id,this.objects))}}]}),angular.module("Dygraphs",["angular-dygraphs"]),angular.module("Dygraphs").component("scriptrDygraphs",{bindings:{displayMetricValue:"@",displayMetricParam:"@",defaultMetricValue:"@",defaultMetricParam:"@",availableUnits:"<?",onLoad:"&onLoad",api:"@",transport:"@",msgTag:"@",apiParams:"<?",onFormatData:"&",resize:"<?",data:"<?",legend:"<?",drawX1Axis:"@",drawYAxis:"@",drawY2Axis:"@",colors:"<?",x1AxisLabelFontSize:"@",yAxisLabelFontSize:"@",y2AxisLabelFontSize:"@",yAxisLabelsKmb:"@",y2AxisLabelsKmb:"@",x1AxisLabelWidth:"@",yAxisLabelWidth:"@",y2AxisLabelWidth:"@",x1AxisLineColor:"@",yAxisLineColor:"@",y2AxisLineColor:"@",x1AxisLineWidth:"@",yAxisLineWidth:"@",y2AxisLineWidth:"@",x1AxisTickSize:"@",yAxisTickSize:"@",y2AxisTickSize:"@",yAxisIncludeZero:"@",y2AxisIncludeZero:"@",x1AxisLabel:"@",yAxisLabel:"@",y2AxisLabel:"@",showRangeSelector:"@",rangeSelectorAlpha:"@",rangeSelectorBackgroundLineWidth:"@",rangeSelectorBackgroundStrokeColor:"@",rangeSelectorForegroundLineWidth:"@",rangeSelectorForegroundStrokeColor:"@",rangeSelectorHeight:"@",rangeSelectorPlotFillColor:"@",rangeSelectorPlotFillGradientColor:"@",rangeSelectorPlotLineWidth:"@",rangeSelectorPlotStrokeColor:"@",goals:"<?",goalLineColors:"<?",events:"<?",eventLineColors:"<?",legendPosition:"@",showLegend:"@",x1DrawGrid:"@",yDrawGrid:"@",y2DrawGrid:"@",x1GridLineColor:"@",yGridLineColor:"@",y2GridLineColor:"@",x1GridLineWidth:"@",yGridLineWidth:"@",y2GridLineWidth:"@",legendLabels:"<?",independentTicks:"@",legendMapping:"<?",customGoals:"<?",colorsMapping:"<?",fetchFromDateParam:"@",fetchFromDateValue:"@",fetchToDateParam:"@",fetchToDateValue:"@",fetchDataInterval:"@"},templateUrl:"/UIComponents/dashboard/frontend/components/dygraphs/dygraphs.html",controller:["$rootScope","httpClient","wsClient","$scope","$timeout",function(a,b,c,d,e){var f=this;this.$onInit=function(){this.apiParams=this.apiParams?this.apiParams:[],void 0===this.api&&void 0===this.msgTag&&(this.data&&0==this.data.length||null==this.data)&&(this.noResults=!0),this.drawX1Axis=!this.drawX1Axis||JSON.parse(this.drawX1Axis),this.drawYAxis=!this.drawYAxis||JSON.parse(this.drawYAxis),this.drawY2Axis=!this.drawY2Axis||JSON.parse(this.drawY2Axis),this.colors=this.colors?this.colors:["#005588","#aa241d"],this.colorsMapping&&(this.colors=_.pluck(this.colorsMapping,"colors")),this.colorsMapping&&(this.legendLabels=["x"],this.legendLabels=this.legendLabels.concat(_.pluck(this.colorsMapping,"labels"))),this.colorsMapping&&(this.legendMapping=["X"],this.legendMapping=this.legendMapping.concat(_.pluck(this.colorsMapping,"axisSelection"))),this.displayMetricParam=this.displayMetricParam?this.displayMetricParam:"display_metric",this.displayMetricValue=a.currentDashboardUnit,this.defaultMetricParam=this.defaultMetricParam?this.defaultMetricParam:"default_metric",this.defaultMetricValue=this.defaultMetricValue?this.defaultMetricValue:null,this.defaultMetricValue&&this.displayMetricValue&&this.defaultMetricValue!=this.displayMetricValue&&this.availableUnits&&Object.keys(this.availableUnits).length>=2&&this.runMetricTransformation(),this.customGoals=this.customGoals?this.customGoals:[{"goal-line-colors":"#ffffff",goals:0}],this.goalLineColors=_.pluck(this.customGoals,"goal-line-colors"),this.goals=_.pluck(this.customGoals,"goals"),this.events=this.events?this.events:[],this.eventLineColors=this.eventLineColors?this.eventLineColors:["#ffffff"],this.x1AxisLabelFontSize=this.x1AxisLabelFontSize?JSON.parse(this.x1AxisLabelFontSize):14,this.yAxisLabelFontSize=this.yAxisLabelFontSize?JSON.parse(this.yAxisLabelFontSize):14,this.y2AxisLabelFontSize=this.y2AxisLabelFontSize?JSON.parse(this.y2AxisLabelFontSize):14,this.yAxisLabelsKmb=!!this.yAxisLabelsKmb&&JSON.parse(this.yAxisLabelsKmb),this.y2AxisLabelsKmb=!!this.y2AxisLabelsKmb&&JSON.parse(this.y2AxisLabelsKmb),this.x1AxisLabelWidth=this.x1AxisLabelWidth?JSON.parse(this.x1AxisLabelWidth):60,this.yAxisLabelWidth=this.yAxisLabelWidth?JSON.parse(this.yAxisLabelWidth):50,this.y2AxisLabelWidth=this.y2AxisLabelWidth?JSON.parse(this.y2AxisLabelWidth):50,this.x1AxisLineColor=this.x1AxisLineColor?this.x1AxisLineColor:"#000000",this.yAxisLineColor=this.yAxisLineColor?this.yAxisLineColor:"#000000",this.y2AxisLineColor=this.y2AxisLineColor?this.y2AxisLineColor:"#000000",this.showLegend=!this.showLegend||JSON.parse(this.showLegend),this.x1AxisLabel=this.x1AxisLabel?this.x1AxisLabel:"",this.yAxisLabel=this.yAxisLabel?this.yAxisLabel:"",this.y2AxisLabel=this.y2AxisLabel?this.y2AxisLabel:"",this.x1AxisLineWidth=this.x1AxisLineWidth?JSON.parse(this.x1AxisLineWidth):.3,this.yAxisLineWidth=this.yAxisLineWidth?JSON.parse(this.yAxisLineWidth):.3,this.y2AxisLineWidth=this.y2AxisLineWidth?JSON.parse(this.y2AxisLineWidth):.3,this.x1AxisTickSize=this.x1AxisTickSize?JSON.parse(this.x1AxisTickSize):3,this.yAxisTickSize=this.yAxisTickSize?JSON.parse(this.yAxisTickSize):3,this.y2AxisTickSize=this.y2AxisTickSize?JSON.parse(this.y2AxisTickSize):3,this.yAxisIncludeZero=!!this.yAxisIncludeZero&&JSON.parse(this.yAxisIncludeZero),this.y2AxisIncludeZero=!!this.y2AxisIncludeZero&&JSON.parse(this.y2AxisIncludeZero),this.showRangeSelector=!!this.showRangeSelector&&JSON.parse(this.showRangeSelector),this.rangeSelectorAlpha=this.rangeSelectorAlpha?JSON.parse(this.rangeSelectorAlpha):.6,this.rangeSelectorBackgroundLineWidth=this.rangeSelectorBackgroundLineWidth?JSON.parse(this.rangeSelectorBackgroundLineWidth):1,this.rangeSelectorBackgroundStrokeColor=this.rangeSelectorBackgroundStrokeColor?this.rangeSelectorBackgroundStrokeColor:"#808080",this.rangeSelectorForegroundLineWidth=this.rangeSelectorForegroundLineWidth?JSON.parse(this.rangeSelectorForegroundLineWidth):1,this.rangeSelectorForegroundStrokeColor=this.rangeSelectorForegroundStrokeColor?this.rangeSelectorForegroundStrokeColor:"#000000",this.rangeSelectorHeight=this.rangeSelectorHeight?JSON.parse(this.rangeSelectorHeight):40,this.rangeSelectorPlotFillColor=this.rangeSelectorPlotFillColor?this.rangeSelectorPlotFillColor:"#A7B1C4",this.rangeSelectorPlotFillGradientColor=this.rangeSelectorPlotFillGradientColor?this.rangeSelectorPlotFillGradientColor:"#FFFFFF",this.rangeSelectorPlotLineWidth=this.rangeSelectorPlotLineWidth?JSON.parse(this.rangeSelectorPlotLineWidth):1.5,this.rangeSelectorPlotStrokeColor=this.rangeSelectorPlotStrokeColor?this.rangeSelectorPlotStrokeColor:"#808FAB",this.x1DrawGrid=!this.x1DrawGrid||JSON.parse(this.x1DrawGrid),this.yDrawGrid=!this.yDrawGrid||JSON.parse(this.yDrawGrid),this.y2DrawGrid=!!this.y2DrawGrid&&JSON.parse(this.y2DrawGrid),this.x1GridLineColor=this.x1GridLineColor?this.x1GridLineColor:"#000000",this.yGridLineColor=this.yGridLineColor?this.yGridLineColor:"#000000",this.y2GridLineColor=this.y2GridLineColor?this.y2GridLineColor:"#000000",this.x1GridLineWidth=this.x1GridLineWidth?JSON.parse(this.x1GridLineWidth):.3,this.yGridLineWidth=this.yGridLineWidth?JSON.parse(this.yGridLineWidth):.3,this.y2GridLineWidth=this.y2GridLineWidth?JSON.parse(this.y2GridLineWidth):.3,this.xDrawGrid=!this.xDrawGrid||JSON.parse(this.xDrawGrid),this.independentTicks=this.independentTicks?this.independentTicks:"y-primary",this.legendLabels=this.legendLabels?this.legendLabels:["X","Y1","Y2","Y3","Y4"],this.legendMapping=this.legendMapping?this.legendMapping:["x","y","y","y2","y2"],this.options={},this.options.axes={},this.x1AxisLabel&&""!=this.x1AxisLabel&&(this.options.xlabel=this.x1AxisLabel),this.yAxisLabel&&""!=this.yAxisLabel&&(this.options.ylabel=this.yAxisLabel),this.y2AxisLabel&&""!=this.y2AxisLabel&&(this.options.y2label=this.y2AxisLabel),this.legendLabels&&""!=this.legendLabels&&(this.options.labels=this.legendLabels),this.options.axes.x={},this.options.axes.x.drawAxis=JSON.parse(this.drawX1Axis),this.options.axes.x.axisLabelFontSize=JSON.parse(this.x1AxisLabelFontSize),this.options.axes.x.axisLabelWidth=JSON.parse(this.x1AxisLabelWidth),this.options.axes.x.axisLineColor=this.x1AxisLineColor,this.options.axes.x.axisLineWidth=JSON.parse(this.x1AxisLineWidth),this.options.axes.x.axisTickSize=JSON.parse(this.x1AxisTickSize),this.options.xValueParser=function(a){return moment(a).format("YYYY-MM-DD HH:mm")},this.options.axes.x.axisLabelFormatter=function(a,b,c){return Dygraph.dateAxisLabelFormatter(new Date(a),Dygraph.TWO_HOURLY,c)},this.options.axes.x.valueFormatter=function(a){return moment(a).format("MM/DD/YYYY hh:mm:ss")},this.options.axes.y={},this.options.axes.y.drawAxis=JSON.parse(this.drawYAxis),this.options.axes.y.axisLabelFontSize=JSON.parse(this.yAxisLabelFontSize),this.options.axes.y.axisLabelWidth=JSON.parse(this.yAxisLabelWidth),this.options.axes.y.axisLineColor=this.yAxisLineColor,this.options.axes.y.axisLineWidth=JSON.parse(this.yAxisLineWidth),this.options.axes.y.axisTickSize=JSON.parse(this.yAxisTickSize),this.options.axes.y.includeZero=JSON.parse(this.yAxisIncludeZero),this.options.axes.y.labelsKMB=JSON.parse(this.yAxisLabelsKmb),this.options.axes.y2={},this.options.axes.y2.drawAxis=JSON.parse(this.drawY2Axis),this.options.axes.y2.axisLabelFontSize=JSON.parse(this.y2AxisLabelFontSize),this.options.axes.y2.axisLabelWidth=JSON.parse(this.y2AxisLabelWidth),this.options.axes.y2.axisLineColor=this.y2AxisLineColor,this.options.axes.y2.axisLineWidth=JSON.parse(this.y2AxisLineWidth),this.options.axes.y2.axisTickSize=JSON.parse(this.y2AxisTickSize),this.options.axes.y2.includeZero=JSON.parse(this.y2AxisIncludeZero),this.options.axes.y2.labelsKMB=JSON.parse(this.y2AxisLabelsKmb),this.options.showRangeSelector=JSON.parse(this.showRangeSelector),this.options.rangeSelectorAlpha=JSON.parse(this.rangeSelectorAlpha),this.options.rangeSelectorBackgroundLineWidth=JSON.parse(this.rangeSelectorBackgroundLineWidth),this.options.rangeSelectorBackgroundStrokeColor=this.rangeSelectorBackgroundStrokeColor,this.options.rangeSelectorForegroundLineWidth=JSON.parse(this.rangeSelectorForegroundLineWidth),this.options.rangeSelectorForegroundStrokeColor=this.rangeSelectorForegroundStrokeColor,this.options.rangeSelectorHeight=JSON.parse(this.rangeSelectorHeight),this.options.rangeSelectorPlotFillColor=this.rangeSelectorPlotFillColor,this.options.rangeSelectorPlotFillGradientColor=this.rangeSelectorPlotFillGradientColor,this.options.rangeSelectorPlotLineWidth=JSON.parse(this.rangeSelectorPlotLineWidth),this.options.rangeSelectorPlotStrokeColor=this.rangeSelectorPlotStrokeColor,this.options.colors=this.colors,this.showLegend?(this.options.showLabelsOnHighlight=!0,this.options.legend="always"):(this.options.showLabelsOnHighlight=!1,this.options.hideOverlayOnMouseOut=!0),this.options.legendPosition=this.legendPosition?this.legendPosition:"top",this.options.axes.x.drawGrid=JSON.parse(this.x1DrawGrid),this.options.axes.y.drawGrid=JSON.parse(this.yDrawGrid),this.options.axes.y2.drawGrid=JSON.parse(this.y2DrawGrid),this.options.axes.x.gridLineColor=this.x1GridLineColor,this.options.axes.y.gridLineColor=this.yGridLineColor,this.options.axes.y2.gridLineColor=this.y2GridLineColor,this.options.axes.x.gridLineWidth=JSON.parse(this.x1GridLineWidth),this.options.axes.y.gridLineWidth=JSON.parse(this.yGridLineWidth),this.options.axes.y2.gridLineWidth=JSON.parse(this.y2GridLineWidth),"y-primary"==this.independentTicks?(this.options.axes.y.independentTicks=!0,this.options.axes.y2.independentTicks=!1):"y2-primary"==this.independentTicks?(this.options.axes.y.independentTicks=!1,this.options.axes.y2.independentTicks=!0):"independent"==this.independentTicks&&(this.options.axes.y.independentTicks=!0,this.options.axes.y2.independentTicks=!0),this.options.goals=this.goals?this.goals:[],this.options.goalLineColors=this.goalLineColors?this.goalLineColors:["#ffffff"],this.options.events=this.events?this.events:[],this.options.eventLineColors=this.eventLineColors?this.eventLineColors:["#ffffff"],this.options.series={};for(var b=0;b<this.legendLabels.length;b++){var c=this.legendLabels[b];0!=b&&"y2"==this.legendMapping[b]&&this.drawY2Axis&&(c?this.options.series[c]={axis:this.legendMapping[b]}:this.options.series["Y"+b]={axis:this.legendMapping[b]})}this.resize=!this.resize||this.resize,this.transport=this.transport?this.transport:"wss",this.msgTag=this.msgTag?this.msgTag:null,this.fetchFromDateParam=this.fetchFromDateParam?this.fetchFromDateParam:"from_date",this.fetchToDateParam=this.fetchToDateParam?this.fetchToDateParam:"to_date",this.fetchToDateValue=this.fetchToDateValue?this.fetchToDateValue:null,this.fetchFromDateValue=this.fetchFromDateValue?this.fetchFromDateValue:null,this.fetchFromDateValue&&(this.apiParams[this.fetchFromDateParam]=this.fetchFromDateValue),this.fetchToDateValue&&(this.apiParams[this.fetchToDateParam]=this.fetchToDateValue),this.fetchDataInterval=this.fetchDataInterval?parseInt(this.fetchDataInterval):null,this.delta=!1},this.runMetricTransformation=function(){if("si"!=this.defaultMetricValue)var a=this.availableUnits.us,b=this.availableUnits.si;else var a=this.availableUnits.si,b=this.availableUnits.us;if(this.customGoals)for(var c=0;c<this.customGoals.length;c++){var d=this.customGoals[c].goals;this.customGoals[c].goals=getConversionFunction(a,b)(d)}},this.$postLink=function(){g(this.transport),this.data&&!this.api?(f.timeout=!1,e(function(){f.consumeData(f.data)},2e3)):f.timeout=!0,d.$watch(function(a){if(a.$ctrl.data&&1==f.timeout)return a.$ctrl.data},function(a){a&&(f.datas=a,f.noResults=!1)})},this.$onDestroy=function(){console.log("destory chart",f.msgTag,d.$id),f.msgTag&&c.unsubscribe(f.msgTag,null,d.$id),f.refreshTimer&&e.cancel(f.refreshTimer)};var g=function(a){"wss"==a?c.onReady.then(function(){f.msgTag&&c.subscribe(f.msgTag,f.consumeData.bind(f),d.$id),f.api&&c.call(f.api,f.apiParams,f.msgTag).then(function(b,c){f.fetchDataInterval&&(f.refreshTimer=e(function(){f.apiParams[f.fetchFromDateParam]=f.fetchToDateValue,f.apiParams[f.fetchToDateParam]=(new Date).getTime(),f.delta=!0,g.bind(f)(a)},1e3*f.fetchDataInterval).then(function(){console.log("Timer resolved!",Date.now())},function(){console.log("Timer rejected!",Date.now())})),f.consumeData(b)},function(a){console.log("reject published promise",a),f.consumeData()})}):"https"==a&&f.api&&b.get(f.api,f.apiParams).then(function(a,b){f.consumeData(a)},function(a){console.log("reject published promise",a),f.consumeData()})};this.consumeData=function(a,b){f.timeout=!0,"function"==typeof f.onFormatData()&&(a=f.onFormatData()(a)),a&&a.length>0&&"object"==typeof a?this.fetchDataInterval&&this.fetchDataInterval>0&&this.datas&&this.delta?this.datas=this.datas.concat(a):(this.datas=a,this.noResults=!1):this.api&&0==a.length&&(!this.datas||this.datas&&0==this.datas.length)&&(this.datas=[],this.noResults=!0)}}]}),angular.module("plotly",["angularPlotly"]),angular.module("plotly").component("scriptrPlotly",{bindings:{displayMetricValue:"@",displayMetricParam:"@",defaultMetricValue:"@",defaultMetricParam:"@",availableUnits:"<?",fetchFromDateParam:"@",fetchFromDateValue:"@",fetchToDateParam:"@",fetchToDateValue:"@",fetchDataInterval:"@",onLoad:"&onLoad",api:"@",retrievedData:"<?",customRanges:"<?",layout:"<?",options:"<?",transport:"@",showLegend:"@",fontSize:"@",msgTag:"@",apiParams:"<?",onFormatData:"&"},templateUrl:"/UIComponents/dashboard/frontend/components/plotly/plotly.html",controller:["$rootScope","$scope","$window","$element","$timeout","httpClient","wsClient","_",function(a,b,c,d,e,f,g,h){var i=this;this.directions=["N","NNE","ENE","E","ESE","SSE","S","SSW","WSW","W","WNW","NNW"],this.speedUnit="m/s",this.noResults=!1,this.$onInit=function(){this.apiParams=this.apiParams?this.apiParams:[],this.plotCustomRanges=this.customRanges&&this.customRanges.length>0?this.customRanges:[{color:"#00476b",lo:0,hi:2},{color:"#005487",lo:2,hi:4},{color:"#006699",lo:4,hi:6},{color:"#0082b5",lo:6,hi:8},{color:"#0294c1",lo:8,hi:10},{color:"#06a9ce",lo:10,hi:20}],this.fetchFromDateParam=this.fetchFromDateParam?this.fetchFromDateParam:"from_date",this.fetchToDateParam=this.fetchToDateParam?this.fetchToDateParam:"to_date",this.fetchToDateValue=this.fetchToDateValue?this.fetchToDateValue:null,this.fetchFromDateValue=this.fetchFromDateValue?this.fetchFromDateValue:null,this.fetchFromDateValue&&(this.apiParams[this.fetchFromDateParam]=this.fetchFromDateValue),this.fetchToDateValue&&(this.apiParams[this.fetchToDateParam]=this.fetchToDateValue),this.displayMetricParam=this.displayMetricParam?this.displayMetricParam:"display_metric",this.displayMetricValue=a.currentDashboardUnit,this.defaultMetricParam=this.defaultMetricParam?this.defaultMetricParam:"default_metric",this.defaultMetricValue=this.defaultMetricValue?this.defaultMetricValue:null,this.retrievedData=this.retrievedData?this.retrievedData:[],this.staticData=angular.copy(this.retrievedData),this.defaultMetricValue&&this.displayMetricValue&&this.defaultMetricValue!=this.displayMetricValue&&this.availableUnits&&Object.keys(this.availableUnits).length>=2&&this.runMetricTransformation(),this.showLegend=this.showLegend?this.showLegend:"true",this.fontSize=this.fontSize?this.fontSize:"12",this.layout={title:"",font:{size:this.fontSize},radialaxis:{ticksuffix:"%"},orientation:270},this.maxRange=h.max(h.pluck(this.plotCustomRanges,"hi")),this.listOfMinRanges=h.pluck(this.plotCustomRanges,"lo"),this.listOfMaxRanges=h.pluck(this.plotCustomRanges,"hi"),this.listOfColors=h.pluck(this.plotCustomRanges,"color"),this.listOfColors.push("#10c3e0"),this.speedUnit=this.availableUnits?this.availableUnits[this.displayMetricValue]:this.speedUnit?this.speedUnit:"",this.style={},angular.element(c).on("resize",function(){return null!=i.timeoutId&&e.cancel(i.timeoutId),i.timeoutId=e(i.resize,100)}),j(this.transport)},i.resize=function(){i.timeoutId=null,c.matchMedia(a.mobileBreakPoint).matches?(i.style.height="300",i.style.width=d.parent()[0].clientWidth):null==i.showLegend||"true"!=i.showLegend?(i.style.height=d.parent()[0].clientHeight,i.style.width=d.parent()[0].clientWidth):(i.style.height=d.parent()[0].clientHeight,i.style.width=d.parent()[0].clientWidth-d.find(".plotly-chart-legend").outerWidth(!0)-5,i.style.width<=0&&(i.style.width=d.parent()[0].clientWidth)),i.layout={title:"",font:{size:i.fontSize},radialaxis:{ticksuffix:"%"},orientation:270,width:i.style.width,height:i.style.height}},this.runMetricTransformation=function(){if("si"!=this.defaultMetricValue)var a=this.availableUnits.us,b=this.availableUnits.si;else var a=this.availableUnits.si,b=this.availableUnits.us;if(this.plotCustomRanges)for(var c=0;c<this.plotCustomRanges.length;c++){var d=this.plotCustomRanges[c].lo,e=this.plotCustomRanges[c].hi;this.plotCustomRanges[c].lo=getConversionFunction(a,b)(d),this.plotCustomRanges[c].hi=getConversionFunction(a,b)(e)}},this.$postLink=function(){e(i.resize,100),null!=i.timeoutId&&e.cancel(i.timeoutId),i.timeoutId=e(i.resize,100),b.$watch(function(a){return a.$ctrl.retrievedData},function(a){i.retrievedData=a})},this.$onDestroy=function(){angular.element(c).off("resize"),console.log("destory wind rose"),i.msgTag&&g.unsubscribe(i.msgTag,null,b.$id),i.refreshTimer&&e.cancel(i.refreshTimer)};var j=function(a){"wss"==a?g.onReady.then(function(){i.msgTag&&g.subscribe(i.msgTag,i.consumeData.bind(i),b.$id),i.api&&i.apiParams&&i.apiParams.streams&&i.apiParams.streams.length>0?g.call(i.api,i.apiParams,i.msgTag).then(function(b,c){i.fetchDataInterval&&!i.refreshTimer&&(i.refreshTimer=e(function(){i.apiParams[i.fetchFromDateParam]=i.fetchToDateValue,i.apiParams[i.fetchToDateParam]=(new Date).getTime(),i.delta=!0,j.bind(i)(a)},1e3*i.fetchDataInterval),i.refreshTimer.then(function(){i.refreshTimer=null,console.log("Timer run resolved!",Date.now())},function(){i.refreshTimer=null,console.log("Timer run rejected!",Date.now())})),i.consumeData(b)},function(a){console.log("reject published promise",a),i.consumeData()}):i.buildWindRoseData()}):"https"==a&&i.api&&f.get(i.api,i.apiParams).then(function(a,b){i.consumeData(a)},function(a){console.log("reject published promise",a)})};this.consumeData=function(a,b){if(h.isEqual(this.retrievedData,this.staticData)&&(this.retrievedData=[]),"function"==typeof this.onFormatData()&&(a=this.onFormatData()(a)),a&&a.length>0){if(this.fetchDataInterval&&this.fetchDataInterval>0&&this.retrievedData&&this.retrievedData.length>0)for(var c=0;c<a.length;c++)this.retrievedData[c].speeds=this.retrievedData[c].speeds.concat(a[c].speeds);else this.retrievedData=a;this.buildWindRoseData()}else this.api&&0==a.length&&(!this.retrievedData||this.retrievedData&&0==this.retrievedData.length)&&(this.retrievedData=[],this.noResults=!0)},this.buildWindRoseData=function(){var a=h.pluck(i.retrievedData,"speeds");i.totalSpeeds=0;for(var b=0;b<a.length;b++)i.totalSpeeds+=a[b].length;0==i.totalSpeeds?i.noResults=!0:i.noResults=!1,i.speedRangeDirectionObj={};for(var b=0;b<i.listOfMinRanges.length;b++)i.speedRangeDirectionObj[i.listOfMinRanges[b]+"-"+i.listOfMaxRanges[b]]=[];i.speedRangeDirectionObj[">="+i.maxRange]=[];for(var b=0;i.retrievedData&&b<i.retrievedData.length;b++){for(var c=i.retrievedData[b].direction,d=i.retrievedData[b].speeds,e=0;e<i.plotCustomRanges.length;e++){var f=this.plotCustomRanges[e],g=h.filter(d,function(a){return a>=f.lo&&a<f.hi}).length;i.speedRangeDirectionObj[i.plotCustomRanges[e].lo+"-"+i.plotCustomRanges[e].hi].push({direction:c,percentage:g/i.totalSpeeds*100})}var j=i.maxRange,k=h.filter(d,function(a){return a>=j}).length;i.speedRangeDirectionObj[">="+i.maxRange].push({direction:c,percentage:k/i.totalSpeeds*100})}for(var l=Object.keys(i.speedRangeDirectionObj),m=Object.keys(i.speedRangeDirectionObj)[0],n=(i.speedRangeDirectionObj[m],JSON.parse(JSON.stringify(i.speedRangeDirectionObj))[m]),b=0;b<l.length;b++){var o=l[b],p=i.speedRangeDirectionObj[o];if(o!=m){for(var e=0;e<p.length;e++)n[e].percentage=p[e].percentage+n[e].percentage,0!=p[e].percentage&&(p[e].percentage=n[e].percentage);i.speedRangeDirectionObj[o]=p}}i.data=[],l=Object.keys(i.speedRangeDirectionObj);for(var b=l.length-1;b>=0;b--){var q=h.pluck(i.speedRangeDirectionObj[l[b]],"percentage"),r=l[b],s=i.listOfColors[b],t={r:q,t:i.directions,name:r+" "+i.speedUnit,marker:{color:s},type:"area",showlegend:!1};i.data.push(t)}}}]}),angular.module("MenuLayout",["ui.bootstrap","ngAnimate","ngSanitize"]).config(["$compileProvider",function(a){a.aHrefSanitizationWhitelist(/^\s*(https?|ftp|mailto|file|javascript):/)}]).component("menu",{bindings:{menuOpened:"<?",transport:"@",api:"@",msgTag:"@",apiParams:"<?",user:"<?"},templateUrl:"/UIComponents/layout/frontend/components/onsetmenu/menu.html",controller:["$scope","$window","httpClient","wsClient",function(a,b,c,d){this.opened=!0,this.firstLoad=!0,this.webVersion=!0;var e=this;this.menuArray=[],this.changeIsCollapsed=function(b){a["isCollapsed"+b]=!a["isCollapsed"+b]},this.$onInit=function(){this.windowWidth=b.innerWidth,this.windowWidth>=992?this.webVersion=!0:this.webVersion=!1,this.webVersion||(this.opened=!1),this.initDataService()},this.logout=function(){c.get("app/api/users/revokeToken",{}).then(function(a,b){"success"==a.data.metadata.status&&($.removeCookie("token",{path:"/"}),window.localStorage.removeItem("user"),window.location=onsetLoginUrl+"/?action=logout")},function(a){})},this.openCloseChild=function(a){this.opened=!this.opened,this.firstLoad=!1,a.stopPropagation()},this.closeChild=function(a){this.opened=!1,this.firstLoad=!1,a.stopPropagation()},this.initDataService=function(){"wss"==this.transport?d.onReady.then(function(){e.msgTag&&d.subscribe(e.msgTag,e.consumeData.bind(e),a.$id),e.api&&d.call(e.api,e.apiParams,e.msgTag).then(function(a,b){e.consumeData(a)},function(a){console.log("reject published promise",a),e.consumeData()})}):"https"==this.transport&&this.api&&c.get(e.api,e.apiParams).then(function(a,b){e.consumeData(a)},function(a){console.log("reject published promise",a)})},this.consumeData=function(a,b){a&&(this.menuArray=a.menuArray,this.user=a.userName,this.prepareMenuParams())},this.prepareMenuParams=function(){for(var b=0;b<this.menuArray.length;b++)a["isCollapsed"+b]=!0},angular.element(b).bind("resize",function(){a.$apply(function(){a.windowWidth=b.innerWidth,a.windowWidth>=992?e.webVersion=!0:e.webVersion=!1})})}]});var underscore=angular.module("underscore",[]);underscore.factory("_",["$window",function(a){return a._}]),angular.module("DashboardBuilder",["underscore","schemaForm","ACL","Grid","Message","xeditable","ui.bootstrap","ngRoute","slickCarousel","ngAnimate","ngSanitize","WsClient","HttpClient","Chart","gridster","DashboardBuilder","Gauge","Speedometer","Odometer","SearchBox","ngMaterial","ngMessages","material.svgAssetsCache","Thermometer","angularSpectrumColorpicker","angular-underscore/filters","pascalprecht.translate","ui.select","ui.codemirror","Display","Dygraphs","plotly","ngSchemaFormFile","mgcrea.ngStrap","mgcrea.ngStrap.modal","mgcrea.ngStrap.select","MenuLayout"]),angular.module("DashboardBuilder").constant("alarmsConfig",{form:[{type:"tabs",tabs:[{title:"Format",items:["message",{key:"widget-layout",notitle:!1,type:"strapselect",titleMap:[{value:"horizontal",name:"Horizontal"},{value:"vertical",name:"Vertical"}]},"border-size",{key:"border-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}},{key:"number-cell-size",notitle:!1,type:"strapselect",titleMap:[{value:"small",name:"Small"},{value:"medium",name:"Medium"},{value:"large",name:"Large"},{value:"",name:"no-width"}]},{type:"section",htmlClass:"col-xs-12 col-sm-6 row",items:[{key:"number-font-family",notitle:!1,type:"strapselect",titleMap:[{value:"Arial",name:"Arial"},{value:"Helvetica",name:"Helvetica"},{value:"Times New Roman",name:"Times New Roman"},{value:"Courier New",name:"Courier New"},{value:"Courier",name:"Courier"},{value:"Verdana",name:"Verdana"},{value:"Georgia",name:"Georgia"},{value:"Palatino",name:"Palatino"},{value:"Garamond",label:"Garamond"},{value:"Bookman",label:"Bookman"},{value:"Comic Sans MS",name:"Comic Sans MS"},{value:"Trebuchet MS",name:"Trebuchet MS"},{value:"Arial Black",name:"Arial Black"},{value:"Impact",name:"Impact"},{value:"Sans-Serif",name:"Sans-Serif"},{value:"Source Sans Pro",name:"Source Sans Pro"}]},"number-font-size","number-font-weight",{key:"number-text-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}},{key:"number-background-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}},{key:"number-Text-Alignment",notitle:!1,type:"strapselect",titleMap:[{value:"left",name:"Left"},{value:"center",name:"Center"},{value:"right",name:"Right"}]}]},{type:"section",htmlClass:"col-xs-12 col-sm-6 row pull-right",items:[{key:"message-font-family",notitle:!1,type:"strapselect",titleMap:[{value:"Arial",name:"Arial"},{value:"Helvetica",name:"Helvetica"},{value:"Times New Roman",name:"Times New Roman"},{value:"Courier New",name:"Courier New"},{value:"Courier",name:"Courier"},{value:"Verdana",name:"Verdana"},{value:"Georgia",name:"Georgia"},{value:"Palatino",name:"Palatino"},{value:"Garamond",name:"Garamond"},{value:"Bookman",name:"Bookman"},{value:"Comic Sans MS",name:"Comic Sans MS"},{value:"Trebuchet MS",name:"Trebuchet MS"},{value:"Arial Black",name:"Arial Black"},{value:"Impact",name:"Impact"},{value:"Sans-Serif",name:"Sans-Serif"},{value:"Source Sans Pro",name:"Source Sans Pro"}]},"message-font-size","message-font-weight",{key:"message-text-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}},{key:"message-background-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}},{key:"message-Text-Alignment",notitle:!1,type:"strapselect",titleMap:[{value:"left",name:"Left"},{value:"center",name:"Center"},{value:"right",name:"Right"}]}]}]}]}],schema:{type:"object",title:"Schema",properties:{"widget-layout":{title:"Layout",type:"string",default:"horizontal",placeholder:" ",description:"Define your widget's layout."},"number-cell-size":{title:"Numbers Cell Size",type:"string",default:"",placeholder:" ",description:"Define your widget's numbers cell size."},message:{title:"Message",type:"string",default:"Items",description:"Define your widget message."},"number-font-family":{title:"Number Font family",type:"string",description:"Define your widget number font family.",default:"Arial",placeholder:" "},"message-font-family":{title:"Message Font family",type:"string",description:"Define your widget message font family.",default:"Arial",placeholder:" "},"number-font-size":{title:"Number Font Size",type:"number",default:42,description:"Define your widget number font size."},"message-font-size":{title:"Message Font Size",type:"number",default:18,description:"Define your widget message font size."},"number-font-weight":{title:"Number Font Weight",type:"number",default:600,description:"Define your widget number font weight."},"message-font-weight":{title:"Message Font Weight",type:"number",default:600,description:"Define your widget message font weight."},"number-text-color":{
title:"Number Text Color",type:"string",description:"Define your widget number text color.",format:"color",default:"#ffffff",validationMessage:"Invalid Color"},"message-text-color":{title:"Message Text Color",type:"string",description:"Define your widget message text color.",format:"color",default:"#686868",validationMessage:"Invalid Color"},"number-background-color":{title:"Number Backgrount Color",type:"string",description:"Define your widget number background color.",format:"color",default:"#005588",validationMessage:"Invalid Color"},"message-background-color":{title:"Message Backgrount Color",type:"string",description:"Define your widget message background color.",format:"color",default:"white",validationMessage:"Invalid Color"},"message-Text-Alignment":{title:"Message Text Alignment",type:"string",default:"center",placeholder:" ",description:"Define your widget message text alignment."},"number-Text-Alignment":{title:"Number Text Alignment",type:"string",default:"center",placeholder:" ",description:"Define your widget number text alignment."},"border-size":{title:"Border Weight",type:"number",default:1,description:"Define your widget border weight."},"border-color":{title:"Border Color",type:"string",description:"Define your widget border color.",format:"color",default:"#d7d7d7",validationMessage:"Invalid Color"},data:{title:"Count",type:"string",description:"Count to display."}},required:[]}}),angular.module("DashboardBuilder").constant("common",{formTab:{title:"Data",hidden:!0,items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:[{key:"transport",notitle:!1,type:"strapselect",titleMap:[{value:"wss",name:"wss"},{value:"https",name:"https"}]}]},{type:"section",htmlClass:"col-xs-6",items:[{key:"msg-tag",condition:"model.transport=='wss'"},{key:"http-method",notitle:!1,type:"strapselect",titleMap:[{value:"GET",name:"GET"}],condition:"model.transport=='https'"}]}]},{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:[{key:"api",condition:"model.stream.length > 0 "}]},{type:"section",htmlClass:"col-xs-6",items:["api-params"]}]},{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12",items:[{key:"data-type"},{key:"data-format"},{key:"schema-for"}]}]},{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12",items:[{key:"columns-definition",condition:"model['schema-for'] == 'grid'"},{key:"row-data",condition:"model['schema-for'] == 'grid'"}]}]},{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12",items:[{key:"data"},{key:"on-format-data",type:"codemirror",codemirrorOptions:{value:"return",styleActiveLine:!0,lineNumbers:!0,lineWrapping:!0,autoCloseBrackets:!0,matchBrackets:!0,theme:"neo",mode:"javascript",readOnly:!1,autoRefresh:!0}}]}]},{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12",items:[{type:"help",helpvalue:"<hr>"}]}]},{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12",items:[{type:"help",helpvalue:'<div class="alert alert-info"><ul><li>Messages published over the subscibe channel need to have the following format in order to be consumed by a widget:<ul><li>{“id”: “&lt;message tag value&gt;”, “result”: “&lt;static data structure&gt;”}</li></ul></li><li>A script would publish a message  over the subscribe channel as follow:<ul><li>publish(“responseChannel”, {“id”: “&lt;message tag value&gt;”, “result”: “&lt;static data structure&gt;”});</li></ul></li><li>Whether https or wss transport is used, Sciptr API should return the static data structure for widget initial load:<ul><li>return &lt;static data structure&gt;;</li></ul></li></ul></div>'}]}]}]},schemaFields:{api:{title:"Api",type:"string",description:"Name of the scriptr api (script name) responsible for publishing or returning the widget data.",default:"app/api/dashboard/GetUserData"},"api-params":{title:"Api params",type:"string",description:"A JSON formatted object containing the parameters to be sent to the scriptr api.","x-schema-form":{type:"textarea",placeholder:"Ex: {'id' : '599865'}"}},"http-method":{title:"Http method",type:"string",description:"Method to be used when calling the scriptr api over https. Default: GET.",default:"GET",placeholder:" "},transport:{title:"Transport",type:"string",description:"Protocol used to call the  scriptr api. Use wss for real time communication whenever your widget needs to update its data live by consuming messages published from scriptr over the subscribe channel defined in settings.",placeholder:""},"msg-tag":{title:"Message tag",type:"string",description:"The dashboard widgets consume messages published over the subscribe channel defined in dashboard settings. Message tag is an identifier sent as part of the published message. The widget uses it to know which messages to consume or ignore."},"on-format-data":{title:"Format data",default:"return data;",type:"string",description:"Callback function to be called after data is returned from backend."},"data-type":{title:"Data Type",type:"string",description:"Set the data type if raw, aggregate, latest.",enum:["raw","aggregate","latest"]},"aggregation-range":{title:"Aggregation Range",type:"string",description:"Select the aggregatin data range.",default:"1800000"},"data-format":{title:"Data Format",type:"string",enum:["dygraphs","grid","live","morris","windrose"]},"schema-for":{title:"Widget Class",type:"string",enum:["line","bar","area","donut","gauge","grid","thermometer","odometer","displaycount","windrose"]},"available-units":{title:"Main Stream Units",type:"string"}}}),angular.module("DashboardBuilder").constant("config",{script:{form:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12 col-md-1 file-attachment",items:[{key:"image",type:"nwpFileUpload",i18n:{add:"Open file browser",preview:"Preview Upload",filename:"File Name",progress:"Progress Status",upload:"Upload",dragorclick:"Drag and drop your file here or click here"},notitle:!0}]},{type:"section",htmlClass:"col-xs-12 col-md-5",items:[{key:"dashboardName",notitle:!0,placeholder:"Dashboard Name"}]},{type:"section",htmlClass:"col-xs-12 col-md-3 period-select-box",items:[{key:"period",type:"strapselect",notitle:!0,placeholder:"Period",titleMap:[{value:"past_day",name:"Past day"},{value:"past_week",name:"Past week"},{value:"past_month",name:"Past month"}],onChange:"setFetchFromDate(modelValue, form);"}]},{type:"section",htmlClass:"col-xs-12 col-md-3 unit-select-box",items:[{key:"unit",notitle:!0,placeholder:"Unit",type:"strapselect",titleMap:[{value:"si",name:"SI units"},{value:"us",name:"US units"}],onChange:"setUnitInLocalStorage(modelValue, form);"}]}]}],schema:{type:"object",title:"Schema",properties:{scriptName:{type:"hidden",fieldHtmlClass:"script-name-input"},dashboardName:{type:"string",fieldHtmlClass:"script-name-input",maxLength:30,pattern:"^[A-Za-z0-9 -]+$",validationMessage:"Dashboard name can contain letters, numbers and hyphen."},image:{title:"Image",type:"array",format:"singlefile",default:"//cdn.rawgit.com/scriptrdotio/onset-static-resources/a923190a/images/default-icon.svg","x-schema-form":{type:"array"},pattern:{mimeType:"image/*",validationMessage:"Wrong File Type. Allowed types "},maxSize:{maximum:"1MB",validationMessage:"File exceeded allowed size of "}},period:{title:"Period",type:"string",description:"",default:"past_day"},unit:{title:"Unit",type:"string",description:"",default:"si",placeholder:" "}},required:["dashboardName","period","unit"]}},metricselector:{form:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12 col-md-3 col-lg-2 period-select-box",items:[{key:"period",type:"strapselect",notitle:!0,placeholder:"Period",titleMap:[{value:"past_day",name:"Past day"},{value:"past_week",name:"Past week"},{value:"past_month",name:"Past month"}],onChange:"setFetchFromDate(modelValue, form);"}]},{type:"section",htmlClass:"col-xs-12 col-md-3 col-lg-2 unit-select-box",items:[{key:"unit",notitle:!0,placeholder:"Unit",type:"strapselect",titleMap:[{value:"si",name:"SI units"},{value:"us",name:"US units"}],onChange:"setUnitInLocalStorage(modelValue, form);"}]}]}],schema:{type:"object",title:"Schema",properties:{period:{title:"Period",type:"string",description:"",default:"past_day"},unit:{title:"Unit",type:"string",description:"",default:"si",placeholder:" "}},required:["unit"]}},transport:{label:"Transport configuration",defaults:{publishChannel:"requestChannel",subscribeChannel:"responseChannel"},form:["*"],schema:{type:"object",title:"Schema",properties:{publishChannel:{title:"Publish channel",type:"string",description:"Widgets use the publish channel to publish messages that will be distributed to its subscribers."},subscribeChannel:{title:"Subscribe channel",type:"string",description:"Widgets use the subscribe channel to consume the messages published over that channel as a data source."}},required:["token","baseUrl","publishChannel","subscribeChannel"]}},defaultWidget:{name:"displaybox"},widgets:[{name:"line",label:"Line Chart",class:"scriptr-dygraphs",commonData:!0,show:!0,defaults:{type:"line","on-format-data":"return data;","data-type":"raw","data-format":"dygraphs","schema-for":"line","fetch-from-date-param":"from_date","fetch-to-date-param":"to_date","display-metric-param":"display_metric","fetch-data-interval":300,boxLabel:"Line Chart",boxBorder:!0,transport:"wss",data:"[[1519312895840,10,26,16,20],[1519312896840,11,25,16,20],[1519312897840,10,26,16,20],[1519312898840,11,25,15,20],[1519312899840,10,26,16,21]]","grid-text-family":"Source Sans Pro","x1-axis-label-font-size":12,"x1-axis-label-width":60,"y2-axis-label-width":95,"y-axis-label-width":95,"y2-axis-label-font-size":12,"y-axis-label-font-size":12},box:{sizeX:3,sizeY:3,minSizeX:2,minSizeY:2},imgSrc:"//cdn.rawgit.com/scriptrdotio/onset-static-resources/97574e7b/images/line-chart.svg",form:[{type:"tabs",tabs:[{title:"Data",items:[{type:"section",htmlClass:"",items:[{key:"stream",type:"uiselectmultiple",placeholder:"",options:{closeOnSelect:!1,groupBy:"dataStream",multiple:"true",callback:"multiSelectCallBack",widgetName:"line",limit:20,limitTo:50},onChange:function(a,b,c){for(var d=["#CC5464","#FCC717","#38B9D6","#1DBC68","#E90088"],e={},f=c["colors-mapping"],g=0;g<f.length;g++)f[g].ykeys&&(e[f[g].ykeys]={labels:f[g].labels,colors:f[g].colors,axisSelection:f[g].axisSelection});for(var h=[],i=0;i<a.length;i++)if(e[a[i].value])h.push({ykeys:a[i].value,labels:e[a[i].value].labels,colors:e[a[i].value].colors,axisSelection:e[a[i].value].axisSelection});else{for(var j=0;j<d.length;j++){for(var k=!1,l=d[j],m=0;m<h.length;m++){var n=h[m].colors;if(n==l){k=!0;break}}if(!k)break}h.push({ykeys:a[i].value,labels:a[i].name,colors:k?d[0]:d[j],axisSelection:"y"})}0==h.length&&(h=[{}]),c["colors-mapping"]=h;for(var o='["x",',p='["X",',i=0;i<a.length;i++)o+="'y'"+(i<a.length-1?" , ":""),p+='"'+a[i].name+'"'+(i<a.length-1?" , ":"");if(c["legend-labels"]=p+"]",c["legend-Mapping"]=o+"]",a.length>0&&delete c.data,a&&a.length>0){for(var q,r=0;r<c["colors-mapping"].length;r++)if("y"==c["colors-mapping"][r].axisSelection){q=c["colors-mapping"][r].ykeys+"-"+c["colors-mapping"][r].labels;break}for(var j=0;j<a.length;j++){if(a[j].value+"-"+a[j].name==q){c["available-units"]={si:a[j].availableUnits.si,us:a[j].availableUnits.us};break}}}}}]}]},{title:"X",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:[{type:"radios-inline",key:"draw-x1-axis",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]},"x1-axis-label","x1-axis-label-font-size"]},{type:"section",htmlClass:"col-xs-6",items:[{key:"x1-axis-line-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}},{key:"x1-axis-line-width",step:"0.1"},"x1-axis-label-width"]}]}]},{title:"Y",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:[{type:"radios-inline",key:"draw-y-axis",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]},"y-axis-label","y-axis-label-font-size","y-axis-label-width"]},{type:"section",htmlClass:"col-xs-6",items:[{key:"y-axis-line-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}},{key:"y-axis-line-width",step:"0.1"},{type:"radios-inline",key:"y-axis-include-zero",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]},{type:"radios-inline",key:"y-axis-labels-kmb",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]}]}]}]},{title:"Y2",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:[{type:"radios-inline",key:"draw-y2-axis",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]},"y2-axis-label","y2-axis-label-font-size","y2-axis-label-width"]},{type:"section",htmlClass:"col-xs-6",items:[{key:"y2-axis-line-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}},{key:"y2-axis-line-width",step:"0.1"},{type:"radios-inline",key:"y2-axis-include-zero",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]},{type:"radios-inline",key:"y2-axis-labels-kmb",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]}]}]}]},{title:"Legend",items:[{type:"radios-inline",key:"show-legend",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]},{type:"section",htmlClass:"",items:[{key:"colors-mapping",title:"Legend Details",add:null,remove:null,items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6 col-sm-3",items:[{key:"colors-mapping[].ykeys",title:"Channel"}]},{type:"section",htmlClass:"col-xs-6 col-sm-3",items:[{key:"colors-mapping[].labels",title:"Legend Label"}]},{type:"section",htmlClass:"col-xs-6 col-sm-3",items:[{key:"colors-mapping[].colors",title:"Color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}}]},{type:"section",htmlClass:"col-xs-6 col-sm-3",items:[{key:"colors-mapping[].axisSelection",title:"Legend Axis",notitle:!1,type:"strapselect",titleMap:[{value:"y",name:"Y"},{value:"y2",name:"Y2"}]}]}]}]}]}]},{title:"Grid",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-4",items:[{type:"radios-inline",key:"x1-draw-grid",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]},{key:"x1-grid-line-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}},{key:"x1-grid-line-width",step:"0.1"}]},{type:"section",htmlClass:"col-xs-4",items:[{type:"radios-inline",key:"y-draw-grid",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]},{key:"y-grid-line-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}},{key:"y-grid-line-width",step:"0.1"}]},{type:"section",htmlClass:"col-xs-4",items:[{type:"radios-inline",key:"y2-draw-grid",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]},{key:"y2-grid-line-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}},{key:"y2-grid-line-width",step:"0.1"}]},{type:"section",htmlClass:"col-xs-12",items:[{key:"independent-ticks",notitle:!1,type:"strapselect",titleMap:[{value:"y-primary",name:"Ticks are aligned. Y is primary"},{value:"y2-primary",name:"Ticks are aligned. Y2 is primary"},{value:"independent",name:"Ticks are not aligned"}]}]}]}]},{title:"Slider",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:[{type:"radios-inline",key:"show-range-selector",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]},"range-selector-alpha","range-selector-background-line-width",{key:"range-selector-background-stroke-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}},"range-selector-foreground-line-width"]},{type:"section",htmlClass:"col-xs-6",items:[{key:"range-selector-foreground-stroke-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}},"range-selector-height",{key:"range-selector-plot-fill-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}},{key:"range-selector-plot-fill-gradient-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}},{key:"range-selector-plot-line-width",step:"0.1"},{key:"range-selector-plot-stroke-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}}]}]}]},{title:"Goals",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12",items:[{key:"custom-goals",title:"Fill Colors & Goals",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:[{key:"custom-goals[].goal-line-colors",title:"Colors",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}}]},{type:"section",htmlClass:"col-xs-6",items:[{key:"custom-goals[].goals",title:"Goals",onFieldLoad:function(a,b,c){if(c["default-metric-value"]&&c["default-metric-value"]!=c["display-metric-value"]&&c["available-units"]){var d=c["available-units"][c["default-metric-value"]],e=c["available-units"][c["display-metric-value"]];d!==e&&(c[b.key[0]][b.key[1]][b.key[2]]=getConversionFunction(d,e)(c[b.key[0]][b.key[1]][b.key[2]]))}}}]}]}]}]}]}]},{title:"Box Properties",items:["boxLabel"]}]}],schema:{type:"object",title:"Schema",properties:{"show-legend":{title:"Show Legend",default:"true",type:"string",description:""},stream:{title:"Channels",type:"array",items:{type:"string"},description:"",placeholder:" "},"legend-position":{title:"Legend Position ",type:"string",default:"bottom",description:"Determines the legend position relative to the graph.",placeholder:" "},"draw-x1-axis":{title:"Draw X-axis",type:"string",default:"true",description:"Determines whether to draw the X-axis. Setting this to false also prevents x-axis ticks from being drawn and reclaims the space for the chart grid/lines."},"draw-y-axis":{title:"Draw Y-axis",type:"string",default:"true",description:"Determines whether to draw the Y-axis. Setting this to false also prevents y-axis ticks from being drawn and reclaims the space for the chart grid/lines."},"draw-y2-axis":{title:"Draw Y2-axis",type:"string",default:"false",description:"Determines whether to draw the Y2-axis. Setting this to false also prevents y2-axis ticks from being drawn and reclaims the space for the chart grid/lines."},"colors-mapping":{title:"Colors",type:"array",default:[],description:"",items:{type:"object",properties:{colors:{title:"Colors",type:"string",format:"color",validationMessage:"Invalid Color"},labels:{title:"Labels",type:"string"},ykeys:{title:"Channel",readonly:!0,type:"string"},axisSelection:{title:"Legend Axis",type:"string",placeholder:" "}}}},"custom-goals":{title:"Goals",type:"array",default:[{"goal-line-colors":"#00476b",goals:0}],description:"Goals: List of y-values to draw as horizontal 'goal' lines on the chart.<br/>Colors: List of color values to use for the goal line colors.",items:{type:"object",properties:{"goal-line-colors":{title:"Colors",type:"string",format:"color",validationMessage:"Invalid Color",default:"#00476b"},goals:{title:"Goals",type:"string"}}}},events:{title:"Events",type:"array",default:["2010-02-02"],description:"List of x-values to draw as vertical 'event' lines on the chart.",items:{type:"string"}},"event-line-colors":{title:"Event Line Colors",type:"array",default:["#ffffff"],description:"List of color values to use for the event line colors.",items:{format:"color",type:"string",validationMessage:"Invalid Color"}},colors:{title:"Lines' Colors",type:"array",default:["#005588","#aa241d"],description:"Array containing colors for the series lines.",items:{format:"color",type:"string",validationMessage:"Invalid Color"}},"x1-axis-label-font-size":{title:"Axis Label Font Size",type:"number",default:12,description:"Size of the font (in pixels) to use in the x axis labels."},"y-axis-label-font-size":{title:"Axis Label Font Size",type:"number",default:12,description:"Size of the font (in pixels) to use in the y axis labels."},"y2-axis-label-font-size":{title:"Axis Label Font Size",type:"number",default:12,description:"Size of the font (in pixels) to use in the y2 axis labels."},"x1-axis-label-width":{title:"Axis Label Width",type:"number",default:60,description:"Width (in pixels) of the axis label width."},"y-axis-label-width":{title:"Axis Label Width",type:"number",default:95,description:"Width (in pixels) of the axis label width. This also controls the width of the y-axis."},"y2-axis-label-width":{title:"Axis Label Width",type:"number",default:95,description:"Width (in pixels) of the axis label width. This also controls the width of the y-axis."},"x1-axis-line-color":{title:"Axis Line Color",type:"string",default:"#000000",format:"color",description:"Color of the axis line.",validationMessage:"Invalid Color"},"y-axis-line-color":{title:"Axis Line Color",type:"string",default:"#000000",format:"color",description:"Color of the axis line.",validationMessage:"Invalid Color"},"y2-axis-line-color":{title:"Axis Line Color",type:"string",default:"#000000",format:"color",description:"Color of the axis line.",validationMessage:"Invalid Color"},"x1-axis-line-width":{title:"Axis Line Width",type:"number",default:.3,description:"Thickness (in pixels) of the axis line."},"y-axis-line-width":{title:"Axis Line Width",type:"number",default:.3,description:"Thickness (in pixels) of the axis line."},"y2-axis-line-width":{title:"Axis Line Width",type:"number",default:.3,description:"Thickness (in pixels) of the axis line."},"y-axis-include-zero":{title:"Include Zero",type:"string",default:"false",description:"If this option is set, the y-axis will always include zero, typically as the lowest value. This can be used to avoid exaggerating the variance in the data."},"y2-axis-include-zero":{title:"Include Zero",type:"string",default:"false",description:"If this option is set, the y-axis will always include zero, typically as the lowest value. This can be used to avoid exaggerating the variance in the data."},"y-axis-labels-kmb":{title:"Labels KMB",type:"string",default:"false",description:"Show K/M/B for thousands/millions/billions on y-axis."},"y2-axis-labels-kmb":{title:"Labels KMB",type:"string",default:"false",description:"Show K/M/B for thousands/millions/billions on y-axis."},"show-range-selector":{title:"Show Slider",type:"string",default:"false",description:"Show or hide the slider widget."},"range-selector-alpha":{title:"Alpha",type:"number",default:.6,description:"The transparency of the veil that is drawn over the unselected portions of the slider mini plot. A value of 0 represents full transparency and the unselected portions of the mini plot will appear as normal. A value of 1 represents full opacity and the unselected portions of the mini plot will be hidden."},"range-selector-background-line-width":{title:"Background Line Width",type:"number",default:1,description:"The width of the lines below and on both sides of the slider mini plot."},"range-selector-background-stroke-color":{title:"Background Stroke Color",type:"string",default:"#808080",format:"color",description:"The color of the lines below and on both sides of the slider mini plot.",validationMessage:"Invalid Color"},"range-selector-foreground-line-width":{title:"Forground Line Width",type:"number",default:1,description:"The width the lines in the interactive layer of the slider."},"range-selector-foreground-stroke-color":{title:"Forground Stroke Color",type:"string",default:"#000000",format:"color",description:"The color of the lines in the interactive layer of the slider.",validationMessage:"Invalid Color"},"range-selector-height":{title:"Height",type:"number",default:40,description:"Height, in pixels, of the slider widget."},"range-selector-plot-fill-color":{title:"Plot Fill Color",type:"string",default:"#A7B1C4",format:"color",description:"The slider mini plot fill color.",validationMessage:"Invalid Color"},"range-selector-plot-fill-gradient-color":{title:"Plot Fill Gradient Color",type:"string",default:"#FFFFFF",format:"color",description:"The top color for the slider mini plot fill color gradient.",validationMessage:"Invalid Color"},"range-selector-plot-line-width":{title:"Plot Line Width",type:"number",default:1.5,description:"The width of the slider mini plot line."},"range-selector-plot-stroke-color":{title:"Plot Stroke Color",type:"string",default:"#808FAB",format:"color",description:"The slider mini plot stroke color.",validationMessage:"Invalid Color"},"x1-draw-grid":{title:"Draw X-Axis Grid Lines",type:"string",default:"true",description:"Determines whether to display x-axis grid lines in the chart."},"y-draw-grid":{title:"Draw Y-Axis Grid Lines",type:"string",default:"true",description:"Determines whether to display y-axis grid lines in the chart."},"y2-draw-grid":{title:"Draw Y2-Axis Grid Lines",type:"string",default:"false",description:"Determines whether to display y2-axis grid lines in the chart."},"x1-grid-line-color":{title:"X-Axis Grid Line Color",type:"string",default:"#000000",format:"color",description:"X-axis grid line color.",validationMessage:"Invalid Color"},"y-grid-line-color":{title:"Y-Axis Grid Line Color",type:"string",default:"#000000",format:"color",description:"Y-axis grid line color.",validationMessage:"Invalid Color"},"y2-grid-line-color":{title:"Y2-Axis Grid Line Color",type:"string",default:"#000000",format:"color",description:"Y2-axis grid line color.",validationMessage:"Invalid Color"},"x1-grid-line-width":{title:"X-Axis Grid Line Width",type:"number",default:.3,description:"X-axis grid line width."},"y-grid-line-width":{title:"Y-Axis Grid Line Width",type:"number",default:.3,description:"Y-axis grid line width."},"y2-grid-line-width":{title:"Y2-Axis Grid Line Width",type:"number",default:.3,description:"Y2-axis grid line width."},"independent-ticks":{title:"Y Axes Alignment",type:"string",default:"y-primary",description:"This option defines whether the y axes should align their ticks or if they should be independent.",placeholder:" "},data:{title:"Data",type:"string",description:"Data series in case of static data.","x-schema-form":{type:"textarea",placeholder:'[["2009-12-31T22:00:00.000Z",1,99,1039600.0000000001,1960400],["2010-01-01T22:00:00.000Z",2,98,1078400,1921600]]'}},"x1-axis-label":{title:"X-axis Label",type:"string",default:"",description:"X-axis Label."},"y-axis-label":{title:"Y-axis Label",type:"string",default:"",description:"Y-axis Label."},"y2-axis-label":{title:"Y2-axis Label",type:"string",default:"",description:"Y2-axis Label."},"legend-labels":{title:"Legend Labels",type:"string",default:"['X', 'Y1', 'Y2', 'Y3', 'Y4']",description:"A name for each data series, including the independent (X) series."},"legend-Mapping":{title:"Legend Mapping",type:"string",default:"['x', 'y', 'y', 'y2', 'y2']",description:"Mapping the legends to their corresponding axis."},boxLabel:{title:"Box label",type:"string",description:"Define your widget box title."},boxBorder:{title:"Box Border",type:"hidden",default:"true",description:"Define your widget box border."}}}},{name:"bar",label:"Bar Chart",class:"scriptr-chart",commonData:!0,show:!0,defaults:{type:"bar",boxLabel:"Bar Chart",boxBorder:!0,stacked:"true","data-type":"aggregate","aggregation-range":"1800000","parse-time":"true","data-format":"morris","schema-for":"bar","xlabel-angle":45,"fetch-from-date-param":"from_date","fetch-to-date-param":"to_date","display-metric-param":"display_metric","fetch-data-interval":300,xkey:"date",ykeys:'["a", "b"]',labels:'["Serie A", "Serie B"]',colors:["#aa241d","#edcfce"],transport:"wss","on-format-data":"return data;",data:'[{"date":"2006","a":88,"b":20},{"date":"2007","a":30,"b":34},{"date":"2008","a":90,"b":42},{"date":"2009","a":89,"b":59},{"date":"2010","a":43,"b":61},{"date":"2011","a":85,"b":69},{"date":"2012","a":29,"b":65}]',"grid-text-family":"Arial","hide-hover":"auto","show-legend":"true"},box:{sizeX:2,sizeY:3,minSizeX:2,minSizeY:2},imgSrc:"//cdn.rawgit.com/scriptrdotio/onset-static-resources/b8a3ec79/images/bar-chart.svg",form:[{type:"tabs",tabs:[{title:"Data",items:[{type:"section",htmlClass:"col-xs-12",items:[{key:"stream",type:"uiselectmultiple",placeholder:"",onChange:function(a,b,c){for(var d=["#CC5464","#FCC717","#38B9D6","#1DBC68","#E90088"],e={},f=c["colors-mapping"],g=0;g<f.length;g++)f[g].ykeys&&(e[f[g].ykeys]={labels:f[g].labels,colors:f[g].colors});for(var h=[],i=0;i<a.length;i++)if(e[a[i].value])h.push({ykeys:a[i].value,labels:e[a[i].value].labels,colors:e[a[i].value].colors});else{for(var j=0;j<d.length;j++){for(var k=!1,l=d[j],m=0;m<h.length;m++){var n=h[m].colors;if(n==l){k=!0;break}}if(!k)break}h.push({ykeys:a[i].value,labels:a[i].name,colors:k?d[0]:d[j]})}0==h.length&&(h=[{}]),c["colors-mapping"]=h,c.xkey="date",a.length>0&&delete c.data,a&&a.length>0&&(c["available-units"]={si:a[0].availableUnits.si,us:a[0].availableUnits.us})},options:{closeOnSelect:!1,groupBy:"dataStream",multiple:"true",callback:"multiSelectCallBack",widgetName:"bar",limit:20,limitTo:50}}]},{type:"section",htmlClass:"col-xs-12",items:[{key:"aggregation-range",condition:"model['data-type'] == 'aggregate'",type:"strapselect",placeholder:"Select the aggregation range for the streams data you are charting.",titleMap:[{value:"1800000",name:"30 minutes"},{value:"3600000",name:"1 hour"},{value:"14400000",name:"4 hours"}]}]}]},{title:"X",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12",items:["xkey","xlabel-angle"]}]}]},{title:"Y",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:["pre-units","ymin",{key:"stacked",type:"radios-inline",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]}]}]}]},{title:"Legend",items:[{type:"radios-inline",key:"show-legend",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]},{type:"section",htmlClass:"",items:[{key:"colors-mapping",title:"Legend Details",add:null,remove:null,items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12 col-sm-4",items:[{key:"colors-mapping[].ykeys",title:"Channel"}]},{type:"section",
htmlClass:"col-xs-12 col-sm-4",items:[{key:"colors-mapping[].labels",title:"Legend Label"}]},{type:"section",htmlClass:"col-xs-12 col-sm-4",items:[{key:"colors-mapping[].colors",title:"Color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}}]}]}]}]}]},{title:"Grid",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:[{type:"radios-inline",key:"grid",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]},{type:"radios-inline",key:"axes",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]},{key:"grid-text-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}}]},{type:"section",htmlClass:"col-xs-6",items:[{key:"grid-text-family",notitle:!1,type:"strapselect",titleMap:[{value:"Arial",name:"Arial"},{value:"Helvetica",name:"Helvetica"},{value:"Times New Roman",name:"Times New Roman"},{value:"Courier New",name:"Courier New"},{value:"Courier",name:"Courier"},{value:"Verdana",name:"Verdana"},{value:"Georgia",name:"Georgia"},{value:"Palatino",name:"Palatino"},{value:"Garamond",name:"Garamond"},{value:"Bookman",name:"Bookman"},{value:"Comic Sans MS",name:"Comic Sans MS"},{value:"Trebuchet MS",name:"Trebuchet MS"},{value:"Arial Black",name:"Arial Black"},{value:"Impact",name:"Impact"},{value:"Sans-Serif",name:"Sans-Serif"},{value:"Source Sans Pro",name:"Source Sans Pro"}]},{key:"grid-text-weight",notitle:!1,type:"strapselect",titleMap:[{value:"normal",name:"Normal"},{value:"bold",name:"Bold"}]},"grid-text-size"]}]}]},{title:"Goals",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12",items:[{key:"custom-goals",title:"Fill Colors & Goals",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:[{key:"custom-goals[].goal-line-colors",title:"Colors",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}}]},{type:"section",htmlClass:"col-xs-6",items:[{key:"custom-goals[].goals",onFieldLoad:function(a,b,c){if(c["default-metric-value"]&&c["default-metric-value"]!=c["display-metric-value"]&&c["available-units"]){var d=c["available-units"][c["default-metric-value"]],e=c["available-units"][c["display-metric-value"]];d!==e&&(c[b.key[0]][b.key[1]][b.key[2]]=getConversionFunction(d,e)(c[b.key[0]][b.key[1]][b.key[2]]))}}}]}]}]}]},{type:"section",htmlClass:"col-xs-6",items:["goal-stroke-width"]}]}]},{title:"Box Properties",items:["boxLabel"]}]}],schema:{type:"object",title:"Schema",properties:{boxLabel:{title:"Box label",type:"string",description:"Define your widget box title."},boxBorder:{title:"Box Border",type:"hidden",default:"true",description:"Define your widget box border."},stream:{title:"Channels",type:"array",items:{type:"string"},description:"",placeholder:" "},data:{title:"Data",type:"string",description:"Data to plot in case of static data.This is an array of objects, containing x and y attributes as described by the xkey and ykeys options. The order in which you provide the data is the order in which the bars are displayed.","x-schema-form":{type:"textarea",placeholder:"[{ y: '2006', a: 100, b: 90 },{ y: '2007', a: 75,  b: 65 }, { y: '2008', a: 50,  b: 40 }]"}},"parse-time":{title:"Parse time",type:"hidden",default:"true",description:"Set to false to skip time/date parsing for X values, instead treating them as an equally-spaced series."},xkey:{title:"X key",type:"string",description:"A string containing the name of the attribute that contains X labels.",default:"date"},"colors-mapping":{title:"Colors",type:"array",default:[],description:"",items:{type:"object",properties:{colors:{title:"Colors",type:"string",format:"color",validationMessage:"Invalid Color"},labels:{title:"Labels",type:"string"},ykeys:{title:"Channel",readonly:!0,type:"string"}}}},stacked:{title:"Stacked",type:"string",default:"false",description:"Set to true to draw bars stacked vertically."},"hide-hover":{title:"Hide hover",default:"auto",type:"hidden",description:"Set to Never to always show a hover legend. Set to 'auto' to only show the hover legend when the mouse cursor is over the chart. Set to 'always' to never show a hover legend."},"show-legend":{title:"Show Legend",type:"string",default:"true",description:"Set visibility of the legend."},"hover-callback":{title:"Hover callback",type:"string",description:"Provide a function on this option to generate custom hover legends. The function will be called with the index of the row under the hover legend, the options object passed to the constructor as arguments, a string containing the default generated hover legend content HTML, and an object containing the original data for the row as passed in the data option. hoverCallback: function (index, options, content, row) {return 'sin(' + row.x + ')='+ row.y}"},axes:{title:"Axes",type:"string",description:"Set to false to disable drawing the x and y axes.",default:"true"},grid:{title:"Grid",type:"string",description:"Set to false to disable drawing the horizontal grid lines.",default:"true"},"grid-text-color":{title:"Grid text color",type:"string",description:"Set the color of the axis labels (default: #888).",format:"color",default:"#888",validationMessage:"Invalid Color"},"grid-text-size":{title:"Grid text size",type:"number",description:"Set the point size of the axis labels (default: 12).",default:12},"grid-text-family":{title:"Grid text family",type:"string",description:"Set the font family of the axis labels (default: sans-serif).",default:"Source Sans Pro",placeholder:" "},"grid-text-weight":{title:"Grid text weight",type:"string",description:"Set the font weight of the axis labels (default: normal).",default:"normal",placeholder:" "},ymax:{title:"Y maximum value",type:"string",default:"auto",description:"Max. bound for Y-values. Alternatively, set this to 'auto' to compute automatically, or 'auto [num]' to automatically compute and ensure that the max y-value is at least [num]."},ymin:{title:"Y minimum value",type:"string",default:"auto 0",description:"Min. bound for Y-values. Alternatively, set this to 'auto' to compute automatically, or 'auto [num]' to automatically compute and ensure that the min y-value is at most [num]. You can use this to create graphs with false origins."},"post-units":{title:"Post units",type:"string",description:"Set to a string value (eg: '%') to add a label suffix all y-labels."},"pre-units":{title:"Pre units",type:"string",description:"Set to a string value (eg: '$') to add a label prefix all y-labels."},"xlabel-angle":{title:"X label angle",type:"number",default:0,description:"The angle in degrees from horizontal to draw x-axis labels."},"ylabel-format":{title:"Y label Format",type:"string",description:"A function that accepts y-values and formats them for display as y-axis labels. function (y) { return y.toString() + 'km'; }"},"goal-stroke-width":{title:"Goal stroke width",type:"number",default:1,description:"Width, in pixels, of the goal lines."},"custom-goals":{title:"Goals",type:"array",description:"Goals: A list of y-values to draw as horizontal 'goal' lines on the chart. goals: [1.0, -1.0] <br/>Colors: Array of color values to use for the goal line colors.",default:[{"goal-line-colors":"#666633",goals:""},{"goal-line-colors":"#999966",goals:""},{"goal-line-colors":"#cc6666",goals:""},{"goal-line-colors":"#663333",goals:""}],items:{type:"object",properties:{"goal-line-colors":{title:"Goal Line Colors",type:"string",format:"color",validationMessage:"Invalid Color",default:"#666633"},goals:{title:"Goals",type:"number"}}}}},required:["xkey","ykeys","labels"]}},{name:"area",label:"Area Chart",class:"scriptr-chart",commonData:!0,show:!0,defaults:{type:"area","on-format-data":"return data;","parse-time":"true","data-type":"raw","data-format":"morris","schema-for":"area","fetch-from-date-param":"from_date","fetch-to-date-param":"to_date","display-metric-param":"display_metric","fetch-data-interval":300,boxLabel:"Area Chart",boxBorder:!0,xkey:"y",ykeys:'["a", "b"]',labels:'["Serie A", "Serie B"]',colors:["#5fc100","#005487"],transport:"wss","grid-text-family":"Arial",data:'[{"y":2000,"a":64,"b":82},{"y":2003,"a":53,"b":48},{"y":2004,"a":81,"b":58},{"y":2005,"a":68,"b":72},{"y":2008,"a":52,"b":60},{"y":20011,"a":55,"b":30},{"y":2013,"a":79,"b":40}]',"hide-hover":"auto","show-legend":"true"},box:{sizeX:2,sizeY:3,minSizeX:2,minSizeY:2},imgSrc:"//cdn.rawgit.com/scriptrdotio/onset-static-resources/15759895/images/area-chart.svg",form:[{type:"tabs",tabs:[{title:"Data",items:[{type:"section",htmlClass:"col-xs-12",items:[{key:"stream",type:"uiselectmultiple",placeholder:"",onChange:function(a,b,c){for(var d=["#CC5464","#FCC717","#38B9D6","#1DBC68","#E90088"],e={},f=c["colors-mapping"],g=0;g<f.length;g++)f[g].ykeys&&(e[f[g].ykeys]={labels:f[g].labels,colors:f[g].colors});for(var h=[],i=0;i<a.length;i++)if(e[a[i].value])h.push({ykeys:a[i].value,labels:e[a[i].value].labels,colors:e[a[i].value].colors});else{for(var j=0;j<d.length;j++){for(var k=!1,l=d[j],m=0;m<h.length;m++){var n=h[m].colors;if(n==l){k=!0;break}}if(!k)break}h.push({ykeys:a[i].value,labels:a[i].name,colors:k?d[0]:d[j]})}0==h.length&&(h=[{}]),c["colors-mapping"]=h;for(var o="[",p="[",i=0;i<a.length;i++)o+='"'+a[i].value+'"'+(i<a.length-1?" , ":""),p+='"'+a[i].name+'"'+(i<a.length-1?" , ":"");c.ykeys=o+"]",c.labels=p+"]",c.xkey="date",a.length>0&&delete c.data,a&&a.length>0&&(c["available-units"]={si:a[0].availableUnits.si,us:a[0].availableUnits.us})},options:{closeOnSelect:!1,groupBy:"dataStream",multiple:"true",callback:"multiSelectCallBack",widgetName:"area",limit:20,limitTo:50}}]}]},{title:"X",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12",items:["xkey","xlabel-angle"]}]}]},{title:"Y",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:["pre-units","ymin"]},{type:"section",htmlClass:"col-xs-6",items:["post-units","ymax"]}]}]},{title:"Legend",items:[{type:"radios-inline",key:"show-legend",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]},{type:"section",htmlClass:"",items:[{key:"colors-mapping",title:"Legend Details",add:null,remove:null,items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12 col-sm-4",items:[{key:"colors-mapping[].ykeys",title:"Channel"}]},{type:"section",htmlClass:"col-xs-12 col-sm-4",items:[{key:"colors-mapping[].labels",title:"Legend Label"}]},{type:"section",htmlClass:"col-xs-12 col-sm-4",items:[{key:"colors-mapping[].colors",title:"Color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}}]}]}]}]}]},{title:"Grid",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:[{type:"radios-inline",key:"grid",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]},{type:"radios-inline",key:"axes",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]},{key:"grid-text-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}}]},{type:"section",htmlClass:"col-xs-6",items:[{key:"grid-text-family",notitle:!1,type:"strapselect",titleMap:[{value:"Arial",name:"Arial"},{value:"Helvetica",name:"Helvetica"},{value:"Times New Roman",name:"Times New Roman"},{value:"Courier New",name:"Courier New"},{value:"Courier",name:"Courier"},{value:"Verdana",name:"Verdana"},{value:"Georgia",name:"Georgia"},{value:"Palatino",name:"Palatino"},{value:"Garamond",name:"Garamond"},{value:"Bookman",name:"Bookman"},{value:"Comic Sans MS",name:"Comic Sans MS"},{value:"Trebuchet MS",name:"Trebuchet MS"},{value:"Arial Black",name:"Arial Black"},{value:"Impact",name:"Impact"},{value:"Sans-Serif",name:"Sans-Serif"},{value:"Source Sans Pro",name:"Source Sans Pro"}]},{key:"grid-text-weight",notitle:!1,type:"strapselect",titleMap:[{value:"normal",name:"Normal"},{value:"bold",name:"Bold"}]},"grid-text-size"]}]}]},{title:"Lines & Points",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:["line-width",{type:"radios-inline",key:"smooth",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]}]},{type:"section",htmlClass:"col-xs-6",items:["point-size",{key:"point-fill-colors",items:[{key:"point-fill-colors[]",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}}]},{key:"point-stroke-colors",items:[{key:"point-stroke-colors[]",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}}]}]}]}]},{title:"Area",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:[{type:"radios-inline",key:"behave-like-line",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]},{key:"fill-opacity",step:"0.1"}]}]}]},{title:"Goals",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12",items:[{key:"custom-goals",title:"Fill Color & Goals",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:[{key:"custom-goals[].goal-line-colors",title:"Colors",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}}]},{type:"section",htmlClass:"col-xs-6",items:[{key:"custom-goals[].goals",onFieldLoad:function(a,b,c){if(c["default-metric-value"]&&c["default-metric-value"]!=c["display-metric-value"]&&c["available-units"]){var d=c["available-units"][c["default-metric-value"]],e=c["available-units"][c["display-metric-value"]];d!==e&&(c[b.key[0]][b.key[1]][b.key[2]]=getConversionFunction(d,e)(c[b.key[0]][b.key[1]][b.key[2]]))}}}]}]}]}]},{type:"section",htmlClass:"col-xs-6",items:["goal-stroke-width"]}]}]},{title:"Events",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12",items:[{key:"custom-events",title:"Fill Colors & Events",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:[{key:"custom-events[].event-line-colors",title:"Colors",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}}]},{type:"section",htmlClass:"col-xs-6",items:[{key:"custom-events[].events"}]}]}]}]},{type:"section",htmlClass:"col-xs-6",items:["event-stroke-width"]}]}]},{title:"Box Properties",items:["boxLabel"]}]}],schema:{type:"object",title:"Schema",properties:{boxLabel:{title:"Box Label",type:"string",description:"Define your widget box title."},boxBorder:{title:"Box Border",type:"hidden",default:"true",description:"Define your widget box border."},stream:{title:"Channels",type:"array",items:{type:"string"},description:"",placeholder:" "},data:{title:"Data",type:"string",description:"Data series in case of static data.","x-schema-form":{type:"textarea",placeholder:"[{ y: '2006', a: 100, b: 90 },{ y: '2007', a: 75,  b: 65 }, { y: '2008', a: 50,  b: 40 }]"}},"parse-time":{title:"Parse time",type:"hidden",default:"true",description:"Set to false to skip time/date parsing for X values, instead treating them as an equally-spaced series."},xkey:{title:"X key",type:"string",description:"A string containing the name of the attribute that contains date (X) values. Timestamps are accepted in the form of millisecond timestamps (as returned by Date.getTime() or as strings in the following formats: 2012, 2012 Q1, 2012 W1, 2012-02, 2012-02-24, 2012-02-24 15:00, 2012-02-24 15:00:00, 2012-02-24 15:00:00.000. date/time strings can optionally contain a T between the date and time parts, and/or a Z suffix, for compatibility with ISO-8601 dates.",default:"date"},"colors-mapping":{title:"Colors",type:"array",default:[],description:"An array of strings containing HTML-style hex colors for each of the donut segments. Note: if there are fewer colors than segments, the colors will cycle back to the start of the array when exhausted.",items:{type:"object",properties:{colors:{title:"Colors",type:"string",format:"color",validationMessage:"Invalid Color"},labels:{title:"labels",type:"string"},ykeys:{title:"Channel",readonly:!0,type:"string"}}}},"line-width":{title:"Line width",type:"number",default:3,description:"Width of the series lines, in pixels."},"point-size":{title:"Point size",type:"number",default:4,description:"Diameter of the series points, in pixels."},"point-fill-colors":{title:"Point fill colors",type:"array",description:"Colors for the series points. By default uses the same values as lineColors.",items:{format:"color",type:"string",validationMessage:"Invalid Color"}},"point-stroke-colors":{title:"Point Stroke Colors",type:"array",default:["#fff"],description:"Colors for the outlines of the series points. (#ffffff by default).",items:{format:"color",type:"string",validationMessage:"Invalid Color"}},ymax:{title:"Y maximum value",type:"string",default:"auto",description:"Max. bound for Y-values. Alternatively, set this to 'auto' to compute automatically, or 'auto [num]' to automatically compute and ensure that the max y-value is at least [num]."},ymin:{title:"Y minimum value",type:"string",default:"auto 0",description:"Min. bound for Y-values. Alternatively, set this to 'auto' to compute automatically, or 'auto [num]' to automatically compute and ensure that the min y-value is at most [num]. You can use this to create graphs with false origins."},smooth:{title:"Smooth",type:"string",default:"true",description:"Set to false to disable line smoothing."},"hide-hover":{title:"Hide hover",default:"auto",type:"hidden",description:"Set to Never to always show a hover legend. Set to 'auto' to only show the hover legend when the mouse cursor is over the chart. Set to 'always' to never show a hover legend."},"show-legend":{title:"Show Legend",type:"string",default:"true",description:"Set visibility of the legend."},"hover-callback":{title:"Hover callback",type:"string",description:"Provide a function on this option to generate custom hover legends. The function will be called with the index of the row under the hover legend, the options object passed to the constructor as arguments, a string containing the default generated hover legend content HTML, and an object containing the original data for the row as passed in the data option. hoverCallback: function (index, options, content, row) {return 'sin(' + row.x + ')='+ row.y}"},"post-units":{title:"Post units",type:"string",description:"Set to a string value (eg: '%') to add a label suffix all y-labels."},"pre-units":{title:"Pre units",type:"string",description:"Set to a string value (eg: '$') to add a label prefix all y-labels."},xlabels:{title:"X labels",type:"string",default:"auto",description:"Sets the x axis labelling interval. By default the interval will be automatically computed.",format:"uiselect",placeholder:" ",items:[{value:"auto",label:"auto"},{value:"decade",label:"decade"},{value:"year",label:"year"},{value:"month",label:"month"},{value:"week",label:"week"},{value:"day",label:"day"},{value:"hour",label:"hour"},{value:"30min",label:"30min"},{value:"15min",label:"15min"},{value:"10min",label:"10min"},{value:"5min",label:"5min"},{value:"minute",label:"minute"},{value:"30sec",label:"30sec"},{value:"15sec",label:"15sec"},{value:"10sec",label:"10sec"},{value:"5sec",label:"5sec"},{value:"second",label:"second"}]},"xlabel-angle":{title:"X label angle",type:"number",default:0,description:"The angle in degrees from horizontal to draw x-axis labels."},"xlabel-format":{title:"X label format",type:"string",description:"A function that accepts Date objects and formats them for display as x-axis labels. Overrides the default formatter chosen by the automatic labeller or the xLabels option. function (x) { return x.toString(); }"},"ylabel-format":{title:"Y label format",type:"string",description:"A function that accepts y-values and formats them for display as y-axis labels. function (y) { return y.toString() + 'km'; }"},"goal-stroke-width":{title:"Goal stroke width",type:"number",default:1,description:"Width, in pixels, of the goal lines."},"custom-goals":{title:"Goals",type:"array",description:"Goals: A list of y-values to draw as horizontal 'goal' lines on the chart. goals: [1.0, -1.0] <br/>Colors: Array of color values to use for the goal line colors.",default:[{"goal-line-colors":"#666633",goals:""},{"goal-line-colors":"#999966",goals:""},{"goal-line-colors":"#cc6666",goals:""},{"goal-line-colors":"#663333",goals:""}],items:{type:"object",properties:{"goal-line-colors":{title:"Goal Line Colors",type:"string",format:"color",validationMessage:"Invalid Color",default:"#666633"},goals:{title:"Goals",type:"number"}}}},"event-stroke-width":{title:"Event stroke width",type:"number",default:1,description:"Width, in pixels, of the event lines."},"custom-events":{title:"Events",type:"array",description:"Events: A list of x-values to draw as vertical 'event' lines on the chart. ex: ['2012-01-01', '2012-02-01'] <br/>Colors: Array of color values to use for the event line colors.",default:[{"event-line-colors":"#666633",events:""},{"event-line-colors":"#999966",events:""},{"event-line-colors":"#cc6666",events:""},{"event-line-colors":"#663333",events:""}],items:{type:"object",properties:{"event-line-colors":{title:"Event Line Colors",type:"string",format:"color",validationMessage:"Invalid Color"},events:{title:"Events",type:"string"}}}},axes:{title:"Axes",type:"string",description:"Set to false to disable drawing the x and y axes.",default:"true"},grid:{title:"Grid",type:"string",description:"Set to false to disable drawing the horizontal grid lines.",default:"true"},"grid-text-color":{title:"Grid text color",type:"string",description:"Set the color of the axis labels (default: #888).",format:"color",default:"#888",validationMessage:"Invalid Color"},"grid-text-size":{title:"Grid text size",type:"number",description:"Set the point size of the axis labels (default: 12).",default:12},"grid-text-family":{title:"Grid text family",type:"string",description:"Set the font family of the axis labels (default: sans-serif).",default:"Source Sans Pro",placeholder:" "},"grid-text-weight":{title:"Grid text weight",type:"string",description:"Set the font weight of the axis labels (default: normal).",default:"normal",placeholder:" "},"fill-opacity":{title:"Fill opacity",type:"number",default:1,description:"Change the opacity of the area fill color. Accepts values between 0.0 (for completely transparent) and 1.0 (for completely opaque).",minimum:0,maximum:1},"behave-like-line":{title:"Behave like Line",type:"string",default:"false",description:"Set to true to overlay the areas on top of each other instead of stacking them."},"date-format":{title:"Date format",type:"string",description:"A function that accepts millisecond timestamps and formats them for display as chart labels. default is function (x) { return new Date(x).toString() }."}},required:["xkey","ykeys"]}},{name:"donut",label:"Donut Chart",class:"scriptr-chart",commonData:!0,show:!0,defaults:{type:"donut","data-type":"latest","data-format":"morris","schema-for":"donut","fetch-from-date-param":"from_date","fetch-to-date-param":"to_date","fetch-data-interval":300,"on-format-data":"return data;",boxLabel:"Donut Chart",boxBorder:!0,transport:"wss",colors:["#005487","#fba723","#aa241d"],data:'[{label: "Serie A", value: 70}, {label: "Serie B",value: 30 }]',ykeys:["Serie A","Serie B"],"show-legend":"true"},box:{sizeX:2,sizeY:3,minSizeX:2,minSizeY:3},imgSrc:"//cdn.rawgit.com/scriptrdotio/onset-static-resources/97574e7b/images/donut-chart.svg",form:[{type:"tabs",tabs:[{title:"Data",items:[{type:"section",htmlClass:"col-xs-12",items:[{key:"stream",type:"uiselectmultiple",placeholder:"",options:{closeOnSelect:!0,groupBy:"dataStream",multiple:"false",callback:"multiSelectCallBack",widgetName:"donut",limit:20,limitTo:50},onChange:function(a,b,c){for(var d=["#CC5464","#FCC717","#38B9D6","#1DBC68","#E90088"],e={},f=c["colors-mapping"],g=0;g<f.length;g++)f[g].ykeys&&(e[f[g].ykeys]={labels:f[g].labels,colors:f[g].colors});for(var h=[],i=0;i<a.length;i++)if(e[a[i].value])h.push({ykeys:a[i].value,labels:e[a[i].value].labels,colors:e[a[i].value].colors});else{for(var j=0;j<d.length;j++){for(var k=!1,l=d[j],m=0;m<h.length;m++){var n=h[m].colors;if(n==l){k=!0;break}}if(!k)break}h.push({ykeys:a[i].value,labels:a[i].name,colors:k?d[0]:d[j]})}0==h.length&&(h=[{}]),c["colors-mapping"]=h}}]}]},{title:"Format",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12",items:[{key:"background-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}},{key:"label-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}}]}]}]},{title:"Legend",items:[{type:"radios-inline",key:"show-legend",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]},{type:"section",htmlClass:"",items:[{key:"colors-mapping",title:"Legend Details",add:null,remove:null,items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12 col-sm-4",items:[{key:"colors-mapping[].ykeys",title:"Channel"}]},{type:"section",htmlClass:"col-xs-12 col-sm-4",items:[{key:"colors-mapping[].labels",title:"Legend Label"}]},{type:"section",htmlClass:"col-xs-12 col-sm-4",items:[{key:"colors-mapping[].colors",title:"Color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}}]}]}]}]}]},{title:"Box Properties",items:["boxLabel"]}]}],schema:{type:"object",title:"Schema",properties:{"show-legend":{title:"Show Legend",default:"true",type:"string",description:"Set visibility of the legend."},"hover-callback":{title:"Hover callback",type:"string",description:"Provide a function on this option to generate custom hover legends. The function will be called with the index of the row under the hover legend, the options object passed to the constructor as arguments, a string containing the default generated hover legend content HTML, and an object containing the original data for the row as passed in the data option. hoverCallback: function (index, options, content, row) {return 'sin(' + row.x + ')='+ row.y}"},stream:{title:"Channel",type:"string",description:"",placeholder:" "},boxLabel:{title:"Box Label",type:"string",description:"Define your widget box title."},boxBorder:{title:"Box Border",type:"hidden",default:"true",description:"Define your widget box border."},data:{title:"Data",type:"string",description:"Data series in case of static data.","x-schema-form":{type:"textarea",placeholder:"[{ y: '2006', a: 100, b: 90 },{ y: '2007', a: 75,  b: 65 }, { y: '2008', a: 50,  b: 40 }]"}},"colors-mapping":{title:"Colors",type:"array",default:[],description:"An array of strings containing HTML-style hex colors for each of the donut segments. Note: if there are fewer colors than segments, the colors will cycle back to the start of the array when exhausted.",items:{type:"object",properties:{colors:{title:"Colors",type:"string",format:"color",validationMessage:"Invalid Color"},labels:{title:"labels",type:"string"},ykeys:{title:"Channel",readonly:!0,type:"string"}}}},"label-color":{title:"Donut Label Color",type:"string",description:"Donut label color.",format:"color",default:"#eeeeee",validationMessage:"Invalid Color"},"background-color":{title:"Donut Background Color",type:"string",description:"Donut background color.",format:"color",default:"#ffffff",validationMessage:"Invalid Color"}},required:[]}},{name:"gauge",label:"Gauge",class:"scriptr-gauge",commonData:!0,show:!0,defaults:{transport:"wss","on-format-data":"if(data) return data[0].value; else return data;","data-type":"latest","data-format":"live","schema-for":"gauge","display-metric-param":"display_metric","fetch-data-interval":300,boxLabel:"Gauge",boxBorder:!0,data:[{value:30}],"value-font-color":"#005588",height:"99","height-unit":"%"},box:{sizeX:1,sizeY:2,minSizeX:1,minSizeY:2},imgCls:"gauge-img",imgSrc:"//cdn.rawgit.com/scriptrdotio/onset-static-resources/97574e7b/images/gauge.svg",form:[{type:"tabs",tabs:[{title:"Data",items:[{type:"section",htmlClass:"",items:[{key:"stream",type:"uiselect",placeholder:"",options:{closeOnSelect:!0,groupBy:"dataStream",callback:"multiSelectCallBack",widgetName:"gauge"},onChange:function(a,b,c){if(a&&a.length>0){var d=_.findWhere(_.findWhere(JSON.parse(window.localStorage.dataStream),{logger_sn:a.split("-")[0]}).sensors,{selectedStreamValue:a});c["available-units"]={si:d.si_unit,us:d.us_unit}}}}]}]},{title:"Format",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6 col-sm-3",items:["symbol"]},{type:"section",htmlClass:"col-xs-6 col-sm-3",items:["value-min-font-size"]},{type:"section",htmlClass:"col-xs-6 col-sm-3",items:[{key:"value-font-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}}]},{type:"section",htmlClass:"col-xs-6 col-sm-3",items:[{key:"hide-value",type:"radios-inline",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]}]}]},{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12",items:[{type:"help",helpvalue:"<hr/>"}]}]},{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-4",items:["label"]},{type:"section",htmlClass:"col-xs-4",items:["label-min-font-size"]},{type:"section",htmlClass:"col-xs-4",items:[{key:"label-font-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}}]}]},{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12",items:[{type:"help",helpvalue:"<hr/>"}]}]},{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:[{key:"value-font-family",notitle:!1,type:"strapselect",titleMap:[{value:"Arial",name:"Arial"},{value:"Helvetica",name:"Helvetica"},{value:"Times New Roman",name:"Times New Roman"},{value:"Courier New",name:"Courier New"},{value:"Courier",name:"Courier"},{value:"Verdana",name:"Verdana"},{value:"Georgia",name:"Georgia"},{value:"Palatino",name:"Palatino"},{value:"Garamond",name:"Garamond"},{value:"Bookman",name:"Bookman"},{value:"Comic Sans MS",name:"Comic Sans MS"},{value:"Trebuchet MS",name:"Trebuchet MS"},{value:"Arial Black",name:"Arial Black"},{value:"Impact",name:"Impact"},{value:"Sans-Serif",
name:"Sans-Serif"},{value:"Source Sans Pro",name:"Source Sans Pro"}]}]},{type:"section",htmlClass:"col-xs-6",items:[{key:"gauge-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}}]}]},{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12",items:[{type:"help",helpvalue:"<hr/>"}]}]},{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:[{key:"format-number",type:"radios-inline",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]}]},{type:"section",htmlClass:"col-xs-6",items:["decimals"]}]},{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:[{key:"human-friendly",type:"radios-inline",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]}]},{type:"section",htmlClass:"col-xs-6",items:["human-friendly-decimal"]}]}]},{title:"Min/Max",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:[{key:"min",onFieldLoad:function(a,b,c){if(c["default-metric-value"]&&c["default-metric-value"]!=c["display-metric-value"]&&c["available-units"]){var d=c["available-units"][c["default-metric-value"]],e=c["available-units"][c["display-metric-value"]];d!==e&&(c[b.key[0]]=getConversionFunction(d,e)(c[b.key[0]])),c.unit&&c.unit!=e&&(c.unit=e)}}},"min-label-min-font-size",{key:"hide-min-max",type:"radios-inline",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]}]},{type:"section",htmlClass:"col-xs-6",items:[{key:"max",onFieldLoad:function(a,b,c){if(c["default-metric-value"]&&c["default-metric-value"]!=c["display-metric-value"]&&c["available-units"]){var d=c["available-units"][c["default-metric-value"]],e=c["available-units"][c["display-metric-value"]];d!==e&&(c[b.key[0]]=getConversionFunction(d,e)(c[b.key[0]])),c.unit&&c.unit!=e&&(c.unit=e)}}},"max-label-min-font-size",{key:"reverse",type:"radios-inline",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]}]}]}]},{title:"Sectors",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:[{key:"pointer",type:"radios-inline",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]}]},{type:"section",htmlClass:"col-xs-6",items:[{key:"gauge-width-scale",step:"0.1"}]}]},{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:[{key:"donut",type:"radios-inline",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]}]},{type:"section",htmlClass:"col-xs-6",items:["donut-start-angle"]}]},{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:[{key:"no-gradient",type:"radios-inline",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]}]},{type:"section",htmlClass:"col-xs-6",items:[{key:"level-colors",items:[{key:"level-colors[]",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}}],style:{add:"btn-primary btn-sm pull-left"}}]}]},{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:[{key:"custom-sectors",title:"",items:[{key:"custom-sectors.percents",title:"Custom percent",type:"radios-inline",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]}]}]},{type:"section",htmlClass:"col-xs-6",items:[{key:"custom-sectors",title:"",items:[{key:"custom-sectors.ranges",startEmpty:!0,title:"Custom Ranges",style:{add:"btn-primary btn-sm pull-left"},items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:[{key:"custom-sectors.ranges[].color",title:"color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}}]},{type:"section",htmlClass:"col-xs-6",items:[{key:"custom-sectors.ranges[].lo",onFieldLoad:function(a,b,c){if(c["default-metric-value"]&&c["default-metric-value"]!=c["display-metric-value"]&&c["available-units"]){var d=c["available-units"][c["default-metric-value"]],e=c["available-units"][c["display-metric-value"]];d!==e&&(c[b.key[0]][b.key[1]][b.key[2]][b.key[3]]=getConversionFunction(d,e)(c[b.key[0]][b.key[1]][b.key[2]][b.key[3]])),c.unit&&c.unit!=e&&(c.unit=e)}}}]},{type:"section",htmlClass:"col-xs-6",items:[{key:"custom-sectors.ranges[].hi",onFieldLoad:function(a,b,c){if(c["default-metric-value"]&&c["default-metric-value"]!=c["display-metric-value"]&&c["available-units"]){var d=c["available-units"][c["default-metric-value"]],e=c["available-units"][c["display-metric-value"]];d!==e&&(c[b.key[0]][b.key[1]][b.key[2]][b.key[3]]=getConversionFunction(d,e)(c[b.key[0]][b.key[1]][b.key[2]][b.key[3]])),c.unit&&c.unit!=e&&(c.unit=e)}}}]}]}]}]}]}]}]},{title:"Shadow",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6 col-sm-3",items:[{key:"show-inner-shadow",type:"radios-inline",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]}]},{type:"section",htmlClass:"col-xs-6 col-sm-3",items:["shadow-size"]},{type:"section",htmlClass:"col-xs-6 col-sm-3",items:[{key:"shadow-opacity",step:"0.1"}]},{type:"section",htmlClass:"col-xs-6 col-sm-3",items:["shadow-vertical-offset"]}]}]},{title:"Animation",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:[{key:"start-animation-type",notitle:!1,type:"strapselect",titleMap:[{value:"linear",name:"linear"},{value:">",name:">"},{value:"<",name:"<"},{value:"<>",name:"<>"},{value:"bounce",name:"bounce"}]},{key:"refresh-animation-type",notitle:!1,type:"strapselect",titleMap:[{value:"linear",name:"linear"},{value:">",name:">"},{value:"<",name:"<"},{value:"<>",name:"<>"},{value:"bounce",name:"bounce"}]},{key:"counter",type:"radios-inline",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]}]},{type:"section",htmlClass:"col-xs-6",items:["start-animation-time","refresh-animation-time"]}]}]},{title:"Box Properties",items:["boxLabel"]}]}],schema:{type:"object",title:"Schema",properties:{boxLabel:{title:"Box Label",type:"string",description:"Define your widget box title."},boxBorder:{title:"Box Border",type:"hidden",default:"true",description:"Define your widget box border."},data:{title:"Static data",type:"number",description:"Gauge static value to show"},stream:{title:"Channel",type:"string",description:"",placeholder:" "},"value-font-color":{title:"Value color",type:"string",default:"#005386",format:"color",description:"Color of the gauge value text",validationMessage:"Invalid Color"},min:{title:"Gauge min",type:"number",default:0,description:"Minimum gauge value."},max:{title:"Gauge max",type:"number",default:100,description:"Maximum gauge value."},"hide-min-max":{title:"Hide min/max",type:"string",default:"false",description:"Select true to hide min and max values (bool)"},"hide-value":{title:"Hide value",type:"string",default:"false",description:"Select true to hide gauge value"},"show-inner-shadow":{title:"Show shadow",type:"string",default:"false",description:"Show gauge inner shadow"},"gauge-color":{title:"Gauge background",type:"string",format:"color",description:"Background color of gauge.",validationMessage:"Invalid Color"},"custom-sectors":{title:"Custom sectors",type:"object",properties:{percents:{title:"Percents",type:"string",default:"false",description:"Set to true for to have percent based sectors."},ranges:{type:"array",items:{type:"object",properties:{color:{title:"Sector Color",type:"string",format:"color",required:!0,validationMessage:"Invalid Color"},lo:{title:"Low",type:"number",required:!0},hi:{title:"High",type:"number",required:!0}}}}}},"shadow-size":{title:"Shadow size",type:"number",default:5,description:"Gauge inner shadow size."},"shadow-opacity":{title:"Shadow opacity",type:"number",default:.2,description:"Shadow opacity, values 0 ~ 1",minimum:0,maximum:1},label:{title:"Label",type:"string",description:"Text to show below gauge value."},"label-font-color":{title:"Label color",type:"string",description:"Color of label under the value",format:"color",validationMessage:"Invalid Color"},"start-animation-type":{title:"Start animation",type:"string",default:"linear",description:"Select type of initial animation.",placeholder:" "},"refresh-animation-type":{title:"Refresh animation",type:"string",default:"linear",description:"Select type of refresh animation.",placeholder:" "},"value-font-family":{title:"Gauge font family",type:"string",default:"Arial",placeholder:" ",description:"Font family of the gauge."},"value-min-font-size":{title:"Value size",type:"number",default:12,description:"Minimum font size for the value."},"label-min-font-size":{title:"Label size",type:"number",default:12,description:"Minimum font size for the label."},"min-label-min-font-size":{title:"Min label size",type:"number",default:12,description:"Minimum font size for the minimum label."},"max-label-min-font-size":{title:"Max label size",type:"number",default:12,description:"Minimum font size for the maximum label."},"gauge-width-scale":{title:"Width scale",type:"number",default:1,description:"Gauge width scale."},"shadow-vertical-offset":{title:"Shadow vertical offset",type:"number",default:3,description:"Defines how much is shadow offset from top."},"level-colors":{title:"Level colors",type:"array",minItems:1,items:{type:"string",format:"color",validationMessage:"Invalid Color"},format:"color",default:["#005588","#5fc100","#fe4444"],description:"Colors of indicator, from lower to upper."},"relative-gauge-size":{title:"Relative gauge size",type:"string",default:"true",description:"Set to true to use sector-based color change, false to use gradual color change."},"no-gradient":{title:"No gradient",type:"string",default:"false",description:"Set to true to use sector-based color change, false to use gradual color change."},"start-animation-time":{title:"Start animation time",type:"number",default:700,description:"Duration of initial load animation in ms."},"refresh-animation-time":{title:"Refresh animation time",type:"number",default:700,description:"Length of refresh animation in ms."},donut:{title:"Donut",type:"string",default:"false",description:"Turn the gauge into a full circle donut."},"donut-start-angle":{title:"Donut start angle",type:"number",default:90,description:"Angle to start from when in donut mode."},width:{title:"Width",type:"number",description:"Gauge width"},height:{title:"Height",type:"number",description:"Gauge height."},reverse:{title:"Reverse",type:"string",default:"false",description:"Set to trueto swap max and min (with max appearing on the left, min on the right)."},decimals:{title:"Decimals",type:"number",default:0,description:"Quantity of decimal numbers to show."},symbol:{title:"Symbol",type:"string",description:"Unit of measure that will be appended to value."},"format-number":{title:"Format number",type:"string",default:"false",description:"Set to true to format numbers."},"human-friendly":{title:"Human friendly",type:"string",default:"false",description:"Set to true to show shorthand big numbers (300K instead of 300XXX)."},"human-friendly-decimal":{title:"Human friendly decimals",type:"number",default:0,description:"Number of decimal places for our human friendly number to contain."},pointer:{title:"Pointer",type:"string",default:"false",description:"Set to true to show value pointer."},counter:{title:"Counter",type:"string",default:"false",description:"Set to true to increase numbers one by one."}},required:["level-colors"]}},{name:"thermometer",label:"Thermometer",class:"scriptr-thermometer",commonData:!0,show:!0,defaults:{transport:"wss","on-format-data":"if(data) return data[0].value; else return data;","data-type":"latest","data-format":"live","schema-for":"thermometer","display-metric-param":"display_metric","fetch-data-interval":300,data:[{value:0}],value:80,boxLabel:"Thermometer",boxBorder:!0,step:30,unit:"°C","custom-sectors":[{color:"#005588",lo:0,hi:30},{color:"#aa241d",lo:30,hi:60},{color:"#ffa500",lo:60,hi:90}]},box:{sizeX:1,sizeY:3,minSizeX:1,minSizeY:3,maxSizeX:1},imgCls:"thermometer-img",imgSrc:"//cdn.rawgit.com/scriptrdotio/onset-static-resources/97574e7b/images/thermometer.svg",form:[{type:"tabs",tabs:[{title:"Data",items:[{type:"section",htmlClass:"",items:[{key:"stream",type:"uiselect",placeholder:"",options:{closeOnSelect:!0,groupBy:"dataStream",callback:"multiSelectCallBack",widgetName:"thermometer"},onChange:function(a,b,c){if(a&&a.length>0){var d=_.findWhere(_.findWhere(JSON.parse(window.localStorage.dataStream),{logger_sn:a.split("-")[0]}).sensors,{selectedStreamValue:a});c["available-units"]={si:d.si_unit,us:d.us_unit}}}}]}]},{title:"Format",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12 col-sm-6",items:[{key:"out-of-range-color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}}]},{type:"section",htmlClass:"col-xs-12 col-sm-6",items:[{type:"section",htmlClass:"",items:["step"]},{type:"section",htmlClass:"",items:[{key:"custom-sectors",title:"Fill Color",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-4",items:[{key:"custom-sectors[].color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}}]},{type:"section",htmlClass:"col-xs-4",items:[{key:"custom-sectors[].lo",onFieldLoad:function(a,b,c){if(c["default-metric-value"]&&c["default-metric-value"]!=c["display-metric-value"]&&c["available-units"]){var d=c["available-units"][c["default-metric-value"]],e=c["available-units"][c["display-metric-value"]];d!==e&&(c[b.key[0]][b.key[1]][b.key[2]]=getConversionFunction(d,e)(c[b.key[0]][b.key[1]][b.key[2]])),c.unit&&c.unit!=e&&(c.unit=e)}}}]},{type:"section",htmlClass:"col-xs-4",items:[{key:"custom-sectors[].hi",onFieldLoad:function(a,b,c){if(c["default-metric-value"]&&c["default-metric-value"]!=c["display-metric-value"]&&c["available-units"]){var d=c["available-units"][c["default-metric-value"]],e=c["available-units"][c["display-metric-value"]];d!==e&&(c[b.key[0]][b.key[1]][b.key[2]]=getConversionFunction(d,e)(c[b.key[0]][b.key[1]][b.key[2]])),c.unit&&c.unit!=e&&(c.unit=e)}}}]}]}]}]}]}]}]},{title:"Box Properties",items:["boxLabel"]}]}],schema:{type:"object",title:"Schema",properties:{data:{title:"Thermometer Value",type:"string",description:"Thermometer Value (0 to 100)"},stream:{title:"Channel",type:"string",description:"",placeholder:" "},height:{title:"Height",type:"number",description:"Set the height of Thermometer."},unit:{title:"Unit",type:"hidden",default:"°C",description:"Set the unit value of Thermometer."},"out-of-range-color":{title:"Out Of Range Color",type:"string",description:"Set the default color for out of range values (default: #005588).",format:"color",default:"#5fc100",validationMessage:"Invalid Color"},"custom-sectors":{title:"Custom sectors",type:"array",items:{type:"object",properties:{color:{title:"Color",type:"string",format:"color",required:!0,validationMessage:"Invalid Color"},lo:{title:"Low",type:"number",required:!0},hi:{title:"High",type:"number",required:!0}}}},step:{title:"Interval",type:"number",description:"Set the interval value between ticks."},boxLabel:{title:"Box Label",type:"string",description:"Define your widget box title."},boxBorder:{title:"Box Border",type:"hidden",default:"true",description:"Define your widget box border."}},required:[]}},{name:"plotly",label:"Wind Rose",class:"scriptr-plotly",commonData:!0,show:!0,defaults:{transport:"wss","data-type":"raw","schema-for":"windrose","data-format":"windrose","fetch-from-date-param":"from_date","fetch-to-date-param":"to_date","display-metric-param":"display_metric","fetch-data-interval":300,"on-format-data":"return data;",boxLabel:"Wind Rose",boxBorder:!0,"retrieved-data":[{direction:"E",speeds:[2,3,15,17]},{direction:"ESE",speeds:[24,8,4]},{direction:"SSE",speeds:[2.5,7,16]},{direction:"S",speeds:[3,8,2,1,9,11]},{direction:"SSW",speeds:[13,3,7.5,8]},{direction:"WSW",speeds:[21,14,9]},{direction:"W",speeds:[7,0,8,9,15,19,11]},{direction:"WNW",speeds:[4,17,21]},{direction:"NNW",speeds:[14,7]},{direction:"N",speeds:[20,0,5,9,7]},{direction:"NNE",speeds:[1,.5,6.5]},{direction:"ENE",speeds:[3.5,30,15]}]},box:{sizeX:2,sizeY:4,minSizeX:2,minSizeY:4},imgCls:"",imgSrc:"//cdn.rawgit.com/scriptrdotio/onset-static-resources/6106965d/images/wind-rose.svg",form:[{type:"tabs",tabs:[{title:"Data",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-6",items:[{key:"windDirection",notitle:!1,type:"uiselectmultiple",placeholder:"",options:{closeOnSelect:!0,groupBy:"dataStream",callback:"multiSelectCallBack",widgetName:"plotly",widgetField:"Wind Direction",limit:"1",limitTo:50},onChange:function(a,b,c){var d=[];a&&d.push(a[0].value),c.windSpeed&&d.push(c.windSpeed[0]),c.stream=d}}]},{type:"section",htmlClass:"col-xs-6",items:[{key:"windSpeed",notitle:!1,type:"uiselectmultiple",options:{closeOnSelect:!0,groupBy:"dataStream",callback:"multiSelectCallBack",widgetName:"plotly",widgetField:"Wind Speed",limit:"1",limitTo:50},onChange:function(a,b,c){var d=[];if(a&&d.push(a[0].value),c.windDirection&&d.push(c.windDirection[0]),c.stream=d,a&&a.length>0){var e=_.findWhere(_.findWhere(JSON.parse(window.localStorage.dataStream),{logger_sn:a[0].value.split("-")[0]}).sensors,{selectedStreamValue:a[0].value});c["available-units"]={si:e.si_unit,us:e.us_unit}}}}]}]}]},{title:"Format",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12 col-sm-6",items:["font-size",{key:"show-legend",type:"radios-inline",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]}]},{type:"section",htmlClass:"col-xs-12 col-sm-6",items:[{key:"custom-ranges",title:"Fill Color & Ranges",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-4",items:[{key:"custom-ranges[].color",title:"color",colorFormat:"hex3",spectrumOptions:{showInput:!0,showAlpha:!1,allowEmpty:!0,showPalette:!0,preferredFormat:"hex3",palette:[["#fce94f","#fcaf3e","#e9b96e"],["#8ae234","#729fcf","#ad7fa8"],["#ef2929","#888a85","#deface"]]}}]},{type:"section",htmlClass:"col-xs-4",items:[{key:"custom-ranges[].lo",onFieldLoad:function(a,b,c){if(c["default-metric-value"]&&c["default-metric-value"]!=c["display-metric-value"]&&c["available-units"]){var d=c["available-units"][c["default-metric-value"]],e=c["available-units"][c["display-metric-value"]];d!==e&&(c[b.key[0]][b.key[1]][b.key[2]]=getConversionFunction(d,e)(c[b.key[0]][b.key[1]][b.key[2]])),c.unit&&c.unit!=e&&(c.unit=e)}}}]},{type:"section",htmlClass:"col-xs-4",items:[{key:"custom-ranges[].hi",onFieldLoad:function(a,b,c){if(c["default-metric-value"]&&c["default-metric-value"]!=c["display-metric-value"]&&c["available-units"]){var d=c["available-units"][c["default-metric-value"]],e=c["available-units"][c["display-metric-value"]];d!==e&&(c[b.key[0]][b.key[1]][b.key[2]]=getConversionFunction(d,e)(c[b.key[0]][b.key[1]][b.key[2]])),c.unit&&c.unit!=e&&(c.unit=e)}}}]}]}]}]}]}]},{title:"Box Properties",items:["boxLabel"]}]}],schema:{type:"object",title:"Schema",properties:{stream:{title:"Stream",type:"hidden"},"font-size":{title:"Font Size",type:"number",default:16,description:"Set the font size of the wind rose (in px)."},windSpeed:{title:"Wind Speed Channel",type:"array",items:{type:"string"},description:"",placeholder:" "},windDirection:{title:"Wind Direction Channel",type:"array",items:{type:"string"},description:"",placeholder:" "},"show-legend":{title:"Show Legend",type:"string",default:"true",description:"Set visibility of the legend."},boxLabel:{title:"Box Label",type:"string",description:"Define your widget box title."},boxBorder:{title:"Box Border",type:"hidden",default:"true",description:"Define your widget box border."},"custom-ranges":{title:"Custom Ranges",type:"array",default:[{color:"#00476b",lo:0,hi:2},{color:"#005487",lo:2,hi:4},{color:"#006699",lo:4,hi:6},{color:"#0082b5",lo:6,hi:8},{color:"#0294c1",lo:8,hi:10},{color:"#06a9ce",lo:10,hi:20}],items:{type:"object",properties:{color:{title:"Sector Color",type:"string",format:"color",required:!0,validationMessage:"Invalid Color"},lo:{title:"Low",type:"number",required:!0},hi:{title:"High",type:"number",required:!0}}}}},required:[]}},{name:"grid",label:"Grid",class:"scriptr-grid",show:!0,commonData:!0,defaults:{"columns-definition":'[{headerName: "Name", field: "name", "minWidth": 110},{headerName: "Model", field: "model", "minWidth": 110},{headerName: "Price", field: "price", "minWidth": 110}]',"row-data":'[{name: "Toyota", model: "Celica", price: 35000},{name: "Ford", model: "Mondeo", price: 32000},{name: "Porsche", model: "Boxter", price: 72000}]',"data-type":"raw","data-format":"morris","schema-for":"grid","fetch-data-interval":300,boxLabel:"Grid",boxBorder:!0,"fixed-height":"false","on-format-data":'return {"documents":data, "count": data.length};',"pagination-page-size":"20",transport:"wss","cell-editable":!1,"enable-client-side-sorting":!0,pagination:"true","enable-server-side-sorting":!1,"enable-server-side-filter":!1,"enable-col-resize":"false"},box:{sizeX:2,sizeY:3,minSizeX:2,minSizeY:3},imgCls:"grid-img",imgSrc:"//cdn.rawgit.com/scriptrdotio/onset-static-resources/97574e7b/images/grid.svg",form:[{type:"tabs",tabs:[{title:"Data",items:[{type:"section",htmlClass:"",items:[{key:"stream",type:"uiselectmultiple",placeholder:"",onChange:function(a,b,c){var e=[];e.push({headerName:"Date",field:"date",minWidth:110,cellRenderer:function(a,b){return moment(d).format("YYYY-MM-DD HH:mm")}}),_.forEach(a,function(a){e.push({headerName:a.name,field:a.value,minWidth:110})}),e.length>0&&(c["columns-definition"]=JSON.stringify(e),console.log("-------model[columns-definition]",c["columns-definition"]),delete c["row-data"])},options:{closeOnSelect:!1,groupBy:"dataStream",multiple:"true",callback:"multiSelectCallBack",widgetName:"grid",limitTo:50,limit:8}}]}]},{title:"Format",items:[{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12",items:[{key:"pagination",type:"radios-inline",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]}]}]},{type:"section",htmlClass:"row",items:[{type:"section",htmlClass:"col-xs-12",items:["pagination-page-size",{key:"enable-server-side-sorting",type:"radios-inline",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]},{key:"enable-server-side-filter",type:"radios-inline",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]},{key:"enable-col-resize",type:"radios-inline",titleMap:[{value:"true",name:"True"},{value:"false",name:"False"}]}]}]}]},{title:"Box Properties",items:["boxLabel"]}]}],schema:{type:"object",title:"Schema",properties:{boxLabel:{title:"Box Label",type:"string",description:"Define your widget box title."},boxBorder:{title:"Box Border",type:"hidden",default:"true",description:"Define your widget box border."},stream:{title:"Channels",type:"array",items:{type:"string"},description:"",placeholder:" "},"columns-definition":{title:"Columns definition",type:"string",description:"Series of data (Each column in the grid is defined using a column definition).","x-schema-form":{type:"textarea",placeholder:"[{'headerName': 'Name', 'field': 'name'}, {'headerName': 'Model', 'field': 'model'}, {'headerName': 'Price', 'field': 'price', 'type': 'numeric'}]"}},"row-data":{title:"Row data",type:"string",description:"You pass static data to the grid.","x-schema-form":{type:"textarea",placeholder:"[{'name': 'Golf', 'model': 'GT', 'price' : '10000'}, {'name': 'BMW', 'model': 'Z3', 'price' : '20000'}]"}},"enable-client-side-sorting":{title:"Enable client Side Sorting",type:"string",description:"Turn on client sorting for the grid."},"enable-client-side-filter":{title:"Enable Client Side Filter",type:"string",description:"Turn on client side filter."},"enable-add-row":{title:"Enable Add Row",type:"hidden",description:"Turn on insert row."},"enable-delete-row":{title:"Enable Delete Row",type:"hidden",description:"Turn on delete row."},"cell-editable":{title:"Cell Editable",type:"hidden",description:"Turn on cell editing."},"row-model-selection":{title:"Row Model Selection",type:"hidden",description:"Set to either 'single' or 'multiple' in case of backend data.",default:"Source Sans Pro",placeholder:" "},"suppress-filter":{title:"Suppress filer",type:"hidden",description:"Hide column filter."},"add-params":{title:"on-add API Params",type:"hidden",description:"On add API params.","x-schema-form":{placeholder:"Ex: {'id' : '599865'}"}},"delete-params":{title:"on-delete API Params",type:"hidden",description:"On delete API params.","x-schema-form":{placeholder:"Ex: {'id' : '599865'}"}},"edit-params":{title:"on-edit API Params",type:"hidden",description:"On edit API params.","x-schema-form":{placeholder:"Ex: {'id' : '599865'}"}},"enable-server-side-sorting":{title:"Enable Sorting",type:"string",description:"Turn on server sorting for the grid."},"enable-server-side-filter":{title:"Enable Filter",type:"string",description:"Turn on server side filter."},"enable-col-resize":{title:"Enable Column Resize",type:"string",description:"Enable column resize."},pagination:{title:"Enable Pagination",type:"string",description:"Enable Pagination."},"row-model-type":{title:"Row Model Type",type:"string",description:"The supported ways are 'virtual' and 'pagination' for only non-static data",default:"pagination",placeholder:" "},"pagination-page-size":{title:"Pagination Page Size",type:"string",description:"Number of rows per page."}},required:["columns-definition"]}},{name:"odometer",label:"Odometer",class:"scriptr-odometer",commonData:!0,show:!0,defaults:{transport:"wss",boxLabel:"Odometer","on-format-data":"if(data) return data[0].value; else return data;","data-type":"latest","data-format":"live","display-metric-param":"display_metric",boxBorder:!0,"schema-for":"odometer","fetch-data-interval":300,data:[{value:28022017}],animation:"count",duration:1e3,size:2},box:{sizeX:1,sizeY:2,minSizeX:1,minSizeY:2},imgCls:"odometer-img",imgSrc:"//cdn.rawgit.com/scriptrdotio/onset-static-resources/97574e7b/images/odometer.svg",form:[{type:"tabs",tabs:[{title:"Data",items:[{type:"section",htmlClass:"",items:[{key:"stream",type:"uiselect",placeholder:"",options:{closeOnSelect:!0,groupBy:"dataStream",callback:"multiSelectCallBack",widgetName:"odometer"}}]}]},{title:"Format",items:["duration","animation","size"]},{title:"Box Properties",items:["boxLabel"]}]}],schema:{type:"object",title:"Schema",properties:{boxLabel:{title:"Box Label",type:"string",description:"Define your widget box title."},boxBorder:{title:"Box Border",type:"hidden",default:"true",description:"Define your widget box border."},stream:{title:"Channel",type:"string",description:"",placeholder:" "},data:{title:"Static data",type:"number",description:"Set a static value for Odometer."},duration:{title:"Duration",type:"number",description:"Animation duration"},size:{title:"Size",type:"number",description:"Recommended size between 0 & 5."},animation:{title:"Animation",type:"string",description:"Count is a simpler animation method which just increments the value,use it when you're looking for something more subtle."}},required:[]}},{name:"separator",show:!1},{name:"alarms",label:"Alarms",class:"scriptr-displaycount",commonData:!1,show:!0,defaults:{"on-format-data":"return data;",transport:"wss",data:"12",message:"Alarms","number-background-color":"#005588","message-font-size":12,"number-font-size":34,"fetch-data-interval":300,api:"app/api/dashboard/getUserAlarms","alarm-type":"number_of_stations"},box:{sizeX:1,sizeY:1,minSizeX:1,minSizeY:1},imgCls:"alarms-img",imgSrc:"//cdn.rawgit.com/scriptrdotio/onset-static-resources/17f2c092/images/alarms.svg",isAlarm:!0},{name:"connectedDevices",label:"Connected Devices",class:"scriptr-displaycount",commonData:!1,show:!0,defaults:{"on-format-data":"return data;",transport:"wss",data:"12","number-background-color":"#005588",message:"Connected Devices","message-font-size":12,"number-font-size":34,"fetch-data-interval":300,api:"app/api/dashboard/getUserAlarms","alarm-type":"successful_connections"},box:{sizeX:1,sizeY:1,minSizeX:1,minSizeY:1},imgCls:"connected-img",imgSrc:"//cdn.rawgit.com/scriptrdotio/onset-static-resources/17f2c092/images/connected-devices.svg",isAlarm:!0},{name:"connectionIssues",label:"Connection Issues",class:"scriptr-displaycount",commonData:!1,show:!0,defaults:{"on-format-data":"return data;",transport:"wss",message:"Connection Issues","number-background-color":"#005588","message-font-size":12,"number-font-size":34,data:"12","fetch-data-interval":300,api:"app/api/dashboard/getUserAlarms","alarm-type":"failed_connections"},box:{sizeX:1,sizeY:1,minSizeX:1,minSizeY:1},imgCls:"connection-img",imgSrc:"//cdn.rawgit.com/scriptrdotio/onset-static-resources/17f2c092/images/connection-issues.svg",isAlarm:!0},{name:"totalDevices",label:"Total Devices",class:"scriptr-displaycount",commonData:!1,show:!0,defaults:{"on-format-data":"return data;",transport:"wss",message:"Total Devices","message-font-size":12,"number-font-size":34,"number-background-color":"#005588",data:"12","fetch-data-interval":300,api:"app/api/dashboard/getUserAlarms","alarm-type":"total"},box:{sizeX:1,sizeY:1,minSizeX:1,minSizeY:1},imgCls:"connected-img",imgSrc:"//cdn.rawgit.com/scriptrdotio/onset-static-resources/17f2c092/images/total-devices.svg",isAlarm:!0}]}),angular.module("DashboardBuilder").component("dashboardsList",{bindings:{dashboard:"<",layout:"@"},templateUrl:"/UIComponents/dashboardBuilder/javascript/components/dashboardsList.html",controller:["$scope","$rootScope","$filter","$timeout","$sce","$window","httpClient","wsClient","$cookies","config","$uibModal","scriptrService","$route","$routeParams","$q","_",function(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p){this.wsClient=h;var q=this;q.acls,this.$onInit=function(){q.user=window.localStorage.user?JSON.parse(window.localStorage.user):null,null!=q.user&&q.user.favDashboardKey&&(q.favDashboardKey=q.user.favDashboardKey),q.loading=!0,q.showPanelMsg=!1,q.layout=void 0!==b.layout?b.layout:"grid",q.users=[{code:"anonymous",icon:"fa fa-group"}],this.urlParams=[],this.transport=angular.copy(j.transport),this.frmGlobalOptions={destroyStrategy:"remove",formDefaults:{feedback:!0}};var e=n.scriptName;e&&this.openEditor(e),this.gridOptions={columnDefs:[{headerName:"",field:"star",valueGetter:function(a){return a.data},cellRenderer:function(a){return'<a href="" ng-click="$ctrl.setFavoriteDashboard(\''+a.value.key+'\')" class="favorite-star" uib-tooltip="Star this dashboard for easy access from the menu. You can star one dashboard at a time." tooltip-placement="auto" tooltip-append-to-body="true"><i ng-class="$ctrl.favDashboardKey == \''+a.value.key+"' ? 'fas fa-star' : 'far fa-star'\" aria-hidden=\"true\"></i></a>"},width:35,cellStyle:{paddingTop:8,textAlign:"center"}},{headerName:"Name",unSortIcon:!0,icons:{sortAscending:'<i class="fas fa-sort-up" aria-hidden="true"></i>',sortDescending:'<i class="fas fa-sort-down" aria-hidden="true"></i>',sortUnSort:'<span class="unsort-state"><i class="fas fa-angle-up" aria-hidden="true"></i><i class="fas fa-angle-down" aria-hidden="true"></i></span>'},field:"dashboardName",comparator:function(a,b,c,d){return a.dashboardName.localeCompare(b.dashboardName)},cellStyle:{paddingTop:6},valueGetter:function(a){return a.data},cellRenderer:function(a){
return'<span class="img-thumb"><div class="table-display"><div class="cell-display">'+(a.value.viewFile?'<img class="img-responsive grid-img" src="'+a.value.viewFile+'" />':'<img class="img-responsive" src="//cdn.rawgit.com/scriptrdotio/onset-static-resources/a923190a/images/default-icon.svg" />')+'</div></div></span><span class="grid-name"><a href="#/dockey/'+a.value.key+'">'+a.value.dashboardName+"</a></span>"}},{headerName:"Modified",field:"lastModifiedDate",cellRenderer:function(a){return c("date")(a.value,"MMMM dd, yyyy HH:mm")},unSortIcon:!0,icons:{sortAscending:'<i class="fas fa-sort-up" aria-hidden="true"></i>',sortDescending:'<i class="fas fa-sort-down" aria-hidden="true"></i>',sortUnSort:'<span class="unsort-state"><i class="fas fa-angle-up" aria-hidden="true"></i><i class="fas fa-angle-down" aria-hidden="true"></i></span>'},cellStyle:{paddingTop:6}},{headerName:"",field:"public",cellRenderer:function(a){return'<span ng-show="false" class="badge badge-warning mt5"><i class="fa fa-eye" aria-hidden="true"></i> Public</span>'},cellStyle:{textAlign:"right",paddingTop:2}},{headerName:"",field:"key",cellRenderer:function(a){return'<a title="Configure this dashboard" ng-href="#/dockey/'+a.value+'/edit"><img class="icon-img" src="//cdn.rawgit.com/scriptrdotio/onset-static-resources/2a8afcdb/images/blue-wrench.svg" /></a>'},width:50,cellStyle:{textAlign:"center",paddingTop:5}},{headerName:"",field:"dashboard",valueGetter:function(a){return a.data},cellRenderer:function(a){return'<a title="Remove this dashboard" ng-click="$ctrl.deleteDashboardConfirmation(\''+a.value.dashboard+"', '"+a.value.dashboardName+"', '"+a.value.key+'\')"><img class="icon-img pointer" src="//cdn.rawgit.com/scriptrdotio/onset-static-resources/2a8afcdb/images/blue-bin.svg" /></a>'},width:30,cellStyle:{textAlign:"center",paddingTop:4}}],rowData:null,rowHeight:34,headerHeight:37,angularCompileRows:!0,enableSorting:!0,animateRows:!0,domLayout:"autoHeight",pagination:!0,paginationPageSize:10,onGridSizeChanged:function(a){if(f.innerWidth<=768){var b=["star","dashboardName","dashboard","key"],c=["lastModifiedDate","public"];q.gridOptions.columnApi.setColumnsVisible(b,!0),q.gridOptions.columnApi.setColumnsVisible(c,!1)}else q.gridOptions.columnApi.setColumnsVisible(["star","dashboardName","dashboard","key","lastModifiedDate","public"],!0);d(q.gridOptions.api.sizeColumnsToFit(),1e3)}},a.$watch(function(a){return a.query},function(a){var b=[];if(void 0!==a&&null!=a&&""!=a)for(var c=0;c<q.customDashboards.length;c++)-1!=q.customDashboards[c].dashboardName.toLowerCase().indexOf(a.toLowerCase())&&b.push(q.customDashboards[c]);else q.customDashboards&&(b=q.customDashboards);q.customDashboards&&(0==b.length?q.noDashboards=!0:(q.noDashboards=!1,q.gridOptions.api.setRowData(b),q.setGridPaginationIcons()))})},this.setGridPaginationIcons=function(){$("button[ref=btPrevious]").html('<img src="//cdn.rawgit.com/scriptrdotio/onset-static-resources/6309fad6/images/previous.png" />'),$("button[ref=btFirst]").html('<img src="//cdn.rawgit.com/scriptrdotio/onset-static-resources/6309fad6/images/first.png" />'),$("button[ref=btNext]").html('<img src="//cdn.rawgit.com/scriptrdotio/onset-static-resources/6309fad6/images/next.png" />'),$("button[ref=btLast]").html('<img src="//cdn.rawgit.com/scriptrdotio/onset-static-resources/6309fad6/images/last.png" />')},this.$postLink=function(){l.loadDashboards({}).then(function(a,b){a?(q.customDashboards=a,q.gridOptions.api.setRowData(a),q.setGridPaginationIcons(),q.loading=!1,0==a.length&&(q.noDashboards=!0)):(console.log("No Dashboards Found"),q.loading=!1)},function(a){q.loading=!1,console.log("reject published promise",a)})},this.deleteDashboardConfirmation=function(a,b,c){k.open({controller:"PopupCont",templateUrl:"/UIComponents/dashboardBuilder/javascript/components/deletePopup.html",backdrop:"static",resolve:{dashboard:function(){return q},path:function(){return a},name:function(){return b},key:function(){return c}}})},this.checkCreateDashboardEligibility=function(b){if(this.customDashboards&&10==this.customDashboards.length){b.preventDefault();k.open({animation:!0,component:"confirmationModal",backdrop:"static",size:"md",scope:a,resolve:{data:function(){return{title:"Information Message",body:"You can save a maximum of 10 dashboards.",btnCancelTitle:"Ok"}}}})}},this.callMenuAPI=function(){l.callMenuAPI().then(function(a,b){},function(a){})},this.setFavoriteDashboard=function(a){var b=!1;q.favDashboardKey&&a==q.favDashboardKey&&(b=!0);var c={dockey:b?null:a};l.setFavoriteDashboard(c).then(function(a,c){a&&a.status&&"success"==a.status?(q.favDashboardKey=a.favDashboardKey,null!=q.user&&(b?delete q.user.favDashboardKey:q.user.favDashboardKey=q.favDashboardKey,window.localStorage.setItem("user",JSON.stringify(q.user))),q.callMenuAPI()):console.log("failure fav")},function(a){q.showMsg("danger","An error has occured"),console.log("reject published promise",a)})},this.deleteDashboard=function(a,b){q.user=window.localStorage.user?JSON.parse(window.localStorage.user):null,null!=q.user&&q.user.favDashboardKey&&(q.favDashboardKey=q.user.favDashboardKey);var c={path:a,removeFavDashboard:!(!q.favDashboardKey||!b||b!=q.favDashboardKey)};q=this,l.deleteDashboard(c).then(function(a,c){if(a&&a.status&&"success"==a.status){if(q.customDashboards=a.documents,q.gridOptions.api.setRowData(a.documents),q.setGridPaginationIcons(),0==a.documents.length?q.noDashboards=!0:q.noDashboards=!1,q.favDashboardKey&&b&&b==q.favDashboardKey){var d=JSON.parse(window.localStorage.user);delete d.favDashboardKey,window.localStorage.setItem("user",JSON.stringify(d)),q.callMenuAPI()}}else a&&a.errorDetail?q.showMsg("danger",a.errorDetail):q.showMsg("danger","An error occurred while deleting the dashboard. Please try again later")},function(a){q.showMsg("danger","An error has occured"),console.log("reject published promise",a)})},this.renameDashboard=function(a,b){var c=o.defer();if(console.log(a,b),a!=b){var d={scriptName:a,newScriptName:b},e=this;return console.log(d),l.renameDashboard(d).then(function(a,b){a&&a.documents?(e.customDashboards=a.documents,0==a.documents.length?e.noDashboards=!0:e.noDashboards=!1,c.resolve(),e.showMsg("success","The dashboard has been renamed successfully.")):(c.reject(),a&&a.errorDetail?e.showMsg("danger",a.errorDetail):e.showMsg("danger","An error has occured"))},function(a){c.reject(),e.showMsg("danger",a.data.response.metadata.errorDetail),console.log("reject published promise",a)}),c.promise}},this.changeLayout=function(a){this.layout=a,b.layout=this.layout},this.closeAlert=function(){this.show=!1},this.showAlert=function(a,b){this.closeAlert(),this.message={type:a,content:b},this.show=!0},this.closeMsg=function(){this.showPanelMsg=!1},this.showMsg=function(a,b){this.closeMsg(),this.message={type:a,content:b},this.showPanelMsg=!0},this.openEditor=function(a){this.model={scriptName:a};var b=this;l.getScript(this.model).then(function(c,d){b.postLoadScript(a,c)},function(a){console.error("reject",a)})}}]}),angular.module("DashboardBuilder").controller("PopupCont",["$scope","$uibModalInstance",function(a,b){a.name=a.$resolve.name,a.close=function(){b.dismiss("cancel")},a.ondeleteDashboard=function(){this.$resolve.dashboard.deleteDashboard(this.$resolve.path,this.$resolve.key),b.dismiss("cancel")}}]),angular.module("DashboardBuilder").service("scriptrService",["httpClient","$cookies",function(a,b){this.callMenuAPI=function(){return a.post("app/api/dashboard/getMenuInfo")},this.saveScript=function(b,c){return a.post("app/api/dashboard/save",b,null,!0)},this.getScript=function(b){return a.post("app/api/dashboard/getDashboardFile",b)},this.getDashboardDocument=function(b){return a.get("app/api/dashboard/get",b)},this.loadDashboards=function(b){return a.get("app/api/dashboard/list",{})},this.deleteDashboard=function(b){return a.get("app/api/dashboard/delete",b)},this.setFavoriteDashboard=function(b){return a.get("app/api/dashboard/favorite",b)},this.renameDashboard=function(b){return a.get("UIComponents/dashboardBuilder/backend/api/renameDashboard",b)},this.getToken=function(){return b.get("token")||null}}]),angular.module("DashboardBuilder").component("dashboard",{bindings:{widgets:"<",dashboard:"<",treeSearchCriteria:"@",iconExpand:"@",iconCollapse:"@",loadTree:"<?",showTree:"<",devicesModel:"@"},templateUrl:"/UIComponents/dashboardBuilder/javascript/components/dashboard.html",controller:["$scope","$rootScope","$timeout","$sce","$window","httpClient","wsClient","$cookies","common","alarmsConfig","config","$uibModal","scriptrService","$route","$routeParams","$q","_","$filter","$element",function(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s){this.wsClient=g;var t=this;t.acls,this.$onInit=function(){var c=new UAParser,d=c.getResult(),e=d.device&&"tablet"===d.device.type;t.tablet=!1,(e||window.matchMedia(b.tabletBreakPoint).matches)&&(t.tablet=!0),t.showTree=void 0===this.showTree||this.showTree,t.loading=!0,t.showPanelMsg=!1,t.isEdit=!1,t.users=[{code:"anonymous",icon:"fa fa-group"}],t.onACLChange=function(a){t.acls=a.join(";");var b=p.defer();return t.saveScript(null,null,!0).then(function(a,c){console.log("success"),b.resolve(a,c)},function(a){console.log("reject",a),b.reject(a)}),b.promise},this.urlParams=[],this.transport=angular.copy(k.transport),this.frmGlobalOptions={destroyStrategy:"remove",formDefaults:{feedback:!1},validationMessage:{302:"Required field."}},this.initializeDashboard();var f="si",g=window.localStorage.user?JSON.parse(window.localStorage.user):null;if(g&&null!=g.preferredUnit&&""!=g.preferredUnit&&(f="SI (Metric)"==g.preferredUnit?"si":"us"),this.schema=angular.copy(k.script.schema),this.form=angular.copy(k.script.form),this.model={period:"past_day",unit:f},this.metric_schema=angular.copy(k.metricselector.schema),this.metric_form=angular.copy(k.metricselector.form),this.metric_model={},this.isInIde=!!o.scriptrIdeRef,a.$root&&a.$root.isNew?(this.isEdit=!0,this.isNew=a.$root.isNew):(this.isEdit=!!o.edit,this.isNew=!1),this.isNew)this.setDefaultDashboardName(),b.currentDashboardUnit=f;else{var h=o.dockey;this.getDashboard(h)}this.slickConfig={enabled:!0,autoplay:!0,draggable:!1,autoplaySpeed:3e3,method:{},event:{beforeChange:function(a,b,c,d){},afterChange:function(a,b,c,d){}}},this.gridsterOptions={defaultSizeY:200,defaultSizeX:200,minRows:1,maxRows:100,floating:!0,columns:(t.tablet,5),colWidth:"auto",rowHeight:"83",margins:[10,10],defaultSizeX:1,defaultSizeY:2,mobileBreakPoint:480,minColumns:1,sparse:!1,resizable:{enabled:t.isEdit,handle:".my-class",start:function(a,b,c){setTimeout(function(){$(window).trigger("resize"),window.dispatchEvent(new Event("resize"))},100)},resize:function(a,b,c){setTimeout(function(){$(window).trigger("resize"),window.dispatchEvent(new Event("resize"))},100)},stop:function(a,b,c){console.log("End resize:",a,b,c),setTimeout(function(){$(window).trigger("resize"),window.dispatchEvent(new Event("resize"))},100),t.notifyDashboardChange()}},draggable:{enabled:t.isEdit,handle:".drag-box",start:function(a,b,c){setTimeout(function(){$(window).trigger("resize"),window.dispatchEvent(new Event("resize"))},100)},drag:function(a,b,c){setTimeout(function(){$(window).trigger("resize"),window.dispatchEvent(new Event("resize"))},100)},stop:function(a,b,c){setTimeout(function(){$(window).trigger("resize"),window.dispatchEvent(new Event("resize"))},100),t.notifyDashboardChange()}}},a.$watch("self.dashboard.widgets",function(a){},!0),a.$on("gridster-resized",function(a,b,c){setTimeout(function(){$(window).trigger("resize"),window.dispatchEvent(new Event("resize"))},100)}),a.$on("gridster-item-initialized",function(a){setTimeout(function(){$(window).trigger("resize"),window.dispatchEvent(new Event("resize"))},100)}),this.widgetsConfig=k.widgets,this.widgetsCommon=i,this.dataLoaded=!0,$(document).ready(function(){$("#stickDiv").sticky({topSpacing:0})})},this.$postLink=function(){var a=this;this.scriptrIdeRef=o.scriptrIdeRef,angular.element(e).on("message",function(b){var c=b.originalEvent.data;c[0]=="get_editor_save_data-"+a.scriptrIdeRef&&e.parent&&e.parent.postMessage(["editor_save-"+a.scriptrIdeRef,a.getEditorValue()],"*"),c[0]=="set_editor_load_data-"+a.scriptrIdeRef&&a.setEditorValue(JSON.parse(c[1]))}),e.parent&&e.parent.postMessage(["editor_loaded-"+this.scriptrIdeRef],"*")},this.trustSrc=function(a){return d.trustAsResourceUrl(a)},this.setDefaultDashboardName=function(){this.model.dashboardName="Dashboard "+r("date")(new Date,"MM-dd-yyyy")},this.addCustomDashboard=function(){this.showDashboard=!0,t.savedScript=null,this.switchStatus=!0,this.model.scriptName=null,this.model.dashboardName=null,t.isEdit=!1,this.dashboard.widgets=[]},this.showCustomDashboard=function(a){this.showDashboard=!0,this.scriptName=a,this.switchStatus=!1,this.dashboardScriptName="/"+this.scriptName,this.openEditor(a)},this.enableEditDashboard=function(){this.closeAlert(),this.isEdit=!0,this.gridsterOptions.draggable.enabled=this.isEdit,this.gridsterOptions.resizable.enabled=this.isEdit,a.setUnitInLocalStorage(t.model.unit)},this.disableEditMode=function(){this.isNew?window.location.href="#/dashboardsList":(this.dashboard.widgets=angular.copy(this.dashboard.originalWidgets),this.dashboard.counter=angular.copy(this.dashboard.originalCounter),this.model=angular.copy(this.originalModel),this.isEdit=!1,this.gridsterOptions.draggable.enabled=this.isEdit,this.gridsterOptions.resizable.enabled=this.isEdit)},this.deleteDashboardConfirmation=function(){var a=this.model.dashboardName;l.open({controller:"PopupCont",templateUrl:"/UIComponents/dashboardBuilder/javascript/components/deletePopup.html",backdrop:"static",resolve:{dashboard:function(){return t},name:function(){return a}}})},this.callMenuAPI=function(){m.callMenuAPI().then(function(a,b){},function(a){})},this.deleteDashboard=function(){t.user=window.localStorage.user?JSON.parse(window.localStorage.user):null,null!=t.user&&t.user.favDashboardKey&&(t.favDashboardKey=t.user.favDashboardKey);var a={path:this.model.scriptName,removeFavDashboard:!(!t.favDashboardKey||!t.dashboardDocument||t.dashboardDocument.key!=t.favDashboardKey)};m.deleteDashboard(a).then(function(a,b){if(console.log("success"),a&&a.status&&"success"==a.status&&(window.location.href="#/dashboardsList",t.favDashboardKey&&t.dashboardDocument&&t.dashboardDocument.key==t.favDashboardKey)){var c=JSON.parse(window.localStorage.user);delete c.favDashboardKey,window.localStorage.setItem("user",JSON.stringify(c)),t.callMenuAPI()}},function(a){console.log("reject published promise",a)})},b.fetchFromDate=(new Date).getTime()-864e5,b.fetchToDate=(new Date).getTime(),a.setFetchFromDate=function(a,c){b.period=a,"past_day"==a&&(b.fetchFromDate=(new Date).getTime()-864e5),"past_week"==a&&(b.fetchFromDate=(new Date).getTime()-6048e5),"past_month"==a&&(b.fetchFromDate=(new Date).getTime()-2592e6),console.log("--------\x3e$rootScope.fetchFromDate---------\x3e",b.fetchFromDate)},a.setUnitInLocalStorage=function(c,d){b.currentDashboardUnit=c,a.$broadcast("unit_change"),console.log("--------\x3e$rootScope.setUnitInLocalStorage---------\x3e",b.currentDashboardUnit)},this.closeAlert=function(){this.show=!1},this.showAlert=function(a,b){this.closeAlert(),this.message={type:a,content:b},this.show=!0},this.closeMsg=function(){this.showPanelMsg=!1},this.showMsg=function(a,b){this.closeMsg(),this.message={type:a,content:b},this.showPanelMsg=!0},this.getEditorValue=function(){var a={};a.items=angular.copy(this.dashboard.widgets),a.urlParams=angular.copy(this.urlParams),a.transport=angular.copy(this.transport.defaults),a.staticdomain=o.staticdomain;var b=this.unsafe_tags(document.querySelector("#handlebar-template").innerHTML),c=Handlebars.compile(b)(a),d={};return d.content=c,d.pluginData=JSON.stringify({wdg:a.items,urlParams:a.urlParams,settings:a.transport}),d},this.setEditorValue=function(a){a&&(this.widgets=a.wdg,this.urlParams=a.urlParams,this.transport.defaults=a.settings,this.dashboard.widgets=this.widgets)},this.notifyDashboardChange=function(){e.parent&&e.parent.postMessage(["editor_data_changed-"+this.scriptrIdeRef,this.getEditorValue()],"*")},this.openEditor=function(a){this.showLoading(),a&&(this.model?this.model.scriptName=a:this.model={scriptName:a});var b=this;m.getScript(this.model).then(function(a,c){b.postLoadScript(a),b.hideLoadingModalInstance()},function(a){console.error("reject",a),b.hideLoadingModalInstance()})},this.initializeDashboard=function(){this.dashboard={widgets:[],counter:0},this.widgets&&(this.dashboard.widgets=this.widgets),this.dashboard.counter=this.dashboard.widgets.length},this.clear=function(){var b=this;l.open({animation:!0,component:"confirmationModal",backdrop:"static",size:"md",scope:a,resolve:{data:function(){return{title:"Clear this dashboard?",body:"Are you sure you want to remove all the widgets?",btnCancelTitle:"Cancel",btnSubmitTitle:"Clear dashboard"}}}}).result.then(function(a){a&&b.clearWidgets()},function(){console.info("modal-component for clearing dashboard update dismissed at: "+new Date)})},this.clearWidgets=function(){this.dashboard.counter=0,this.dashboard.widgets=[],this.notifyDashboardChange()},this.logout=function(){$.scriptr.authorization({loginPage:login.loginTarget}).logout()};var u=function(a,b){var c={};for(var d in a)c[d]=a[d];for(var d in b)c[d]=b[d];return c};this.addWidget=function(a){if("string"==typeof a&&(a=JSON.parse(a)),a.url)return void window.open(a.url);if(this.dashboard.counter>=20)this.showInformationModel();else{a.defaults["default-metric-value"]||(a.defaults["default-metric-value"]=b.currentDashboardUnit);var c=angular.copy(a.form),d=angular.copy(a.schema),e=q.findWhere(t.widgetsConfig,{name:a.name}),c=angular.copy(e.form),d=angular.copy(e.schema);if(e.commonData&&(c[0].tabs=angular.copy([i.formTab].concat(e.form[0].tabs)),c[0].selectedTabIndex=1,d.properties=u(e.schema.properties,i.schemaFields)),a.isAlarm&&(c=angular.copy(j.form),c[0].selectedTabIndex=0,d=angular.copy(j.schema)),a.selectedStreamValue&&a.selectedStreamFieldName){var f=[a.selectedStreamValue];a.defaults[a.selectedStreamFieldName]=f,a.defaults["available-units"]={si:a.selectedStreamUnits.si,us:a.selectedStreamUnits.us},a.defaults.boxLabel=a.selectedStreamLabel,a.defaults["colors-mapping"]=[{ykeys:a.selectedStreamLabel,labels:a.selectedStreamLabel,colors:"#CC5464",axisSelection:"y"}],a.defaults.data=[],a.defaults["fetch-from-date-value"]=b.fetchFromDate,a.defaults["fetch-to-date-value"]=b.fetchToDate,a.defaults.api="app/api/dashboard/GetUserData",a.defaults["api-params"]=JSON.stringify({dataType:a.defaults["data-type"],streams:a.defaults[a.selectedStreamFieldName],dataFormat:a.defaults["data-format"],aggregationRange:a.defaults["aggregation-range"],display_metric:b.currentDashboardUnit})}var g=(t.tablet,0);a.selectedStreamValue=null,this.dashboard.widgets.push({name:a.name,sizeX:a.box&&a.box.sizeX?a.box.sizeX<3?a.box.sizeX+g:a.box.sizeX:2,sizeY:a.box&&a.box.sizeY?a.box.sizeY:2,minSizeX:a.box&&a.box.minSizeX?a.box.minSizeX<3?a.box.minSizeX+0:a.box.minSizeX:2,maxSizeX:a.box&&a.box.maxSizeX?a.box.maxSizeX+g:null,minSizeY:a.box&&a.box.minSizeY?a.box.minSizeY:2,maxSizeY:a.box&&a.box.maxSizeY?a.box.maxSizeY+g:null,label:a.label,type:a.class,options:a.defaults,schema:d,form:c}),this.notifyDashboardChange()}},this.showInformationModel=function(){l.open({animation:!0,component:"confirmationModal",backdrop:"static",size:"md",scope:a,resolve:{data:function(){return{title:"Information Message",body:"You can add a maximum of 20 widgets.",btnCancelTitle:"Ok"}}}})},this.setTransportSettings=function(a){var b=this;l.open({animation:!0,component:"modalComponent",backdrop:"static",size:"lg",resolve:{widget:function(){return{label:b.transport.label,options:b.transport.defaults,schema:b.transport.schema,form:b.transport.form}}}}).result.then(function(a){console.log("modal-component transport settings data :",a,"submitted at: "+new Date),"cancel"!=a&&(b.transport.defaults&&b.transport.defaults.publishChannel!=a.publishChannel&&b.wsClient.updatePublishingChannel(a.publishChannel),b.transport.defaults&&b.transport.defaults.subscribeChannel!=a.subscribeChannel&&b.wsClient.updateSubscriptionChannel(a.subscribeChannel),b.transport.defaults=angular.copy(a),b.notifyDashboardChange())},function(){console.log("modal-component transport settings dismissed at: "+new Date)})},this.getDashboard=function(a){var c={dockey:a};m.getDashboardDocument(c).then(function(a,c){console.log("resolve",a),a.documents&&a.documents.length>0&&(t.dashboardDocument=angular.copy(a.documents[0]),t.model.scriptName=t.dashboardDocument.dashboard,t.model.dashboardName=t.dashboardDocument.dashboardName,t.model.unit=t.dashboardDocument.unit,t.model.period=t.dashboardDocument.period,t.model.image=t.dashboardDocument.viewFile,b.currentDashboardUnit=t.dashboardDocument.unit,t.originalModel=angular.copy(t.model),t.metric_model&&(t.metric_model.unit=t.model.unit,t.metric_model.period=t.model.period)),t.model.scriptName?t.openEditor():t.setDefaultDashboardName()},function(a){t.showAlert("danger",a.data.response.metadata.errorDetail),console.log("reject",a.data.response.metadata.errorDetail)})},this.showLoading=function(){this.loadingModalInstance=l.open({controller:"LoadingCtrl",windowTemplateUrl:"/UIComponents/dashboardBuilder/javascript/components/loading.html",templateUrl:"/UIComponents/dashboardBuilder/javascript/components/loading.html",backdrop:"static",resolve:{loadingTitle:function(){return"Saving..."}}})},this.hideLoadingModalInstance=function(){this.loadingModalInstance.dismiss()},this.saveDashboard=function(b,c,d){var e=this;if(a.$broadcast("schemaFormValidate"),b&&b.$valid||d){if(!(this.dashboard.widgets.length>20)){this.showLoading();var f={};f.items=angular.copy(this.dashboard.widgets),f.urlParams=angular.copy(this.urlParams),f.token=m.getToken(),f.transport=angular.copy(this.transport.defaults);var g=this.unsafe_tags(document.querySelector("#handlebar-template").innerHTML),h=Handlebars.compile(g)(f),i={};i.content=h,i.dashboardName=this.model.dashboardName,i.unit=this.model.unit,i.period=this.model.period,b.uploadForm.file.$dirty&&(i.apsdb_attachments=b.uploadForm.file.$modelValue),e.dashboardDocument&&e.model.image!=e.dashboardDocument.viewFile&&(i.apsdb_attachments=null),i.pluginData=JSON.stringify({wdg:f.items,urlParams:f.urlParams,settings:f.transport,builtWithTablet:e.tablet}),e.isEdit&&!e.isNew&&(i.update=!0),e.savedScript&&(i.previousScriptName=e.savedScript),i.acls=this.acls;var j=new FormData;for(var k in i)j.append(k,i[k]);var l=p.defer();return m.saveScript(j).then(function(a,b){"failure"==a.status?(e.isEdit=!0,e.showAlert("danger",a.errorDetail),e.hideLoadingModalInstance()):(a.data&&a.data.document&&a.data.document.key&&e.getDashboard(a.data.document.key),e.hideLoadingModalInstance(),e.isEdit=!1,e.isNew=!1,e.gridsterOptions.draggable.enabled=e.isEdit,e.gridsterOptions.resizable.enabled=e.isEdit,e.savedScript=a.scriptName,e.showAlert("info","Dashboard successfully saved."),l.resolve(a,b))},function(a){e.hideLoadingModalInstance(),e.showAlert("danger",a.data.response.metadata.errorDetail),console.log("reject",a.data.response.metadata.errorDetail),l.reject(a)}),l.promise}e.showAlert("danger","You can add a maximum of 20 widgets.")}},this.setACLs=function(a){this.acls=a.ACL.execute;var b=this.acls.split(";");this.users=[];for(var c=0;c<b.length;c++){var d={};d.code=b[c],this.users.push(d)}},this.postLoadScript=function(a){var b=/\/\*#\*SCRIPTR_PLUGIN\*#\*(.*\n?.*)\*#\*#\*\//;if(a){var c=a.userConfig,d=c.match(b);if(c&&d){var e=JSON.parse(d[1]);if(e&&e.metadata&&"DashboardBuilder"==e.metadata.name){var f=JSON.parse(e.metadata.plugindata);this.widgets=[];var g=f.wdg;q.map(g,function(a,b){var c=q.findWhere(t.widgetsConfig,{name:a.name}),d=angular.copy(c.form),e=angular.copy(c.schema);c.commonData&&(d[0].tabs=angular.copy([i.formTab].concat(c.form[0].tabs)),d[0].selectedTabIndex=1,e.properties=u(c.schema.properties,i.schemaFields)),c.isAlarm&&(d=angular.copy(j.form),d[0].selectedTabIndex=0,e=angular.copy(j.schema)),a.form=angular.copy(d),a.schema=angular.copy(e),t.widgets.push(a)}),this.urlParams=JSON.parse(e.metadata.plugindata).urlParams,this.transport.defaults=JSON.parse(e.metadata.plugindata).settings,this.dashboard.widgets=this.widgets,this.dashboard.originalWidgets=angular.copy(this.dashboard.widgets),this.dashboard.counter=this.widgets.length,this.dashboard.originalCounter=this.dashboard.counter,this.savedScript=this.model.scriptName,this.setACLs(a)}else this.showAlert("danger","Invalid dashboard script. Pass another script."),console.error("Invalid dashboard script. Pass another script.")}else this.showAlert("danger","Invalid dashboard script. Pass another script."),console.error("Invalid dashboard script. Pass another script.")}else this.showAlert("danger","Invalid dashboard script. Pass another script."),console.error("Invalid dashboard script. Pass another script.");console.debug("resolve get script "+this.model.scriptName+" :",a)},this.safe_tags=function(a){return a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")},this.unsafe_tags=function(a){return a.replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&quot;/g,'"')}}]}),angular.module("DashboardBuilder").component("box",{require:{parent:"^^dashboard"},bindings:{widget:"<",isEdit:"<?"},templateUrl:"/UIComponents/dashboardBuilder/javascript/components/box.html",controller:["$rootScope","$scope","$compile","$element","$uibModal",function(a,b,c,d,e){var f=this;this.remove=function(a){var c=this;e.open({animation:!0,component:"confirmationModal",backdrop:"static",size:"md",scope:b,resolve:{data:function(){return{title:"Delete this widget?",body:'Are you sure you want to delete this widget "'+a.label+'"?',btnCancelTitle:"Cancel",btnSubmitTitle:"Delete"}}}}).result.then(function(b){b&&c.removeWidget(a)},function(){console.info("modal-component for removing widget dismissed at: "+new Date)})},this.removeWidget=function(a){delete this[a.formatFunction],this.parent.dashboard.widgets.splice(this.parent.dashboard.widgets.indexOf(a),1),this.parent.dashboard.counter--,this.parent.notifyDashboardChange()},this.$postLink=function(){setTimeout(function(){var a=document.getElementsByClassName("gridster-item");if(a&&a.length>0){a[a.length-1]}},200)},this.$onInit=function(){a.mobileBreakPoint="(max-width: 480px)",a.tabletBreakPoint="(max-width: 991px)",b.$on("gridster-mobile-changed",function(b,c){c.isMobile&&(a.mobileBreakPoint="(max-width:"+$(window).innerWidth()+"px)")}),b.$on("unit_change",function(a){if(c.widget.options["api-params"]){var b;"us"==JSON.parse(c.widget.options["api-params"]).display_metric?(b=JSON.parse(c.widget.options["api-params"]),b.display_metric="si"):(b=JSON.parse(c.widget.options["api-params"]),b.display_metric="us"),c.widget.options["api-params"]=JSON.stringify(b)}c.updateWidget(c.widget.options)}),b.$on("gridster-item-transition-end",function(a){setTimeout(function(){$(window).trigger("resize"),window.dispatchEvent(new Event("resize"))},100)}),b.$on("gridster-item-resized",function(a){setTimeout(function(){$(window).trigger("resize"),window.dispatchEvent(new Event("resize"))},100)});var c=this;this.widget&&this.addWidget(this.widget),b.$on("resize_widget",function(a,b){if(setTimeout(function(){$(window).trigger("resize"),window.dispatchEvent(new Event("resize"))},100),c.widget==b.element&&"scriptr-grid"==c.widget.type){var d=b.wdg.height();b.element.options["grid-height"]=d-110,c.updateWidget(b.element.options)}f.parent.notifyDashboardChange()}),b.$on("drag_widget",function(a,b){f.parent.notifyDashboardChange()})},this.openSettings=function(){var a=this;e.open({animation:!0,component:"modalComponent",backdrop:"static",size:"lg",scope:b,resolve:{widget:function(){return a.widget}}}).result.then(function(b){"cancel"!=b&&a.updateWidget(b)},function(){console.info("modal-component for widget update dismissed at: "+new Date)})},this.addWidget=function(e){var f=this;this.chart=angular.element(document.createElement(e.type)),angular.forEach(e.options,function(b,c){if(angular.isArray(b)||angular.isObject(b))f.chart.attr(c,JSON.stringify(b));else if("on-format-data"==c){this.parent.dashboard.counter||(this.parent.dashboard.counter=0);var d=!1;e.formatFunction&&(d=!0),d||(this.parent.dashboard.counter+=1);var g=this.parent.dashboard.counter,h=e.name+"FormatData"+g;f[h]=new Function("data",b),e.formatFunction=h,e.formatFunctionValue=b,f.chart.attr("on-format-data","$ctrl."+h)}else if("fetch-from-date-value"==c)f.chart.attr("fetch-from-date-value",a.fetchFromDate);else if("fetch-to-date-value"==c)f.chart.attr("fetch-to-date-value",a.fetchToDate);else if("display-metric-value"==c)f.chart.attr("display-metric-value",a.currentDashboardUnit);else if("api-params"==c){var i=JSON.parse(b);i.display_metric&&(i.display_metric=a.currentDashboardUnit,f.chart.attr("api-params",JSON.stringify(i)))}else f.chart.attr(c,b)},this);var g=c(this.chart)(b);angular.element(d.find(".box-content")).append(g)},this.updateWidget=function(a){var b=this;angular.forEach(a,function(a,c){angular.isArray(a)||angular.isObject(a)?b.chart.attr(c,JSON.stringify(a)):"on-format-data"==c?(b[b.widget.formatFunction]=new Function("data",a),b[b.widget.formatFunctionValue]=a,b.chart.attr("on-format-data","$ctrl."+b.widget.formatFunction)):b.chart.attr(c,a)},this);var c=angular.copy(a),d=this.parent.dashboard.widgets.indexOf(this.widget),e=angular.copy(this.widget);e.options=angular.copy(c),this.parent.dashboard.widgets.splice(d,1,e),this.parent.notifyDashboardChange()}}]}),angular.module("DashboardBuilder").component("modalComponent",{bindings:{resolve:"<",close:"&",dismiss:"&"},templateUrl:"/UIComponents/dashboardBuilder/javascript/components/myModalContent.html",controller:["$rootScope","$scope","httpClient","$q","$http",function(a,b,c,d,e){this.$onInit=function(){this.widget=this.resolve.widget,b.$broadcast("schemaFormRedraw"),this.frmGlobalOptions={destroyStrategy:"remove",formDefaults:{feedback:!1}},this.widget&&(this.widget.schema&&(this.schema=angular.copy(this.widget.schema)),this.widget.form&&(this.form=angular.copy(this.widget.form)),this.widget.options["display-metric-value"]=a.currentDashboardUnit,this.model=this.widget.options?angular.copy(this.widget.options):{})},b.multiSelectCallBack=function(a,b){var c=a.widgetName,d=a.widgetField,e=window.localStorage.getItem("dataStream"),f=window.localStorage.getItem("dataMapping"),g=[];f&&e&&(f=JSON.parse(f),e=JSON.parse(e));for(var h=0;h<e.length;h++)for(var i=e[h].label,j=e[h].sensors,k=0;k<j.length;k++){var l=j[k].measurement_type;if(f[l]){var m=f[l].allowed;if(m.indexOf(c)>-1&&(!d||l==d)){var n=j[k].selectedStreamValue;g.push({value:n,name:j[k].label,dataStream:i,availableUnits:{si:j[k].si_unit,us:j[k].us_unit}})}}}return g},this.onSubmit=function(c){b.$broadcast("schemaFormValidate"),console.log(this.model),c.$valid&&(this.model.stream&&this.model.stream.length>0?(this.model["fetch-from-date-value"]=a.fetchFromDate,this.model["fetch-to-date-value"]=a.fetchToDate,this.model["default-metric-value"]=a.currentDashboardUnit,this.model["api-params"]=JSON.stringify({dataType:this.model["data-type"],streams:this.model.stream,dataFormat:this.model["data-format"],aggregationRange:this.model["aggregation-range"],display_metric:a.currentDashboardUnit})):this.schema.properties.stream&&delete this.model.api,this.close({$value:this.model}),console.log("component_form_parent",this.model))},this.onCancel=function(a){this.schema={},this.form={},this.model=angular.copy(this.widget.options),this.dismiss({$value:"cancel"}),console.log("Dissmissed")}}]}),angular.module("DashboardBuilder").component("sidetoolbar",{bindings:{},templateUrl:"/UIComponents/dashboardBuilder/javascript/components/sideToolbar.html",controller:["$scope","$mdSidenav",function(a,b){this.close=function(){b("left").close().then(function(){console.debug("close LEFT is done")})}}]}),angular.module("DashboardBuilder").component("confirmationModal",{
